...
import Drasil.GOOL (GSProgram, SVariable, Value, OOProg, MS, VS, ProgramSym(..),
...
observerType :: (OOTypeSym r typ) => VS (r typ)
...
-- | New Observer object.
newObserver :: (OOTypeSym r typ, OOValueExpression r typ) => VS (r Value)
