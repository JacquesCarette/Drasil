...
stakehldrGeneral :: (NamedIdea a) => a -> Sentence -> Section
...
tClientF :: (NamedIdea a) => a -> Sentence ->  Section
...
tCustomerF :: (NamedIdea a) => a -> Section
tCustomerF kWord = SRS.theCustomer [customerIntro kWord] []

customerIntro :: (NamedIdea a) => a -> Contents
