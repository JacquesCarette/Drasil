...
\\
${\symbf{v}_{j}}$ & Velocity of the J-Th Body's Velocity & $\frac{\text{m}}{\text{s}}$
\\
${\symbf{v}_{\text{O}}}$ & Velocity at Point Origin & $\frac{\text{m}}{\text{s}}$
\\
$\text{||}\symbf{d}\text{||}$ & Euclidean norm of the distance between the center of mass of two bodies & ${\text{m}}$
\\
$\text{||}\symbf{n}\text{||}$ & Length of the normal vector & ${\text{m}}$
\\
$\text{||}{\symbf{u}_{\text{A}\text{P}}}\text{*}\symbf{n}\text{||}$ & Length of the Perpendicular Vector to the Contact Displacement Vector of Rigid Body A & ${\text{m}}$
\\
$\text{||}{\symbf{u}_{\text{B}\text{P}}}\text{*}\symbf{n}\text{||}$ & Length of the Perpendicular Vector to the Contact Displacement Vector of Rigid Body B & ${\text{m}}$
\\
${\text{||}\symbf{d}\text{||}^{2}}$ & Squared distance & ${\text{m}^{2}}$
\\
$α$ & Angular acceleration & $\frac{\text{rad}}{\text{s}^{2}}$
\\
${α_{j}}$ & Force on the rotational motion of a set of 2D rigid body & $\frac{\text{rad}}{\text{s}^{2}}$
\\
...
\subsection{Characteristics of the Intended Reader}
...
\\ \midrule \\
Equation & \begin{displaymath}
           \symbf{F}=G \frac{{m_{1}} {m_{2}}}{\text{||}\symbf{d}\text{||}^{2}} \symbf{\hat{d}}=G \frac{{m_{1}} {m_{2}}}{\text{||}\symbf{d}\text{||}^{2}} \frac{\symbf{d}}{\text{||}\symbf{d}\text{||}}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
              \item{$\symbf{F}$ is the force (${\text{N}}$)}
              ...
              \item{$\text{||}\symbf{d}\text{||}$ is the Euclidean norm of the distance between the center of mass of two bodies (${\text{m}}$)}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & Two rigid bodies in the universe attract each other with a force $\symbf{F}$ that is directly proportional to the product of their masses, ${m_{1}}$ and ${m_{2}}$, and inversely proportional to the squared distance ${\text{||}\symbf{d}\text{||}^{2}}$ between them.
...
\\ \midrule \\
Equation & \begin{displaymath}
           \symbf{g}=-\frac{G M}{\text{||}\symbf{d}\text{||}^{2}} \symbf{\hat{d}}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
...
\begin{displaymath}
\symbf{F}=\frac{G {m_{1}} {m_{2}}}{{\text{||}\symbf{d}\text{||}^{2}}} \symbf{\hat{d}}
\end{displaymath}
...
\begin{displaymath}
\symbf{\hat{d}}=\frac{\symbf{d}}{\text{||}\symbf{d}\text{||}}
\end{displaymath}
...
\\ \midrule \\
Equation & \begin{displaymath}
           j=\frac{-\left(1+{C_{\text{R}}}\right) {{\symbf{v}_{\text{i}}}^{\text{A}\text{B}}}\cdot{}\symbf{n}}{\left(\frac{1}{{m_{\text{A}}}}+\frac{1}{{m_{\text{B}}}}\right) \text{||}\symbf{n}\text{||}^{2}+\frac{\text{||}{\symbf{u}_{\text{A}\text{P}}}\text{*}\symbf{n}\text{||}^{2}}{{\symbf{I}_{\text{A}}}}+\frac{\text{||}{\symbf{u}_{\text{B}\text{P}}}\text{*}\symbf{n}\text{||}^{2}}{{\symbf{I}_{\text{B}}}}}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
              ...
              \item{$\text{||}\symbf{n}\text{||}$ is the length of the normal vector (${\text{m}}$)}
              \item{$\text{||}{\symbf{u}_{\text{A}\text{P}}}\text{*}\symbf{n}\text{||}$ is the length of the perpendicular vector to the contact displacement vector of rigid body A (${\text{m}}$)}
              \item{${\symbf{I}_{\text{A}}}$ is the moment of inertia of rigid body A ($\text{kg}\text{m}^{2}$)}
              \item{$\text{||}{\symbf{u}_{\text{B}\text{P}}}\text{*}\symbf{n}\text{||}$ is the length of the perpendicular vector to the contact displacement vector of rigid body B (${\text{m}}$)}
...
\\ \midrule \\
Description & \begin{symbDescription}
              \item{${\symbf{a}_{j}}$ is the force on the translational motion of a set of 2D rigid bodies ($\frac{\text{m}}{\text{s}^{2}}$)}
              \item{$\symbf{g}$ is the gravitational acceleration ($\frac{\text{m}}{\text{s}^{2}}$)}
...
\\ \midrule \\
Description & \begin{symbDescription}
              \item{${α_{j}}$ is the Force on the rotational motion of a set of 2D rigid body ($\frac{\text{rad}}{\text{s}^{2}}$)}
...
\end{tabular}
\end{minipage}
\paragraph{Detailed derivation of Force on the rotational motion of a set of 2D rigid body:}
