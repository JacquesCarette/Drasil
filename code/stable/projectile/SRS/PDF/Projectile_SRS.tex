...
\\ \midrule
RefBy & \hyperref[IM:calOfLandingDist]{IM:calOfLandingDist}, \hyperref[outputValues2]{FR:Output-Values-2}, \hyperref[outputValues]{FR:Output-Values}, and \hyperref[calcValues]{FR:Calculate-Values}
...
\\ \midrule
RefBy & \hyperref[IM:offsetIM]{IM:offsetIM}, \hyperref[outputValues]{FR:Output-Values}, and \hyperref[calcValues]{FR:Calculate-Values}
...
\\ \midrule
RefBy & \hyperref[outputValues2]{FR:Output-Values-2}, \hyperref[outputValues]{FR:Output-Values}, and \hyperref[calcValues]{FR:Calculate-Values}
...
\item[Output-Values:\phantomsection\label{outputValues}]{Output ${t_{\text{flight}}}$ (from \hyperref[IM:calOfLandingTime]{IM:calOfLandingTime}), ${p_{\text{land}}}$ (from \hyperref[IM:calOfLandingDist]{IM:calOfLandingDist}), and ${d_{\text{offset}}}$ (from \hyperref[IM:offsetIM]{IM:offsetIM}).}
\item[Output-Values-2:\phantomsection\label{outputValues2}]{Output ${d_{\text{offset}}}$ (from \hyperref[IM:offsetIM]{IM:offsetIM}) and ${t_{\text{flight}}}$ (from \hyperref[IM:calOfLandingTime]{IM:calOfLandingTime}).}
\end{description}
\begin{longtblr}
...
\\
\hyperref[outputValues2]{FR:Output-Values-2} &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
...
\hyperref[portable]{NFR:Portability} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[outputValues2]{FR:Output-Values-2} &  &  &  &  &  &  &  &  &  & X &  & X &  &  &  &  &  &  &  &  &  &  & 
