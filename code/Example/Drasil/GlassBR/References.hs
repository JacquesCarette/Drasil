...
astm_LR2009 = Misc 
  [
  Author [mononym "ASTM Standards Committee"],
...
astm_C1036 = Misc 
  [
  Author [mononym "ASTM developed by subcommittee C14.08"],
