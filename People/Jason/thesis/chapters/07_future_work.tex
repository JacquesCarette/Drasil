...
\easytodo{ChunkDB arithmetic \textemdash{} now we have the full power of
    database knowledge and operations that we can apply to our code. Filling up
    our ChunkDB in a less-manual method too.}
