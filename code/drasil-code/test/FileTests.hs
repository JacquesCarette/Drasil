...
fileTestsOO :: (OOProg r tp vis) => OO.GSProgram r
...
fileTestsProc :: (ProcProg r tp vis) => GProc.GSProgram r
...
goodBye :: (SharedProg r tp vis) => MSBlock r
goodBye = block [
