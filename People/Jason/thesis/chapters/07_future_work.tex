...
into lists, and then using the lists to form the \ChunkDB{}\todo{Ref. chunk db
manual input code snippet}. We could attempt to automatically register the
...
\todo{Cite Dr Carettes comment about this}. 
