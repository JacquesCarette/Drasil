...
[1]: Parnas, David L. and Clements, P. C. "A rational design process: How and why to fake it." *IEEE Transactions on Software Engineering*, vol. 12, no. 2, Washington, USA: February, 1986. pp. 251&ndash;257. Print.

<div id="pointSource"></div>

[2]: Pierce, Rod. *Point*. May, 2017. <https://www.mathsisfun.com/geometry/point.html>.

<div id="lineSource"></div>

[3]: The Editors of Encyclopaedia Britannica. *Line*. June, 2019. <https://www.britannica.com/science/line-mathematics>.

<div id="chaslesWiki"></div>

[4]: Wikipedia Contributors. *Chasles' theorem (kinematics)*. November, 2018. <https://en.wikipedia.org/wiki/Chasles'_theorem_(kinematics)>.

<div id="cartesianWiki"></div>

[5]: Wikipedia Contributors. *Cartesian coordinate system*. June, 2019. <https://en.wikipedia.org/wiki/Cartesian_coordinate_system>.

<div id="dampingSource"></div>

[6]: Wikipedia Contributors. *Damping*. July, 2019. <https://en.wikipedia.org/wiki/Damping_ratio>.
