...
\intodo{Describe EquationalModels}

\subsection{Symbol Constraints}

\intodo{Describe EquationalConstraints}

\subsection{Realms}

\intodo{Describe EquationalRealms}

\subsection{Differential Equations}

\intodo{Describe DEModel and NewDEModel}

\subsection{Leftovers}

\intodo{Discuss the last 1-2 kinds of models left}
