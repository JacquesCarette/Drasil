...
import Drasil.DocLang.SRS as SRS (charOfIR, goalStmt, inModel, orgOfDoc,
  prpsOfDoc, scpOfReq, thModel)

import Data.Drasil.Concepts.Computation (algorithm)
import Data.Drasil.Concepts.Documentation as Doc (goal, organization, goalStmt, inModel, thModel,
...
introductionSection problemIntroduction programDefinition = intro 
...
orgIntro i bottom bottomSec trailingSentence = [foldlSP [
          ...
          where lastS EmptyS = refineChain (zip [Doc.goalStmt, Doc.thModel, Doc.inModel]
                  [SRS.goalStmt [] [], SRS.thModel [] [], SRS.inModel [] []])
                lastS t = refineChain (zip [Doc.goalStmt, Doc.thModel, Doc.inModel] 
                  [SRS.goalStmt [] [], SRS.thModel [] [], SRS.inModel [] []]) 
                  +:+. t
