...
\lstdefinelanguage{haskell1}{
	...
	keywords=[3]{rectVel, speed', equationsSent, lbldExpr, unlbldExpr, lo, 
	makeEquation, toEqn, layLabelled, layUnlabelled, makeMetadata, DocDesc, 
	printLO, makeTable, makeRows, makeHeaderCols, makeColumns, markdownCell, 
	markdownB', markdownE, mkLsnDesc, mkNb, section, mkIntro, mkLearnObj, 
	mkReview, mkCaseProb, mkExample, mkSmmry, mkBib, mkAppndx, mkSections},
	keywordstyle=[3]\color{McMasterHeritageMaroon},
	keywords=[4]{T, QP, P, J, NB, Lsn},
