...
\end{enumerate}
\answer{Explain your answer here.}{0cm}{7cm}
Sample Answer: learning about input/output is good to know for related applications in Drasil, but not highly recommended. Learning about monads and lensing is highly recommended, as knowing these concepts will help you to more easily read and understand the Drasil code and how it works.
