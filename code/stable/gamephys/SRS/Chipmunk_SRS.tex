...
\\
${\mathbf{r}_{\text{O}B}}$ & Displacement vector between the origin and point B & m
\\
...
\\
${{\mathbf{v}_{\text{i}}}^{AB}}$ & Initial Relative Velocity Between Rigid Bodies of A and B & $\frac{\text{m}}{\text{s}}$
\\
...
\\
$\text{||}{\mathbf{r}_{AP}}\text{*}\mathbf{n}\text{||}$ & Length of the Perpendicular Vector To the Contact Displacement Vector of Rigid Body A & m
\\
$\text{||}{\mathbf{r}_{BP}}\text{*}\mathbf{n}\text{||}$ & Length of the Perpendicular Vector To the Contact Displacement Vector of Rigid Body B & m
\\
...
\\ \midrule \\
Equation & \begin{displaymath}
           {\mathbf{v}_{B}}={\mathbf{v}_{\text{O}}}+ω\times{\mathbf{r}_{\text{O}B}}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
              ...
              \item{${\mathbf{r}_{\text{O}B}}$ is the displacement vector between the origin and point B (m)}
              \end{symbDescription}
\\ \midrule \\
Notes & The linear velocity ${\mathbf{v}_{B}}$ ($\frac{\text{m}}{\text{s}}$) of any point B in a rigid body \hyperref[assumpOT]{A: objectTy} is the sum of the linear velocity ${\mathbf{v}_{\text{O}}}$ ($\frac{\text{m}}{\text{s}}$) of the rigid body at the origin (axis of rotation) and the resultant vector from the cross product of the rigid body's angular velocity $ω$ ($\frac{\text{rad}}{\text{s}}$) and the displacement vector between the origin and point B, ${\mathbf{r}_{\text{O}B}}$ (m).
\\ \midrule \\
Source & --
\\ \midrule \\
RefBy & 
...
\\ \midrule \\
Equation & \begin{displaymath}
           j=\frac{-\left(1+{C_{\text{R}}}\right) {{\mathbf{v}_{\text{i}}}^{AB}}\cdot{}\mathbf{n}}{\left(\frac{1}{{m_{A}}}+\frac{1}{{m_{B}}}\right) \text{||}\mathbf{n}\text{||}^{2}+\frac{\text{||}{\mathbf{r}_{AP}}\text{*}\mathbf{n}\text{||}^{2}}{{\mathbf{I}_{A}}}+\frac{\text{||}{\mathbf{r}_{BP}}\text{*}\mathbf{n}\text{||}^{2}}{{\mathbf{I}_{B}}}}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
              \item{$j$ is the impulse (scalar) (Ns)}
              \item{${C_{\text{R}}}$ is the coefficient of restitution (Unitless)}
              \item{${{\mathbf{v}_{\text{i}}}^{AB}}$ is the initial relative velocity between rigid bodies of A and B ($\frac{\text{m}}{\text{s}}$)}
              ...
              \item{$\text{||}{\mathbf{r}_{AP}}\text{*}\mathbf{n}\text{||}$ is the length of the perpendicular vector to the contact displacement vector of rigid body A (m)}
              \item{${\mathbf{I}_{A}}$ is the moment of inertia of rigid body A (kg$\text{m}^{2}$)}
              \item{$\text{||}{\mathbf{r}_{BP}}\text{*}\mathbf{n}\text{||}$ is the length of the perpendicular vector to the contact displacement vector of rigid body B (m)}
...
\\ \midrule \\
Equation & \begin{displaymath}
           {C_{\text{R}}}=-\left(\frac{{{\mathbf{v}_{f}}^{AB}}\cdot{}\mathbf{n}}{{{\mathbf{v}_{\text{i}}}^{AB}}\cdot{}\mathbf{n}}\right)
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
              \item{${C_{\text{R}}}$ is the coefficient of restitution (Unitless)}
...
\\ \midrule \\
Symbol & ${{\mathbf{v}_{\text{i}}}^{AB}}$
\\ \midrule \\
Units & $\frac{\text{m}}{\text{s}}$
\\ \midrule \\
Equation & \begin{displaymath}
           {{\mathbf{v}_{\text{i}}}^{AB}}={\mathbf{v}^{AP}}-{\mathbf{v}^{BP}}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
              \item{${{\mathbf{v}_{\text{i}}}^{AB}}$ is the initial relative velocity between rigid bodies of A and B ($\frac{\text{m}}{\text{s}}$)}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & In a collision, the velocity of a rigid body \hyperref[assumpOT]{A: objectTy} A colliding with another rigid body B relative to that body ${{\mathbf{v}_{\text{i}}}^{AB}}$ is the difference between the velocities of A and B at point P.
\\ \midrule \\
Source & --
\\ \midrule \\
RefBy & 
...
\\ \midrule \\
Equation & \begin{displaymath}
           {\mathbf{v}_{A}}\left({t_{\text{c}}}\right)={\mathbf{v}_{A}}\left(t\right)+\frac{j}{{m_{A}}} \mathbf{n}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
