...
\\ \midrule
Equation & \begin{displaymath}
           \resizeExpression{\frac{\,d^{2}y_{\text{t}}}{\,dt^{2}}+\left(1+K_{\text{d}}\right)\,\frac{\,dy_{\text{t}}}{\,dt}+\left(20+K_{\text{p}}\right)\,{y_{\text{t}}}=r_{\text{t}}\,K_{\text{p}}}
           \end{displaymath}
\\ \midrule
Description & \begin{symbDescription}
              \item{$t$ is the time (${\text{s}}$)}
...
\begin{displaymath}
\resizeExpression{\frac{\,d\frac{\,dy_{\text{t}}}{\,dt}}{\,dt}+\left(1+K_{\text{d}}\right)\,\frac{\,dy_{\text{t}}}{\,dt}+\left(20+K_{\text{p}}\right)\,y_{\text{t}}-K_{\text{d}}\,\frac{\,dr_{\text{t}}}{\,dt}-r_{\text{t}}\,K_{\text{p}}=0}
\end{displaymath}
...
\begin{displaymath}
\resizeExpression{\frac{\,d\frac{\,dy_{\text{t}}}{\,dt}}{\,dt}+\left(1+K_{\text{d}}\right)\,\frac{\,dy_{\text{t}}}{\,dt}+\left(20+K_{\text{p}}\right)\,y_{\text{t}}-r_{\text{t}}\,K_{\text{p}}=0}
\end{displaymath}
