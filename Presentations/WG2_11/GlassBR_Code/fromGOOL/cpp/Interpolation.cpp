...
double GlassBR::lin_interp(double x1, double y1, double x2, double y2, double x) {
    double y = (((y2 - y1) / (x2 - x1)) * (x - x1)) + y1;
    return y;
}

int GlassBR::indInSeq(vector<double> &arr, double v) {
...
vector<double> GlassBR::matrixCol(vector< vector<double> > &mat, int c) {
    vector<double> col(0);
...
double GlassBR::interpY(vector< vector<double> > &x_array, vector< vector<double> > &y_array, vector<double> &z_array, double x, double z) {
...
double GlassBR::interpZ(vector< vector<double> > &x_array, vector< vector<double> > &y_array, vector<double> &z_array, double x, double y) {
