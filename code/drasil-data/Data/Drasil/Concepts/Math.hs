...
de           = commonIdea "de"     (cn' "differential equation")          "DE"   ["math concept"]
ode          = commonIdea "ode"    (cn' "Ordinary Differential Equation") "ODE"  ["math concept"]
pde          = commonIdea "pde"    (cn' "partial differential equation")  "PDE"  ["math concept"]
