...
\section[Research]{Research Plan \& Progress}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%D This slide and the next one should be moved after the question/answer slides.
\begin{frame}
...
\begin{itemize}
\item Focus: avoid knowledge duplication across artifacts %D copy/pasting
