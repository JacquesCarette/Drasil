...
nameGenTestOO :: OOProg r tp vis smt par => OO.GSProgram r
nameGenTestOO = OO.prog "NameGenTest" "" [OO.fileDoc $ OO.buildModule
  "NameGenTest" [] [main, helper] []]

nameGenTestProc :: ProcProg r tp vis smt par => GProc.GSProgram r
nameGenTestProc = GProc.prog "NameGenTest" "" [GProc.fileDoc $ GProc.buildModule
  "NameGenTest" [] [main, helper]]

helper :: SharedProg r tp vis smt par => SMethod r
...
main :: SharedProg r tp vis smt par => SMethod r
