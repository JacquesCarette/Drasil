...
\label{Sec:PhysSyst}
The physical system of Pendulum, as shown in \hyperref[Figure:PendulumMotion]{Fig:PendulumMotion}, includes the following elements:
...
Notes & ${{p_{\text{x}}}^{\text{i}}}$ is the horizontal position
        ...
        ${{p_{\text{x}}}^{\text{i}}}$ is shown in \hyperref[Figure:PendulumMotion]{Fig:PendulumMotion}.
...
Notes & ${{p_{\text{y}}}^{\text{i}}}$ is the vertical position
        ...
        ${{p_{\text{y}}}^{\text{i}}}$ is shown in \hyperref[Figure:PendulumMotion]{Fig:PendulumMotion}.
