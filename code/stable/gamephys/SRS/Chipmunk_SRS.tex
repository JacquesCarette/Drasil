                         ...
                         Equation & \begin{dmath}
                                    ...
                                    Description & \begin{symbDescription}
                                                  ...
                                                  Notes & An impulse (vector) $\mathbf{J}$ occurs when a force $\mathbf{F}$ acts over a body over an interval of time.
                                                          \hyperref[A:objectTy]{A: objectTy}
=======
\end{minipage}
\par~
...
\\
<<<<<<< HEAD
IM1 (\hyperref[DD:ChaslesDD]{DD: ChaslesDD}) & X & X &  &  &  & X & X
\\
IM2 (\hyperref[DD:torque]{DD: torque}) & X & X &  & X &  & X & X
\\
IM3 (\hyperref[DD:impulseV]{DD: impulseV}) & X & X &  &  & X & X & X
\\
