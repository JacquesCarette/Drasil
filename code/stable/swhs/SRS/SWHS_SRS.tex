...
\item[Temp-Heating-Coil-Constant-over-Length:\phantomsection\label{assumpTHCCoL}]The temperature of the heating coil does not vary along its length. \hyperref[likeChgTCVOL]{LC: Temperature-Coil-Variable-Over-Length} \hyperref[DD:htFluxC]{DD: htFluxC}.
...
\end{displaymath}
Using \hyperref[DD:htFluxC]{DD: htFluxC} and \hyperref[DD:ht.flux.P]{DD: ht\_flux\_P} for ${q_{C}}$ and ${q_{P}}$ respectively, this can be written as:
\begin{displaymath}
