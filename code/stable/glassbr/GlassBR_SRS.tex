...
\\
$g$ & Glass type $g$ \useEps \{AN, FT, HS\} & Unitless
\\
...
\\
$t$ & Nominal thickness $t$ \useEps \{2.5, 2.7, 3.0, 4.0, 5.0, 6.0, 8.0, 10.0, 12.0, 16.0, 19.0, 22.0\} & mm
\\
...
\end{cases}$
\\ \midrule \\
Description & $h$ is the actual thickness (m)\newline$t$ is the nominal thickness $t$ \useEps \{2.5, 2.7, 3.0, 4.0, 5.0, 6.0, 8.0, 10.0, 12.0, 16.0, 19.0, 22.0\} (mm)
\\ \bottomrule \end{tabular}
\end{minipage}\\
~\newline
\noindent \begin{minipage}{\textwidth}
...
\end{cases}$
\\ \midrule \\
Description & $GTF$ is the glass type factor\newline$g$ is the glass type $g$ \useEps \{AN, FT, HS\}
\\ \bottomrule \end{tabular}
\end{minipage}\\
~\newline
\noindent \begin{minipage}{\textwidth}
...
\\
\midrule
$a$ & $a>0.0$ and $\frac{a}{b}>1.0$ & ${d_{min}}\leq{}a$, $a\leq{}{d_{max}}$, and $\frac{a}{b}<{AR_{max}}$ & $1.5$ m & 0.1
\\
$b$ & $b>0.0$ and $b<a$ & ${d_{min}}\leq{}b$, $b\leq{}{d_{max}}$, and $\frac{a}{b}<{AR_{max}}$ & $1.2$ m & 0.1
\\
