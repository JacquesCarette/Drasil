...
\label{Sec:ReqsScope}
The scope of the requirements includes the analysis of a projectile motion problem. Given the appropriate inputs, Projectile determines if the projectile hits the target.
