...
\begin{tabular}{p{0.18\textwidth} | p{0.20\textwidth} p{0.20\textwidth} p{0.20\textwidth} p{0.20\textwidth}}\hline
    ...
    Family of RK & 
        \begin{itemize}[wide]
        \item (4)5 Dormand Prince
        \item 8(5,3) Dormand Prince
        \end{itemize} & 
        \begin{itemize}[wide]
        \item Second order
        \item Fourth order
        ...
        \item 5(4) Higham and Hall
        \item 5(4) Dormand Prince
        \item 8(5,3) Dormand Prince
        \end{itemize} & \checkmark & \checkmark \\\hline
    Family of Euler && 
        \begin{itemize}[wide]
        \item Euler method
        \end{itemize} & \checkmark &\\\hline
