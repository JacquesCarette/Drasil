...
traceMGF :: [LabelledContent] -> [Sentence] -> [LabelledContent] -> [Section] -> Section
...
traceMIntro :: [LabelledContent] -> [Sentence] -> LabelledContent
traceMIntro refs trailings = llcc "traceMIntro" (mkLabelRA'' "traceMIntroLabel") $ 
        Paragraph $ foldlSent [(phrase purpose) `ofThe'` (plural traceyMatrix),
...
-- generalized traceability matrix and graph introduction: variables are references to the three tables
-- generally found in this section (in order of being mentioned)
traceGIntro :: [LabelledContent] -> [Sentence] -> LabelledContent
traceGIntro refs trailings = llcc "traceGIntro" (mkLabelRA'' "traceGIntroLabel") $ 
        Paragraph $ foldlSent
