...
\subsection{Generation and Rendering Summary}
Taken together, these examples show how Drasil separates knowledge capture from 
artifact production. Recipes select and organize the relevant chunks, rendering 
translates their projections into target-specific representations, and assembly 
combines those representations with cross-references and supporting files to 
produce complete artifacts. These artifacts need not present the knowledge 
identically; each recipe selects and structures it for its particular purpose 
while retaining a traceable connection to the same source. Consequently, 
changes to shared knowledge can be propagated across the generated artifact set 
without maintaining separate copies of that knowledge.
