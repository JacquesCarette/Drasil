...
\\
${\mathbf{x}_{slope}}$ & X-Coordinates of the Slope: x-coordinates of points on the slope & m
\\
${\mathbf{x}_{wt}}$ & X-Coordinates: x-positions of the water table & m
\\
...
\item[Surface-Load:\phantomsection\label{assumpSL}]There is no imposed surface load, and therefore no external forces, acting on the slope. \hyperref[IM:nrmShrFor]{IM: nrmShrFor} \hyperref[IM:fctSfty]{IM: fctSfty}.
\end{itemize}
...
\end{displaymath}
This equation can be simplified by applying assumptions \hyperref[assumpSF]{A: Seismic-Force} and \hyperref[assumpSL]{A: Surface-Load}, which state that the seismic and external forcess, respectively, are zero:
\begin{displaymath}
                                             ...
                                             Output Constraints & \\ \midrule \\
                                                                  Equation & \begin{displaymath}
                                                                             ...
                                                                             Description & \begin{symbDescription}
                                                                                           ...
                                                                                           \item{${\mathbf{x}_{slope}}$ is the x-coordinates of the slope (m)}
                                                                                           \item{${\mathbf{y}_{slope}}$ is the y-coordinates of the slope (m)}
                                                                                           \item{${\mathbf{x}_{wt}}$ is the x-coordinates (m)}
                                                                                           \item{${\mathbf{y}_{wt}}$ is the y-coordinates of the water table (m)}
                                                                                           \item{$c'$ is the effective cohesion (Pa)}
                                                                                           \item{$φ'$ is the effective angle of friction (${}^{\circ}$)}
                                                                                           \item{$γ$ is the soil dry unit weight ($\frac{\text{N}}{\text{m}^{3}}$)}
