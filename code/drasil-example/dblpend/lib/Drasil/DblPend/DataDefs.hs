...
positionXEqn_2 = sy (positionXDD_1 ^. defLhs) `add` (sy lenRod_2 `mulRe` sin (sy pendDisAngle_2))
...
positionYEqn_2 = sy (positionYDD_1 ^. defLhs) `add` neg (sy lenRod_2 `mulRe` cos (sy pendDisAngle_2))
