...
fileTestsOO :: (OOProg r vis smt mthd svr att prg) => OO.GSProgram r prg
...
fileTestsProc :: (ProcProg r vis smt mthd prg) => GProc.GSProgram r prg
...
readStory :: (SharedProg r vis smt mthd) => MS (r smt)
...
goodBye :: (SharedProg r vis smt mthd) => MS (r Block)
goodBye = block [
