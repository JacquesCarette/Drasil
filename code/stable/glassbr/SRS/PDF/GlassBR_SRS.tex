...
\\ \midrule
RefBy & \hyperref[IM:riskFun]{IM:riskFun} and \hyperref[outputValues2]{FR:Output-Values-2}
...
\\ \midrule
RefBy & \hyperref[IM:isSafePb]{IM:isSafePb} and \hyperref[outputValues2]{FR:Output-Values-2}
...
\\ \midrule
RefBy & \hyperref[IM:isSafeLR]{IM:isSafeLR}, \hyperref[outputValues2]{FR:Output-Values-2}, and \hyperref[checkGlassSafety]{FR:Check-Glass-Safety}
...
\\ \midrule
RefBy & \hyperref[IM:isSafePb]{IM:isSafePb}, \hyperref[outputValues2]{FR:Output-Values-2}, and \hyperref[checkGlassSafety]{FR:Check-Glass-Safety}
...
\item[Output-Values-2:\phantomsection\label{outputValues2}]{Output $\mathit{isSafePb}$ (from \hyperref[IM:isSafePb]{IM:isSafePb}), $\mathit{isSafeLR}$ (from \hyperref[IM:isSafeLR]{IM:isSafeLR}), ${P_{\text{b}}}$ (from \hyperref[IM:probOfBreak]{IM:probOfBreak}), and $J$ (from \hyperref[IM:stressDistFac]{IM:stressDistFac}).}
\end{description}
\begin{longtblr}
...
\hyperref[portable]{NFR:Portablity} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[outputValues2]{FR:Output-Values-2} &  &  &  &  &  &  &  &  &  &  & X &  &  &  &  & X &  & X & X &  &  &  &  &  &  &  &  &  &  &  &  & 
