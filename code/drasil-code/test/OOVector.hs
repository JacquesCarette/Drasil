...
ooVector :: OOProg r vis stmt mthd stvr attch mod file prg => GSProgram r prg
ooVector = prog "OOVector" "" [fileDoc (buildModule "OOVector" []
  [main] [vectorClass])]

vectorClass :: OOProg r vis stmt mthd stvr attch mod file prg => CS (r Class)
...
dimension :: OOProg r vis stmt mthd stvr attch mod file prg => MS (r mthd)
...
magnitude :: OOProg r vis stmt mthd stvr attch mod file prg => MS (r mthd)
...
norm :: OOProg r vis stmt mthd stvr attch mod file prg => MS (r mthd)
...
dot :: OOProg r vis stmt mthd stvr attch mod file prg => MS (r mthd)
...
add :: OOProg r vis stmt mthd stvr attch mod file prg => MS (r mthd)
...
scale :: OOProg r vis stmt mthd stvr attch mod file prg => MS (r mthd)
...
print_ :: OOProg r vis stmt mthd stvr attch mod file prg => MS (r mthd)
print_ = docFunc "Prints the vector elements to console." [] Nothing $
  pubMethod "printSelf" void [] $ oneLiner $ printLn $ valueOf thisV

main :: OOProg r vis stmt mthd stvr attch mod file prg => MS (r mthd)
