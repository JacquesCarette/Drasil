...
ooVector :: OOProg r vis smt mthd svr att prg => GSProgram r prg
ooVector = prog "OOVector" "" [fileDoc (buildModule "OOVector" []
  [main] [vectorClass])]

vectorClass :: OOProg r vis smt mthd svr att prg => CS (r Class)
...
dimension :: OOProg r vis smt mthd svr att prg => MS (r mthd)
...
magnitude :: OOProg r vis smt mthd svr att prg => MS (r mthd)
...
norm :: OOProg r vis smt mthd svr att prg => MS (r mthd)
...
dot :: OOProg r vis smt mthd svr att prg => MS (r mthd)
...
add :: OOProg r vis smt mthd svr att prg => MS (r mthd)
...
scale :: OOProg r vis smt mthd svr att prg => MS (r mthd)
