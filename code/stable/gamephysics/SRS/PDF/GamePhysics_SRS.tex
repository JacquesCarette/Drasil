...
\\ \midrule
RefBy & \hyperref[outputValues]{FR:Output-Values} and \hyperref[IM:transMot]{IM:transMot}
...
\\ \midrule
RefBy & \hyperref[outputValues]{FR:Output-Values} and \hyperref[IM:rotMot]{IM:rotMot}
