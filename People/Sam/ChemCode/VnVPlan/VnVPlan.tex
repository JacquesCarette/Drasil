...
\begin{enumerate}
  ...
  \item[T\refstepcounter{testnum}\thetestnum \label{test_bal_accuracy}:]
    ...
    Chemical equations are only useful if they are
    ...
    (e.g., by using integer comparison). This verification will be performed by
    the \nameref{sec_sysFunReqs} and satisfies R1, R2, R3, R5, R6, and NFR1
    from SRS \sjc{add link}.
