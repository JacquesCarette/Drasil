...
knowledge of given terms at a given time, depending on their needs (which 
include precision, brevity, and clarity, among others), the expectations of the 
audience, and contextual relevance. \footnote{We have only referred to the term 
as $\hat{q}$ in this section to emphasize our argument and make the meta-point 
that the definition is irrelevant to our audience in this example. What matters 
is the symbolic reference, which we share a common understanding of.}
