...
\\ \midrule
RefBy & \hyperref[outputValues2]{FR:Output-Values-2}, \hyperref[outputValues]{FR:Output-Values}, and \hyperref[calculateValues]{FR:Calculate-Values}
...
\item[Output-Values:\phantomsection\label{outputValues}]{Output ${y_{\text{t}}}$ (from \hyperref[IM:pdEquationIM]{IM:pdEquationIM}) over the simulation time.}
\item[Output-Values-2:\phantomsection\label{outputValues2}]{Output ${y_{\text{t}}}$ (from \hyperref[IM:pdEquationIM]{IM:pdEquationIM}).}
\end{description}
\begin{longtblr}
...
\hyperref[verifiability]{NFR:Verifiability} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[outputValues2]{FR:Output-Values-2} &  &  &  &  &  &  &  &  & X &  &  &  &  &  &  &  &  & 
