...
\\
${m_{T}}$ & Total Mass of the Rigid Body & kg
\\
...
\begin{itemize}
\item[Determine-Linear-Properties (GS1):\phantomsection\label{linearGS}]{Determine their new positions and velocities over a period of time.}
\item[Determine-Angular-Properties (GS2):\phantomsection\label{angularGS}]{Determine their new orientations and angular velocities over a period of time.}
\end{itemize}
...
\begin{itemize}
\item[objectTy (A1):\phantomsection\label{assumpOT}]{All objects are rigid bodies. (RefBy: \hyperref[DD:chaslesThm]{DD: chaslesThm}, \hyperref[DD:reVeInColl]{DD: reVeInColl}, \hyperref[IM:transMot]{IM: transMot}, \hyperref[IM:rotMot]{IM: rotMot}, \hyperref[DD:potEnergy]{DD: potEnergy}, \hyperref[DD:ctrOfMass]{DD: ctrOfMass}, \hyperref[DD:momentOfInertia]{DD: momentOfInertia}, \hyperref[DD:linVel]{DD: linVel}, \hyperref[DD:linDisp]{DD: linDisp}, \hyperref[DD:linAcc]{DD: linAcc}, \hyperref[DD:kEnergy]{DD: kEnergy}, \hyperref[DD:impulseV]{DD: impulseV}, \hyperref[DD:impulse]{DD: impulse}, \hyperref[IM:col2D]{IM: col2D}, \hyperref[DD:angVel]{DD: angVel}, \hyperref[DD:angDisp]{DD: angDisp}, and \hyperref[DD:angAccel]{DD: angAccel}.)}
\item[objectDimension (A2):\phantomsection\label{assumpOD}]{All objects are 2D. (RefBy: \hyperref[IM:transMot]{IM: transMot}, \hyperref[IM:rotMot]{IM: rotMot}, \hyperref[DD:potEnergy]{DD: potEnergy}, \hyperref[TM:NewtonSecLawRotMot]{TM: NewtonSecLawRotMot}, \hyperref[DD:kEnergy]{DD: kEnergy}, \hyperref[DD:impulse]{DD: impulse}, \hyperref[IM:col2D]{IM: col2D}, \hyperref[DD:angVel]{DD: angVel}, \hyperref[DD:angDisp]{DD: angDisp}, and \hyperref[DD:angAccel]{DD: angAccel}.)}
\item[coordinateSystemTy (A3):\phantomsection\label{assumpCST}]{The library uses a Cartesian coordinate system.}
\item[axesDefined (A4):\phantomsection\label{assumpAD}]{The axes are defined using right-handed coordinate system. (RefBy: \hyperref[IM:rotMot]{IM: rotMot}, \hyperref[DD:impulse]{DD: impulse}, and \hyperref[IM:col2D]{IM: col2D}.)}
\item[collisionType (A5):\phantomsection\label{assumpCT}]{All rigid bodies collisions are vertex-to-edge collisions. (RefBy: \hyperref[lcEC]{LC: Expanded-Collisions}, \hyperref[DD:impulse]{DD: impulse}, and \hyperref[IM:col2D]{IM: col2D}.)}
\item[dampingInvolvement (A6):\phantomsection\label{assumpDI}]{There is no damping involved throughout the simulation and this implies that there are no friction forces. (RefBy: \hyperref[IM:transMot]{IM: transMot}, \hyperref[DD:potEnergy]{DD: potEnergy}, \hyperref[lcID]{LC: Include-Dampening}, \hyperref[DD:kEnergy]{DD: kEnergy}, and \hyperref[IM:col2D]{IM: col2D}.)}
\item[constraintsAndJointsInvolvement (A7):\phantomsection\label{assumpCAJI}]{There are no constraints and joints involved throughout the simulation. (RefBy: \hyperref[IM:transMot]{IM: transMot}, \hyperref[lcIJC]{LC: Include-Joints-Constraints}, and \hyperref[IM:col2D]{IM: col2D}.)}
\end{itemize}
...
\toprule \textbf{Refname} & \textbf{TM:NewtonSecLawMot} (TM1)
\phantomsection 
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{TM:NewtonThirdLawMot} (TM2)
\phantomsection 
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{TM:UniversalGravLaw} (TM3)
\phantomsection 
...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & Two rigid bodies in the universe attract each other with a force $\mathbf{F}$ that is directly proportional to the product of their masses, ${m_{1}}$ and ${m_{2}}$, and inversely proportional to the squared distance ${\text{||}\mathbf{r}\text{||}^{2}}$ between them.
        
        The vector $\mathbf{r}$ is the displacement between the centres of the rigid bodies and $\text{||}\mathbf{r}\text{||}$ is the absolute distance between the two.
        
        $\mathbf{\hat{r}}$ is equivalent to the displacement divided by the Euclidean norm of the displacement, as shown above.
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{TM:NewtonSecLawRotMot} (TM4)
\phantomsection 
...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & The net torque $τ$ on a rigid body is proportional to its angular acceleration $α$, where $\mathbf{I}$ denotes the moment of inertia of the rigid body as the constant of proportionality.
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{GD:accelGravity} (GD1)
\phantomsection 
...
\\ \midrule \\
Equation & \begin{displaymath}
           g=\frac{G M}{\text{||}\mathbf{r}\text{||}^{2}} \mathbf{\hat{r}}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
              \item{$g$ is the gravitational acceleration ($\frac{\text{m}}{\text{s}^{2}}$)}
              \item{$G$ is the gravitational constant ($\frac{\text{m}^{3}}{(\text{kg}\text{s}^{2})}$)}
              \item{$M$ is the mass of the larger rigid body (kg)}
              \item{$\text{||}\mathbf{r}\text{||}$ is the Euclidean norm of the displacement (m)}
              \item{$\mathbf{\hat{r}}$ is the displacement unit vector (m)}
              \end{symbDescription}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:ctrOfMass} (DD1)
\phantomsection 
\label{DD:ctrOfMass}
\\ \midrule \\
...
Description & \begin{symbDescription}
              ...
              \item{${m_{T}}$ is the total mass of the rigid body (kg)}
              \end{symbDescription}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:linDisp} (DD2)
\phantomsection 
\label{DD:linDisp}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:linVel} (DD3)
\phantomsection 
\label{DD:linVel}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:linAcc} (DD4)
\phantomsection 
\label{DD:linAcc}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:angDisp} (DD5)
\phantomsection 
\label{DD:angDisp}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:angVel} (DD6)
\phantomsection 
\label{DD:angVel}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:angAccel} (DD7)
\phantomsection 
\label{DD:angAccel}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:impulse} (DD8)
\phantomsection 
\label{DD:impulse}
\\ \midrule \\
...
\end{tabular}
\end{minipage}
\paragraph{Detailed derivation of impulse (scalar):}
\label{DD:impulseDeriv}
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:chaslesThm} (DD9)
\phantomsection 
\label{DD:chaslesThm}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:torque} (DD10)
\phantomsection 
\label{DD:torque}
\\ \midrule \\
Label & Torque
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:kEnergy} (DD11)
\phantomsection 
\label{DD:kEnergy}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:coeffRestitution} (DD12)
\phantomsection 
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:reVeInColl} (DD13)
\phantomsection 
\label{DD:reVeInColl}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:impulseV} (DD14)
\phantomsection 
\label{DD:impulseV}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:potEnergy} (DD15)
\phantomsection 
\label{DD:potEnergy}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:momentOfInertia} (DD16)
\phantomsection 
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{IM:transMot} (IM1)
\phantomsection 
\label{IM:transMot}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{IM:rotMot} (IM2)
\phantomsection 
\label{IM:rotMot}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{IM:col2D} (IM3)
\phantomsection 
\label{IM:col2D}
\\ \midrule \\
...
Notes & The output of the instance model will be the functions of position, velocity, orientation, and angular acceleration over time that satisfy the equations for the velocity and angular acceleration, with the given initial conditions for position, velocity, orientation, and angular acceleration. The motion is translational, so the position, velocity, orientation, and angular acceleration functions are for the centre of mass (from \hyperref[DD:ctrOfMass]{DD: ctrOfMass}).
        ...
        $j$ is defined in \hyperref[DD:impulse]{DD: impulse}.
...
\\
$\mathbf{I}$ & $\mathbf{I}\gt{}0$ & $74.5$ kg$\text{m}^{2}$ & 10$\%$
\\
$L$ & $L\gt{}0$ & $44.2$ m & 10$\%$
\\
$m$ & $m\gt{}0$ & $56.2$ kg & 10$\%$
...
\begin{itemize}
\item[Simulation-Space (FR1):\phantomsection\label{simSpace}]{Create a space for all of the rigid bodies in the physical simulation to interact in.}
\item[Input-Initial-Conditions (FR2):\phantomsection\label{inputInitialConds}]{Input the initial masses, velocities, orientations, angular velocities of, and forces applied on rigid bodies.}
\item[Input-Surface-Properties (FR3):\phantomsection\label{inputSurfaceProps}]{Input the surface properties of the bodies such as friction or elasticity.}
\item[Verify-Physical\_Constraints (FR4):\phantomsection\label{verifyPhysCons}]{Verify that the inputs satisfy the required physical constraints from \hyperref[Sec:SolCharSpec]{Section: Solution Characteristics Specification}.}
\item[Calculate-Translation-Over-Time (FR5):\phantomsection\label{calcTransOverTime}]{Determine the positions and velocities over a period of time of the 2D rigid bodies acted upon by a force.}
\item[Calculate-Rotation-Over-Time (FR6):\phantomsection\label{calcRotOverTime}]{Determine the orientations and angular velocities over a period of time of the 2D rigid bodies.}
\item[Determine-Collisions (FR7):\phantomsection\label{deterColls}]{Determine if any of the rigid bodies in the space have collided.}
\item[Determine-Collision-Response-Over-Time (FR8):\phantomsection\label{deterCollRespOverTime}]{Determine the positions and velocities over a period of time of the 2D rigid bodies that have undergone a collision.}
\end{itemize}
...
\begin{itemize}
\item[High-Performance (NFR1):\phantomsection\label{highPerformance}]{The code has a short reponse time when performing computation.}
\item[Correct (NFR2):\phantomsection\label{correct}]{The outputs of the code have the properties described in \hyperref[Sec:CorSolProps]{Section: Properties of a Correct Solution}.}
...
\item[Portable (NFR4):\phantomsection\label{portable}]{The code is able to be run in different environments.}
\item[Reliable (NFR5):\phantomsection\label{reliable}]{The code gives consistent outputs.}
\item[Reusable (NFR6):\phantomsection\label{reusable}]{The code is modularized.}
\item[Maintainable (NFR7):\phantomsection\label{maintainable}]{The traceability between requirements, assumptions, theoretical models, general definitions, data definitions, instance models, likely changes, unlikely changes, and modules is completely recorded in traceability matrices in the SRS and module guide.}
\end{itemize}
...
\begin{itemize}
\item[Variable-ODE-Solver (LC1):\phantomsection\label{lcVODES}]{The internal ODE-solving algorithm used by the library may be changed in the future.}
\item[Expanded-Collisions (LC2):\phantomsection\label{lcEC}]{\hyperref[assumpCT]{A: collisionType} - The library may be expanded to deal with edge-to-edge and vertex-to-vertex collisions.}
\item[Include-Dampening (LC3):\phantomsection\label{lcID}]{\hyperref[assumpDI]{A: dampingInvolvement} - The library may be expanded to include motion with damping.}
\item[Include-Joints-Constraints (LC4):\phantomsection\label{lcIJC}]{\hyperref[assumpCAJI]{A: constraintsAndJointsInvolvement} - The library may be expanded to include joints and constraints.}
\end{itemize}
...
\begin{itemize}
\item[Simulate-Rigid-Bodies (UC1):\phantomsection\label{ucSRB}]{The goal of the system is to simulate the interactions of rigid bodies.}
\item[External-Input (UC2):\phantomsection\label{ucEI}]{There will always be a source of input data external to the software.}
\item[Cartesian-Coordinate-System (UC3):\phantomsection\label{ucCCS}]{A Cartesian Coordinate system is used.}
\item[Objects-Rigid-Bodies (UC4):\phantomsection\label{ucORB}]{All objects are rigid bodies.}
\end{itemize}
...
\toprule
\textbf{} & \textbf{\hyperref[assumpOT]{A1}} & \textbf{\hyperref[assumpOD]{A2}} & \textbf{\hyperref[assumpCST]{A3}} & \textbf{\hyperref[assumpAD]{A4}} & \textbf{\hyperref[assumpCT]{A5}} & \textbf{\hyperref[assumpDI]{A6}} & \textbf{\hyperref[assumpCAJI]{A7}}
\\
\midrule
\endhead
\hyperref[DD:ctrOfMass]{DD1} & X &  &  &  &  &  & 
\\
\hyperref[DD:linDisp]{DD2} & X &  &  &  &  &  & 
\\
\hyperref[DD:linVel]{DD3} & X &  &  &  &  &  & 
\\
\hyperref[DD:linAcc]{DD4} & X &  &  &  &  &  & 
\\
\hyperref[DD:angDisp]{DD5} & X & X &  &  &  &  & 
\\
\hyperref[DD:angVel]{DD6} & X & X &  &  &  &  & 
\\
\hyperref[DD:angAccel]{DD7} & X & X &  &  &  &  & 
\\
\hyperref[DD:impulse]{DD8} & X & X &  & X & X &  & 
\\
\hyperref[DD:chaslesThm]{DD9} & X &  &  &  &  &  & 
\\
\hyperref[DD:torque]{DD10} &  &  &  &  &  &  & 
\\
\hyperref[DD:kEnergy]{DD11} & X & X &  &  &  & X & 
\\
\hyperref[DD:coeffRestitution]{DD12} &  &  &  &  &  &  & 
\\
\hyperref[DD:reVeInColl]{DD13} & X &  &  &  &  &  & 
\\
\hyperref[DD:impulseV]{DD14} & X &  &  &  &  &  & 
\\
\hyperref[DD:potEnergy]{DD15} & X & X &  &  &  & X & 
\\
\hyperref[DD:momentOfInertia]{DD16} & X &  &  &  &  &  & 
\\
\hyperref[TM:NewtonSecLawMot]{TM1} &  &  &  &  &  &  & 
\\
\hyperref[TM:NewtonThirdLawMot]{TM2} &  &  &  &  &  &  & 
\\
\hyperref[TM:UniversalGravLaw]{TM3} &  &  &  &  &  &  & 
\\
\hyperref[TM:NewtonSecLawRotMot]{TM4} &  & X &  &  &  &  & 
\\
\hyperref[GD:accelGravity]{GD1} &  &  &  &  &  &  & 
\\
\hyperref[IM:transMot]{IM1} & X & X &  &  &  & X & X
\\
\hyperref[IM:rotMot]{IM2} & X & X &  & X &  &  & 
\\
\hyperref[IM:col2D]{IM3} & X & X &  & X & X & X & X
\\
\hyperref[simSpace]{FR1} &  &  &  &  &  &  & 
\\
\hyperref[inputInitialConds]{FR2} &  &  &  &  &  &  & 
\\
\hyperref[inputSurfaceProps]{FR3} &  &  &  &  &  &  & 
\\
\hyperref[verifyPhysCons]{FR4} &  &  &  &  &  &  & 
\\
\hyperref[calcTransOverTime]{FR5} &  &  &  &  &  &  & 
\\
\hyperref[calcRotOverTime]{FR6} &  &  &  &  &  &  & 
\\
\hyperref[deterColls]{FR7} &  &  &  &  &  &  & 
\\
\hyperref[deterCollRespOverTime]{FR8} &  &  &  &  &  &  & 
\\
\hyperref[highPerformance]{NFR1} &  &  &  &  &  &  & 
\\
\hyperref[correct]{NFR2} &  &  &  &  &  &  & 
\\
\hyperref[understandable]{NFR3} &  &  &  &  &  &  & 
\\
\hyperref[portable]{NFR4} &  &  &  &  &  &  & 
\\
\hyperref[reliable]{NFR5} &  &  &  &  &  &  & 
\\
\hyperref[reusable]{NFR6} &  &  &  &  &  &  & 
\\
\hyperref[maintainable]{NFR7} &  &  &  &  &  &  & 
\\
\hyperref[lcVODES]{LC1} &  &  &  &  &  &  & 
\\
\hyperref[lcEC]{LC2} &  &  &  &  & X &  & 
\\
\hyperref[lcID]{LC3} &  &  &  &  &  & X & 
\\
\hyperref[lcIJC]{LC4} &  &  &  &  &  &  & X
\\
\hyperref[ucSRB]{UC1} &  &  &  &  &  &  & 
\\
\hyperref[ucEI]{UC2} &  &  &  &  &  &  & 
...
\toprule
\textbf{} & \textbf{\hyperref[DD:ctrOfMass]{DD1}} & \textbf{\hyperref[DD:linDisp]{DD2}} & \textbf{\hyperref[DD:linVel]{DD3}} & \textbf{\hyperref[DD:linAcc]{DD4}} & \textbf{\hyperref[DD:angDisp]{DD5}} & \textbf{\hyperref[DD:angVel]{DD6}} & \textbf{\hyperref[DD:angAccel]{DD7}} & \textbf{\hyperref[DD:impulse]{DD8}} & \textbf{\hyperref[DD:chaslesThm]{DD9}} & \textbf{\hyperref[DD:torque]{DD10}} & \textbf{\hyperref[DD:kEnergy]{DD11}} & \textbf{\hyperref[DD:coeffRestitution]{DD12}} & \textbf{\hyperref[DD:reVeInColl]{DD13}} & \textbf{\hyperref[DD:impulseV]{DD14}} & \textbf{\hyperref[DD:potEnergy]{DD15}} & \textbf{\hyperref[DD:momentOfInertia]{DD16}} & \textbf{\hyperref[TM:NewtonSecLawMot]{TM1}} & \textbf{\hyperref[TM:NewtonThirdLawMot]{TM2}} & \textbf{\hyperref[TM:UniversalGravLaw]{TM3}} & \textbf{\hyperref[TM:NewtonSecLawRotMot]{TM4}} & \textbf{\hyperref[GD:accelGravity]{GD1}} & \textbf{\hyperref[IM:transMot]{IM1}} & \textbf{\hyperref[IM:rotMot]{IM2}} & \textbf{\hyperref[IM:col2D]{IM3}}
\\
\midrule
\endhead
\hyperref[DD:ctrOfMass]{DD1} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:linDisp]{DD2} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:linVel]{DD3} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:linAcc]{DD4} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:angDisp]{DD5} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:angVel]{DD6} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:angAccel]{DD7} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:impulse]{DD8} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:chaslesThm]{DD9} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:torque]{DD10} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:kEnergy]{DD11} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:coeffRestitution]{DD12} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:reVeInColl]{DD13} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:impulseV]{DD14} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:potEnergy]{DD15} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:momentOfInertia]{DD16} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[TM:NewtonSecLawMot]{TM1} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[TM:NewtonThirdLawMot]{TM2} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
...
\hyperref[TM:UniversalGravLaw]{TM3} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[TM:NewtonSecLawRotMot]{TM4} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[GD:accelGravity]{GD1} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[IM:transMot]{IM1} & X & X & X & X &  &  &  &  &  &  &  &  &  &  &  &  & X &  &  &  & X &  &  & 
\\
\hyperref[IM:rotMot]{IM2} &  &  &  &  & X & X & X &  &  &  &  &  &  &  &  &  &  &  &  & X &  &  &  & 
\\
\hyperref[IM:col2D]{IM3} & X &  &  &  &  &  &  & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\bottomrule
...
\toprule
\textbf{} & \textbf{\hyperref[DD:ctrOfMass]{DD1}} & \textbf{\hyperref[DD:linDisp]{DD2}} & \textbf{\hyperref[DD:linVel]{DD3}} & \textbf{\hyperref[DD:linAcc]{DD4}} & \textbf{\hyperref[DD:angDisp]{DD5}} & \textbf{\hyperref[DD:angVel]{DD6}} & \textbf{\hyperref[DD:angAccel]{DD7}} & \textbf{\hyperref[DD:impulse]{DD8}} & \textbf{\hyperref[DD:chaslesThm]{DD9}} & \textbf{\hyperref[DD:torque]{DD10}} & \textbf{\hyperref[DD:kEnergy]{DD11}} & \textbf{\hyperref[DD:coeffRestitution]{DD12}} & \textbf{\hyperref[DD:reVeInColl]{DD13}} & \textbf{\hyperref[DD:impulseV]{DD14}} & \textbf{\hyperref[DD:potEnergy]{DD15}} & \textbf{\hyperref[DD:momentOfInertia]{DD16}} & \textbf{\hyperref[TM:NewtonSecLawMot]{TM1}} & \textbf{\hyperref[TM:NewtonThirdLawMot]{TM2}} & \textbf{\hyperref[TM:UniversalGravLaw]{TM3}} & \textbf{\hyperref[TM:NewtonSecLawRotMot]{TM4}} & \textbf{\hyperref[GD:accelGravity]{GD1}} & \textbf{\hyperref[IM:transMot]{IM1}} & \textbf{\hyperref[IM:rotMot]{IM2}} & \textbf{\hyperref[IM:col2D]{IM3}} & \textbf{\hyperref[simSpace]{FR1}} & \textbf{\hyperref[inputInitialConds]{FR2}} & \textbf{\hyperref[inputSurfaceProps]{FR3}} & \textbf{\hyperref[verifyPhysCons]{FR4}} & \textbf{\hyperref[calcTransOverTime]{FR5}} & \textbf{\hyperref[calcRotOverTime]{FR6}} & \textbf{\hyperref[deterColls]{FR7}} & \textbf{\hyperref[deterCollRespOverTime]{FR8}} & \textbf{\hyperref[highPerformance]{NFR1}} & \textbf{\hyperref[correct]{NFR2}} & \textbf{\hyperref[understandable]{NFR3}} & \textbf{\hyperref[portable]{NFR4}} & \textbf{\hyperref[reliable]{NFR5}} & \textbf{\hyperref[reusable]{NFR6}} & \textbf{\hyperref[maintainable]{NFR7}}
\\
\midrule
\endhead
\hyperref[linearGS]{GS1} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[angularGS]{GS2} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[simSpace]{FR1} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[inputInitialConds]{FR2} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
