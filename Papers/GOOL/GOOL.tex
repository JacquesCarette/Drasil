...
communication; they must be valid, executable programs, for machines, but
...
call the same common function but with different parameters. The number of 
common methods between each pair of renderers are shown in 
Figure~\ref{fig:common}. $143$ methods are
