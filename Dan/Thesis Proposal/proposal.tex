...
updated, as it would be impossible to verify that the software is correct. I
want to ensure that maintaining and updating software artifacts comes at very
...
vital. Due to version changes, minor hacks, and undocumented modifications, it
is often difficult for other scientists to reproduce the exact results from a
given simulation. Would it not lead to higher confidence if we could reproduce
and analyze the results of the original experiment? I want to help scientists
ensure their work is easily reproducible by giving them a means of sharing how
their software was built, as well as any necessary input or configuration data.
