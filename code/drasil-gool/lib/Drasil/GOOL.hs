...
module Drasil.GOOL (Label, GSProgram, SFile, MSBody, MSBlock, VSType,
  ...
  VariableSym(..), ScopeSym(..), ScopeData, OOVariableSym(..), staticVar,
  staticConst, VariableElim(..), ($->), listOf, listVar, ValueSym(..),
  ...
  Set(..), listSlice, listIndexExists, at, ObserverPattern(..),
