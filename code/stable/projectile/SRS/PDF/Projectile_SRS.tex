...
\item[posXDirection:\phantomsection\label{posXDirection}]{The positive $x$-direction is from the launcher to the target. (RefBy: \hyperref[IM:calOfOffset]{IM:calOfOffset}, \hyperref[IM:selOfMessage]{IM:selOfMessage}, \hyperref[IM:calOfLandingDist]{IM:calOfLandingDist}, and \hyperref[IM:calOfLandingTime]{IM:calOfLandingTime}.)}
...
\\ \midrule
Label & Calculation of flight duration
...
\\ \midrule
RefBy & \hyperref[IM:calOfOffset]{IM:calOfOffset} and \hyperref[calcValues]{FR:Calculate-Values}
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{IM:calOfOffset}
\phantomsection 
\label{IM:calOfOffset}
\\ \midrule
Label & Calculation of offset
...
\\ \midrule
Description & \begin{symbDescription}
              \item{${d_{\text{offset}}}$ is the offset (${\text{m}}$)}
              \item{${p_{\text{land}}}$ is the landing position (${\text{m}}$)}
...
\\ \midrule
RefBy & \hyperref[IM:selOfMessage]{IM:selOfMessage}, \hyperref[outputValues]{FR:Output-Values}, and \hyperref[calcValues]{FR:Calculate-Values}
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{IM:selOfMessage}
\phantomsection 
\label{IM:selOfMessage}
\\ \midrule
Label & Selection of output message as a string
...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule
Notes & ${d_{\text{offset}}}$ is from \hyperref[IM:calOfOffset]{IM:calOfOffset}.
...
\\
${d_{\text{offset}}}$ & Offset & \hyperref[IM:calOfOffset]{IM:calOfOffset} & ${\text{m}}$
\\
$s$ & Output message as a string & \hyperref[IM:selOfMessage]{IM:selOfMessage} & --
\\
${t_{\text{flight}}}$ & Flight duration & \hyperref[IM:calOfLandingTime]{IM:calOfLandingTime} & ${\text{s}}$
...
\\
\hyperref[IM:calOfOffset]{IM:calOfOffset} &  &  &  &  &  & X &  &  &  &  &  &  &  &  & 
\\
\hyperref[IM:selOfMessage]{IM:selOfMessage} &  &  &  &  &  & X &  &  &  &  &  &  &  &  & 
\\
...
\textbf{} & \textbf{\hyperref[DD:vecMag]{DD:vecMag}} & \textbf{\hyperref[DD:speedIX]{DD:speedIX}} & \textbf{\hyperref[DD:speedIY]{DD:speedIY}} & \textbf{\hyperref[TM:acceleration]{TM:acceleration}} & \textbf{\hyperref[TM:velocity]{TM:velocity}} & \textbf{\hyperref[GD:rectVel]{GD:rectVel}} & \textbf{\hyperref[GD:rectPos]{GD:rectPos}} & \textbf{\hyperref[GD:velVec]{GD:velVec}} & \textbf{\hyperref[GD:posVec]{GD:posVec}} & \textbf{\hyperref[IM:calOfLandingTime]{IM:calOfLandingTime}} & \textbf{\hyperref[IM:calOfLandingDist]{IM:calOfLandingDist}} & \textbf{\hyperref[IM:calOfOffset]{IM:calOfOffset}} & \textbf{\hyperref[IM:selOfMessage]{IM:selOfMessage}} & \textbf{\hyperref[inputValues]{FR:Input-Values}} & \textbf{\hyperref[verifyInVals]{FR:Verify-Input-Values}} & \textbf{\hyperref[calcValues]{FR:Calculate-Values}} & \textbf{\hyperref[outputValues]{FR:Output-Values}} & \textbf{\hyperref[correct]{NFR:Correct}} & \textbf{\hyperref[verifiable]{NFR:Verifiable}} & \textbf{\hyperref[understandable]{NFR:Understandable}} & \textbf{\hyperref[reusable]{NFR:Reusable}} & \textbf{\hyperref[maintainable]{NFR:Maintainable}} & \textbf{\hyperref[portable]{NFR:Portable}}
\\
