...
\begin{displaymath}
\int_{{v^{\text{i}}}}^{v}{1.0}\,dv=\int_{0.0}^{t}{{a^{c}}}\,dt
\end{displaymath}
...
\\ \midrule \\
Equation & \begin{displaymath}
           p={p^{\text{i}}}+{v^{\text{i}}} t+\frac{{a^{c}} t^{2}}{2.0}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
...
Assume we have rectilinear motion of a particle (of negligible size and shape, from \hyperref[pointMass]{A: pointMass}); that is, motion in a straight line. The position is $p$ and the velocity is $v$. The motion in \hyperref[TM:velocity]{TM: velocity} is now one-dimensional. The initial position (at $t=0.0$, from \hyperref[timeStartZero]{A: timeStartZero}) is represented by ${p^{\text{i}}}$. From \hyperref[TM:velocity]{TM: velocity}, using the above symbols we have:
...
\begin{displaymath}
\int_{{p^{\text{i}}}}^{p}{1.0}\,dp=\int_{0.0}^{t}{v}\,dt
\end{displaymath}
From \hyperref[GD:rectVel]{GD: rectVel} we can replace $v$:

\begin{displaymath}
\int_{{p^{\text{i}}}}^{p}{1.0}\,dp=\int_{0.0}^{t}{{v^{\text{i}}}+{a^{c}} t}\,dt
\end{displaymath}
Performing the integration, we have the required equation:
...
For a two-dimensional Cartesian coordinate system (\hyperref[twoDMotion]{A: twoDMotion} and \hyperref[cartSyst]{A: cartSyst}), we can represent the velocity vector as $\mathbf{v}=\begin{bmatrix}
                                                                                                                                                                                   ...
                                                                                                                                                                                   \end{bmatrix}$ and the acceleration vector as $\mathbf{a}=\begin{bmatrix}
                                                                                                                                                                                                                                             ...
                                                                                                                                                                                                                                             \end{bmatrix}$. The acceleration is assumed to be constant (\hyperref[constAccel]{A: constAccel}) and the constant acceleration vector is represented as ${\mathbf{a}^{\text{c}}}=\begin{bmatrix}
                                                                                                                                                                                                                                                                                                                                                                                                                               {{a_{\text{x}}}^{\text{c}}}\\
                                                                                                                                                                                                                                                                                                                                                                                                                               {{a_{\text{y}}}^{\text{c}}}
                                                                                                                                                                                                                                                                                                                                                                                                                               \end{bmatrix}$. The initial velocity (at $t=0.0$, from \hyperref[timeStartZero]{A: timeStartZero}) is represented by ${\mathbf{v}^{\text{i}}}=\begin{bmatrix}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             {{v_{\text{x}}}^{\text{i}}}\\
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             {{v_{\text{y}}}^{\text{i}}}
...
Equation & \begin{displaymath}
           \mathbf{p}=\begin{bmatrix}
                      {{p_{\text{x}}}^{\text{i}}}+{{v_{\text{x}}}^{\text{i}}} t+\frac{{{a_{\text{x}}}^{\text{c}}} t^{2}}{2.0}\\
                      {{p_{\text{y}}}^{\text{i}}}+{{v_{\text{y}}}^{\text{i}}} t+\frac{{{a_{\text{y}}}^{\text{c}}} t^{2}}{2.0}
                      \end{bmatrix}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
...
Input Constraints & \begin{displaymath}
                    {v_{\text{launch}}}\gt{}0.0
                    \end{displaymath}
                    \begin{displaymath}
                    0.0\lt{}θ\lt{}\frac{π}{2}
                    \end{displaymath}
\\ \midrule \\
Output Constraints & \begin{displaymath}
                     {t_{\text{flight}}}\gt{}0.0
                     \end{displaymath}
\\ \midrule \\
Equation & \begin{displaymath}
           {t_{\text{flight}}}=\frac{2.0 {v_{\text{launch}}} \sin\left(θ\right)}{\mathbf{g}}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & The constraint $0.0\lt{}θ\lt{}\frac{π}{2}$ is from \hyperref[posXDirection]{A: posXDirection} and \hyperref[yAxisGravity]{A: yAxisGravity}, and is shown in \hyperref[Figure:Launch]{Fig:Launch}.
        
        $\mathbf{g}$ is defined in \hyperref[gravAccelValue]{A: gravAccelValue}.
        
        The constraint ${t_{\text{flight}}}\gt{}0.0$ is from \hyperref[timeStartZero]{A: timeStartZero}.
...
We know that ${{p_{\text{y}}}^{\text{i}}}=0.0$ (\hyperref[launchOrigin]{A: launchOrigin}) and ${{a_{\text{y}}}^{\text{c}}}=-\mathbf{g}$ (\hyperref[accelYGravity]{A: accelYGravity}). Substituting these values into the y-direction of \hyperref[GD:posVec]{GD: posVec} gives us:

\begin{displaymath}
{p_{\text{y}}}={{v_{\text{y}}}^{\text{i}}} t-\frac{\mathbf{g} t^{2}}{2.0}
\end{displaymath}
To find the time that the projectile lands, we want to find the $t$ value (${t_{\text{flight}}}$) where ${p_{\text{y}}}=0.0$ (since the target is on the $x$-axis from \hyperref[targetXAxis]{A: targetXAxis}). From the equation above we get:

\begin{displaymath}
{{v_{\text{y}}}^{\text{i}}} {t_{\text{flight}}}-\frac{\mathbf{g} {t_{\text{flight}}}^{2}}{2.0}=0.0
\end{displaymath}
Dividing by ${t_{\text{flight}}}$ (with the constraint ${t_{\text{flight}}}\gt{}0.0$) gives us:

\begin{displaymath}
{{v_{\text{y}}}^{\text{i}}}-\frac{\mathbf{g} {t_{\text{flight}}}}{2.0}=0.0
\end{displaymath}
Solving for ${t_{\text{flight}}}$ gives us:

\begin{displaymath}
{t_{\text{flight}}}=\frac{2.0 {{v_{\text{y}}}^{\text{i}}}}{\mathbf{g}}
\end{displaymath}
...
\\ \midrule \\
Equation & \begin{displaymath}
           {p_{\text{land}}}=\frac{2.0 {v_{\text{launch}}}^{2} \sin\left(θ\right) \cos\left(θ\right)}{\mathbf{g}}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
...
Notes & The constraint $0.0\lt{}θ\lt{}\frac{π}{2}$ is from \hyperref[posXDirection]{A: posXDirection} and \hyperref[yAxisGravity]{A: yAxisGravity}, and is shown in \hyperref[Figure:Launch]{Fig:Launch}.
        ...
        The constraint ${p_{\text{land}}}\gt{}0.0$ is from \hyperref[posXDirection]{A: posXDirection}.
...
We know that ${{p_{\text{x}}}^{\text{i}}}=0.0$ (\hyperref[launchOrigin]{A: launchOrigin}) and ${{a_{\text{x}}}^{\text{c}}}=0.0$ (\hyperref[accelXZero]{A: accelXZero}). Substituting these values into the x-direction of \hyperref[GD:posVec]{GD: posVec} gives us:
...
\begin{displaymath}
{p_{\text{land}}}=\frac{{{v_{\text{x}}}^{\text{i}}}\cdot{}2.0 {v_{\text{launch}}} \sin\left(θ\right)}{\mathbf{g}}
\end{displaymath}
From \hyperref[DD:speedIX]{DD: speedIX} (with ${v^{\text{i}}}={v_{\text{launch}}}$) we can replace ${{v_{\text{x}}}^{\text{i}}}$:

\begin{displaymath}
{p_{\text{land}}}=\frac{{v_{\text{launch}}} \cos\left(θ\right)\cdot{}2.0 {v_{\text{launch}}} \sin\left(θ\right)}{\mathbf{g}}
\end{displaymath}
...
Notes & ${p_{\text{land}}}$ is from \hyperref[IM:calOfLandingDist]{IM: calOfLandingDist}.
        ...
        The constraints ${p_{\text{land}}}\gt{}0.0$ and ${p_{\text{target}}}\gt{}0.0$ are from \hyperref[posXDirection]{A: posXDirection}.
...
Equation & \begin{displaymath}
           s=\begin{cases}
             ...
             \text{``The projectile fell short.''}, & {d_{\text{offset}}}\lt{}0.0\\
             \text{``The projectile went long.''}, & {d_{\text{offset}}}\gt{}0.0
             \end{cases}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
...
Notes & ${d_{\text{offset}}}$ is from \hyperref[IM:offsetIM]{IM: offsetIM}.
        ...
        The constraint ${p_{\text{target}}}\gt{}0.0$ is from \hyperref[posXDirection]{A: posXDirection}.
        
        The constraint ${d_{\text{offset}}}\gt{}-{p_{\text{land}}}$ is from the fact that ${p_{\text{land}}}\gt{}0.0$, from \hyperref[posXDirection]{A: posXDirection}.
...
\midrule
\endhead
${p_{\text{target}}}$ & ${p_{\text{target}}}\gt{}0.0$ & $1.0\cdot{}10^{3}$ ${\text{m}}$ & 10$\%$
\\
${v_{\text{launch}}}$ & ${v_{\text{launch}}}\gt{}0.0$ & $100.0$ $\frac{\text{m}}{\text{s}}$ & 10$\%$
\\
$θ$ & $0.0\lt{}θ\lt{}\frac{π}{2}$ & $\frac{π}{4}$ ${\text{rad}}$ & 10$\%$
\\
\bottomrule
...
\midrule
\endhead
${p_{\text{land}}}$ & ${p_{\text{land}}}\gt{}0.0$
\\
