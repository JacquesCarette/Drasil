...
module GProc.HelloWorld (helloWorld) where

import Drasil.GProc (GSProgram, MSBody, MSBlock, MSStatement, SMethod, SVariable,
...
import GProc.Helper (helper)

-- | Creates the HelloWorld program and necessary files.
helloWorld :: (ProcProg r) => GSProgram r
...
myOtherList :: (ProcProg r) => SVariable r
...
helloWorldMain :: (ProcProg r) => SMethod r
...
helloInitVariables :: (ProcProg r) => MSBlock r
...
mySlicedList, mySlicedList2, mySlicedList3, mySlicedList4, mySlicedList5,
  ...
  mySlicedList10, mySlicedList11 :: (ProcProg r) => SVariable r
...
listSliceTests :: (ProcProg r) => [MSBlock r]
listSliceTests = [
...
helloIfBody :: (ProcProg r) => MSBody r
...
helloSwitch :: (ProcProg r) => MSStatement r
...
helloTryCatch :: (ProcProg r) => MSStatement r
