...
It will be reviewed by Samuel Crawford during the writing process, then
...
check it against the SRS checklist and the SRS rubric for CAS 741 \sjc{add
  links}; the only exception is that the Drasil team will only verify the SRS
