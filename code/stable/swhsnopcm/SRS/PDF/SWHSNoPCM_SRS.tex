...
\\ \midrule
RefBy & \hyperref[unlikeChgNIHG]{UC:No-Internal-Heat-Generation}, \hyperref[outputValues2]{FR:Output-Values-2}, \hyperref[outputValues]{FR:Output-Values}, \hyperref[findMass]{FR:Find-Mass}, and \hyperref[calcValues]{FR:Calculate-Values}
...
\item[Output-Values:\phantomsection\label{outputValues}]{Output ${T_{\text{W}}}$ (from \hyperref[IM:eBalanceOnWtr]{IM:eBalanceOnWtr}) and ${E_{\text{W}}}$ (from \hyperref[IM:heatEInWtr]{IM:heatEInWtr}) over $t$.}
\item[Output-Values-2:\phantomsection\label{outputValues2}]{Output ${T_{\text{W}}}$ (from \hyperref[IM:eBalanceOnWtr]{IM:eBalanceOnWtr}) and ${E_{\text{W}}}$ (from \hyperref[IM:heatEInWtr]{IM:heatEInWtr}).}
\end{description}
\begin{longtblr}
