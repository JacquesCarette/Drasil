...
Source & \cite{chen2005} and \cite{karchewski2012}
\\ \midrule \\
RefBy & \hyperref[IM:nrmShrFor]{IM: nrmShrFor} \hyperref[IM:intsliceFs]{IM: intsliceFs} \hyperref[IM:intsliceFs]{IM: intsliceFs} \hyperref[IM:fctSfty]{IM: fctSfty} \hyperref[displayShear]{FR: Display-Interslice-Shear-Forces} \hyperref[displayNormal]{FR: Display-Interslice-Normal-Forces} \hyperref[displayFS]{FR: Display-Factor-of-Safety} \hyperref[calculateFS]{FR: Calculate-Factors-of-Safety}.
\\ \bottomrule \end{tabular}
\end{minipage}
...
Source & \cite{chen2005} and \cite{karchewski2012}
\\ \midrule \\
RefBy & \hyperref[IM:nrmShrFor]{IM: nrmShrFor} \hyperref[IM:nrmShrForNum]{IM: nrmShrForNum} \hyperref[IM:nrmShrForDen]{IM: nrmShrForDen} \hyperref[IM:intsliceFs]{IM: intsliceFs} \hyperref[IM:fctSfty]{IM: fctSfty} \hyperref[displayShear]{FR: Display-Interslice-Shear-Forces} \hyperref[displayNormal]{FR: Display-Interslice-Normal-Forces} \hyperref[displayFS]{FR: Display-Factor-of-Safety} \hyperref[calculateFS]{FR: Calculate-Factors-of-Safety}.
\\ \bottomrule \end{tabular}
\end{minipage}
...
Source & \cite{li2010}
\\ \midrule \\
RefBy & \hyperref[generateCSS]{FR: Generate-Critical-Slip-Surfaces} \hyperref[displayGraph]{FR: Display-Graph} \hyperref[determineCritSlip]{FR: Determine-Critical-Slip-Surface}.
\\ \bottomrule \end{tabular}
\end{minipage}
...
\item[Generate-Critical-Slip-Surfaces:\phantomsection\label{generateCSS}]Generate potential critical slip surfaces for the input slope (using \hyperref[IM:crtSlpId]{IM: crtSlpId}).
\item[Calculate-Factors-of-Safety:\phantomsection\label{calculateFS}]Calculate the factors of safety for each of the potential critical slip surfaces (using \hyperref[IM:fctSfty]{IM: fctSfty}, \hyperref[IM:nrmShrFor]{IM: nrmShrFor}, \hyperref[IM:intsliceFs]{IM: intsliceFs}).
\item[Determine-Critical-Slip-Surface:\phantomsection\label{determineCritSlip}]Compare the factor of safety for each potential critical slip surface to determine the minimum factor of safety, corresponding to the critical slip surface (using \hyperref[IM:crtSlpId]{IM: crtSlpId}).
...
\begin{itemize}
\item[Correct:\phantomsection\label{correct}]The the outputs of the code have the properties described in (Properties of a Correct Solution).
