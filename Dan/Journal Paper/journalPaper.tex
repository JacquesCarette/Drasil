...
scope for our proof of concept in the interest of time.
...
\end{lstlisting}
\caption{Assembling a document using only the low-level document language is 
tedious}
\label{Fig:DumbDoc}
\end{figure}
...
of its components, then we will take a look at the \emph{GlassBR} example 
...
\ds{Somewhere in here (probably in GlassBR) I need to really emphasize the 
