...
\begin{itemize}
  ...
  \uncover<5->{\item \textbf{patterns}: For more efficient coding}
  \uncover<6->{\item \textbf{expressivity}: So language works for real examples}
...
\item Design language allowed users to influence design
