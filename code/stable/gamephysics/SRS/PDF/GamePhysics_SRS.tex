...
\\ \midrule \\
Equation & \begin{displaymath}
           g=-\frac{G M}{\|\symbf{d}\|^{2}} \symbf{\hat{d}}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
...
\\ \midrule \\
Input & ${\symbf{v}_{j}}$, $t$, $g$, ${\symbf{F}_{j}}$, ${m_{j}}$
...
\\ \midrule \\
Equation & \begin{displaymath}
           {\symbf{a}_{j}}=g+\frac{{\symbf{F}_{j}}\left(t\right)}{{m_{j}}}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
