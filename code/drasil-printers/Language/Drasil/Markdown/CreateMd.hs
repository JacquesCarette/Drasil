...
makeMd :: [Doc] -> Doc
makeMd lst = (vcat . punctuate secSep . filtEmp) lst <>
    doubleSep <> endNote 
...
-- | Drasil Tree icon.
drasilImage :: Doc
drasilImage = text "<div style=\"text-align: center;\">" <> 
  contSep <> text "<img src=\"../../../../drasil-website/WebInfo/images/Icon.png\" alt=\"Drasil Tree\" width=\"200\" />"
  <> contSep <> text "</div>"
-- | End section.
endNote :: Doc
endNote = secSep <> contSep <> text "*This README is a software artifact generated by Drasil.*" <> doubleSep <> license <> doubleSep <> drasilImage 
