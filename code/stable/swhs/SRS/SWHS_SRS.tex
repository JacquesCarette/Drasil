...
\\ \bottomrule \end{tabular}
\end{minipage}
\textbf{Detailed derivation of simplified rate of change of temperature:}
...
\\ \bottomrule \end{tabular}
\end{minipage}
\textbf{Detailed derivation of the energy balance on water:}
...
\\ \bottomrule \end{tabular}
\end{minipage}
\textbf{Detailed derivation of the energy balance on the PCM during sensible heating phase:}
