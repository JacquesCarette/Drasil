...
In this section we will explore previous efforts in automating software artifact
generation, as well as take a look at the current state of Model Driven
Engineering and scientific knowledge ontologies.
...
artifact reuse. One aim of these approaches was to remove the burden of
replicating some artifacts.
...
\wss{This feels like introductory material.  It should likely go earlier in the paper.}
...
Once we have properly captured the relevant knowledge, we shouldn't \wss{avoid
