...
\item[Portability Requirement:\phantomsection\label{portable}]{The code shall be portable to multiple Operating Systems, particularly Windows, Mac OSX, Linux.}
\end{itemize}
...
\\
\hyperref[portable]{NFR:Portability Requirement} &  &  &  &  &  &  & 
