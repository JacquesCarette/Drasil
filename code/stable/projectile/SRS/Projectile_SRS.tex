...
\item[posXDirection:\phantomsection\label{posXDirection}]The positive x-direction is from the launcher to the target. \hyperref[IM:calOfLandingTime]{IM: calOfLandingTime} \hyperref[IM:offsetIM]{IM: offsetIM} \hyperref[IM:messageIM]{IM: messageIM} \hyperref[IM:calOfLandingDist]{IM: calOfLandingDist} \hyperref[IM:calOfLandingDist]{IM: calOfLandingDist}.
...
\item[timeStartZero:\phantomsection\label{timeStartZero}]Time starts at zero. \hyperref[IM:calOfLandingTime]{IM: calOfLandingTime} \hyperref[GD:rectVel]{GD: rectVel} \hyperref[GD:rectPos]{GD: rectPos}.
\end{itemize}
...
Source & --
\\ \midrule \\
RefBy & \hyperref[IM:offsetIM]{IM: offsetIM} \hyperref[calcValues]{FR: Calculate-Values}.
\\ \bottomrule \end{tabular}
\end{minipage}
...
Source & --
\\ \midrule \\
RefBy & \hyperref[outputValues]{FR: Output-Values} \hyperref[IM:messageIM]{IM: messageIM} \hyperref[calcValues]{FR: Calculate-Values}.
\\ \bottomrule \end{tabular}
\end{minipage}
\par~
...
Description & \begin{symbDescription}
              ...
              \item{${d_{offset}}$ is the offset between the target position and the landing position (m)}
              \item{${p_{target}}$ is the target position (m)}
              \item{$ε$ is the tolerance for a hit (Unitless)}
              \end{symbDescription}
\\ \midrule \\
...
Source & --
\\ \midrule \\
RefBy & \hyperref[outputValues]{FR: Output-Values} \hyperref[calcValues]{FR: Calculate-Values}.
\\ \bottomrule \end{tabular}
\end{minipage}
