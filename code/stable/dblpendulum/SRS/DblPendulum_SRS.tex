...
\begin{displaymath}
m {L_{\text{rod}}}^{2.0} \frac{\,d\frac{\,d{θ_{p}}}{\,dt}}{\,dt}=-{L_{\text{rod}}} m \mathbf{g} \sin\left({θ_{p}}\right)
\end{displaymath}
...
\\ \midrule \\
Equation & \begin{displaymath}
           T=2.0 π \sqrt{\frac{{L_{\text{rod}}}}{\mathbf{g}}}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & The constraint ${θ_{i}}\gt{}0.0$ is required The. angular frequency is defined in \hyperref[GD:angFrequencyGD]{GD: angFrequencyGD}
...
\begin{displaymath}
-m \mathbf{g} \sin\left({θ_{p}}\right) {L_{\text{rod}}}=m {L_{\text{rod}}}^{2.0} \frac{\,d\frac{\,d{θ_{p}}}{\,dt}}{\,dt}
\end{displaymath}
And rearranged as:

\begin{displaymath}
\frac{\,d\frac{\,d{θ_{p}}}{\,dt}}{\,dt}+\frac{\mathbf{g}}{{L_{\text{rod}}}} \sin\left({θ_{p}}\right)=0.0
\end{displaymath}
...
\begin{displaymath}
\frac{\,d\frac{\,d{θ_{p}}}{\,dt}}{\,dt}+\frac{\mathbf{g}}{{L_{\text{rod}}}} {θ_{p}}=0.0
\end{displaymath}
...
\midrule
\endhead
${L_{\text{rod}}}$ & ${L_{\text{rod}}}\gt{}0.0$ & $44.2$ ${\text{m}}$ & 10$\%$
\\
${θ_{i}}$ & ${θ_{i}}\gt{}0.0$ & $2.1$ ${\text{rad}}$ & 10$\%$
\\
\bottomrule
