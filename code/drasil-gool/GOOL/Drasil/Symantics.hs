...
class (ScopeSym repr, StatementSym repr) => StateVarSym repr where
  ...
  privDVar :: VS (repr (Variable repr)) -> CS (repr (StateVar repr))
  pubDVar  :: VS (repr (Variable repr)) -> CS (repr (StateVar repr))
  pubSVar  :: VS (repr (Variable repr)) -> CS (repr (StateVar repr))
