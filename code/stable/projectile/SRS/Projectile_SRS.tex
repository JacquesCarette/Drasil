...
Source & --
\\ \midrule \\
RefBy & \hyperref[outputValues]{FR: Output-Values} \hyperref[IM:messageIM]{IM: messageIM} \hyperref[IM:hitIM]{IM: hitIM} \hyperref[calcValues]{FR: Calculate-Values}.
\\ \bottomrule \end{tabular}
\end{minipage}
\par~
