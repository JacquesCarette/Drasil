...
orientation = uc' "phi" "orientation" 
...
force_1 = uc' "F_1" "force exerted by the first body (on another body)"
  "FIXME: Define this or remove the need for definitions" 
  (sub (force ^. symbol) (Atomic "1")) newton
force_2 = uc' "F_2" "force exerted by the second body (on another body)"
  "FIXME: Define this or remove the need for definitions" 
...
mass_1  = uc' "m_1" "mass of the first body" 
  "FIXME: Define this or remove the need for definitions"
  (sub (mass ^. symbol) (Atomic "1")) kilogram
mass_2  = uc' "m_2" "mass of the second body" 
  "FIXME: Define this or remove the need for definitions" 
  (sub (mass ^. symbol) (Atomic "2")) kilogram
dispUnit = uc' "rhat" "unit displacement vector" 
...
dispNorm    = uc' "||r||" "Euclidean norm of the displacement"
  "FIXME: Define this or remove the need for definitions" 
  (Concat [Atomic "||", (disp ^. symbol), Atomic "||"]) metre
sqrDist = uc' "||r||^2" "squared distance" 
  "FIXME: Define this or remove the need for definitions" 
...
pos_CM = uc' "p_CM" ("the mass-weighted average position of a rigid " ++
    "body's particles") 
    "FIXME: Define this or remove the need for definitions" 
    (sub (position ^. symbol) (Atomic "CM")) metre
mass_i = uc' "m_i" "mass of the i-th particle" 
  "FIXME: Define this or remove the need for definitions" 
  (sub (mass ^. symbol) lI) kilogram
pos_i = uc' "p_i" "position vector of the i-th particle"
  "FIXME: Define this or remove the need for definitions" 
  (sub (position ^. symbol) lI) metre
mTot = uc' "M" "total mass of the rigid body"
