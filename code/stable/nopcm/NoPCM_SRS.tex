...
The instance models that govern Solar Water Heating Systems are presented in Section~\ref{Sec:IMs}. The information to understand the meaning of the instance models and their derivation is also presented, so that the instance models can be verified.
...
Description & \begin{description}
              ...
              \item{$\rho{}$ is the density ($\frac{\text{kg}}{\text{m}^{3}}$)}
...
\\ \midrule \\
Equation & \begin{dmath}
           \mathbf{q}\left(t\right)=h \Delta{}T\left(t\right)
           \end{dmath}
\\ \midrule \\
Description & \begin{description}
              \item{$\mathbf{q}$ is the thermal flux vector ($\frac{\text{W}}{\text{m}^{2}}$)}
              ...
              \item{$\Delta{}T$ is the change in temperature (${}^{\circ}$C)}
              \end{description}
\\ \midrule \\
Source & 
\\ \midrule \\
...
\noindent \begin{minipage}{\textwidth}
\begin{tabular}{p{0.2\textwidth} p{0.73\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:ht\_flux\_C}
\phantomsection 
\label{DD:ht\_flux\_C}
\\ \midrule \\
...
\\ \midrule \\
Equation & \begin{dmath}
           \frac{d\,{T_{W}}}{d\,t}=\frac{1}{{\tau{}_{W}}} \left({T_{C}}-{T_{W}}\left(t\right)\right)
           \end{dmath}
\\ \midrule \\
Description & \begin{description}
              \item{${T_{W}}$ is the temperature of the water (${}^{\circ}$C)}
              \item{$t$ is the time (s)}
              \item{${\tau{}_{W}}$ is the ODE parameter for water (s)}
              \item{${T_{C}}$ is the temperature of the heating coil (${}^{\circ}$C)}
              \end{description}
\\ \midrule \\
Source & 
...
\end{description}
\begin{description}
\item[\refstepcounter{lcnum}\lcthelcnum\label{LC:likeChg3}:]A\ref{A:assump9.npnc}- The model currently only accounts for charging of the tank. A more complete model would also account for discharging of the tank.
\end{description}
\begin{description}
