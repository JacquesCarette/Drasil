...
nameGenTestOO :: OOProg r vis smt mthd svr att prg => OO.GSProgram r prg
nameGenTestOO = OO.prog "NameGenTest" "" [OO.fileDoc $ OO.buildModule
  "NameGenTest" [] [main, helper] []]

nameGenTestProc :: ProcProg r vis smt mthd prg => GProc.GSProgram r prg
nameGenTestProc = GProc.prog "NameGenTest" "" [GProc.fileDoc $ GProc.buildModule
  "NameGenTest" [] [main, helper]]

helper :: SharedProg r vis smt mthd => MS (r mthd)
...
main :: SharedProg r vis smt mthd => MS (r mthd)
