...
\label{chap:intro:sec:research-questions}
...
that existed, in full, before I started contributing to Drasil. As such, I had
no part in contributing to those code snippets. All other code snippets,
excluding excerpts from generated artifact snippets, includes my work, but might
also include the work of others who were also contributing to the project while
I was also actively contributing. The work of others might include, but not
limited to, code formatting, code commenting, and extensions.
