...
data SomeProgGenerator where
  SomeProgGenerator
    :: forall repr vis scope typ var param val stmt mthd stvr attch prg file mod bod block. (OOProg repr vis scope typ var param val stmt mthd stvr attch prg file mod bod block)
