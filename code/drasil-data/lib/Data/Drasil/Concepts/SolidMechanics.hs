...
shearForce = cncpt''' (mkUid "shearForce") (cn' "shear force")
  (S "a" +:+ phrase force +:+ S "applied parallel to the plane of the material")

stffness   = cncpt''' (mkUid "stffness") (cn "stiffness")
