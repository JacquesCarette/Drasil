...
gbConstants = [constantM, constantK, constantModElas, constant_LoadDur, constant_LoadSF]
                ++ gBRSpecParamVals 

constantM, constantK, constantModElas, constant_LoadDur, constant_LoadSF :: QDefinition
