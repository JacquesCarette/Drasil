...
def derived_params(params):
    # cal aspect ratio
    params.asprat = round (params.a / params.b, 11)
    ...
    if params.t == "2.5":
        ...
        params.h = 2.59
    elif (params.t == "3" or params.t == "3.0"):
        params.h = 2.92
    elif (params.t == "4" or params.t == "4.0"):
        params.h = 3.78
    elif (params.t == "5" or params.t == "5.0"):
        params.h = 4.57
    elif (params.t == "6" or params.t == "6.0"):
        params.h = 5.56
    elif (params.t == "8" or params.t == "8.0"):
        params.h = 7.42
    elif (params.t == "10" or params.t == "10.0"):
        params.h = 9.02
    elif (params.t == "12" or params.t == "12.0"):
        params.h = 11.91
    elif (params.t == "16" or params.t == "16.0"):
        params.h = 15.09
    elif (params.t == "19" or params.t == "19.0"):
        params.h = 18.26
    elif (params.t == "22" or params.t == "22.0"):
        params.h = 21.44
    else:
