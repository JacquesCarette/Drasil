...
\begin{itemize}
\item[objectTy:\phantomsection\label{assumpOT}]All objects are rigid bodies. \hyperref[DD:chalses]{DD: chalses} \hyperref[DD:relVelInColl]{DD: relVelInColl} \hyperref[IM:transMot]{IM: transMot} \hyperref[IM:rotMot]{IM: rotMot} \hyperref[DD:ctrOfMass]{DD: ctrOfMass} \hyperref[DD:linVel]{DD: linVel} \hyperref[DD:linDisp]{DD: linDisp} \hyperref[DD:linAcc]{DD: linAcc} \hyperref[DD:impulse]{DD: impulse} \hyperref[IM:col2D]{IM: col2D} \hyperref[TM:ChaslesThm]{TM: ChaslesThm} \hyperref[DD:angVel]{DD: angVel} \hyperref[DD:angDisp]{DD: angDisp} \hyperref[DD:angAccel]{DD: angAccel}.
\item[objectDimension:\phantomsection\label{assumpOD}]All objects are 2D. \hyperref[IM:transMot]{IM: transMot} \hyperref[IM:rotMot]{IM: rotMot} \hyperref[DD:ctrOfMass]{DD: ctrOfMass} \hyperref[TM:NewtonSecLawRotMot]{TM: NewtonSecLawRotMot} \hyperref[DD:linVel]{DD: linVel} \hyperref[DD:linDisp]{DD: linDisp} \hyperref[DD:linAcc]{DD: linAcc} \hyperref[DD:impulse]{DD: impulse} \hyperref[IM:col2D]{IM: col2D} \hyperref[DD:angVel]{DD: angVel} \hyperref[DD:angDisp]{DD: angDisp} \hyperref[DD:angAccel]{DD: angAccel}.
...
\noindent \begin{minipage}{\textwidth}
\begin{tabular}{p{0.2\textwidth} p{0.73\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:relVelInColl}
\phantomsection 
\label{DD:relVelInColl}
\\ \midrule \\
Label & Relative Velocity Between Rigid Bodies of A and B
        \\ \midrule \\
...
\noindent \begin{minipage}{\textwidth}
\begin{tabular}{p{0.2\textwidth} p{0.73\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:kinetic energy}
\phantomsection 
\label{DD:kinetic energy}
\\ \midrule \\
...
\toprule
 & \hyperref[reqVPC]{FR: Verify-Physical\_Constraints} & \hyperref[IM:rotMot]{IM: rotMot} & \hyperref[DD:impulse]{DD: impulse} & \hyperref[IM:col2D]{IM: col2D} & \hyperref[IM:transMot]{IM: transMot} & \hyperref[lcIJC]{LC: Include-Joints-Constraints} & \hyperref[lcEC]{LC: Expanded-Collisions} & \hyperref[DD:linVel]{DD: linVel} & \hyperref[DD:linDisp]{DD: linDisp} & \hyperref[DD:linAcc]{DD: linAcc} & \hyperref[lcID]{LC: Include-Dampening} & \hyperref[DD:angVel]{DD: angVel} & \hyperref[DD:angDisp]{DD: angDisp} & \hyperref[DD:angAccel]{DD: angAccel} & \hyperref[DD:ctrOfMass]{DD: ctrOfMass} & \hyperref[TM:NewtonSecLawRotMot]{TM: NewtonSecLawRotMot} & \hyperref[DD:chalses]{DD: chalses} & \hyperref[DD:relVelInColl]{DD: relVelInColl} & \hyperref[TM:ChaslesThm]{TM: ChaslesThm}
\\
\midrule
\endhead
...
\\
\hyperref[assumpDI]{A: dampingInvolvement} &  & X &  & X & X &  &  & X & X & X & X & X & X & X &  &  &  &  & 
\\
\hyperref[assumpOD]{A: objectDimension} &  & X & X & X & X &  &  & X & X & X &  & X & X & X & X & X &  &  & 
\\
\hyperref[assumpOT]{A: objectTy} &  & X & X & X & X &  &  & X & X & X &  & X & X & X & X &  & X & X & X
\\
...
\\
IM3 (\hyperref[DD:relVelInColl]{DD: relVelInColl}) & X & X &  &  & X & X & X
\\
LC1 (\hyperref[DD:kinetic energy]{DD: kinetic energy}) &  &  &  &  &  &  & 
\\
LC2 (\hyperref[IM:transMot]{IM: transMot}) &  &  &  &  & X &  & 
\\
LC3 (\hyperref[IM:rotMot]{IM: rotMot}) &  &  &  &  &  & X & 
\\
LC4 (\hyperref[IM:col2D]{IM: col2D}) &  &  &  &  &  &  & X
\\
\bottomrule
...
IM2 (\hyperref[DD:torque]{DD: torque}) &  &  &  &  & X &  &  &  &  &  &  &  & X & X & X & X &  &  &  &  &  &  & 
\\
IM3 (\hyperref[DD:relVelInColl]{DD: relVelInColl}) &  &  &  &  &  & X & X &  &  &  & X & X & X &  &  &  &  &  &  & X &  &  & 
\\
\bottomrule
