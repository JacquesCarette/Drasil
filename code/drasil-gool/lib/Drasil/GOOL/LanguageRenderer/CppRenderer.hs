...
instance (Pair p) => StatementSym (p CppSrcCode CppHdrCode) (Doc, Terminator)
...
instance StatementSym CppSrcCode (Doc, Terminator)
...
instance StatementSym CppHdrCode (Doc, Terminator)
