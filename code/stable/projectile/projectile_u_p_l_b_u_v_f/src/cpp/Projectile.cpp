...
int main(int argc, const char *argv[]) {
    ...
    outfile.open("log.txt", std::fstream::app);
    outfile << "var 'g' assigned ";
    outfile << g;
    outfile << " in module Projectile" << std::endl;
    outfile.close();
    outfile.open("log.txt", std::fstream::app);
    outfile << "var 'epsilon' assigned ";
    outfile << epsilon;
    outfile << " in module Projectile" << std::endl;
    outfile.close();
...
float func_t_flight(InputParameters &inParams, float g) {
    ofstream outfile;
    outfile.open("log.txt", std::fstream::app);
    ...
    return 2.0f * inParams.v_launch * sin(inParams.theta) / g;
}

float func_p_land(InputParameters &inParams, float g) {
    ofstream outfile;
    outfile.open("log.txt", std::fstream::app);
    ...
    return 2.0f * pow(inParams.v_launch, 2.0f) * sin(inParams.theta) * cos(inParams.theta) / g;
}
...
string func_s(InputParameters &inParams, float epsilon, float d_offset) {
    ofstream outfile;
    outfile.open("log.txt", std::fstream::app);
