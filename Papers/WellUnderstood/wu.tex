...
of IEEE XXXX~\cite{IEEESpec}
and the Volere template~\cite{Volere}.
...
The admitedly awkward embedding of English used here allows us to do all sorts of
...
We can the generate multiple artifacts (here: specification in HTML and \LaTeX,
