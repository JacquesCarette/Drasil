...
Source & \cite{astm2009}
\\ \midrule \\
RefBy & \hyperref[DD:sdf.tol]{DD: sdf\_tol} \hyperref[DD:riskFun]{DD: riskFun} \hyperref[DD:nFL]{DD: nFL} \hyperref[DD:dimlessLoad]{DD: dimlessLoad}.
\\ \bottomrule \end{tabular}
\end{minipage}
\par~
...
Source & \cite{astm2009}
\\ \midrule \\
RefBy & \hyperref[DD:sdf.tol]{DD: sdf\_tol} \hyperref[DD:riskFun]{DD: riskFun}.
\\ \bottomrule \end{tabular}
\end{minipage}
\par~
