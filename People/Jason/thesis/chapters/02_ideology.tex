...
might be able to write a \ACF{ffi}, but they're often brittle and demanding of
...
highly practical. For example, \ACFP{aml} (such as HashedExpression
...
Finally, we've reached the deep depth and wide breadth of knowledge capture.
