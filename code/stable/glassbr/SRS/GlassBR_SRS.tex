...
\\ \midrule \\
RefBy & \hyperref[IM:isSafeLR]{IM: isSafeLR} \hyperref[IM:isSafeLR]{IM: isSafeLR} \hyperref[checkGlassSafety]{FR: Check-Glass-Safety}.
...
Source & \cite{astm2009}
\\ \midrule \\
RefBy & \hyperref[IM:isSafePb]{IM: isSafePb} \hyperref[IM:isSafePb]{IM: isSafePb} \hyperref[checkGlassSafety]{FR: Check-Glass-Safety}.
\\ \bottomrule \end{tabular}
\end{minipage}
...
\\ \midrule \\
RefBy & \hyperref[IM:isSafePb]{IM: isSafePb} \hyperref[IM:isSafePb]{IM: isSafePb}.
\\ \bottomrule \end{tabular}
\end{minipage}
\par~
...
Source & \cite{astm2009}
\\ \midrule \\
RefBy & \hyperref[IM:isSafeLR]{IM: isSafeLR} \hyperref[IM:isSafeLR]{IM: isSafeLR}.
\\ \bottomrule \end{tabular}
\end{minipage}
\par~
...
Source & \cite{astm2009}
\\ \midrule \\
RefBy & \hyperref[IM:isSafeLR]{IM: isSafeLR} \hyperref[IM:isSafeLR]{IM: isSafeLR} \hyperref[DD:dimlessLoad]{DD: dimlessLoad}.
\\ \bottomrule \end{tabular}
\end{minipage}
