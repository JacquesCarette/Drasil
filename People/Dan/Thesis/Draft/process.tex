...
\ds{This is the spot for talking about knowledge in different contexts, the 
naive "slap it all in one database" approach vs. context-specific organized 
groups. This is also where the Domain/Common knowledge breakdown comes into 
play -- talk about physics problems, SI units, Chemistry, etc}
