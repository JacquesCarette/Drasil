...
mkLklyChnkL :: String -> Sentence -> Label -> LabelledContent
mkLklyChnkL i desc label = mkRawLC (Change (lc i desc label)) label

mkUnLklyChnkL :: String -> Sentence -> Label -> LabelledContent 
mkUnLklyChnkL i desc label = mkRawLC (Change (ulc i desc label)) label
