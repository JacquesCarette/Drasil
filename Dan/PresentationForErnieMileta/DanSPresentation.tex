...
\begin{itemize}
\item Update the definition in the SRS
\item Update the definition in the LPM
\item Modify the source code to reflect the new requirements
\item Trace any and all dependencies
\item Modify dependents to accomodate the change
\item Ensure each of the documents is up to date and consistent
\end{itemize}
