...
\\
$P$ & Resistive Shear Force: Mohr Coulomb frictional force per meter in the z-direction that describes the limit ofmobilized shear force a slice can withstand before failure & $\frac{\text{N}}{\text{m}}$
\\
$Q$ & External Force: a downward force per meter in the z-direction acting into the surface from midpoint of slice i & $\frac{\text{N}}{\text{m}}$
\\
...
\\
${U_{b}}$ & Base Hydrostatic Force: per meter in the z-direction from water pressure within the slice & $\frac{\text{N}}{\text{m}}$
\\
${U_{t}}$ & Surface Hydrostatic Force: per meter in the z-direction from water pressure acting into the slice from standing water on the slope surface for slice index i & $\frac{\text{N}}{\text{m}}$
\\
...
\\
$z$ & Z-Ordinate: in the Cartesian coordinate system & m
\\
$α$ & Angle: between the base of a slice and the horizontal & ${}^{\circ}$
\\
$β$ & Angle: between the surface of a slice and the horizontal & ${}^{\circ}$
\\
...
\\
$ω$ & Angle: between the external force acting into the surface and the vertical & ${}^{\circ}$
\\
${ℓ_{b}}$ & Width of the Base of a Slice: in the x-direction & m
\\
...
\item[Soil-Layer-Homogeneous:\phantomsection\label{assumpSLH}]The soil mass is homogeneous, with consistent soil properties throughout. \hyperref[GD:resShr]{GD: resShr} \hyperref[LC_inhomogeneous]{LC: Calculate-Inhomogeneous-Soil-Layers}.
...
\\ \bottomrule \end{tabular}
\end{minipage}
Force equilibrium is derived from the free body diagram of \hyperref[Figure:ForceDiagram]{Fig:ForceDiagram} in \hyperref[Sec:PhysSyst]{Section: Physical System Description}.
\par~
        ...
        Units & $\frac{\text{N}}{\text{m}}$
                ...
                Equation & \begin{displaymath}
                           ...
                           Description & \begin{symbDescription}
                                         ...
                                         \item{$φ'$ is the effective angle of friction (${}^{\circ}$)}
                                         \item{$c'$ is the effective cohesion (Pa)}
                                         \item{${ℓ_{b}}$ is the width of the base of a slice (m)}
                                         \end{symbDescription}
                                         \\ \midrule \\
...
\end{cases}
                                    ...
                                    Description & \begin{symbDescription}
                                                  ...
                                                  Notes & \hyperref[assumpSBSBISL]{A: Surface-Base-Slice-between-Interslice-Straight-Lines}
                                                          ...
                                                          Source & \cite{fredlund1977}
                                                                   \\ \midrule \\
                                                                   RefBy & \hyperref[GD:normForcEq]{GD: normForcEq} \hyperref[GD:bsShrFEq]{GD: bsShrFEq}.
\\ \bottomrule \end{tabular}
\end{minipage}
\par~
...
\label{DD:lengthLb}
\\ \midrule \\
Label & Width of the base of a slice
        \\ \midrule \\
        Symbol & ${ℓ_{b}}$
                 \\ \midrule \\
                 Units & m
                         ...
                         Equation & \begin{displaymath}
                                    ...
                                    Description & \begin{symbDescription}
                                                  ...
                                                  Notes & \hyperref[assumpSBSBISL]{A: Surface-Base-Slice-between-Interslice-Straight-Lines}
                                                          ...
                                                          Source & \cite{fredlund1977}
                                                                   \\ \midrule \\
                                                                   RefBy & \hyperref[GD:resShr]{GD: resShr} \hyperref[GD:mobShr]{GD: mobShr}.
\\ \bottomrule \end{tabular}
\end{minipage}
\par~
