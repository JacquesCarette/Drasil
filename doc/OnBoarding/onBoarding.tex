...
\item Brandon Bosman, MSc candidate
\item Xinlu Yan, MEng candidate
\item Zhuo (Joe) Zheng, MEng candidate
\item Daphne Jarabek, BSc candidate
\item Camila Shibata, BSc candidate
\end{itemize}
...
\item [Start date:] Monday, May 4, 2026

\item [End date:] Variable Friday, Aug 21, 2026

\item [Workspace:] ITB/232. You will need a proximity card to access your
...
problems, please talk to the Assistant Department Manager, Ms. Connie Carrabs,
located in ITB/202.
...
\item [``All hands'' meetings:] Tuesdays at 1:45 pm in ITB/159.  These meetings are for the full Drasil team.  We will focus on blockers for your work.  The first meeting will be on Tuesday, May 5, 2026.  The agendas for the
\href{https://github.com/JacquesCarette/Drasil/issues/4937} {first meeting} and subsequent meetings with be on GitHub.
\end{description}
...
We use several repos for our work.  They are listed below roughly in order of
...
{SE2AA4/CS2ME3 tutorial}.

\item Although we start new contributors with issues labelled ``newcomers'', our
goal is for each contributor to find a substantial, well-defined project.  We
will work with you to find a project that is interesting and rewarding for you,
while also matching our current goals for the Drasil project.  You can start
thinking about potential projects as you work through the issues and learn about
Drasil.  We will discuss potential projects with you throughout the summer, and
we will help you to define a project that is a good fit for your interests and
skills.  You can find a list of
\href{https://github.com/JacquesCarette/Drasil/wiki/Potential-Projects}
{potential projects} in the Drasil wiki. The scope of some of these projects is
too large for a summer, but they can be broken down into smaller pieces.  If you
have an idea for a project that is not on the list, please let us know.  We are
...
\item
\href{https://github.com/JacquesCarette/Drasil/wiki/Letter-to-Summer-Students}
...
\begin{itemize}
\item For all your open branches, if they are unsalvageable or not useful,
please delete them. Otherwise, please file a draft PR, explaining the state and
nature of the work. If possible, explaining how others may continue it.
\item For all your open issues and/or pull requests, please discuss the state
of the work. It would be appreciated if you could leave it in a state where another
summer student could read your comments and pick up where you left off.
