...
created to tackle these problems. \ds{Add something here about what Drasil is 
before the isn't}
...
\end{center}}{A subset of Drasil's chunks showing how different chunks may belong to 
multiple classifications \ds{with specific conceptual 
properties}}{fig:chunksClassified}
...
template table of contents\ds{Link to the ToC figure or embed here}. We use a 
number of helper functions and data types 
