...
\\ \midrule \\
Equation & \begin{displaymath}
           \frac{\,d\frac{\,d{y_{\text{t}}}}{\,dt}}{\,dt}+\left(1.0+{K_{\text{d}}}\right) \frac{\,d{y_{\text{t}}}}{\,dt}+\left(20.0+{K_{\text{p}}}\right) {y_{\text{t}}}-{r_{\text{t}}} {K_{\text{p}}}=0.0
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
              \item{$t$ is the time (${\text{s}}$)}
...
\begin{displaymath}
{Y_{\text{s}}}=\left({R_{\text{s}}}-{Y_{\text{s}}}\right) \left({K_{\text{p}}}+{K_{\text{d}}} s\right) \frac{1.0}{s^{2}+s+20.0}
\end{displaymath}
Substituting the values and rearranging the equation.

\begin{displaymath}
s^{2} {Y_{\text{s}}}+\left(1.0+{K_{\text{d}}}\right) {Y_{\text{s}}} s+\left(20.0+{K_{\text{p}}}\right) {Y_{\text{s}}}-{R_{\text{s}}} s {K_{\text{d}}}-{R_{\text{s}}} {K_{\text{p}}}=0.0
\end{displaymath}
...
\begin{displaymath}
\frac{\,d\frac{\,d{y_{\text{t}}}}{\,dt}}{\,dt}+\left(1.0+{K_{\text{d}}}\right) \frac{\,d{y_{\text{t}}}}{\,dt}+\left(20.0+{K_{\text{p}}}\right) {y_{\text{t}}}-{K_{\text{d}}} \frac{\,d{r_{\text{t}}}}{\,dt}-{r_{\text{t}}} {K_{\text{p}}}=0.0
\end{displaymath}
...
\midrule
\endhead
${K_{\text{d}}}$ & ${K_{\text{d}}}\geq{}0.0$ & $1.0$ & 10$\%$
\\
${K_{\text{p}}}$ & ${K_{\text{p}}}\gt{}0.0$ & $20.0$ & 10$\%$
\\
${r_{\text{t}}}$ & ${r_{\text{t}}}\gt{}0.0$ & $1.0$ & 10$\%$
\\
${t_{\text{sim}}}$ & $1.0\leq{}{t_{\text{sim}}}\leq{}60.0$ & $10.0$ ${\text{s}}$ & 10$\%$
\\
