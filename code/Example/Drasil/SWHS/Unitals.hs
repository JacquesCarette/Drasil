...
temp_init = uqc "temp_init" (nounPhraseSP "initial temperature")
  ...
  [physc $ Bounded (Exc,0) (Exc, sy melt_pt)] (dbl 40) 0.1 Nothing
...
time_final = uqc "time_final" (nounPhraseSP "final time")
  ...
  [gtZeroConstr,
  sfwrc $ UpTo $ (Exc, sy time_final_max)] (dbl 50000) 0.1 Nothing
...
temp_W = uqcNU "temp_W"
  ...
  [physc $ Bounded (Inc, sy temp_init) (Inc, sy temp_C)] (dbl 0) Nothing
