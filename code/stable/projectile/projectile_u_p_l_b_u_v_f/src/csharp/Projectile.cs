...
public class Projectile {
    ...
    */
    public static void Main(string[] args) {
        ...
        outfile = new StreamWriter("log.txt", true);
        outfile.Write("var 'g' assigned ");
        outfile.Write(g);
        outfile.WriteLine(" in module Projectile");
        outfile.Close();
        outfile = new StreamWriter("log.txt", true);
        outfile.Write("var 'epsilon' assigned ");
    ...
    */
    public static float func_t_flight(InputParameters inParams, float g) {
        StreamWriter outfile;
        outfile = new StreamWriter("log.txt", true);
    ...
    */
    public static float func_p_land(InputParameters inParams, float g) {
        StreamWriter outfile;
        outfile = new StreamWriter("log.txt", true);
    ...
    */
    public static string func_s(InputParameters inParams, float epsilon, float d_offset) {
        StreamWriter outfile;
        outfile = new StreamWriter("log.txt", true);
