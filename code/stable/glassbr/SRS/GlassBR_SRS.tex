...
\end{description}
\begin{description}
\item[\refstepcounter{assumpnum}\atheassumpnum\label{A:glassCondition}:]Following \cite{astm2009} (pg. 1), this practice does not apply to any form of wired, patterned, etched, sandblasted, drilled, notched, or grooved glass with surface and edge treatments that alter the glass strength. \hyperref[accAlteredGlass]{UC: Accommodate-Altered-Glass}.
\end{description}
\begin{description}
\item[\refstepcounter{assumpnum}\atheassumpnum\label{A:explainScenario}:]This system only considers the external explosion scenario for its calculations. \hyperref[calcInternalBlastRisk]{LC: Calculate-Internal-Blask-Risk}.
\end{description}
\begin{description}
...
\end{description}
\begin{description}
\item[\refstepcounter{assumpnum}\atheassumpnum\label{A:boundaryConditions}:]Boundary conditions for the glass slab are assumed to be 4-sided support for calculations. \hyperref[accMoreBoundaryConditions]{LC: Accomodate-More-Boundary-Conditions}.
\end{description}
\begin{description}
\item[\refstepcounter{assumpnum}\atheassumpnum\label{A:responseType}:]The response type considered in GlassBR is flexural. \hyperref[considerMoreThanFlexGlass]{LC: Consider-More-than-Flexure-Glass}.
\end{description}
\begin{description}
\item[\refstepcounter{assumpnum}\atheassumpnum\label{A:ldfConstant}:]With reference to \hyperref[A:standardValues]{A: standardValues}, the value of load duration factor ($LDF$) is a constant in GlassBR. \hyperref[varValsOfmkE]{LC: Variable-Values-of-m,k,E} \hyperref[DD:loadDurFactor]{DD: loadDurFactor}.
\end{description}
...
\\ \midrule \\
RefBy & \hyperref[T:isSafeLR]{TM: isSafeLR} \hyperref[checkGlassSafety]{FR: Check-Glass-Safety}.
...
Source & \cite{astm2009}
\\ \midrule \\
RefBy & \hyperref[T:isSafePb]{TM: isSafePb} \hyperref[checkGlassSafety]{FR: Check-Glass-Safety}.
\\ \bottomrule \end{tabular}
\end{minipage}\\
...
\\ \midrule \\
RefBy & \hyperref[T:isSafePb]{TM: isSafePb}.
\\ \bottomrule \end{tabular}
\end{minipage}\\
~\newline
\noindent \begin{minipage}{\textwidth}
...
Source & \cite{astm2009}
\\ \midrule \\
RefBy & \hyperref[T:isSafeLR]{TM: isSafeLR}.
\\ \bottomrule \end{tabular}
\end{minipage}\\
~\newline
\noindent \begin{minipage}{\textwidth}
...
Source & \cite{astm2009}
\\ \midrule \\
RefBy & \hyperref[T:isSafeLR]{TM: isSafeLR} \hyperref[DD:dimlessLoad]{DD: dimlessLoad}.
\\ \bottomrule \end{tabular}
\end{minipage}\\
...
\toprule
 & \hyperref[checkInputWithDataCons]{FR: Check-Input-with-Data\_Constraints} & \hyperref[inputGlassProps]{FR: Input-Glass-Props} & \hyperref[DD:tolLoad]{DD: tolLoad} & \hyperref[DD:stressDistFac]{DD: stressDistFac} & \hyperref[accMoreBoundaryConditions]{LC: Accomodate-More-Boundary-Conditions} & \hyperref[T:isSafeLR]{TM: isSafeLR} & \hyperref[DD:dimlessLoad]{DD: dimlessLoad} & \hyperref[calcInternalBlastRisk]{LC: Calculate-Internal-Blask-Risk} & \hyperref[DD:calofCapacity]{DD: calofCapacity} & \hyperref[accAlteredGlass]{UC: Accommodate-Altered-Glass} & \hyperref[accMoreThanSingleLite]{LC: Accomodate-More-than-Single-Lite} & \hyperref[outputValsAndKnownQuants]{FR: Output-Values-and-Known-Quantities} & \hyperref[varValsOfmkE]{LC: Variable-Values-of-m,k,E} & \hyperref[DD:loadDurFactor]{DD: loadDurFactor} & \hyperref[DD:sdf.tol]{DD: sdf\_tol} & \hyperref[DD:risk.fun]{DD: risk\_fun} & \hyperref[DD:nFL]{DD: nFL} & \hyperref[T:isSafePb]{TM: isSafePb} & \hyperref[considerMoreThanFlexGlass]{LC: Consider-More-than-Flexure-Glass} & \hyperref[DD:probOfBreak]{DD: probOfBreak} & \hyperref[checkGlassSafety]{FR: Check-Glass-Safety} & \hyperref[DD:calofCapacity]{DD: calofCapacity} & \hyperref[IM:calOfDemand]{IM: calOfDemand}
\\
\midrule
...
\\
\hyperref[T:isSafeLR]{TM: isSafeLR} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & X &  &  & X &  & 
\\
\hyperref[T:isSafePb]{TM: isSafePb} &  &  &  &  &  & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  & X &  & 
\\
...
\\
DD7 (\hyperref[DD:sdf.tol]{DD: sdf\_tol}) &  &  &  &  &  &  &  &  &  &  &  &  & X
\\
...
\\
\midrule
T1 (\hyperref[T:isSafePb]{TM: isSafePb}) &  &  &  &  &  &  &  & 
\\
T2 (\hyperref[T:isSafeLR]{TM: isSafeLR}) &  &  &  &  &  &  &  & 
\\
IM1 (\hyperref[IM:calOfDemand]{IM: calOfDemand}) &  &  &  & X &  & X & X & 
\\
IM2 (\hyperref[DD:risk.fun]{DD: risk\_fun}) & X & X &  &  & X &  &  & 
\\
IM3 (\hyperref[DD:min.thick]{DD: min\_thick}) &  &  &  &  &  &  &  & 
\\
DD1 (\hyperref[DD:loadDurFactor]{DD: loadDurFactor}) &  &  &  &  &  &  &  & 
...
\\
DD7 (\hyperref[DD:sdf.tol]{DD: sdf\_tol}) &  &  &  &  &  &  &  & 
\\
DD8 (\hyperref[DD:standOffDist]{DD: standOffDist}) &  &  &  & X &  &  &  & 
\\
