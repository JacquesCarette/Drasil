...
module Drasil.DblPend.IMods (iMods, angularAccelIM_1, angularAccelIM_2) where
...
import Drasil.DblPend.Unitals (pendDisAngle_1, pendDisAngle_2, lenRod_1, lenRod_2,
  massObj_1, massObj_2, angularAccel_1, angularAccel_2, angularVel_1, angularVel_2)
import Drasil.DblPend.GenDefs (xForceGD_2, yForceGD_2, xForceGD_1, yForceGD_1, accelXGD_1, accelXGD_2, accelYGD_1, accelYGD_2)
