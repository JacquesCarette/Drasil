...
% "Important" TODOs
\newcommand{\imptodo}[1]{\todo[inline,backgroundcolor=Red]{#1}}

% "Easy" TODOs
\newcommand{\easytodo}[1]{\todo[inline,backgroundcolor=SeaGreen]{#1}}
\newcommand{\eztodo}[1]{\easytodo{#1}}

% "Tedious" TODOs
\newcommand{\tedioustodo}[1]{\todo[backgroundcolor=PineGreen]{#1}}

% "Question" TODO Notes
\newcommand{\questiontodo}[1]{\todo[backgroundcolor=Lavender]{#1}}
