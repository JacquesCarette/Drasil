...
knowledge as needed to re-generate the original artifacts. As a result of
capturing the meaning, we are become able to generate the same ``software
solution'' using other programming languages and tools.
...
in a wider variety of other languages by discussing similar usability of the
