...
-- I want to include SI as an acronym, but I can't find a way for the description to have accents when using makeCC.
...
boiling, charging, coil, discharging, gaseous, gauss_div, heat_flux, heat_trans, 
  ...
  perfect_insul, phase_change_material, phs_change, sens_heat, solid, specific_heat,
  swhs_pcm, tank, tank_pcm, thermal_analysis, thermal_conduction, thermal_energy, 
  transient, water :: ConceptChunk
...
law_cooling = makeCC "Newton's law of cooling" "Newton's law of convective cooling"
liquid = makeCC "Liquid" "liquid state"
mech_energy = makeCC "Mechanical energy" "The energy that comes from motion and position"
melting = makeCC "Melting" "Phase change from solid to liquid"
perfect_insul = makeCC "perfectly insulated" "Describes the property of a material not allowing heat transfer through its boundaries"
...
swhs_pcm = makeCC "solar water heating systems incorporating PCM" "Solar water heating systems incorporating phase change material"
tank = makeCC "Tank" "Solar water heating tank"
tank_pcm = makeCC "Solar water heating tank incorporating PCM" "solar water heating tank incorporating PCM"
thermal_analysis = makeCC "Thermal analysis" "The study of material properties as they change with temperature"
thermal_conduction = makeCC "Thermal conduction" "The transfer of heat energy through a substance."
thermal_conductor = makeCC "Thermal conductor" "An object through which thermal energy can be transferred"
