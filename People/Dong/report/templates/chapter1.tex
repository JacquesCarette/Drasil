...
\label{fig_nopcm}
\end{figure}
The square represent a water tank, and it has a heating coil at bottom of the tank. $qc$ represents the heat flux into the water from the coil. The goal is to estimate the temperature of the water over time. We can describe this natural phenomena in a second-order ODE, Equation~\ref{eq_nopcmorginal}.
