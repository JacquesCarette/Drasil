...
conductance from Figure~\ref{fig:h_g} and the equation for heat transfer coefficient
between clad and coolant from Figure~\ref{fig:h_c}, 
...
will fill in the appropriate details related to any and all symbols that appear in the
equations. %D As shown in figure blah-ble-blah
Now if we were to need to update the description
