...
a given distance. This could be in the context of building an armored
vehicule.
...
In the GlassBR example, the main specialization occurs because glass
thickness is standardized, and so the thickness parameter is not free to vary,
but must take on specific values.

The example is atypical in this way; most examples involve more significant
