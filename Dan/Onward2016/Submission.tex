...
version control software~\cite{Wilson2006}. However, code generation has been
successful in SC, but thus far the focus has been on the creation of only one
software artifact: the code. Examples include Gaussian elimination~\cite{Carette2006}, ATLAS, Blitz++, Spiral, FFT~\cite{KiselyovEtAl2004}, and FEniCS~\cite{LoggEtAl2012}.
