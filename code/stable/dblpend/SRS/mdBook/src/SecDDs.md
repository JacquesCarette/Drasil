...
|Units      |\\({\text{m}}\\)                                                                                                                                                                                                                                                                                                                                                                                             |
|Equation   |\\[{\boldsymbol{p}\_{2}}={L\_{1}} \begin{bmatrix}\sin\left({θ\_{1}}\right)\\\\-\cos\left({θ\_{1}}\right)\end{bmatrix}+{L\_{2}} \begin{bmatrix}\sin\left({θ\_{2}}\right)\\\\-\cos\left({θ\_{2}}\right)\end{bmatrix}\\]                                                                                                                                                                                        |
|Description|<ul><li>\\({\boldsymbol{p}\_{2}}\\) is the position of the second object (\\({\text{m}}\\))</li><li>\\({L\_{1}}\\) is the length of the first rod (\\({\text{m}}\\))</li><li>\\({θ\_{1}}\\) is the angle of the first rod (\\({\text{rad}}\\))</li><li>\\({L\_{2}}\\) is the length of the second rod (\\({\text{m}}\\))</li><li>\\({θ\_{2}}\\) is the angle of the second rod (\\({\text{rad}}\\))</li></ul>|
