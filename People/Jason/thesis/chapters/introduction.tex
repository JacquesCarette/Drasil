...
% TODO: continue a bit, but try to keep it succinct
...
ultimately represents what they were trying to build.
...
sequence of domain-specific languages together can be used to describe common
undergraduate level physics models and problems and describe the a target
program that simulates said models. Note, however, that this idea likely only
