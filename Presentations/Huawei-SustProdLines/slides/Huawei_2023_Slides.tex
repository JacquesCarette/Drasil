...
%\frametitle{Family of Mechanics Programs - why gen all things?}
...
\begin{tikzpicture}[remember picture,overlay]
\node [xshift=-3.0cm,yshift=2.95cm] at (current page.center)
{
$\mathbf{F} = m \mathbf{a}$
};
\end{tikzpicture}
...
\begin{tikzpicture}[remember picture,overlay]
\node [xshift=-3.0cm,yshift=2.4cm] at (current page.center)
{
...
\begin{tikzpicture}[remember picture,overlay]
\node [xshift=-3.0cm,yshift=1.8cm] at (current page.center)
{
...
\begin{tikzpicture}[remember picture,overlay]
\node [xshift=-3.0cm,yshift=0.3cm] at (current page.center)
{
