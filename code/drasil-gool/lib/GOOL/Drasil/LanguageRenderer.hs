...
moduleDox desc as date v m = (doxFile ++ m) : 
...
doxCommand, doxBrief, doxParam, doxReturn, doxFile, doxAuthor, doxDate, doxDrasilGen :: String
doxCommand = "\\"
...
doxDrasilGen = doxCommand ++ "Generated by Drasil Version: "
