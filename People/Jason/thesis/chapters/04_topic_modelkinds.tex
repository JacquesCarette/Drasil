...
\section{Usage: Converting to Software and Specifications}
...
\begin{enumerate}
	...
	\item Drasil is limited to using theories with expressions written in a very
	      ...
	      \begin{itemize}
		      ...
		      \item The conversion relied on the \relToQD{} hack.\todo{Add code
			            snippet of original relToQD and discuss how it wasn't a
			            sustainable solution for the long-term. relToQD was
			            exactly the implicit knowledge I mentioned, it assumes,
			            without statically checking consistency, that the
			            Relations/Exprs provided as input for code generation
			            were all of the form: \(y = f(\ldots{})\). See
...
\QDefinition{} (\refCurrentQDefinitionHaskell{}). If an \EquationalModel{}
