...
\intodo{The ideology also vaguely relates to the question ``Which programming
    language do I pick for my project?''. This is a silly question under this
    ideology. There is no 1 single language that we even use to describe
    ...
    shouldn't be choosing just one.}
