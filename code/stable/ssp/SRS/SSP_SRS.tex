...
\\
$\mathbf{b}$ & Base width of slices & m
\\
${\mathbf{C}_{den}}$ & Proportionality constant denominator & N
\\
${\mathbf{C}_{num}}$ & Proportionality constant numerator & N
\\
$c'$ & Effective cohesion & Pa
\\
$const_f$ & Decision on f & --
\\
${F_{rot}}$ & Force causing rotation & N
\\
${F_{S}}$ & Factor of safety & --
\\
${{F_{S}}^{min}}$ & Minimum factor of safety & --
\\
...
$\mathbf{F}$ & Force & N
\\
${{\mathbf{F}_{x}}^{G}}$ & Sums of the interslice normal forces & N
\\
${{\mathbf{F}_{x}}^{H}}$ & Sums of the interslice normal water forces & N
\\
$\mathbf{f}$ & Interslice normal to shear force ratio variation function & --
\\
$\mathbf{G}$ & Interslice normal forces & $\frac{\text{N}}{\text{m}}$
\\
$g$ & Gravitational acceleration & $\frac{\text{m}}{\text{s}^{2}}$
\\
$\mathbf{H}$ & Interslice normal water forces & $\frac{\text{N}}{\text{m}}$
\\
$h$ & Height & m
\\
$\mathbf{h}$ & $y$-direction heights of slices & m
\\
${\mathbf{h}^{L}}$ & Heights of the left side of slices & m
\\
${\mathbf{h}^{R}}$ & Heights of the right side of slices & m
\\
${\mathbf{h}_{z}}$ & Heights of interslice normal forces & m
\\
${\mathbf{h}_{z,w}}$ & Heights of the water table & m
\\
$i$ & Index & --
\\
$\mathbf{\hat{j}}$ & Unit Vector & --
\\
${K_{c}}$ & Seismic coefficient & --
\\
$M$ & Moment & Nm
\\
$m$ & Mass & kg
\\
$\mathbf{N}$ & Normal forces & $\frac{\text{N}}{\text{m}}$
\\
$\mathbf{N'}$ & Effective normal forces & $\frac{\text{N}}{\text{m}}$
\\
$n$ & Number of slices & --
\\
$P$ & Resistive shear force & N
\\
$\mathbf{P}$ & Resistive shear forces & $\frac{\text{N}}{\text{m}}$
\\
$p$ & Pressure & Pa
\\
$\mathbf{Q}$ & External forces & $\frac{\text{N}}{\text{m}}$
\\
$\mathbf{R}$ & Resistive shear forces without the influence of interslice forces & $\frac{\text{N}}{\text{m}}$
\\
$r$ & Length of the moment arm & m
\\
$\mathbf{r}$ & Displacement & m
\\
$S$ & Mobilized shear force & N
\\
$\mathbf{S}$ & Mobilized shear forces & $\frac{\text{N}}{\text{m}}$
\\
$\mathbf{T}$ & Mobilized shear forces without the influence of interslice forces & $\frac{\text{N}}{\text{m}}$
\\
${\mathbf{U}_{b}}$ & Base hydrostatic forces & $\frac{\text{N}}{\text{m}}$
\\
${\mathbf{U}_{t}}$ & Surface hydrostatic forces & $\frac{\text{N}}{\text{m}}$
\\
$u$ & Pore pressure & Pa
\\
$V$ & Volume & $\text{m}^{3}$
\\
${\mathbf{V}_{dry}}$ & Volumes of dry soil & $\text{m}^{3}$
\\
${\mathbf{V}_{sat}}$ & Volumes of saturated soil & $\text{m}^{3}$
\\
$v$ & Local index & --
\\
$W$ & Weight & N
\\
$\mathbf{W}$ & Weights & $\frac{\text{N}}{\text{m}}$
\\
$\mathbf{X}$ & Interslice shear forces & $\frac{\text{N}}{\text{m}}$
\\
$x$ & $x$-coordinate & m
\\
...
\\
${\mathbf{x}_{cs}},{\mathbf{y}_{cs}}$ & The set of $x$-coordinates and $y$-coordinates & m
\\
${\mathbf{x}_{slip}}$ & $x$-coordinates of the slip surface & m
\\
...
\\
${\mathbf{y}_{slip}}$ & $y$-coordinates of the slip surface & m
\\
...
$z$ & $z$-coordinate & m
\\
$\mathbf{α}$ & Base angles & ${}^{\circ}$
\\
$\mathbf{β}$ & Surface angles & ${}^{\circ}$
\\
$γ$ & Specific weight & $\frac{\text{N}}{\text{m}^{3}}$
\\
...
$τ$ & Torque & Nm
\\
$Υ$ & Minimization function & --
\\
$\mathbf{Φ}$ & First function for incorporating interslice forces into shear force & --
\\
$φ'$ & Effective angle of friction & ${}^{\circ}$
\\
$\mathbf{Ψ}$ & Second function for incorporating interslice forces into shear force & --
\\
$\mathbf{ω}$ & Imposed load angles & ${}^{\circ}$
\\
${\mathbf{ℓ}_{b}}$ & Total base lengths of slices & m
\\
${\mathbf{ℓ}_{s}}$ & Surface lengths of slices & m
\\
\bottomrule
\caption{}
\label{Table:ToS}
