...
newA1 = assump' "Thermal-Energy-Only" assumpS1
newA2 = assump' "Heat-Transfer-Coeffs-Constant" assumpS2 
newA3 = assump' "Constant-Water-Temp-Across-Tank" assumpS3
newA4 = assump' "Temp-PCM-Constant-Across-Volume" assumpS4
newA5 = assump' "Density-Water-PCM-Constant-over-Volume" assumpS5
newA6 = assump' "Specific-Heat-Energy-Constant-over-Volume" assumpS6
newA7 = assump' "Law-Convective-Cooling-Coil-Water" assumpS7
newA8 = assump' "Temp-Heating-Coil-Constant-over-Time" assumpS8
newA9 = assump' "Temp-Heating-Coil-Constant-over-Length" assumpS9
newA10 = assump' "Law-Convective-Cooling-Water-PCM" assumpS10
newA11 = assump' "Charging-Tank-No-Temp-Discharge" assumpS11
newA12 = assump' "Same-Initial-Temp-Water-PCM" assumpS12
newA13 = assump' "PCM-Initialli-Soild" assumpS13
newA14 = assump' "Water-Always-Liquid" assumpS14
newA15 = assump' "Perfect-Insulation-Tank" assumpS15
newA16 = assump' "No-Internal-Heat-Generation-By-Water-PCM" assumpS16
newA17 = assump' "Volume-Change-Melting-PCM-Negligible" assumpS17
newA18 = assump' "No-Gaseous-State-PCM" assumpS18
newA19 = assump' "Atmospheric-Pressure-Tank" assumpS19
newA20 = assump' "Volume-Coil-Negligible" assumpS20 

assump' :: String -> Sentence -> AssumpChunk
assump' a b = assump a b (shortname' a) []
...
assump1  = let a1  = "assump1"  in mkAssump a1 assumpS1
assump2  = let a2  = "assump2"  in mkAssump a2 assumpS2
assump3  = let a3  = "assump3"  in mkAssump a3 assumpS3
assump4  = let a4  = "assump4"  in mkAssump a4 assumpS4
assump5  = let a5  = "assump5"  in mkAssump a5 assumpS5
assump6  = let a6  = "assump6"  in mkAssump a6 assumpS6
assump7  = let a7  = "assump7"  in mkAssump a7 assumpS7
assump8  = let a8  = "assump8"  in mkAssump a8 assumpS8 
assump9  = let a9  = "assump9"  in mkAssump a9 assumpS9
assump10 = let a10 = "assump10" in mkAssump a10 assumpS10
assump11 = let a11 = "assump11" in mkAssump a11 assumpS11
assump12 = let a12 = "assump12" in mkAssump a12 assumpS12
assump13 = let a13 = "assump13" in mkAssump a13 assumpS13
assump14 = let a14 = "assump14" in mkAssump a14 assumpS14
assump15 = let a15 = "assump15" in mkAssump a15 assumpS15
assump16 = let a16 = "assump16" in mkAssump a16 assumpS16
assump17 = let a17 = "assump17" in mkAssump a17 assumpS17
assump18 = let a18 = "assump18" in mkAssump a18 assumpS18
assump19 = let a19 = "assump19" in mkAssump a19 assumpS19
assump20 = let a20 = "assump20" in mkAssump a20 assumpS20
