...
# value1 in data1 and data2[jdx,idx] == data2[jdx+1,idx] and value2 < data2[jdx,idx]
    def test_find_bounds(self):
        idx,jdx,kdx,num_interp1,num_interp2=interp.find_bounds(self.data1,self.data2,140,4.76)
    ...
    def test_interp(self):
        interp_value=interp.interp(3,3,0,0,1,self.data1,self.data2,self.data3,140,4.76)
        self.assertEqual(interp_value,5.46)
