...
\begin{enumerate}
	...
	\item add the ability to determine the limiting reactant(s) in a
	reaction.\cref{chemProbExs}
	\item add the ability to, given the limiting reactant(s) of a reaction,
	determine the theoretical yield of each product and the amount of excess
	reactant.\cref{chemProbExs}
	...
	Drasil. (While using external ODE solvers in Drasil, the developers ``did not
		...
		by Drasil.)
	\item do the same as 1.~but in terms of mass.\cref{chemProbExs}
