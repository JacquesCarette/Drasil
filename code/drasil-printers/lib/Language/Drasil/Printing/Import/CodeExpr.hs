...
codeExpr (UnaryOpCN Norm u)          sm = P.Fenced P.Norm P.Norm $ codeExpr u sm
codeExpr (UnaryOpCN Dim u)           sm = mkCall sm P.Dim u
codeExpr (UnaryOp Sqrt u)            sm = P.Sqrt $ codeExpr u sm
codeExpr (UnaryOp Neg u)             sm = neg sm u
codeExpr (UnaryOpCC NegC u)          sm = neg sm u
...
codeExpr (CCNBinaryOp Dot a b)       sm = mkBOp sm P.Dot a b
