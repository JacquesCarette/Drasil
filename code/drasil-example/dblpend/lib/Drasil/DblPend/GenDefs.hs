...
module Drasil.DblPend.GenDefs (
    genDefns, 
    mvVelGD_1, mvVelGD_2, 
    mvAccelGD_1, mvAccelGD_2, 
...
-----------------------------------------------
-- List of all GA-generated definitions --
-----------------------------------------------
genDefns :: [GenDefn]
...
-------------------------------------------------
mvVelQD_1 :: QDefinition ModelExpr
mvVelQD_1 = mkQuantDef' mvVel_1
    (nounPhraseSP "velocity vector of the first object")
    E.mvVelExpr_1

mvVelDeriv_1 :: Derivation
mvVelDeriv_1 = mkDerivName 
    (phrase velocity +:+ S "of the first object")
    (weave [mvVelDerivSents_1, mvVelDerivEqns_1])

mvVelDerivSents_1, mvVelDerivEqns_1 :: [Sentence]
mvVelDerivSents_1 =
    [ S "The velocity vector in Clifford algebra represents both magnitude and direction as a unified geometric entity."
...
-------------------------------------------------
mvVelQD_2 :: QDefinition ModelExpr
mvVelQD_2 = mkQuantDef' mvVel_2
    (nounPhraseSP "velocity vector of the second object")
    E.mvVelExpr_2

mvVelDeriv_2 :: Derivation
mvVelDeriv_2 = mkDerivName 
    (phrase velocity +:+ S "of the second object")
    (weave [mvVelDerivSents_2, mvVelDerivEqns_2])

mvVelDerivSents_2, mvVelDerivEqns_2 :: [Sentence]
mvVelDerivSents_2 =
    [ S "The velocity vector for the second object combines the velocity from the first pendulum with its own rotational motion."
...
-------------------------------------------------
mvAccelQD_1 :: QDefinition ModelExpr
mvAccelQD_1 = mkQuantDef' mvAccel_1
    (nounPhraseSP "acceleration vector of the first object")
    E.mvAccelExpr_1

mvAccelDeriv_1 :: Derivation
mvAccelDeriv_1 = mkDerivName 
    (phrase acceleration +:+ S "of the first object")
    (weave [mvAccelDerivSents_1, mvAccelDerivEqns_1])

mvAccelDerivSents_1, mvAccelDerivEqns_1 :: [Sentence]
mvAccelDerivSents_1 =
    [ S "The acceleration vector in Clifford algebra combines centripetal and tangential acceleration components."
...
-------------------------------------------------
mvAccelQD_2 :: QDefinition ModelExpr
mvAccelQD_2 = mkQuantDef' mvAccel_2
    (nounPhraseSP "acceleration vector of the second object")
    E.mvAccelExpr_2

mvAccelDeriv_2 :: Derivation
mvAccelDeriv_2 = mkDerivName 
    (phrase acceleration +:+ S "of the second object")
    (weave [mvAccelDerivSents_2, mvAccelDerivEqns_2])

mvAccelDerivSents_2, mvAccelDerivEqns_2 :: [Sentence]
mvAccelDerivSents_2 =
    [ S "The second object's acceleration is the geometric sum of the first object's acceleration and its own relative acceleration."
...
-------------------------------------------------
mvForceQD_1 :: QDefinition ModelExpr
mvForceQD_1 = mkQuantDef' mvForce_1
    (nounPhraseSP "force vector on the first object")
    E.mvForceExpr_1

mvForceDeriv_1 :: Derivation
mvForceDeriv_1 = mkDerivName 
    (phrase force +:+ S "on the first object")
    (weave [mvForceDerivSents_1, mvForceDerivEqns_1])

mvForceDerivSents_1, mvForceDerivEqns_1 :: [Sentence]
mvForceDerivSents_1 =
    [ S "The force vector in Clifford algebra combines inertial and gravitational forces as vectors."
    , S "The inertial force is proportional to the mass times acceleration vector, preserving Newton's second law in geometric form."
...
-------------------------------------------------
mvForceQD_2 :: QDefinition ModelExpr
mvForceQD_2 = mkQuantDef' mvForce_2
    (nounPhraseSP "force vector on the second object")
    E.mvForceExpr_2

mvForceDeriv_2 :: Derivation
mvForceDeriv_2 = mkDerivName 
    (phrase force +:+ S "on the second object")
    (weave [mvForceDerivSents_2, mvForceDerivEqns_2])

mvForceDerivSents_2, mvForceDerivEqns_2 :: [Sentence]
mvForceDerivSents_2 =
    [ S "The force on the second object combines its inertial response with gravitational effects."
