...
\\ \midrule
Equation & \begin{displaymath}
           \resizeExpression{{f_{1}}=-\left({\symbf{T}_{1}} \begin{bmatrix}
                                                            \sin\left({θ_{1}}\right)\\
                                                            -\cos\left({θ_{1}}\right)
...
\\ \midrule
Equation & \begin{displaymath}
           \resizeExpression{{f_{2}}=-\left({\symbf{T}_{2}} \begin{bmatrix}
                                                            \sin\left({θ_{2}}\right)\\
                                                            -\cos\left({θ_{2}}\right)
...
\\ \midrule
Equation & \begin{displaymath}
           \resizeExpression{{v_{1}}=\frac{\,d{\symbf{p}_{1}}}{\,dt}}
           \end{displaymath}
\\ \midrule
Description & \begin{symbDescription}
              \item{${v_{1}}$ is the velocity of the first object ($\frac{\text{m}}{\text{s}}$)}
...
\\ \midrule
Equation & \begin{displaymath}
           \resizeExpression{{v_{2}}=\frac{\,d{\symbf{p}_{2}}}{\,dt}}
           \end{displaymath}
\\ \midrule
Description & \begin{symbDescription}
              \item{${v_{2}}$ is the velocity of the second object ($\frac{\text{m}}{\text{s}}$)}
...
\\ \midrule
Equation & \begin{displaymath}
           \resizeExpression{{a_{1}}=\frac{\,d{v_{1}}}{\,dt}}
           \end{displaymath}
\\ \midrule
Description & \begin{symbDescription}
              \item{${a_{1}}$ is the acceleration of the first object ($\frac{\text{m}}{\text{s}^{2}}$)}
...
\\ \midrule
Equation & \begin{displaymath}
           \resizeExpression{{a_{2}}=\frac{\,d{v_{2}}}{\,dt}}
           \end{displaymath}
\\ \midrule
Description & \begin{symbDescription}
              \item{${a_{2}}$ is the acceleration of the second object ($\frac{\text{m}}{\text{s}^{2}}$)}
...
\begin{displaymath}
\resizeExpression{{m_{1}}\,{a_{1}}=-{\symbf{T}_{1}}\,\sin\left({θ_{1}}\right)}
\end{displaymath}

\begin{displaymath}
\resizeExpression{{m_{1}}\,{a_{1}}={\symbf{T}_{1}}\,\cos\left({θ_{1}}\right)-{m_{1}}\,g}
\end{displaymath}
Multiply the equation 1 by $\cos\left({θ_{1}}\right)$ and the equation 2 by $\sin\left({θ_{1}}\right)$ and rearrange to get:

\begin{displaymath}
\resizeExpression{{m_{2}}\,{a_{2}}=-{\symbf{T}_{2}}\,\sin\left({θ_{2}}\right)}
\end{displaymath}

\begin{displaymath}
\resizeExpression{{m_{2}}\,{a_{2}}={\symbf{T}_{2}}\,\cos\left({θ_{2}}\right)-{m_{2}}\,g}
\end{displaymath}
