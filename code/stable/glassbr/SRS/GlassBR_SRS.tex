...
\begin{itemize}
\item[Predict-Glass-Withstands-Explosion (GS1):\phantomsection\label{willBreakGS}]{Analyze and predict whether the glass slab under consideration will be able to withstand the explosion of a certain degree which is calculated based on user input.}
\end{itemize}
...
\begin{itemize}
\item[glassType (A1):\phantomsection\label{assumpGT}]{The standard E1300-09a for calculation applies only to monolithic, laminated, or insulating glass constructions of rectangular shape with continuous lateral support along one, two, three, or four edges. This practice assumes that: (1) the supported glass edges for two, three and four-sided support conditions are simply supported and free to slip in plane; (2) glass supported on two sides acts as a simply supported beam; and (3) glass supported on one side acts as a cantilever.}
\item[glassCondition (A2):\phantomsection\label{assumpGC}]{Following \cite[(pg. 1)]{astm2009}, this practice does not apply to any form of wired, patterned, etched, sandblasted, drilled, notched, or grooved glass with surface and edge treatments that alter the glass strength. (RefBy: \hyperref[accAlteredGlass]{UC: Accommodate-Altered-Glass}.)}
\item[explainScenario (A3):\phantomsection\label{assumpES}]{This system only considers the external explosion scenario for its calculations. (RefBy: \hyperref[calcInternalBlastRisk]{LC: Calculate-Internal-Blask-Risk}.)}
\item[standardValues (A4):\phantomsection\label{assumpSV}]{The values provided in \hyperref[Sec:AuxConstants]{Section: Values of Auxiliary Constants} are assumed for the duration of load (${t_{\text{d}}}$), and the material properties of $m$, $k$, and $E$. (RefBy: \hyperref[varValsOfmkE]{LC: Variable-Values-of-m,k,E}, \hyperref[DD:sdfTol]{DD: sdfTol}, \hyperref[DD:nFL]{DD: nFL}, \hyperref[DD:loadDurFactor]{DD: loadDurFactor}, \hyperref[DD:dimlessLoad]{DD: dimlessLoad}, and \hyperref[assumpLDFC]{A: ldfConstant}.)}
\item[glassLite (A5):\phantomsection\label{assumpGL}]{Glass under consideration is assumed to be a single lite; hence, the value of LSF is equal to 1 for all calculations in GlassBR. (RefBy: \hyperref[DD:calofCapacity]{DD: calofCapacity}, \hyperref[DD:dimlessLoad]{DD: dimlessLoad}, and \hyperref[accMoreThanSingleLite]{LC: Accomodate-More-than-Single-Lite}.)}
\item[boundaryConditions (A6):\phantomsection\label{assumpBC}]{Boundary conditions for the glass slab are assumed to be 4-sided support for calculations. (RefBy: \hyperref[accMoreBoundaryConditions]{LC: Accomodate-More-Boundary-Conditions}.)}
\item[responseType (A7):\phantomsection\label{assumpRT}]{The response type considered in GlassBR is flexural. (RefBy: \hyperref[considerMoreThanFlexGlass]{LC: Consider-More-than-Flexure-Glass}.)}
\item[ldfConstant (A8):\phantomsection\label{assumpLDFC}]{With reference to \hyperref[assumpSV]{A: standardValues}, the value of load duration factor ($LDF$) is a constant in GlassBR. (RefBy: \hyperref[varValsOfmkE]{LC: Variable-Values-of-m,k,E} and \hyperref[DD:loadDurFactor]{DD: loadDurFactor}.)}
\end{itemize}
...
\toprule \textbf{Refname} & \textbf{TM:isSafeProb} (TM1)
\phantomsection 
\label{TM:isSafeProb}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{TM:isSafeLoad} (TM2)
\phantomsection 
\label{TM:isSafeLoad}
\\ \midrule \\
Label & Safety Load
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:riskFun} (DD1)
\phantomsection 
\label{DD:riskFun}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:minThick} (DD2)
\phantomsection 
\label{DD:minThick}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:loadDurFactor} (DD3)
\phantomsection 
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:stressDistFac} (DD4)
\phantomsection 
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:nFL} (DD5)
\phantomsection 
\label{DD:nFL}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:gTF} (DD6)
\phantomsection 
\label{DD:gTF}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:dimlessLoad} (DD7)
\phantomsection 
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:tolLoad} (DD8)
\phantomsection 
\label{DD:tolLoad}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:sdfTol} (DD9)
\phantomsection 
\label{DD:sdfTol}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:standOffDist} (DD10)
\phantomsection 
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:aspectRatio} (DD11)
\phantomsection 
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:eqTNTW} (DD12)
\phantomsection 
\label{DD:eqTNTW}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:probOfBreak} (DD13)
\phantomsection 
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:calofCapacity} (DD14)
\phantomsection 
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:calofDemand} (DD15)
\phantomsection 
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{IM:isSafePb} (IM1)
\phantomsection 
\label{IM:isSafePb}
\\ \midrule \\
Label & Safety Req-Pb
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{IM:isSafeLR} (IM2)
\phantomsection 
\label{IM:isSafeLR}
\\ \midrule \\
Label & Safety Req-LR
...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & If $is-safeLR$, the glass is considered safe. $is-safePb$ (from \hyperref[IM:isSafePb]{IM: isSafePb}) and $is-safeLR$ are either both True or both False. LR is the load resistance (also called capacity), as defined in \hyperref[DD:calofCapacity]{DD: calofCapacity}. $q$ (also referred as the Applied Load (demand)) is the 3 second duration equivalent pressure, as defined in \hyperref[DD:calofDemand]{DD: calofDemand}.
...
\begin{itemize}
\item[Input-Glass-Props (FR1):\phantomsection\label{inputGlassProps}]{Input the quantities from \hyperref[Table:ReqInputs]{Table:ReqInputs}, which define the glass dimensions, type of glass, tolerable probability of failure, and the characteristics of the blast.}
\item[System-Set-Values-Following-Assumptions (FR2):\phantomsection\label{sysSetValsFollowingAssumps}]{The system shall set the known values as described in \hyperref[Table:ReqAssignments]{Table:ReqAssignments}.}
\item[Check-Input-with-Data\_Constraints (FR3):\phantomsection\label{checkInputWithDataCons}]{The system shall check the entered input values to ensure that they do not exceed the data constraints mentioned in \hyperref[Sec:DataConstraints]{Section: Data Constraints}. If any of the input parameters are out of bounds, an error message is displayed and the calculations stop.}
\item[Output-Values-and-Known-Quantities (FR4):\phantomsection\label{outputValsAndKnownQuants}]{Output the input quantities from \hyperref[inputGlassProps]{FR: Input-Glass-Props} and the known quantities from \hyperref[sysSetValsFollowingAssumps]{FR: System-Set-Values-Following-Assumptions}.}
\item[Check-Glass-Safety (FR5):\phantomsection\label{checkGlassSafety}]{If $is-safePb\land{}is-safeLR$ (from \hyperref[TM:isSafeProb]{TM: isSafeProb} and \hyperref[TM:isSafeLoad]{TM: isSafeLoad}), output the message ``For the given input parameters, the glass is considered safe.'' If the condition is false, then output the message ``For the given input parameters, the glass is NOT considered safe.''}
\item[Output-Quantities (FR6):\phantomsection\label{outputQuants}]{Output the quantities from \hyperref[Table:ReqOutputs]{Table:ReqOutputs}.}
\end{itemize}
\begin{longtabu}{l X[l] l}
\toprule
\textbf{Symbol} & \textbf{Description} & \textbf{Units}
...
\item[Portable (NFR6):\phantomsection\label{portable}]{The code is able to be run in different environments.}
\end{itemize}
...
\begin{itemize}
\item[Calculate-Internal-Blask-Risk (LC1):\phantomsection\label{calcInternalBlastRisk}]{\hyperref[assumpES]{A: explainScenario} - The system currently only calculates for external blast risk. In the future, calculations can be added for the internal blast risk.}
\item[Variable-Values-of-m,k,E (LC2):\phantomsection\label{varValsOfmkE}]{\hyperref[assumpSV]{A: standardValues}, \hyperref[assumpLDFC]{A: ldfConstant} - Currently, the values for $m$, $k$, and $E$ are assumed to be the same for all glass. In the future, these values can be changed to variable inputs.}
\item[Accomodate-More-than-Single-Lite (LC3):\phantomsection\label{accMoreThanSingleLite}]{\hyperref[assumpGL]{A: glassLite} - The software may be changed to accommodate more than a single lite.}
\item[Accomodate-More-Boundary-Conditions (LC4):\phantomsection\label{accMoreBoundaryConditions}]{\hyperref[assumpBC]{A: boundaryConditions} - The software may be changed to accommodate more boundary conditions than 4-sided support.}
\item[Consider-More-than-Flexure-Glass (LC5):\phantomsection\label{considerMoreThanFlexGlass}]{\hyperref[assumpRT]{A: responseType} - The software may be changed to consider more than just flexure of the glass.}
\end{itemize}
...
\begin{itemize}
\item[Predict-Withstanding-of-Certain-Degree (UC1):\phantomsection\label{predictWithstandOfCertDeg}]{The goal of the system is to predict whether the glass slab under consideration can withstand an explosion of a certain degree.}
\item[Accommodate-Altered-Glass (UC2):\phantomsection\label{accAlteredGlass}]{\hyperref[assumpGC]{A: glassCondition} requires that the glass is not altered in any way. Therefore, this cannot be used on altered glass.}
\end{itemize}
...
\toprule
\textbf{} & \textbf{\hyperref[assumpGT]{A1}} & \textbf{\hyperref[assumpGC]{A2}} & \textbf{\hyperref[assumpES]{A3}} & \textbf{\hyperref[assumpSV]{A4}} & \textbf{\hyperref[assumpGL]{A5}} & \textbf{\hyperref[assumpBC]{A6}} & \textbf{\hyperref[assumpRT]{A7}} & \textbf{\hyperref[assumpLDFC]{A8}}
\\
\midrule
\endhead
\hyperref[DD:riskFun]{DD1} &  &  &  &  &  &  &  & 
\\
\hyperref[DD:minThick]{DD2} &  &  &  &  &  &  &  & 
\\
\hyperref[DD:loadDurFactor]{DD3} &  &  &  & X &  &  &  & X
\\
\hyperref[DD:stressDistFac]{DD4} &  &  &  &  &  &  &  & 
\\
\hyperref[DD:nFL]{DD5} &  &  &  & X &  &  &  & 
\\
\hyperref[DD:gTF]{DD6} &  &  &  &  &  &  &  & 
\\
\hyperref[DD:dimlessLoad]{DD7} &  &  &  & X & X &  &  & 
\\
\hyperref[DD:tolLoad]{DD8} &  &  &  &  &  &  &  & 
\\
\hyperref[DD:sdfTol]{DD9} &  &  &  & X &  &  &  & 
\\
\hyperref[DD:standOffDist]{DD10} &  &  &  &  &  &  &  & 
\\
\hyperref[DD:aspectRatio]{DD11} &  &  &  &  &  &  &  & 
\\
\hyperref[DD:eqTNTW]{DD12} &  &  &  &  &  &  &  & 
\\
\hyperref[DD:probOfBreak]{DD13} &  &  &  &  &  &  &  & 
\\
\hyperref[DD:calofCapacity]{DD14} &  &  &  &  & X &  &  & 
\\
\hyperref[DD:calofDemand]{DD15} &  &  &  &  &  &  &  & 
\\
\hyperref[TM:isSafeProb]{TM1} &  &  &  &  &  &  &  & 
\\
\hyperref[TM:isSafeLoad]{TM2} &  &  &  &  &  &  &  & 
\\
\hyperref[IM:isSafePb]{IM1} &  &  &  &  &  &  &  & 
\\
\hyperref[IM:isSafeLR]{IM2} &  &  &  &  &  &  &  & 
\\
\hyperref[inputGlassProps]{FR1} &  &  &  &  &  &  &  & 
\\
\hyperref[sysSetValsFollowingAssumps]{FR2} &  &  &  &  &  &  &  & 
\\
\hyperref[checkInputWithDataCons]{FR3} &  &  &  &  &  &  &  & 
\\
\hyperref[outputValsAndKnownQuants]{FR4} &  &  &  &  &  &  &  & 
\\
\hyperref[checkGlassSafety]{FR5} &  &  &  &  &  &  &  & 
\\
\hyperref[outputQuants]{FR6} &  &  &  &  &  &  &  & 
\\
...
\\
\hyperref[portable]{NFR6} &  &  &  &  &  &  &  & 
\\
\hyperref[calcInternalBlastRisk]{LC1} &  &  & X &  &  &  &  & 
\\
\hyperref[varValsOfmkE]{LC2} &  &  &  & X &  &  &  & X
\\
\hyperref[accMoreThanSingleLite]{LC3} &  &  &  &  & X &  &  & 
\\
\hyperref[accMoreBoundaryConditions]{LC4} &  &  &  &  &  & X &  & 
\\
\hyperref[considerMoreThanFlexGlass]{LC5} &  &  &  &  &  &  & X & 
\\
\hyperref[predictWithstandOfCertDeg]{UC1} &  &  &  &  &  &  &  & 
\\
\hyperref[accAlteredGlass]{UC2} &  & X &  &  &  &  &  & 
\\
\bottomrule
...
\toprule
\textbf{} & \textbf{\hyperref[DD:riskFun]{DD1}} & \textbf{\hyperref[DD:minThick]{DD2}} & \textbf{\hyperref[DD:loadDurFactor]{DD3}} & \textbf{\hyperref[DD:stressDistFac]{DD4}} & \textbf{\hyperref[DD:nFL]{DD5}} & \textbf{\hyperref[DD:gTF]{DD6}} & \textbf{\hyperref[DD:dimlessLoad]{DD7}} & \textbf{\hyperref[DD:tolLoad]{DD8}} & \textbf{\hyperref[DD:sdfTol]{DD9}} & \textbf{\hyperref[DD:standOffDist]{DD10}} & \textbf{\hyperref[DD:aspectRatio]{DD11}} & \textbf{\hyperref[DD:eqTNTW]{DD12}} & \textbf{\hyperref[DD:probOfBreak]{DD13}} & \textbf{\hyperref[DD:calofCapacity]{DD14}} & \textbf{\hyperref[DD:calofDemand]{DD15}} & \textbf{\hyperref[TM:isSafeProb]{TM1}} & \textbf{\hyperref[TM:isSafeLoad]{TM2}} & \textbf{\hyperref[IM:isSafePb]{IM1}} & \textbf{\hyperref[IM:isSafeLR]{IM2}}
\\
\midrule
\endhead
\hyperref[DD:riskFun]{DD1} &  & X & X & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:minThick]{DD2} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:loadDurFactor]{DD3} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:stressDistFac]{DD4} &  &  &  &  &  &  & X &  &  &  & X &  &  &  &  &  &  &  & 
\\
\hyperref[DD:nFL]{DD5} &  & X &  &  &  &  &  & X &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:gTF]{DD6} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:dimlessLoad]{DD7} &  & X &  &  &  & X &  &  &  &  &  &  &  &  & X &  &  &  & 
\\
\hyperref[DD:tolLoad]{DD8} &  &  &  &  &  &  &  &  & X &  & X &  &  &  &  &  &  &  & 
\\
\hyperref[DD:sdfTol]{DD9} &  & X & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:standOffDist]{DD10} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:aspectRatio]{DD11} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
...
\hyperref[DD:eqTNTW]{DD12} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:probOfBreak]{DD13} & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:calofCapacity]{DD14} &  &  &  &  & X & X &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:calofDemand]{DD15} &  &  &  &  &  &  &  &  &  & X &  & X &  &  &  &  &  &  & 
\\
\hyperref[TM:isSafeProb]{TM1} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[TM:isSafeLoad]{TM2} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[IM:isSafePb]{IM1} &  &  &  &  &  &  &  &  &  &  &  &  & X &  &  &  &  &  & X
\\
\hyperref[IM:isSafeLR]{IM2} &  &  &  &  &  &  &  &  &  &  &  &  &  & X & X &  &  & X & 
\\
\bottomrule
...
\toprule
\textbf{} & \textbf{\hyperref[DD:riskFun]{DD1}} & \textbf{\hyperref[DD:minThick]{DD2}} & \textbf{\hyperref[DD:loadDurFactor]{DD3}} & \textbf{\hyperref[DD:stressDistFac]{DD4}} & \textbf{\hyperref[DD:nFL]{DD5}} & \textbf{\hyperref[DD:gTF]{DD6}} & \textbf{\hyperref[DD:dimlessLoad]{DD7}} & \textbf{\hyperref[DD:tolLoad]{DD8}} & \textbf{\hyperref[DD:sdfTol]{DD9}} & \textbf{\hyperref[DD:standOffDist]{DD10}} & \textbf{\hyperref[DD:aspectRatio]{DD11}} & \textbf{\hyperref[DD:eqTNTW]{DD12}} & \textbf{\hyperref[DD:probOfBreak]{DD13}} & \textbf{\hyperref[DD:calofCapacity]{DD14}} & \textbf{\hyperref[DD:calofDemand]{DD15}} & \textbf{\hyperref[TM:isSafeProb]{TM1}} & \textbf{\hyperref[TM:isSafeLoad]{TM2}} & \textbf{\hyperref[IM:isSafePb]{IM1}} & \textbf{\hyperref[IM:isSafeLR]{IM2}} & \textbf{\hyperref[inputGlassProps]{FR1}} & \textbf{\hyperref[sysSetValsFollowingAssumps]{FR2}} & \textbf{\hyperref[checkInputWithDataCons]{FR3}} & \textbf{\hyperref[outputValsAndKnownQuants]{FR4}} & \textbf{\hyperref[checkGlassSafety]{FR5}} & \textbf{\hyperref[outputQuants]{FR6}} & \textbf{\hyperref[correct]{NFR1}} & \textbf{\hyperref[verifiable]{NFR2}} & \textbf{\hyperref[understandable]{NFR3}} & \textbf{\hyperref[reusable]{NFR4}} & \textbf{\hyperref[maintainable]{NFR5}} & \textbf{\hyperref[portable]{NFR6}}
\\
\midrule
\endhead
\hyperref[willBreakGS]{GS1} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[inputGlassProps]{FR1} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[sysSetValsFollowingAssumps]{FR2} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
...
\hyperref[checkInputWithDataCons]{FR3} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[outputValsAndKnownQuants]{FR4} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & X & X &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[checkGlassSafety]{FR5} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & X & X &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[outputQuants]{FR6} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[correct]{NFR1} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
