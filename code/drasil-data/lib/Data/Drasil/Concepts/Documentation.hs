...
doccon = [abbAcc, abbreviation, acronym, analysis, appendix, aspect, body,
  caseProb, charOfIR, characteristic, class_, client, code, column,
  company, concept, condition, connection, consVals, constant,
...
physical        = nc "adjPhysical"    (cn'    "physical"           ) --FIXME: Adjective
...
second_         = nc "ordSecond"      (cn'    "second"             ) --Does it make sense for this to be here?
