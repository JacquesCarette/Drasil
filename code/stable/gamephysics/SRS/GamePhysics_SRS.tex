...
We may calculate the total angular acceleration of rigid body $j$ by calculating the derivative of it's angular velocity with respect to time (from \hyperref[DD:angAccel]{DD:angAccel}).
