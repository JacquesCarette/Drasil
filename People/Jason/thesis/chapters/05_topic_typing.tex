...
conjunction, and if-then-else (ternary operators), we might write the syntax as
follows:

\intodo{Syntax of \(\bb{L}\).}

\intodo{Showcase of how lack of typing allows for invalid expressions.}

If we choose to add typing rules to restrict the syntax to only ``valid''
expression, we might write write them as follows:
