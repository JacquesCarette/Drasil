...
Equation & \begin{displaymath}
           \resizeExpression{\symbf{v}\text{(}t\text{)}=\begin{bmatrix}
                                                        v^{\text{i}}_{\text{x}}+a^{\text{c}}_{\text{x}}\,t\\
                                                        v^{\text{i}}_{\text{y}}+a^{\text{c}}_{\text{y}}\,t
                                                        \end{bmatrix}}
           \end{displaymath}
\\ \midrule
Description & \begin{symbDescription}
              \item{$\symbf{v}\text{(}t\text{)}$ is the velocity ($\frac{\text{m}}{\text{s}}$)}
              \item{$v^{\text{i}}_{\text{x}}$ is the $x$-component of initial velocity ($\frac{\text{m}}{\text{s}}$)}
              \item{$a^{\text{c}}_{\text{x}}$ is the $x$-component of constant acceleration ($\frac{\text{m}}{\text{s}^{2}}$)}
              \item{$t$ is the time (${\text{s}}$)}
              \item{$v^{\text{i}}_{\text{y}}$ is the $y$-component of initial velocity ($\frac{\text{m}}{\text{s}}$)}
              \item{$a^{\text{c}}_{\text{y}}$ is the $y$-component of constant acceleration ($\frac{\text{m}}{\text{s}^{2}}$)}
              \end{symbDescription}
\\ \midrule
Source & --
...
Equation & \begin{displaymath}
           \resizeExpression{\symbf{p}\text{(}t\text{)}=\begin{bmatrix}
                                                        p^{\text{i}}_{\text{x}}+v^{\text{i}}_{\text{x}}\,t+\frac{a^{\text{c}}_{\text{x}}\,t^{2}}{2}\\
                                                        p^{\text{i}}_{\text{y}}+v^{\text{i}}_{\text{y}}\,t+\frac{a^{\text{c}}_{\text{y}}\,t^{2}}{2}
                                                        \end{bmatrix}}
           \end{displaymath}
\\ \midrule
Description & \begin{symbDescription}
...
\\ \midrule
Equation & \begin{displaymath}
           \resizeExpression{v^{\text{i}}_{\text{x}}=v^{\text{i}}\,\cos\left(θ\right)}
           \end{displaymath}
\\ \midrule
Description & \begin{symbDescription}
              \item{$v^{\text{i}}_{\text{x}}$ is the $x$-component of initial velocity ($\frac{\text{m}}{\text{s}}$)}
...
\\ \midrule
Equation & \begin{displaymath}
           \resizeExpression{v^{\text{i}}_{\text{y}}=v^{\text{i}}\,\sin\left(θ\right)}
           \end{displaymath}
\\ \midrule
Description & \begin{symbDescription}
              \item{$v^{\text{i}}_{\text{y}}$ is the $y$-component of initial velocity ($\frac{\text{m}}{\text{s}}$)}
...
We know that $p^{\text{i}}_{\text{y}}=0$ (\hyperref[launchOrigin]{A:launchOrigin}) and $a^{\text{c}}_{\text{y}}=-g$ (\hyperref[accelYGravity]{A:accelYGravity}). Substituting these values into the y-direction of \hyperref[GD:posVec]{GD:posVec} gives us:

\begin{displaymath}
\resizeExpression{p_{\text{y}}=v^{\text{i}}_{\text{y}}\,t-\frac{g\,t^{2}}{2}}
\end{displaymath}
...
\begin{displaymath}
\resizeExpression{v^{\text{i}}_{\text{y}}\,t_{\text{flight}}-\frac{g\,t_{\text{flight}}^{2}}{2}=0}
\end{displaymath}
Dividing by $t_{\text{flight}}$ (with the constraint $t_{\text{flight}}\gt{}0$) gives us:

\begin{displaymath}
\resizeExpression{v^{\text{i}}_{\text{y}}-\frac{g\,t_{\text{flight}}}{2}=0}
\end{displaymath}
Solving for $t_{\text{flight}}$ gives us:

\begin{displaymath}
\resizeExpression{t_{\text{flight}}=\frac{2\,v^{\text{i}}_{\text{y}}}{g}}
\end{displaymath}
From \hyperref[DD:speedIY]{DD:speedIY} (with $v^{\text{i}}=v_{\text{launch}}$) we can replace $v^{\text{i}}_{\text{y}}$:
...
We know that $p^{\text{i}}_{\text{x}}=0$ (\hyperref[launchOrigin]{A:launchOrigin}) and $a^{\text{c}}_{\text{x}}=0$ (\hyperref[accelXZero]{A:accelXZero}). Substituting these values into the x-direction of \hyperref[GD:posVec]{GD:posVec} gives us:

\begin{displaymath}
\resizeExpression{p_{\text{x}}=v^{\text{i}}_{\text{x}}\,t}
\end{displaymath}
...
\begin{displaymath}
\resizeExpression{p_{\text{land}}=\frac{v^{\text{i}}_{\text{x}}\cdot{}2\,v_{\text{launch}}\,\sin\left(θ\right)}{g}}
\end{displaymath}
From \hyperref[DD:speedIX]{DD:speedIX} (with $v^{\text{i}}=v_{\text{launch}}$) we can replace $v^{\text{i}}_{\text{x}}$:
