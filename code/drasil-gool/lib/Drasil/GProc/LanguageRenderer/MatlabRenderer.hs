...
mlListAccessFunc :: (CommonRenderSym r vis smt mthd) => r Value -> Doc
...
mlForEach :: (CommonRenderSym r vis smt mthd) => r Variable ->
  r Value -> r Body -> Doc
...
mlRange :: (CommonRenderSym r vis smt mthd) => SValue r -> SValue r ->
  SValue r -> SValue r
...
mlTryCatch :: (CommonRenderSym r vis smt mthd) => r Body -> r Body -> Doc
