...
\noindent p\_land := func\_p\_land(inParams)\\
\noindent d\_offset := func\_d\_offset(inParams, p\_land)\\
\noindent s := func\_s(inParams, d\_offset)\\
...
The data from inputFile is read sequentially to populate the state variables from
...
\begin{center}
 ...
 \textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
 \hline
 func\_p\_land & Params & $\mathbb{R}$ & None \\
 \hline
 func\_d\_offset & Params, $\mathbb{R}$ & $\mathbb{R}$ & None \\
 \hline
 func\_s & Params, $\mathbb{R}$ & String & None \\
 \hline
 \end{tabular}
 \end{center}
...
func\_p\_land(inParams):
 \begin{itemize}
 \item out: $\textit{out} := \frac{2 v^2 sin(inParams.\theta) cos(inParams.\theta)}{g}$
 \item exception: exc := none
 \end{itemize}
 
func\_d\_offset(inParams):
 \begin{itemize}
