...
\\ \midrule
RefBy & \hyperref[IM:messageIM]{IM:messageIM} and \hyperref[calcValues]{FR:Calculate-Values}
...
\label{IM:messageIM}
\\ \midrule
Label & Output message as a string
...
\\
<<<<<<< HEAD
${d_{\text{offset}}}$ & Distance between the target position and the landing position & \hyperref[IM:offsetIM]{IM:offsetIM} & ${\text{m}}$
=======
${d_{\text{offset}}}$ & Offset & \hyperref[IM:offsetIM]{IM:offsetIM} & ${\text{m}}$
>>>>>>> 05f9eb3216 (use names of unitals for names of IMs in Projectile)
\\
$s$ & Output message as a string & \hyperref[IM:messageIM]{IM:messageIM} & --
\\
