...
\\ \midrule \\
RefBy & \hyperref[GD:sliceWght]{GD: sliceWght} \hyperref[GD:sliceWght]{GD: sliceWght} \hyperref[GD:sliceWght]{GD: sliceWght}.
\\ \bottomrule \end{tabular}
\end{minipage}
...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & This equation is derived from Bernoulli's equation.
\\ \midrule \\
...
\\
\hyperref[assumpHFSM]{A: Hydrostatic-Force-Slice-Midpoint} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & X & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
