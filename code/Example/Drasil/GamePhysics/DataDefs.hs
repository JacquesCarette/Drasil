...
dispEqn :: Expr
dispEqn = Deriv Total (FCall (sy QP.position) [sy QP.time]) QP.time
{-
dd2descr :: Sentence
...
velEqn :: Expr
velEqn = Deriv Total (FCall (sy QP.displacement) [sy QP.time]) QP.time
{-
dd3descr :: Sentence
...
accelEqn :: Expr
accelEqn = Deriv Total (FCall (sy QP.velocity) [sy QP.time]) QP.time
{-
dd4descr :: Sentence
...
angDispEqn :: Expr
angDispEqn = Deriv Total (FCall (sy QM.orientation) [sy QP.time]) QP.time
{-
dd5descr :: Sentence
...
angVelEqn :: Expr
angVelEqn = Deriv Total (FCall (sy QP.angularDisplacement) [sy QP.time]) QP.time
{-
dd6descr :: Sentence
...
angAccelEqn :: Expr
angAccelEqn = Deriv Total (FCall (sy QP.angularVelocity) [sy QP.time]) QP.time
{-
dd7descr :: Sentence
