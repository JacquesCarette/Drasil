...
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{MmodInputConstraints}:]Input Constraints Module
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{Mmodoutputfdesc}:]Output Format Module
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{MmodDerivedVals}:]Derived Values Module
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{Mmodcalcdesc}:]Calculations Module
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{MmodControl}:]Control Module
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{MmodInterpData}:]Interpolation Data Module
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{MmodInterpolation}:]Interpolation Module
\end{description}
\begin{longtable}{l l}
\toprule
Level 1 & Level 2
...
"Input Parameters Module (M\ref{MmodInputParams})" -> "Input Constraints Module (M\ref{MmodInputConstraints})";
...
"Derived Values Module (M\ref{MmodDerivedVals})" -> "Input Parameters Module (M\ref{MmodInputParams})";
"Calculations Module (M\ref{Mmodcalcdesc})" -> "Input Parameters Module (M\ref{MmodInputParams})";
...
"Control Module (M\ref{MmodControl})" -> "Input Constraints Module (M\ref{MmodInputConstraints})";
"Control Module (M\ref{MmodControl})" -> "Derived Values Module (M\ref{MmodDerivedVals})";
"Control Module (M\ref{MmodControl})" -> "Calculations Module (M\ref{Mmodcalcdesc})";
"Control Module (M\ref{MmodControl})" -> "Interpolation Module (M\ref{MmodInterpolation})";
"Control Module (M\ref{MmodControl})" -> "Output Format Module (M\ref{Mmodoutputfdesc})";
"Interpolation Module (M\ref{MmodInterpolation})" -> "Interpolation Data Module (M\ref{MmodInterpData})";
}
\end{dot2tex}
\end{tikzpicture}
\end{adjustbox}
