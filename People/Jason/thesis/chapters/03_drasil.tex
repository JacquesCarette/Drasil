...
using a structured \ACF{srs} \cite{SmithAndLai2005} abstraction. The \acs{srs}
...
problem descriptions (\refCaseStudiesCodeTable{})\footnote{It is helpful to
...
\refRoughNetworkOfDomains{}\footnote{Note that this is not representative of all
...
the needs of a series of case studies (\refCaseStudiesTable{}) that Drasil
...
of Drasil's case studies development. Code generation for \acs{pdcontroller} is
