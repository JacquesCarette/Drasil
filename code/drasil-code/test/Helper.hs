...
helperOO :: (OOProg r tp vis smt par fun) => OO.SFile r
helperOO = OO.fileDoc (OO.buildModule "Helper" [] [doubleAndAdd] [])

-- | Creates Helper module that contains an addition function.
helperProc :: (ProcProg r tp vis smt par fun) => GProc.SFile r
...
doubleAndAdd :: (SharedProg r tp vis smt par fun) => SMethod r
