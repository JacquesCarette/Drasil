...
(\refCurrentModelExprHaskell{}), and \CodeExpr{} (\todo{ref Current CodeExpr
Haskell}). \Expr{} has its indefinite values split off into \ModelExpr{}
...
\refPseudoPartialModelKindsUpgrade{}, creating a type argument in \ModelKinds{}
