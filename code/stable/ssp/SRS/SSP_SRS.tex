...
\\
$\mathbf{r}$ & Position Vector: The a vector from the origin of the Cartesian coordinate system defined to the point where the force is applied. & m
\\
...
\\
$\mathbf{u}$ & Displacement: The change in an object's location relative to a reference point. & m
\\
...
\\
$\mathbf{τ}$ & Torque: A twisting force that tends to cause rotation. & Nm
\\
