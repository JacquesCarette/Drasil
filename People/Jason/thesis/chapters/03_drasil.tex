...
Drasil encodes/organizes data, called \textit{chunks} (alternatively,
\textit{fragments of knowledge}, and used interchangeably for the purposes of
this work), by their Haskell-level type. A focused \textit{ChunkDB} datatype
contains all information about a knowledge system.
