...
\end{description}
\begin{description}
\item[\refstepcounter{assumpnum}\atheassumpnum\label{A:Temp-PCM-Constant-Across-Volume}:]The temperature of the phase change material is the same throughout the volume of PCM {[}\hyperref[GD:rocTempSimp]{Definition~GD:rocTempSimp}, \hyperref[DD:ht.flux.P]{Definition~DD:ht.flux.P}{]}.
\end{description}
\begin{description}
...
\end{description}
\begin{description}
\item[\refstepcounter{assumpnum}\atheassumpnum\label{A:Same-Initial-Temp-Water-PCM}:]The initial temperature of the water and the PCM is the same {[}\hyperref[IM:eBalanceOnWtr]{Definition~IM:eBalanceOnWtr}, \hyperref[IM:eBalanceOnPCM]{Definition~IM:eBalanceOnPCM}{]}.
\end{description}
\begin{description}
...
\end{description}
\begin{description}
\item[\refstepcounter{assumpnum}\atheassumpnum\label{A:Perfect-Insulation-Tank}:]The tank is perfectly insulated so that there is no heat loss from the tank {[}\hyperref[IM:eBalanceOnWtr]{Definition~IM:eBalanceOnWtr}{]}.
\end{description}
\begin{description}
...
\\ \midrule \\
Source & \href{http://www.efunda.com/formulae/heat_transfer/conduction/overview_cond.cfm}{efunda.com}
\\ \midrule \\
...
\\ \midrule \\
Source & \href{http://en.wikipedia.org/wiki/Sensible_heat}{wikipedia.org}
\\ \midrule \\
RefBy & FIXME: This needs to be filled in
\\ \bottomrule \end{tabular}
\end{minipage}\\
...
\\ \midrule \\
Source & \href{http://en.wikipedia.org/wiki/Latent_heat}{wikipedia.org}
\\ \midrule \\
RefBy & FIXME: This needs to be filled in
\\ \bottomrule \end{tabular}
\end{minipage}\\
...
\end{longtabu}
\begin{description}
\item[\refstepcounter{reqnum}\rthereqnum\label{FR:Use-Above-Find-Mass-IM1-IM4}:]Use the inputs in R\ref{FR:Input-Initial-Quantities} to find the mass needed for \hyperref[IM:eBalanceOnWtr]{Definition~IM:eBalanceOnWtr}, \hyperref[IM:eBalanceOnPCM]{Definition~IM:eBalanceOnPCM}, \hyperref[IM:heatEInWtr]{Definition~IM:heatEInWtr}, and \hyperref[IM:heatEInPCM]{Definition~IM:heatEInPCM}, as follows, where ${V_{W}}$ is the volume of water and ${V_{tank}}$ is the volume of the cylindrical tank:
\end{description}
\begin{dmath}
...
\end{description}
\begin{description}
\item[\refstepcounter{reqnum}\rthereqnum\label{FR:Output-Input-Derived-Quantities}:]Output the input quantities and derived quantities in the following list: the quantities from R\ref{FR:Input-Initial-Quantities}, the masses from R\ref{FR:Use-Above-Find-Mass-IM1-IM4}, ${τ_{W}}$ (from \hyperref[IM:eBalanceOnWtr]{Definition~IM:eBalanceOnWtr}), $η$ (from \hyperref[IM:eBalanceOnWtr]{Definition~IM:eBalanceOnWtr}), ${{τ_{P}}^{S}}$ (from \hyperref[IM:eBalanceOnPCM]{Definition~IM:eBalanceOnPCM}) and ${{τ_{P}}^{L}}$ (from \hyperref[IM:eBalanceOnPCM]{Definition~IM:eBalanceOnPCM}).
\end{description}
\begin{description}
\item[\refstepcounter{reqnum}\rthereqnum\label{FR:Calculate-Temperature-Water-Over-Time}:]Calculate and output the temperature of the water (${T_{W}}$($t$)) over the simulation time (from \hyperref[IM:eBalanceOnWtr]{Definition~IM:eBalanceOnWtr}).
\end{description}
\begin{description}
\item[\refstepcounter{reqnum}\rthereqnum\label{FR:Calculate-Temperature-PCM-Over-Time}:]Calculate and output the temperature of the phase change material (${T_{P}}$($t$)) over the simulation time (from \hyperref[IM:eBalanceOnPCM]{Definition~IM:eBalanceOnPCM}).
\end{description}
\begin{description}
\item[\refstepcounter{reqnum}\rthereqnum\label{FR:Calculate-Change-Heat.Energy-Water-Over-Time}:]Calculate and output the change in heat energy in the water (${E_{W}}$($t$)) over the simulation time (from \hyperref[IM:heatEInWtr]{Definition~IM:heatEInWtr}).
\end{description}
\begin{description}
\item[\refstepcounter{reqnum}\rthereqnum\label{FR:Calculate-Change-Heat.Energy-PCM-Over-Time}:]Calculate and output the change in heat energy in the PCM (${E_{P}}$($t$)) over the simulation time (from \hyperref[IM:heatEInPCM]{Definition~IM:heatEInPCM}).
\end{description}
\begin{description}
...
\end{description}
\begin{description}
\item[\refstepcounter{reqnum}\rthereqnum\label{FR:Calculate-PCM-melt-begin-time}:]Calculate and output the time at which the PCM begins to melt ${{t_{melt}}^{init}}$ (from \hyperref[IM:eBalanceOnPCM]{Definition~IM:eBalanceOnPCM}).
\end{description}
\begin{description}
\item[\refstepcounter{reqnum}\rthereqnum\label{FR:Calculate-PCM-melt-end-time}:]Calculate and output the time at which the PCM stops melting ${{t_{melt}}^{final}}$ (from \hyperref[IM:eBalanceOnPCM]{Definition~IM:eBalanceOnPCM}).
\end{description}
