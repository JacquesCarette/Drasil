...
Description & \begin{symbDescription}
              ...
              \item{${K_{c}}$ is the earthquake load factor (--)}
...
Description & \begin{symbDescription}
              \item{$X$ is the interslice shear force (N)}
              \item{$λ$ is the interslice normal/shear force ratio (--)}
              \item{$f$ is the scaling function (--)}
              \item{$G$ is the interslice normal force (N)}
              \end{symbDescription}
\\ \midrule \\
...
\\ \midrule \\
Description & \begin{symbDescription}
              \item{$SpencerFixme1Please$ is the fixme (--)}
              \item{$G$ is the interslice normal force (N)}
              \item{$i$ is the index (--)}
              \end{symbDescription}
\\ \midrule \\
...
\\ \midrule \\
Description & \begin{symbDescription}
              \item{$SpencerFixme2Please$ is the fixme (--)}
              \item{$H$ is the interslice water force (N)}
              \item{$i$ is the index (--)}
              \end{symbDescription}
\\ \midrule \\
...
Description & \begin{symbDescription}
              \item{$FS$ is the factor of safety (--)}
              \item{$R$ is the resistive shear force (N)}
              \item{$v$ is the local index (--)}
              \item{$Ψ$ is the constant (N)}
              \item{$u$ is the local index (--)}
              \item{$Φ$ is the constant (N)}
              \item{$n$ is the number of slices (--)}
              \item{$T$ is the mobilized shear force (N)}
              \end{symbDescription}
\\ \midrule \\
...
\\ \midrule \\
Description & \begin{symbDescription}
              \item{${FS_{Loc,i}}$ is the local factor of safety (--)}
              \item{$i$ is the index (--)}
              \item{$c'$ is the effective cohesion (Pa)}
              \item{${K_{bn}}$ is the normal stiffness ($\frac{\text{Pa}}{\text{m}}$)}
              \item{$δv$ is the displacement (m)}
...
\\ \midrule \\
Description & \begin{symbDescription}
              \item{${FS_{min}}$ is the minimum factor of safety (--)}
              \item{$Υ$ is the function (--)}
