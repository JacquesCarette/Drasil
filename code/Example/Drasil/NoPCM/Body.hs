...
s4_2_1_list = map (\x -> Paragraph x) [assump1, assump2, assump3, assump4, assump5, assump7,
  assump8, assump9, assump9_npcm, assump14, assump15, assump12, assump13,
  assump20]
  
assump3, assump4, assump5, assump9_npcm, assump12, assump13 :: Sentence
...
s4_2_3_description = map foldlSPCol [
  ...
  s4_2_3_desc4 ht_flux_in ht_flux_out in_SA out_SA density QT.heat_cap_spec
    QT.temp vol (map (\x -> Paragraph x) [assump3, assump4, assump5]),
