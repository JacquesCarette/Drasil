...
\item[Interslice-Norm-Shear-Forces-Linear:\phantomsection\label{assumpINSFL}]{Following the assumption of Morgenstern and Price (\cite{morgenstern1965}), interslice normal forces and interslice shear forces have a proportional relationship, depending on a proportionality constant ($λ$) and a function ($\mathbf{f}$) describing variation depending on $x$ position. (RefBy: \hyperref[IM:nrmShrFor]{IM:nrmShrFor}, \hyperref[GD:normShrR]{GD:normShrR}, \hyperref[UC_normshearlinear]{UC:Normal-And-Shear-Linear-Only}, and \hyperref[IM:fctSfty]{IM:fctSfty}.)}
...
\\ \midrule \\
RefBy & \hyperref[IM:nrmShrFor]{IM:nrmShrFor}, \hyperref[IM:nrmShrForNum]{IM:nrmShrForNum}, \hyperref[IM:nrmShrForDen]{IM:nrmShrForDen}, \hyperref[IM:intsliceFs]{IM:intsliceFs}, \hyperref[displayShear]{FR:Display-Interslice-Shear-Forces}, \hyperref[displayNormal]{FR:Display-Interslice-Normal-Forces}, \hyperref[displayFS]{FR:Display-Factor-of-Safety}, \hyperref[determineCritSlip]{FR:Determine-Critical-Slip-Surface}, and \hyperref[IM:fctSfty]{IM:fctSfty}
...
\\
${\mathbf{x}_{\text{slope}}}$ & -- & $0$ ${\text{m}}$ & 10$\%$
\\
${\mathbf{x}_{\text{wt}}}$ & -- & $0$ ${\text{m}}$ & 10$\%$
\\
${{y_{\text{slip}}}^{\text{max}}}$ & -- & $30$ ${\text{m}}$ & 10$\%$
\\
${{y_{\text{slip}}}^{\text{min}}}$ & -- & $0$ ${\text{m}}$ & 10$\%$
\\
${\mathbf{y}_{\text{slope}}}$ & -- & $0$ ${\text{m}}$ & 10$\%$
\\
${\mathbf{y}_{\text{wt}}}$ & -- & $0$ ${\text{m}}$ & 10$\%$
\\
...
\end{longtable}
The purpose of the traceability graphs is also to provide easy references on what has to be additionally modified if a certain component is changed. The arrows in the graphs represent dependencies. The component at the tail of an arrow is depended on by the component at the head of that arrow. Therefore, if a component is changed, the components that it points to should also be changed. \hyperref{../../../traceygraphs/SSP/avsa.pdf}{}{}{TraceGraphAvsA} shows the dependencies of assumptions on the assumptions. \hyperref{../../../traceygraphs/SSP/avsall.pdf}{}{}{TraceGraphAvsAll} shows the dependencies of data definitions, theoretical models, general definitions, instance models, requirements, likely changes, and unlikely changes on the assumptions. \hyperref{../../../traceygraphs/SSP/refvsref.pdf}{}{}{TraceGraphRefvsRef} shows the dependencies of data definitions, theoretical models, general definitions, and instance models with each other. \hyperref{../../../traceygraphs/SSP/allvsr.pdf}{}{}{TraceGraphAllvsR} shows the dependencies of requirements, goal statements on the data definitions, theoretical models, general definitions, and instance models. \hyperref{../../../traceygraphs/SSP/allvsall.pdf}{}{}{TraceGraphAllvsAll} shows the dependencies of dependencies of assumptions, models, definitions, requirements, goals, and changes with each other.

\begin{itemize}
\item{\hyperref{../../../traceygraphs/SSP/avsa.pdf}{}{}{TraceGraphAvsA}}
\item{\hyperref{../../../traceygraphs/SSP/avsall.pdf}{}{}{TraceGraphAvsAll}}
\item{\hyperref{../../../traceygraphs/SSP/refvsref.pdf}{}{}{TraceGraphRefvsRef}}
\item{\hyperref{../../../traceygraphs/SSP/allvsr.pdf}{}{}{TraceGraphAllvsR}}
\item{\hyperref{../../../traceygraphs/SSP/allvsall.pdf}{}{}{TraceGraphAllvsAll}}
\end{itemize}
