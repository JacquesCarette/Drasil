...
\\
\hyperref[TM:ChaslesThm]{TM4} & X &  &  &  &  &  & 
\\
\hyperref[TM:NewtonSecLawRotMot]{TM5} &  & X &  &  &  &  & 
\\
...
\toprule
\textbf{} & \textbf{\hyperref[DD:ctrOfMass]{DD1}} & \textbf{\hyperref[DD:linDisp]{DD2}} & \textbf{\hyperref[DD:linVel]{DD3}} & \textbf{\hyperref[DD:linAcc]{DD4}} & \textbf{\hyperref[DD:angDisp]{DD5}} & \textbf{\hyperref[DD:angVel]{DD6}} & \textbf{\hyperref[DD:angAccel]{DD7}} & \textbf{\hyperref[DD:impulse]{DD8}} & \textbf{\hyperref[DD:chalses]{DD9}} & \textbf{\hyperref[DD:torque]{DD10}} & \textbf{\hyperref[DD:kEnergy]{DD11}} & \textbf{\hyperref[DD:coeffRestitution]{DD12}} & \textbf{\hyperref[DD:reVeInColl]{DD13}} & \textbf{\hyperref[DD:impulseV]{DD14}} & \textbf{\hyperref[DD:potEnergy]{DD15}} & \textbf{\hyperref[DD:momentOfInertia]{DD16}} & \textbf{\hyperref[TM:NewtonSecLawMot]{TM1}} & \textbf{\hyperref[TM:NewtonThirdLawMot]{TM2}} & \textbf{\hyperref[TM:UniversalGravLaw]{TM3}} & \textbf{\hyperref[TM:ChaslesThm]{TM4}} & \textbf{\hyperref[TM:NewtonSecLawRotMot]{TM5}} & \textbf{\hyperref[IM:transMot]{IM1}} & \textbf{\hyperref[IM:rotMot]{IM2}} & \textbf{\hyperref[IM:col2D]{IM3}}
\\
\midrule
\endhead
...
\hyperref[TM:UniversalGravLaw]{TM3} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[TM:ChaslesThm]{TM4} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[TM:NewtonSecLawRotMot]{TM5} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[IM:transMot]{IM1} & X & X & X & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
