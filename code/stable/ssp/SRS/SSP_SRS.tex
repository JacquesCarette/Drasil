...
Source & \cite{fredlund1977}
\\ \midrule \\
RefBy & \hyperref[GD:resShearWO]{GD: resShearWO} \hyperref[IM:nrmShrForNum]{IM: nrmShrForNum} \hyperref[GD:normForcEq]{GD: normForcEq} \hyperref[GD:momentEql]{GD: momentEql} \hyperref[GD:mobShearWO]{GD: mobShearWO} \hyperref[GD:bsShrFEq]{GD: bsShrFEq} \hyperref[DD:surfWtrF]{DD: surfWtrF}.
\\ \bottomrule \end{tabular}
\end{minipage}
The surface hydrostatic forces come from the weight of the water standing on top of the soil of the slope surface. Substituting values for water into the equation for weight from \hyperref[DD:weightDD]{DD: weightDD} yields:
\begin{displaymath}
{\mathbf{U}_{t}}={\mathbf{V}_{wat}} {γ_{w}}
\end{displaymath}
...
\end{displaymath}
This equation is \hyperref[DD:surfWtrF]{DD: surfWtrF} with \hyperref[DD:surfWtrFRDD]{DD: surfWtrFRDD} and \hyperref[DD:surfWtrFLDD]{DD: surfWtrFLDD} substituted in.
\par~
...
\noindent \begin{minipage}{\textwidth}
\begin{tabular}{p{0.2\textwidth} p{0.73\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:weightDD}
\phantomsection 
\label{DD:weightDD}
\\ \midrule \\
Label & Weight
...
Source & \cite{fredlund1977}
\\ \midrule \\
RefBy & \hyperref[DD:surfWtrF]{DD: surfWtrF} \hyperref[DD:surfWtrF]{DD: surfWtrF}.
\\ \bottomrule \end{tabular}
\end{minipage}
\par~
...
\\
\hyperref[DD:surfWtrF]{DD: surfWtrF} & X & X & X & X & X &  &  &  &  &  &  & X &  & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
...
\\
\hyperref[DD:weightDD]{DD: weightDD} &  &  &  &  &  &  &  &  &  &  &  &  &  & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\bottomrule
