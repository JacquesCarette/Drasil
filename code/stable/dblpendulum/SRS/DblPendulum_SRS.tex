...
\label{Sec:PhysSyst}
The physical system of DblPendulum, as shown in \hyperref[Figure:pendulum]{Fig:pendulum}, includes the following elements:
...
The instance models that govern DblPendulum are presented in \hyperref[Sec:IMs]{Sec:Instance Models}. The information to understand the meaning of the instance models and their derivation is also presented, so that the instance models can be verified.
...
\begin{figure}
\begin{center}
\includegraphics[width=\textwidth]{../../../traceygraphs/DblPendulum/avsa.png}
...
\begin{figure}
\begin{center}
\includegraphics[width=\textwidth]{../../../traceygraphs/DblPendulum/avsall.png}
...
\begin{figure}
\begin{center}
\includegraphics[width=\textwidth]{../../../traceygraphs/DblPendulum/refvsref.png}
...
\begin{figure}
\begin{center}
\includegraphics[width=\textwidth]{../../../traceygraphs/DblPendulum/allvsr.png}
...
\begin{figure}
\begin{center}
\includegraphics[width=\textwidth]{../../../traceygraphs/DblPendulum/allvsall.png}
