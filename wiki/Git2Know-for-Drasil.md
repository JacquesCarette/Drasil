...
1. [Working with `git`](#working-with-git)
   ...
   3. [Commits](#commits)
      1. [Co-Authorship](#co-authorship)
   4. [Oops, how do I undo a commit?!?](#oops-how-do-i-undo-a-commit)
      1. [It’s on my local repo!](#its-on-my-local-repo)
      2. [I pushed it to the remote repo!](#i-pushed-it-to-the-remote-repo)
   5. [Pull Requests](#pull-requests)
   6. [Merge Conflicts](#merge-conflicts)
   7. [Mac OS terminal need2know](#mac-os-terminal-need2know)
      1. [Example code for opening a new project:](#example-code-for-opening-a-new-project)
   8. [Windows/git bash terminal need2know](#windowsgit-bash-terminal-need2know)
   9. [Additional `git` information](#additional-git-information)
      1. [Starting a new branch](#starting-a-new-branch)
      2. [Renaming a branch you already pushed to main](#renaming-a-branch-you-already-pushed-to-main)
      3. [Other commands](#other-commands)
      4. [Helpful VS Code Shortcuts](#helpful-vs-code-shortcuts)
...
A local branch is a branch that exists only on your computer. Only you can access it. A remote branch is a branch from a remote location (e.g., the “origin” repo, your fork, etc.). It is also possible to push your local branch to the remote server, so other people with access to the remote server can track it.
...
- It might seem obvious, but don’t forget to save your changes!
- Or, if you are trying to change the capitalization of a file name and you use macOS, see this [Stack Overflow page](https://stackoverflow.com/questions/10523849/changing-capitalization-of-filenames-in-git).
