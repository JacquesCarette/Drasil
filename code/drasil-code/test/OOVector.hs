...
ooVector :: OOProg r vis stmt mthd stvr att prg => GSProgram r prg
ooVector = prog "OOVector" "" [fileDoc (buildModule "OOVector" []
  [main] [vectorClass])]

vectorClass :: OOProg r vis stmt mthd stvr att prg => CS (r Class)
...
dimension :: OOProg r vis stmt mthd stvr att prg => MS (r mthd)
...
magnitude :: OOProg r vis stmt mthd stvr att prg => MS (r mthd)
...
norm :: OOProg r vis stmt mthd stvr att prg => MS (r mthd)
...
dot :: OOProg r vis stmt mthd stvr att prg => MS (r mthd)
...
add :: OOProg r vis stmt mthd stvr att prg => MS (r mthd)
...
scale :: OOProg r vis stmt mthd stvr att prg => MS (r mthd)
