...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & The Mohr-Coulomb resistive shear strength of a slice $τ$ from \hyperref[T:mcShrStrgth]{Definition~T:mcShrStrgth} is multiplied by the area $b \sec\left(α\right)\cdot{}1$ to obtain the resistive shear force $P$. Note the extra $1$ is to represent a unit of width which is multiplied by the total base length of a slice ${ℓ_{b}}$ of the plane where the normal occurs, where ${ℓ_{b}}=b \sec\left(α\right)$ and $b$ is the x width of the base. This accounts for the effective normal force $N'=N-{U_{b}}$ of a soil from \hyperref[T:effStress]{Definition~T:effStress} where the normal stress is multiplied by the same area to obtain the effective normal force $σ b \sec\left(α\right)\cdot{}1=N'$ A\ref{A:Soil-Layer-Homogeneous} A\ref{A:Soil-Properties} A\ref{A:Soil-Layers-Isotropic}
\\ \midrule \\
Source & \cite{chen2005}
\\ \midrule \\
RefBy & FIXME: This needs to be filled in
...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & From the definition of the factor of safety in \hyperref[T:factOfSafety]{Definition~T:factOfSafety}, and the new definition of $P$, a new relation for the net mobile shear force of the slice $T$ is found as the resistive shear $P$ (\hyperref[GD:resShr]{Definition~GD:resShr}) divided by the factor of safety $FS$. A\ref{A:Factor-of-Safety} A\ref{A:Soil-Layer-Homogeneous} A\ref{A:Soil-Properties} A\ref{A:Soil-Layers-Isotropic}
\\ \midrule \\
Source & \cite{chen2005}
\\ \midrule \\
RefBy & FIXME: This needs to be filled in
...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & For a slice of mass in the slope the moment equilibrium to satisfy \hyperref[T:equilibrium]{Definition~T:equilibrium} in the direction perpendicular to the base surface of the slice. Moment equilibrium is derived from the free body diagram of Section~\ref{Sec:PhysSyst}. Index i refers to the values of the properties for slice/interslices following convention in Section~\ref{Sec:PhysSyst}. Variable definitions can be found in \hyperref[DD:sliceWght]{Definition~DD:sliceWght} to \hyperref[DD:lengthLs]{Definition~DD:lengthLs}. A\ref{A:Interslice-Norm-Shear-Forces-Linear}
\\ \midrule \\
Source & \cite{chen2005}
\\ \midrule \\
RefBy & FIXME: This needs to be filled in
...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & A\ref{A:Surface-Base-Slice-between-Interslice-Straight-Lines}
\\ \midrule \\
Source & \cite{fredlund1977}
\\ \midrule \\
RefBy & FIXME: This needs to be filled in
...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & A\ref{A:Soil-Layer-Homogeneous}
        A\ref{A:Soil-Properties}
        A\ref{A:Soil-Layers-Isotropic}
\\ \midrule \\
Source & \cite{chen2005}
\\ \midrule \\
RefBy & FIXME: This needs to be filled in
...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & The value of the interslice normal force $G$ at interface $i$ The net force. is the weight of the slices adjacent to interface $i$ exert horizontally on each other. A\ref{A:Factor-of-Safety} A\ref{A:Seismic-Force} A\ref{A:Surface-Load}
\\ \midrule \\
Source & \cite{chen2005}
\\ \midrule \\
RefBy & FIXME: This needs to be filled in
...
\end{dmath}
Substituting the equation for $N'$ from equation (16) \hyperref[DD:resShearWO]{Definition~DD:resShearWO} and \hyperref[DD:mobShearWO]{Definition~DD:mobShearWO} into equation (17) and rearranging results in equation (18):
\begin{dmath}
...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & Given the necessary slope inputs, a minimization algorithm or function $Υ$ will identify the critical slip surface of the slope, with the critical slip coordinates $\{{x_{cs}}{,y_{cs}}\}$ and the minimum factor of safety ${FS_{min}}$ that results. A\ref{A:Soil-Properties}
\\ \midrule \\
Source & \cite{li2010}
\\ \midrule \\
RefBy & FIXME: This needs to be filled in
