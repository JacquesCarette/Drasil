...
\intodo{How much of the below discussion is required?}
...
\intodo{Continue a bit, but try to keep it succinct}
...
\intodo{Discuss the job of the domain expert \& importance}
...
\intodo{Mention Drasil}

\section{Problem Statement}

\intodo{Move more of this below content to intro}
...
``valid''. \intodo{Still a bit awkward}

\section{Contributions}

\intodo{contributions}
