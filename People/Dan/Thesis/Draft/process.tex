...
\ds{Add something about how this is about deving the framework itself, not dev 
in general. This is about our developing of the framework itself}
...
\ds{Add an example, something like hghc or F=ma, to set the scene}.

\ds{Make sure to tell the audience why information is being presented here and 
how it's relevant to the chapter ahead. Give an outline of the entire chapter, 
not just the first bit. Get into some detail.}
