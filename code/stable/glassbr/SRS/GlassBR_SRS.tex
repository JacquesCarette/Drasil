...
\toprule
 & T1 (\hyperref[T:isSafePb]{Definition~T:isSafePb}) & T2 (\hyperref[T:isSafeLR]{Definition~T:isSafeLR}) & IM1 (\hyperref[IM:calofCapacity]{Definition~IM:calofCapacity}) & IM2 (\hyperref[IM:calOfDemand]{Definition~IM:calOfDemand}) & IM3 (\hyperref[DD:risk.fun]{Definition~DD:risk.fun}) & DD1 (\hyperref[DD:min.thick]{Definition~DD:min.thick}) & DD2 (\hyperref[DD:loadDurFactor]{Definition~DD:loadDurFactor}) & DD3 (\hyperref[DD:stressDistFac]{Definition~DD:stressDistFac}) & DD4 (\hyperref[DD:nFL]{Definition~DD:nFL}) & DD5 (\hyperref[DD:gTF]{Definition~DD:gTF}) & DD6 (\hyperref[DD:dimlessLoad]{Definition~DD:dimlessLoad}) & DD7 (\hyperref[DD:tolLoad]{Definition~DD:tolLoad}) & DD8 (\hyperref[DD:sdf.tol]{Definition~DD:sdf.tol})
\\
\midrule
...
\\
IM1 (\hyperref[IM:calofCapacity]{Definition~IM:calofCapacity}) &  &  &  &  &  & X & X & X &  &  &  &  & 
\\
IM2 (\hyperref[IM:calOfDemand]{Definition~IM:calOfDemand}) &  &  &  &  &  &  &  &  & X & X &  &  & 
\\
IM3 (\hyperref[DD:risk.fun]{Definition~DD:risk.fun}) &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
DD1 (\hyperref[DD:min.thick]{Definition~DD:min.thick}) &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
DD2 (\hyperref[DD:loadDurFactor]{Definition~DD:loadDurFactor}) &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
...
\toprule
 & T1 (\hyperref[T:isSafePb]{Definition~T:isSafePb}) & T2 (\hyperref[T:isSafeLR]{Definition~T:isSafeLR}) & IM1 (\hyperref[IM:calofCapacity]{Definition~IM:calofCapacity}) & IM2 (\hyperref[IM:calOfDemand]{Definition~IM:calOfDemand}) & IM3 (\hyperref[DD:risk.fun]{Definition~DD:risk.fun}) & DD1 (\hyperref[DD:min.thick]{Definition~DD:min.thick}) & DD2 (\hyperref[DD:loadDurFactor]{Definition~DD:loadDurFactor}) & DD3 (\hyperref[DD:stressDistFac]{Definition~DD:stressDistFac}) & DD4 (\hyperref[DD:nFL]{Definition~DD:nFL}) & DD5 (\hyperref[DD:gTF]{Definition~DD:gTF}) & DD6 (\hyperref[DD:dimlessLoad]{Definition~DD:dimlessLoad}) & DD7 (\hyperref[DD:tolLoad]{Definition~DD:tolLoad}) & DD8 (\hyperref[DD:sdf.tol]{Definition~DD:sdf.tol}) & Data Constraints (Section~\ref{Sec:DataConstraints}) & R1 (\hyperref[inputGlassProps]{FR: Input-Glass-Props}) & R2 (\hyperref[sysSetValsFollowingAssumps]{FR: System-Set-Values-Following-Assumptions}) & R3 (\hyperref[checkInputWithDataCons]{FR: Check-Input-with-Data\_Constraints}) & R4 (\hyperref[outputValsAndKnownQuants]{FR: Output-Values-and-Known-Quantities}) & R5 (\hyperref[checkGlassSafety]{FR: Check-Glass-Safety}) & R6 (\hyperref[outputQuants]{FR: Output-Quantities})
\\
\midrule
...
IM1 (\hyperref[IM:calofCapacity]{Definition~IM:calofCapacity}) &  &  &  & X &  & X & X & 
\\
IM2 (\hyperref[IM:calOfDemand]{Definition~IM:calOfDemand}) & X & X &  &  & X &  &  & 
\\
IM3 (\hyperref[DD:risk.fun]{Definition~DD:risk.fun}) &  &  &  &  &  &  &  & 
\\
DD1 (\hyperref[DD:min.thick]{Definition~DD:min.thick}) &  &  &  &  &  &  &  & 
