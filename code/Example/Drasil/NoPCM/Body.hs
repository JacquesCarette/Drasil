...
assumps_Nopcm_list_new = [assump_new_1, assump_new_2, assump3_new_nopcm, assump4_new_nopcm, assump5_new_nopcm,
 assump6_new_nopcm, assump7_new_nopcm, assump8_new_nopcm,
 assump9_npcm_new_nopcm, assump10_new_nopcm, assump11_new_nopcm, assump12_new_nopcm, assump13_new_nopcm, assump14_new_nopcm]
--------------------------
...
assump6_new_nopcm = assump "assump6"
  (foldlSent [CT.law_conv_cooling ^. defn, S "applies between the",
  phrase coil `sAnd` S "the", phrase water,
  sSqBr $ makeRef $ datadefn dd1HtFluxC]) (S "assump6")
assump7_new_nopcm = assump "assump7" (foldlSent [
  S "The", phrase temp_C, S "is constant over", phrase time,
  sSqBr $ makeRef $ datadefn dd1HtFluxC]) (S "assump7")
assump8_new_nopcm = assump "assump8" (foldlSent [
...
assump10_new_nopcm = assump "assump10"
  (foldlSent [
  ...
  phrase boil_pt, sSqBr $ acroIM 1 `sC` acroIM 3]) (S "assump10")
assump11_new_nopcm = assump "assump11" (foldlSent [
  S "The", phrase tank, S "is", phrase perfect_insul,
  S "so that there is no", phrase CT.heat, S "loss from the",
  phrase tank, sSqBr $ acroIM 1]) (S "assump11")
