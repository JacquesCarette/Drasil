...
\ifshowquestions
  \newenvironment{writingquestions}{\begin{mdquestions}\centering\textbf{Writing Questions}\begin{itemize}}{\end{itemize}\end{mdquestions}}
\else
  \excludecomment{writingquestions}
\fi
