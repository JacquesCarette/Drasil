...
\\ \midrule \\
Equation & \begin{dmath}
           {\mathbf{v}_{B}}={\mathbf{v}_{O}}+\omega{}\times{\mathbf{r}_{OB}}
           \end{dmath}
\\ \midrule \\
Description & \begin{description}
              ...
              \item{$\omega{}$ is the angular velocity ($\frac{\text{rad}}{\text{s}}$)}
...
\\ \midrule \\
Description & \begin{description}
              \item{$\tau{}$ is the torque (Nm)}
              \item{$\mathbf{I}$ is the moment of inertia (kg$\text{m}^{2}$)}
              \item{$\alpha{}$ is the angular acceleration ($\frac{\text{rad}}{\text{s}^{2}}$)}
              \end{description}
\\ \midrule \\
Source & FIXME: This needs to be filled in
\\ \midrule \\
...
\\ \midrule \\
Equation & \begin{dmath}
           \alpha{}=\frac{d\,\omega{}\left(t\right)}{d\,t}=\frac{{\tau{}_{i}}\left(t\right)}{\mathbf{I}}
           \end{dmath}
\\ \midrule \\
Description & \begin{description}
              \item{$\alpha{}$ is the angular acceleration ($\frac{\text{rad}}{\text{s}^{2}}$)}
              \item{$t$ is the time (s)}
              \item{$\omega{}$ is the angular velocity ($\frac{\text{rad}}{\text{s}}$)}
              \item{${\tau{}_{i}}$ is the is the torque applied to the i-th body (Nm)}
              \item{$\mathbf{I}$ is the moment of inertia (kg$\text{m}^{2}$)}
              \end{description}
\\ \midrule \\
Source & 
