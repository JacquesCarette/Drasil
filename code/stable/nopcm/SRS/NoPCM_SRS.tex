...
\end{displaymath}
Using \hyperref[DD:htFluxC]{DD: htFluxC} for ${q_{\text{C}}}$, this can be written as:
...
\\
\hyperref[DD:balanceDecayRate]{DD2} &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
...
\\
\hyperref[GD:rocTempSimp]{GD2} &  &  & X & X & X &  &  &  &  &  &  &  & 
\\
...
\toprule
\textbf{} & \textbf{\hyperref[DD:htFluxC]{DD1}} & \textbf{\hyperref[DD:balanceDecayRate]{DD2}} & \textbf{\hyperref[TM:consThermE]{TM1}} & \textbf{\hyperref[TM:sensHtE]{TM2}} & \textbf{\hyperref[GD:nwtnCooling]{GD1}} & \textbf{\hyperref[GD:rocTempSimp]{GD2}} & \textbf{\hyperref[IM:eBalanceOnWtr]{IM1}} & \textbf{\hyperref[IM:heatEInWtr]{IM2}}
\\
\midrule
\endhead
