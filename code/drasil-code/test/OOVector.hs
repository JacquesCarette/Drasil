...
ooVector :: OOProg r vis smt md svr => GSProgram r
ooVector = prog "OOVector" "" [fileDoc (buildModule "OOVector" []
  [main] [vectorClass])]

vectorClass :: OOProg r vis smt md svr => SClass r
...
dimension :: OOProg r vis smt md svr => MS (r md)
...
magnitude :: OOProg r vis smt md svr => MS (r md)
...
norm :: OOProg r vis smt md svr => MS (r md)
...
dot :: OOProg r vis smt md svr => MS (r md)
...
add :: OOProg r vis smt md svr => MS (r md)
...
scale :: OOProg r vis smt md svr => MS (r md)
