...
\refExampleAngleEquationEncoding as \(\mathit{targetDistanceFromCannon} \cdot{}
...
\begin{enumerate}
      ...
      \item[\namedlabel{rq:modelkinds}{RQ1}] Drasil's current encoding of
            ...
            we codify that?\qtodo{Would it be better to rephrase this as
                  desiring domain-specific transformation of theories?}
      ...
      \item[\namedlabel{rq:lang_division}{RQ2}] Drasils theory encodings rely on
            ...
            \qtodo{Should we remove this as an RQ? It was something we did along
                  the way for ModelKinds, technically, and it might be too basic. I'm
                  tending towards ``yes, we should remove it.''}
...
the fruits of this work. \Cref{chap:modelkinds} discusses how Drasil contains
...
\Cref{chap:typedExpr} discusses issues associated with the formation of
mathematical expressions and what it means for expressions to be ``well-formed''
(\ref{rq:typing}). \Cref{chap:storingChunks} focuses on how Drasil stores
