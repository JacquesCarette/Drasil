...
fileTestsOO :: (OOProg r tp) => OO.GSProgram r
...
fileTestsProc :: (ProcProg r tp) => GProc.GSProgram r
...
readStory :: (SharedProg r tp) => MSStatement r
...
goodBye :: (SharedProg r tp) => MSBlock r
goodBye = block [
