...
\citep{AckroydEtAl2008, AlMatiiAndBoujarwah2002, CarverEtAl2007,
...
SmithAndYu2009, SmithEtAl2015-SS-TR, SmithKoothoorAndNedialkov2014,
Thimbleby1986}. Despite this, it is not often
...
inter-artifact synchronization issues.
...
They also do not generate all \sfs{}\textemdash{}commonly, they are used to
generate only application programming interface (API) documentation targeted
toward developers or user manuals.
...
adapted to generate additional artifact types, such as design documents, test
cases, and verification and validation reports, those artifacts are outside the
scope of the present work.

Our work on Drasil is most relevant to software that is 
well-understood~\citep{CaretteEtAl2023} and undergoes frequent change
...
software (also called research software). Specifically, we are looking at 
software that follows the pattern 
...
It also has the benefit of seldom changing, and when it does, existing models
...
As \citet{Kelly2007} observes, many SC software developers put the emphasis on
science rather than development. SC software could therefore benefit from
greater buy-in to good software development practices. Rather than following
rigid, process-heavy approaches that \citet{CarverEtAl2007} report are viewed
unfavourably by the teams they studied, developers of SC software choose to use
knowledge acquisition driven~\citep{Kelly2015},
agile~\citep{Segal2005, CarverEtAl2007, AckroydEtAl2008, 
EasterbrookAndJohns2009}, or amethodical~\citep{Kelly2013} processes instead.
...
guaranteed by current AI-based methods~\citep{OuyangEtAl2025,
BalachandranEtAl2024}.
...
\begin{itemize}
    ...
    (DSLs) embedded in Haskell for knowledge capture and artifact generation.
...
\begin{itemize}
    ...
    \item \textbf{Evidence that single-source generation enforces 
...
than the individual artifacts. We can still produce what
\citet{ParnasAndClements1986} call a ``rational design'' without the explicit
tedium of manually keeping everything in sync.
