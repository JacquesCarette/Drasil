...
\\
$\mathbf{\hat{r}}$ & Unit vector directed from the large mass to the smaller mass & m
\\
$t$ & Time & s
\\
...
Description & \begin{symbDescription}
              ...
              \item{$\mathbf{\hat{r}}$ is the unit vector directed from the large mass to the smaller mass (m)}
