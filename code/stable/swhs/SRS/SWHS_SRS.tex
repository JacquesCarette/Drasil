...
\end{description}
\begin{description}
\item[\refstepcounter{assumpnum}\atheassumpnum\label{A:Charging-Tank-No-Temp-Discharge}:]The model only accounts for charging of the tank, not discharging. The temperature of the water and temperature of the phase change material can only increase, or remain constant; they do not decrease. This implies that the initial temperature {[}A\ref{A:Same-Initial-Temp-Water-PCM}{]} is less than (or equal) to the temperature of the heating coil {[}LC\ref{LC:Discharging-Tank}{]}.
\end{description}
\begin{description}
...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & A\ref{A:Newton-Law-Convective-Cooling-Coil-Water}
        A\ref{A:Temp-Heating-Coil-Constant-over-Time}
        A\ref{A:Temp-Heating-Coil-Constant-over-Length}
\\ \midrule \\
...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & \hyperref[DD:htFusion]{Definition~DD:htFusion}
\\ \midrule \\
Source & \cite{koothoor2013}
\\ \midrule \\
RefBy & FIXME: This needs to be filled in
