...
angAccelEqn_1 = sy massObj_1 $* sy mvAccel_1 $=
  neg (sy tension_1) $* sin (sy pendDisAngle_1)

angAccelEqn_2 = sy massObj_1 $* sy mvAccel_1 $=
  sy tension_1 $* cos (sy pendDisAngle_1)
  $- (sy massObj_1 $* sy gravitationalMagnitude)

angAccelEqn_3 = sy massObj_2 $* sy mvAccel_2 $=
  neg (sy tension_2) $* sin (sy pendDisAngle_2)

angAccelEqn_4 = sy massObj_2 $* sy mvAccel_2 $=
