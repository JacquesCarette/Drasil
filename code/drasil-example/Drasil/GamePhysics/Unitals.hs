...
orientCons     = constrained' QM.orientation        [sfwrc $ Bounded (Inc, dbl 0) (Inc, dbl 2 `mulRe` sy QM.pi_)] (sy QM.pi_ $/ dbl 2) -- physical constraint not needed space is radians
