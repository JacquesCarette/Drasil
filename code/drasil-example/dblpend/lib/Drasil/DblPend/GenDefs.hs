...
import Language.Drasil (ModelQDef, Derivation, Sentence(..), mkDerivName, eS, nounPhraseSP,
  (+:+), phrase, getUnit, mkQuantDef', express, sy, ($=))
...
mvVelQD_1 :: ModelQDef  
mvVelQD_1 = mkQuantDef' mvVel_1 (nounPhraseSP "multivector velocity of the first object") (express E.mvVelExpr_1)
...
mvVelDerivEqns_1 = [eS $ sy mvVel_1 $= express E.mvVelExpr_1]
...
mvVelQD_2 :: ModelQDef
mvVelQD_2 = mkQuantDef' mvVel_2 (nounPhraseSP "multivector velocity of the second object") (express E.mvVelExpr_2)
...
mvVelDerivEqns_2 = [eS $ sy mvVel_2 $= express E.mvVelExpr_2]
...
mvAccelQD_1 = mkQuantDef' mvAccel_1 (nounPhraseSP "multivector acceleration of the first object") (express E.mvAccelExpr_1)
...
mvAccelDerivEqns_1 = [eS $ sy mvAccel_1 $= express E.mvAccelExpr_1]
...
mvAccelQD_2 = mkQuantDef' mvAccel_2 (nounPhraseSP "multivector acceleration of the second object") (express E.mvAccelExpr_2)
...
mvAccelDerivEqns_2 = [eS $ sy mvAccel_2 $= express E.mvAccelExpr_2]
...
mvForceQD_1 = mkQuantDef' mvForce_1 (nounPhraseSP "multivector force on the first object") (express E.mvForceExpr_1)
...
mvForceDerivEqns_1 = [eS $ sy mvForce_1 $= express E.mvForceExpr_1]
...
mvForceQD_2 = mkQuantDef' mvForce_2 (nounPhraseSP "multivector force on the second object") (express E.mvForceExpr_2)
