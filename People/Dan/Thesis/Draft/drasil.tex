...
a human-usable way to generate \sfs{}. The name Drasil is derived from 
Yggdrasil (the world tree of Norse mythology) whose branches spread across the 
many realms. So too does Drasil spread across the many domains and contexts 
