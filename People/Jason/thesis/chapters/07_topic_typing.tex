...
future-proof scheme that will scale against our
expectations\cite{CaretteDiscussion2022}: \textit{bidirectional type-checking}.
...
(\refOriginalSpaceHaskell{}), in Drasil that we can work with and start using as
intended.
...
\newTypeRule{Frac. Bin. Op}{fracBinOp}
      ...
      {\Gamma \vdash \frac{l}{r} \Rightarrow \bb{B}}
...
\imptodo{Add a future work note, building ``breadcrumbs''-style explanation of
      explaining where a type issue arose.}
