...
\end{itemize}
\item{\hyperref[Sec:Stakeholder]{Stakeholders}}
\begin{itemize}
\item{\hyperref[Sec:Customer]{The Customer}}
\item{\hyperref[Sec:Client]{The Client}}
\end{itemize}
...
Description & \begin{symbDescription}
              ...
              \item{$t$ is the nominal thickness (${\text{mm}}$)}
              \end{symbDescription}
\\ \midrule
Notes & $t$ is a function that maps from the nominal thickness ($h$) to the minimum thickness.
        
        nominal thickness t is in $\{2.5,2.7,3.0,4.0,5.0,6.0,8.0,10.0,12.0,16.0,19.0,22.0\}$
