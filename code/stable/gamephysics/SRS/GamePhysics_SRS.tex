...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & The linear velocity ${\mathbf{v}_{\text{B}}}$ ($\frac{\text{m}}{\text{s}}$) of any point B in a rigid body (from \hyperref[assumpOT]{A: objectTy}) is the sum of the linear velocity ${\mathbf{v}_{\text{O}}}$ ($\frac{\text{m}}{\text{s}}$) of the rigid body at the origin (axis of rotation) and the resultant vector from the cross product of the rigid body's angular velocity $ω$ ($\frac{\text{rad}}{\text{s}}$) and the displacement vector between the origin and point B, ${\mathbf{r}_{\text{O}\text{B}}}$ (m).
