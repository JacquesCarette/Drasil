...
documentation should not impede scientists' work.  Major problems in creating SC
software stems from the maintainability and technique selection challenges
...
verification plans, design specification and code. \lss{} aims to generate all of these
