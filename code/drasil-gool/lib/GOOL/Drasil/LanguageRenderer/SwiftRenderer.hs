...
swiftModDoc desc as date v m = m : [desc | not (null desc)] ++ 
  ...
  ++ [swiftDocCommandInit ++ swiftDateDoc ++ swiftDocCommandSep ++ date 
    | not (null date)] ++ [swiftDocCommandInit ++ swiftDrasilVers ++ 
    swiftDocCommandSep ++ v]

swiftDocCommandInit, swiftDocCommandSep, swiftParamDoc, swiftRetDoc,
  swiftAuthorDoc, swiftDateDoc, swiftDrasilVers :: String
swiftDocCommandInit = "- "
swiftDocCommandSep = ": "
...
swiftDateDoc = "Date"
swiftDrasilVers = "Generated by Drasil Version"
