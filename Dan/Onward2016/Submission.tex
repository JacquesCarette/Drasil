...
\begin{tikzpicture}[node distance=6mm]
  ...
  \node (rc) [below left = of uc]	{RelationChunk (\emph{relation})};
  \node (eq) [below = of uc]	{EqChunk (\emph{equation})};

  \draw [->, line width=2pt] (ch) -- (co);
  \draw [->, line width=2pt] (co.west) -- (-2.77,-1.365) -- (rc); 
		%No idea how to do this
  \draw [->, line width=2pt] (co) -- (qu);
  \draw [->, line width=2pt] (co.east) -- (2.95,-1.365) -- (u );
  \draw [->, line width=2pt] (qu) -- (uc);
  \draw [->, line width=2pt] (u .south) -- (2.95,-4.28) -- (uc);
