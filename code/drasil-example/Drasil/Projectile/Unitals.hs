...
launAngle = constrained'    (dqd' launAngleConcept (staged lTheta (Variable "angle")) Real (Just radian)) [physc $ Bounded (Exc, 0) (Exc, sy pi_ / 2)] (sy pi_ / 4)
...
unitHelper sym substr = const $ sub sym $ Label substr
