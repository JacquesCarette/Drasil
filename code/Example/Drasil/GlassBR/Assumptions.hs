...
newA1 = assump "glassTyA" a1Desc (shortname' "glassTy") []
newA2 = assump "glassConditionA" a2Desc (shortname' "glassCondition") []
newA3 = assump "explsnScenarioA"a3Desc (shortname' "explainScenario") []
newA4 = assump "standardValuesA" (a4Desc load_dur) (shortname' "StandardValues") []
newA5 = assump "glassLiteA" a5Desc (shortname' "glassLite") []
newA6 = assump "bndryConditionsA" a6Desc (shortname' "boundaryConditions") []
newA7 = assump "responseTyA" a7Desc (shortname' "responseType") []
newA8 = assump "ldfConstantA" (a8Desc constant_LoadDF) (shortname' "ldfConstant") []
