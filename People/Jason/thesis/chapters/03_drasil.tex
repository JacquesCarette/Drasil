...
\eztodo{Discuss Dr. Smiths template a bit more, I need to explain the sections
      quickly, give an example, and explain that it dissects SCS into
      well-understood components, which should provide sufficient information
      for a developer to build a representational software. Perhaps I can
      include a sample schematic?}
