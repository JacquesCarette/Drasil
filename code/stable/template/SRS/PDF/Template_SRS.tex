...
\\
${b_{D}}$ & maximum demand of apples & --
\\
${b_{S}}$ & minimum supply of apples & --
\\
$D$ & Demand & --
\\
${D_{l}}$ & price-dependant apple demand & --
\\
$\text{inEquilibrium}$ & In equilibrium & --
\\
${m_{D}}$ & marginal apple demand by price & --
\\
${m_{S}}$ & marginal apple supply by price & --
\\
$P$ & Price & --
\\
${p_{A}}$ & Apple price & --
...
$S$ & Supply & --
\\
${S_{l}}$ & price-dependant apple supply & --
\label{Table:ToS}
\end{longtblr}
...
\\ \midrule
Equation & \begin{displaymath}
           \resizeExpression{{S_{l}}\left({p_{A}}\right)={m_{S}}\,{p_{A}}+{b_{S}}}
           \end{displaymath}
\\ \midrule
Description & \begin{symbDescription}
              \item{${S_{l}}$ is the price-dependant apple supply (Unitless)}
              \item{${m_{S}}$ is the marginal apple supply by price (Unitless)}
              \item{${p_{A}}$ is the apple price (Unitless)}
              \item{${b_{S}}$ is the minimum supply of apples (Unitless)}
              \end{symbDescription}
\\ \midrule
Source & --
...
Description & \begin{symbDescription}
              ...
              \item{${b_{D}}$ is the maximum demand of apples (Unitless)}
              \item{${b_{S}}$ is the minimum supply of apples (Unitless)}
              \item{${m_{S}}$ is the marginal apple supply by price (Unitless)}
              \item{${m_{D}}$ is the marginal apple demand by price (Unitless)}
              \end{symbDescription}
\\ \midrule
Source & --
