...
pSpec (Ref Internal r a _)      = reflink     r $ pSpec a
pSpec (Ref Cite2    r a EmptyS) = reflink     r $ pSpec a -- no difference for citations?
pSpec (Ref Cite2    r a n)      = reflinkInfo r (pSpec a) (pSpec n) -- no difference for citations?
pSpec (Ref External r a _)      = reflinkURI  r $ pSpec a
