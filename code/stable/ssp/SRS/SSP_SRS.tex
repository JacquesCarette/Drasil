...
\\
$H$ & Interslice Normal Water Force: exerted in the x-ordinate direction between adjacent slices for interslice index i & N
\\
...
\\
${h_{z}}$ & Center of Slice Height: the distance from the lowest part of the slice to the height of the centers of slice & m
\\
...
\\
$P$ & Resistive Shear Force Per Meter in the Z-Direction: Mohr Coulomb frictional force that describes the limit of mobilized shear force the slice i can withstand before failure & $\frac{\text{N}}{\text{m}}$
\\
...
\\
$S$ & Mobilized Shear Force Per Meter in the Z-Direction: for slice index i & $\frac{\text{N}}{\text{m}}$
\\
...
\item[Factor-of-Safety:\phantomsection\label{assumpFOS}]The factor of safety is assumed to be constant across the entire slip surface. \hyperref[GD:mobShr]{GD: mobShr} \hyperref[IM:intsliceFs]{IM: intsliceFs}.
\item[Soil-Layer-Homogeneous:\phantomsection\label{assumpSLH}]The soil mass is homogeneous, with consistent soil properties throughout. \hyperref[GD:resShr]{GD: resShr} \hyperref[GD:mobShr]{GD: mobShr} \hyperref[LC_inhomogeneous]{LC: Calculate-Inhomogeneous-Soil-Layers}.
...
\item[Soil-Layers-Isotropic:\phantomsection\label{assumpSLI}]The soil mass is treated as if the effective cohesion and effective angle of friction are isotropic properties. \hyperref[GD:resShr]{GD: resShr} \hyperref[GD:mobShr]{GD: mobShr} \hyperref[UC_normshearlinear]{UC: Normal-And-Shear-Linear-Only}.
\item[Interslice-Norm-Shear-Forces-Linear:\phantomsection\label{assumpINSFL}]Following the assumption of Morgenstern and Price (\cite{morgenstern1965}), interslice normal force and interslice shear force have a proportional relationship, depending on a proportionality constant ($λ$) and a function ($f$) describing variation depending on $x$ position. \hyperref[IM:nrmShrFor]{IM: nrmShrFor} \hyperref[GD:normShrR]{GD: normShrR} \hyperref[GD:momentEql]{GD: momentEql} \hyperref[IM:intsliceFs]{IM: intsliceFs} \hyperref[IM:fctSfty]{IM: fctSfty} \hyperref[UC_normshearlinear]{UC: Normal-And-Shear-Linear-Only}.
\item[Plane-Strain-Conditions:\phantomsection\label{assumpPSC}]The slope and slip surface extends far into and out of the geometry ($z$ coordinate). This implies plane strain conditions, making 2D analysis appropriate. \hyperref[GD:effNormF]{GD: effNormF}.
...
Label & Factor of safety
        ...
        Equation & \begin{displaymath}
                   ...
                   Description & \begin{symbDescription}
                                 ...
                                 \item{$P$ is the resistive shear force per meter in the z-direction ($\frac{\text{N}}{\text{m}}$)}
                                 \item{$S$ is the mobilized shear force per meter in the z-direction ($\frac{\text{N}}{\text{m}}$)}
                                 \end{symbDescription}
                                 \\ \midrule \\
...
Label & Normal force equilibrium
        ...
        Equation & \begin{displaymath}
                   ...
                   Description & \begin{symbDescription}
                                 ...
                                 \item{$H$ is the interslice normal water force (N)}
                                 \end{symbDescription}
                                 \\ \midrule \\
...
Label & Resistive shear force
        ...
        Equation & \begin{displaymath}
                   ...
                   Description & \begin{symbDescription}
                                 ...
                                 \end{symbDescription}
                                 \\ \midrule \\
                                 Notes & The Mohr-Coulomb resistive shear strength of a slice $τ$ from \hyperref[TM:mcShrStrgth]{TM: mcShrStrgth} is multiplied by the area $b \sec\left(α\right)$ to obtain the resistive shear force per meter in the z-direction $P$. Note the extra $1$ is to represent a unit of width which is multiplied by the total base length of a slice ${ℓ_{b}}$ of the plane where the normal occurs, where ${ℓ_{b}}=b \sec\left(α\right)$ and $b$ is the x width of the base. This accounts for the effective normal force $N'=N-{U_{b}}$ of a soil from \hyperref[TM:effStress]{TM: effStress} where the effective normal stress is multiplied by the same area to obtain the effective normal force ${σ_{N}}' b \sec\left(α\right)=N'$ \hyperref[assumpSLH]{A: Soil-Layer-Homogeneous} \hyperref[assumpSP]{A: Soil-Properties} \hyperref[assumpSLI]{A: Soil-Layers-Isotropic}
                                         \\ \midrule \\
                                         Source & \cite{chen2005}
                                                  \\ \midrule \\
                                                  RefBy & \hyperref[GD:mobShr]{GD: mobShr}.
...
Label & Mobile shear force
        ...
        Equation & \begin{displaymath}
                   ...
                   Description & \begin{symbDescription}
                                 ...
                                 \end{symbDescription}
                                 \\ \midrule \\
                                 Notes & From the definition of the factor of safety in \hyperref[TM:factOfSafety]{TM: factOfSafety}, and the new definition of $P$, a new relation for the net mobile shear force of the slice $T$ is found as the resistive shear $P$ (\hyperref[GD:resShr]{GD: resShr}) divided by the factor of safety ${F_{S}}$. \hyperref[assumpFOS]{A: Factor-of-Safety} \hyperref[assumpSLH]{A: Soil-Layer-Homogeneous} \hyperref[assumpSP]{A: Soil-Properties} \hyperref[assumpSLI]{A: Soil-Layers-Isotropic}
                                         \\ \midrule \\
                                         Source & \cite{chen2005}
                                                  \\ \midrule \\
                                                  RefBy & \hyperref[IM:intsliceFs]{IM: intsliceFs} \hyperref[IM:fctSfty]{IM: fctSfty}.
...
Label & Moment equilibrium
        \\ \midrule \\
        Equation & \begin{displaymath}
                   0=-G_{i} \left({h_{z,i}}-\frac{b_{i}}{2} \tan\left(α_{i}\right)\right)+G_{i-1} \left({h_{z,i-1}}-\frac{b_{i}}{2} \tan\left(α_{i}\right)\right)-H_{i} \left({h_{z,i}}-\frac{b_{i}}{2} \tan\left(α_{i}\right)\right)+H_{i-1} \left({h_{z,i-1}}-\frac{b_{i}}{2} \tan\left(α_{i}\right)\right)-\frac{b_{i}}{2} \left(X_{i}+X_{i-1}\right)+\frac{{K_{c}} W_{i} h_{i}}{2}-{U_{t,i}} \sin\left(β_{i}\right) h_{i}-Q_{i} \sin\left(ω_{i}\right) h_{i}
                   \end{displaymath}
                   \\ \midrule \\
                   Description & \begin{symbDescription}
                                 \item{$G$ is the interslice normal force (N)}
                                 \item{$i$ is the index (Unitless)}
                                 \item{${h_{z}}$ is the center of slice height (m)}
                                 \item{$b$ is the base width of a slice (m)}
                                 \item{$α$ is the angle (${}^{\circ}$)}
                                 \item{$H$ is the interslice normal water force (N)}
                                 \item{$X$ is the interslice shear force (N)}
...
\end{cases}
                                    ...
                                    Description & \begin{symbDescription}
                                                  ...
                                                  \end{symbDescription}
                                                  \\ \midrule \\
                                                  Notes & \hyperref[assumpSBSBISL]{A: Surface-Base-Slice-between-Interslice-Straight-Lines}
                                                          \\ \midrule \\
                                                          Source & \cite{fredlund1977}
                                                                   \\ \midrule \\
                                                                   RefBy & 
                         ...
                         Equation & \begin{displaymath}
                                    ...
                                    Description & \begin{symbDescription}
                                                  ...
                                                  Notes & This equation is based on the assumption that the base of a slice is a straight line (\hyperref[assumpSBSBISL]{A: Surface-Base-Slice-between-Interslice-Straight-Lines}).
                                                          ...
                                                          Source & \cite{fredlund1977}
                                                                   \\ \midrule \\
                                                                   RefBy & \hyperref[DD:lengthLb]{DD: lengthLb} \hyperref[DD:convertFunc2]{DD: convertFunc2} \hyperref[DD:convertFunc1]{DD: convertFunc1}.
\\ \bottomrule \end{tabular}
\end{minipage}
\par~
                         ...
                         Equation & \begin{displaymath}
                                    ...
                                    Description & \begin{symbDescription}
                                                  ...
                                                  Notes & This equation is based on the assumption that the surface of a slice is a straight line (\hyperref[assumpSBSBISL]{A: Surface-Base-Slice-between-Interslice-Straight-Lines}).
                                                          ...
                                                          Source & \cite{fredlund1977}
                                                                   \\ \midrule \\
                                                                   RefBy & \hyperref[DD:lengthLs]{DD: lengthLs}.
\\ \bottomrule \end{tabular}
\end{minipage}
\par~
                 ...
                 Units & m
                         ...
                         Equation & \begin{displaymath}
                                    ...
                                    Description & \begin{symbDescription}
                                                  ...
                                                  Source & \cite{fredlund1977}
                                                           \\ \midrule \\
                                                           RefBy & \hyperref[DD:lengthLs]{DD: lengthLs} \hyperref[DD:lengthLb]{DD: lengthLb}.
\\ \bottomrule \end{tabular}
\end{minipage}
\par~
                         ...
                         Equation & \begin{displaymath}
                                    ...
                                    Description & \begin{symbDescription}
                                                  ...
                                                  Source & \cite{huston2008}
                                                           \\ \midrule \\
                                                           RefBy & \hyperref[TM:effStress]{TM: effStress} \hyperref[GD:effNormF]{GD: effNormF}.
\\ \bottomrule \end{tabular}
\end{minipage}
\par~
...
\end{cases}
                                    ...
                                    Description & \begin{symbDescription}
                                                  ...
                                                  Source & \cite{fredlund1977}
                                                           \\ \midrule \\
                                                           RefBy & \hyperref[DD:convertFunc2]{DD: convertFunc2} \hyperref[DD:convertFunc1]{DD: convertFunc1}.
\\ \bottomrule \end{tabular}
\end{minipage}
\par~
                                    ...
                                    Description & \begin{symbDescription}
                                                  ...
                                                  Notes & $f$ is defined in \hyperref[DD:ratioVariation]{DD: ratioVariation} and $α$ is defined in \hyperref[DD:angleA]{DD: angleA}.
                                                          ...
                                                          Source & \cite{chen2005} and \cite{karchewski2012}
                                                                   \\ \midrule \\
                                                                   RefBy & \hyperref[IM:fctSfty]{IM: fctSfty} \hyperref[DD:convertFunc2]{DD: convertFunc2}.
\\ \bottomrule \end{tabular}
\end{minipage}
\par~
...
\\ \bottomrule \end{tabular}
\end{minipage}
The mobilized shear force per meter in the z-direction defined in \hyperref[GD:bsShrFEq]{GD: bsShrFEq} can be substituted into the definition of mobilized shear force per meter in the z-direction based on the factor of safety, from \hyperref[GD:mobShr]{GD: mobShr} yielding equation (1) below:
\begin{displaymath}
...
\end{displaymath}
Applying assumptions \hyperref[assumpSF]{A: Seismic-Force} and \hyperref[assumpSL]{A: Surface-Load}, which state that the earthquake load factor and the imposed surface load, respectively, are zero, allows for further simplification as shown below:
\begin{displaymath}
...
b_{i} \left({{F_{x}}^{G}}+{{F_{x}}^{H}}\right) \tan\left(α_{i}\right)+h \left({K_{c}} W_{i}-2 {U_{t,i}} \sin\left(β_{i}\right)-2 Q_{i} \cos\left(ω_{i}\right)\right), & 2\leq{}i\leq{}n-1\\
...
\begin{displaymath}
0=-G_{i} \left({h_{z,i}}-\frac{b_{i}}{2} \tan\left(α_{i}\right)\right)+G_{i-1} \left({h_{z,i-1}}-\frac{b_{i}}{2} \tan\left(α_{i}\right)\right)-H_{i} \left({h_{z,i}}-\frac{b_{i}}{2} \tan\left(α_{i}\right)\right)+H_{i-1} \left({h_{z,i-1}}-\frac{b_{i}}{2} \tan\left(α_{i}\right)\right)-λ \frac{b_{i}}{2} \left(G_{i} f_{i}+G_{i-1} f_{i-1}\right)+\frac{{K_{c}} W_{i} h_{i}}{2}-{U_{t,i}} \sin\left(β_{i}\right) h_{i}-Q_{i} \sin\left(ω_{i}\right) h_{i}
\end{displaymath}
Rearranging the equation in terms of $λ$ leads to equation (10):
\begin{displaymath}
λ=\frac{-G_{i} \left({h_{z,i}}-\frac{b_{i}}{2} \tan\left(α_{i}\right)\right)+G_{i-1} \left({h_{z,i-1}}-\frac{b_{i}}{2} \tan\left(α_{i}\right)\right)-H_{i} \left({h_{z,i}}-\frac{b_{i}}{2} \tan\left(α_{i}\right)\right)+H_{i-1} \left({h_{z,i-1}}-\frac{b_{i}}{2} \tan\left(α_{i}\right)\right)+\frac{{K_{c}} W_{i} h_{i}}{2}-{U_{t,i}} \sin\left(β_{i}\right) h_{i}-Q_{i} \sin\left(ω_{i}\right) h_{i}}{\frac{b_{i}}{2} \left(G_{i} f_{i}+G_{i-1} f_{i-1}\right)}
\end{displaymath}
...
\begin{displaymath}
λ_{i}=\frac{\displaystyle\sum_{i=1}^{n}{b_{i} \left({{F_{x}}^{G}}+{{F_{x}}^{H}}\right) \tan\left(α_{i}\right)+h_{i} \left({K_{c}} W_{i}-2 {U_{t,i}} \sin\left(β_{i}\right)-2 Q_{i} \sin\left(ω_{i}\right)\right)}}{\displaystyle\sum_{i=1}^{n}{b_{i} \left(G_{i} f_{i}+G_{i-1} f_{i-1}\right)}}
\end{displaymath}
...
\end{displaymath}
Taking the base shear force equilibrium of \hyperref[GD:bsShrFEq]{GD: bsShrFEq} with the definition of mobilized shear force per meter in the z-direction from \hyperref[GD:mobShr]{GD: mobShr} and the assumption of \hyperref[GD:normShrR]{GD: normShrR}, the equilibrium equation can be rewritten as equation (17):
\begin{displaymath}
...
\end{displaymath}
The constants $Ψ$ and $Φ$ described in equation (20) and equation (19) are functions of the unknowns: the proportionality constant $λ$ (\hyperref[IM:nrmShrFor]{IM: nrmShrFor}) and the factor of safety ${F_{S}}$ (\hyperref[IM:fctSfty]{IM: fctSfty}).
\par~
