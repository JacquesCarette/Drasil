...
\title{Software Requirements Specification for Projectile Motion Analysis}
...
\begin{itemize}
\item{Provide initial conditions of the physical state of the motion and the input data related to the Projectile Motion Analysis, ensuring no errors in the data entry.}
