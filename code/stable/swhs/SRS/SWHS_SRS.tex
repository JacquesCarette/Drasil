...
\\
IM1 (\hyperref[DD:aspectRatio]{DD: aspectRatio}) &  &  &  &  & X & X & X &  &  &  &  &  & X &  & 
\\
IM2 (\hyperref[IM:eBalanceOnWtr]{IM: eBalanceOnWtr}) &  &  &  &  & X &  & X & X & X &  & X & X &  &  & X
\\
IM3 (\hyperref[IM:eBalanceOnPCM]{IM: eBalanceOnPCM}) &  & X &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
IM4 (\hyperref[IM:heatEInWtr]{IM: heatEInWtr}) &  & X & X &  &  &  & X &  & X & X &  &  & X &  & 
\\
\bottomrule
\caption{Traceability Matrix Showing the Connections Between Items of Different Sections}
\label{Table:Tracey2}
...
\\
IM1 (\hyperref[DD:aspectRatio]{DD: aspectRatio}) &  &  &  &  &  &  &  &  &  &  & X & X &  & X & X & X &  &  & X
\\
IM2 (\hyperref[IM:eBalanceOnWtr]{IM: eBalanceOnWtr}) &  &  &  &  &  &  &  &  &  &  &  & X & X &  &  & X & X & X & 
\\
IM3 (\hyperref[IM:eBalanceOnPCM]{IM: eBalanceOnPCM}) &  &  &  &  &  &  &  &  &  &  &  &  &  & X &  &  &  &  & X
\\
IM4 (\hyperref[IM:heatEInWtr]{IM: heatEInWtr}) &  &  &  &  &  &  &  &  &  &  &  &  & X &  &  &  &  & X & 
\\
LC1 (\hyperref[IM:heatEInPCM]{IM: heatEInPCM}) &  &  &  & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
LC2 (\hyperref[likeChgUTP]{LC: Uniform-Temperature-PCM}) &  &  &  &  &  &  &  & X &  &  &  &  &  &  &  &  &  &  & 
\\
LC3 (\hyperref[likeChgTCVOD]{LC: Temperature-Coil-Variable-Over-Day}) &  &  &  &  &  &  &  &  & X &  &  &  &  &  &  &  &  &  & 
\\
LC4 (\hyperref[likeChgTCVOL]{LC: Temperature-Coil-Variable-Over-Length}) &  &  &  &  &  &  &  &  &  &  & X &  &  &  &  &  &  &  & 
\\
LC5 (\hyperref[likeChgDT]{LC: Discharging-Tank}) &  &  &  &  &  &  &  &  &  &  &  & X &  &  &  &  &  &  & 
\\
LC6 (\hyperref[likeChgDITPW]{LC: Different-Initial-Temps-PCM-Water}) &  &  &  &  &  &  &  &  &  &  &  &  &  &  & X &  &  &  & 
\\
\bottomrule
