...
\begin{columns}
    ...
    \block{What is Drasil?}{ Drasil is a framework for generating families of
        ...
        studies, and documentation studies can be found on its website;
    ...
    \block{Research Motivation/Problem}{
        \begin{itemize}
            ...
            \item Only a handful of the case studies generate code,
                  because...
                  \begin{itemize}
                      \item Code is validated, and has rigid rules we must obey,
                      ...
                      \item Cognitive load of writing expressions in precise
                            ...
                            increase.
                      \item Understanding \& usage of the expressions is weak
                            and brittle as they don't expose sufficient
            ...
            \item Created a system of classifying \textit{theories}
                  ...
                  \begin{itemize}
                      ...
                      \item First-class representation of theories, with their
                            fundamental components flexibly usable. No more
                            brittle cast-like conversion of mathematical
                            expressions (low information density) to
