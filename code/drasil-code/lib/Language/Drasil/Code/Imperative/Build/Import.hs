...
instance RuleTransformer CodeHarness where
  makeRule (Ch b r s m d) = maybe [mkRule ["Project Name and Purpose: " ++ progName m ++ " - To " ++ progPurp m] buildTarget [] []]
    ...
    in [
    mkRule ["Project Name and Purpose: " ++ progName m ++ " - To " ++ progPurp m] buildTarget [outnm] [],
