...
\end{dmath}
Where ${q_{in}}$, ${q_{out}}$, ${A_{in}}$, and ${A_{out}}$ are explained in \hyperref[GD:rocTempSimp]{Definition~GD:rocTempSimp}. Assuming $ρ$, $C$ and $T$ are constant over the volume, which is true in our case by Assumptions (A\ref{A:Constant-Water-Temp-Across-Tank}), (A\ref{A:Temp-PCM-Constant-Across-Volume}), (A\ref{A:Density-Water-PCM-Constant-over-Volume}), and (A\ref{A:Specific-Heat-Energy-Constant-over-Volume}), we have:
\begin{dmath}
