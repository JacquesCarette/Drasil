...
fragment. Oddly\todo{Is it odd though? Or expected?}, these transformations are
...
\textit{SmithEtAl} knowledge transformer. It is currently represented using the
entry point to Haskell programs, the \inlineHs{main :: IO ()} function is
