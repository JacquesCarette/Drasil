...
\begin{displaymath}
\mathbf{T} \cos\left(θ\right) \mathbf{\hat{j}}-\mathbf{T} \sin\left(θ\right)-m \mathbf{g} \mathbf{\hat{j}}=m {L_{\text{rod}}} \left(α \cos\left(θ\right) \mathbf{\hat{j}}-ω ω \sin\left(θ\right)+α \sin\left(θ\right) \mathbf{\hat{j}}+ω ω \cos\left(θ\right) \mathbf{\hat{j}}\right)
\end{displaymath}
