...
\\ \midrule \\
Equation & \begin{displaymath}
           B=\frac{k}{\left(a b\right)^{m-1.0}} \left(E h^{2}\right)^{m} LDF e^{J}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
...
\\ \midrule \\
Equation & \begin{displaymath}
           LDF=\left(\frac{{t_{\text{d}}}}{60.0}\right)^{\frac{m}{16.0}}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
              \item{$LDF$ is the load duration factor (Unitless)}
...
\\ \midrule \\
Equation & \begin{displaymath}
           NFL=\frac{{\hat{q}_{\text{tol}}} E h^{4.0}}{\left(a b\right)^{2}}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
...
\\ \midrule \\
Equation & \begin{displaymath}
           \hat{q}=\frac{q \left(a b\right)^{2}}{E h^{4.0} GTF}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
              \item{$\hat{q}$ is the dimensionless load (Unitless)}
...
\\ \midrule \\
Equation & \begin{displaymath}
           {J_{\text{tol}}}=\ln\left(\ln\left(\frac{1}{1-{P_{\text{b}\text{tol}}}}\right) \frac{\left(a b\right)^{m-1.0}}{k \left(E h^{2}\right)^{m} LDF}\right)
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
              \item{${J_{\text{tol}}}$ is the stress distribution factor (Function) based on Pbtol (Unitless)}
...
\\ \midrule \\
Equation & \begin{displaymath}
           SD=\sqrt{{SD_{\text{x}}}^{2.0}+{SD_{\text{y}}}^{2.0}+{SD_{\text{z}}}^{2.0}}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
...
\midrule
\endhead
$a$ & $a\gt{}0.0\land{}a\geq{}b$ & ${d_{\text{min}}}\leq{}a\leq{}{d_{\text{max}}}$ & $1.5$ ${\text{m}}$ & 10$\%$
\\
$AR$ & $AR\geq{}1.0$ & $AR\leq{}{AR_{\text{max}}}$ & $1.5$ & 10$\%$
\\
$b$ & $0.0\lt{}b\leq{}a$ & ${d_{\text{min}}}\leq{}b\leq{}{d_{\text{max}}}$ & $1.2$ ${\text{m}}$ & 10$\%$
\\
${P_{\text{b}\text{tol}}}$ & $0.0\leq{}{P_{\text{b}\text{tol}}}\leq{}1.0$ & -- & $0.008$ & 0.1$\%$
\\
$SD$ & $SD\gt{}0.0$ & ${SD_{\text{min}}}\leq{}SD\leq{}{SD_{\text{max}}}$ & $45.0$ ${\text{m}}$ & 10$\%$
\\
$TNT$ & $TNT\gt{}0.0$ & -- & $1.0$ & 10$\%$
\\
$w$ & $w\gt{}0.0$ & ${w_{\text{min}}}\leq{}w\leq{}{w_{\text{max}}}$ & $42.0$ ${\text{kg}}$ & 10$\%$
\\
\bottomrule
...
\midrule
\endhead
${P_{\text{b}}}$ & $0.0\leq{}{P_{\text{b}}}\leq{}1.0$
\\
