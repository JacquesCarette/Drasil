...
A rational document driven design process for Scientific Computing (SC)
software\footnote{We will also abbreviate SC software to SCS}
potentially improves the software qualities of verifiability,
reliability, usability, maintainability, reusability and
...
they argue that scientific developers naturally use an agile
philosophy~\cite{CarverEtAl2007, EasterbrookAndJohns2009, Segal2005}, 
amethododical~\cite{Kelly2013}, or a knowledge acquisition
...
programming.
%Section~\ref{sec:lss} 
Then we introduce our framework, \lss{},
