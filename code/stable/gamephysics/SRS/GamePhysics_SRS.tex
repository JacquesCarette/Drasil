...
$\mathbf{τ}$ & Torque & Nm
\\
${\mathbf{τ}_{i}}$ & Torque applied to the i-th body & Nm
\\
...
\\ \midrule \\
Description & \begin{symbDescription}
              \item{$\mathbf{τ}$ is the torque (Nm)}
...
Description & \begin{symbDescription}
              ...
              \item{$t$ is the time (s)}
              \item{$ω$ is the angular velocity ($\frac{\text{rad}}{\text{s}}$)}
              \item{${\mathbf{τ}_{i}}$ is the torque applied to the i-th body (Nm)}
              \item{$\mathbf{I}$ is the moment of inertia (kg$\text{m}^{2}$)}
              \end{symbDescription}
\\ \midrule \\
