...
htTransCladCoolDD = mkDD htTransCladCool (Just [{-References-}]) [{-Derivation-}] "htTransCladCool"--Label
  []--no additional notes
...
htTransCladFuelDD = mkDD htTransCladFuel (Just [{-References-}]) [{-Derivation-}] "htTransCladFuel"--Label
  []--no additional notes
