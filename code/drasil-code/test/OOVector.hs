...
ooVector :: OOProg r vis stmt mthd stvr attch prg file mod bod block => GSProgram r prg
ooVector = prog "OOVector" "" [fileDoc (buildModule "OOVector" []
  [main] [vectorClass])]

vectorClass :: OOProg r vis stmt mthd stvr attch prg file mod bod block => CS (r Class)
...
magnitude :: OOProg r vis stmt mthd stvr attch prg file mod bod block => MS (r mthd)
...
norm :: OOProg r vis stmt mthd stvr attch prg file mod bod block => MS (r mthd)
...
dot :: OOProg r vis stmt mthd stvr attch prg file mod bod block => MS (r mthd)
...
add :: OOProg r vis stmt mthd stvr attch prg file mod bod block => MS (r mthd)
...
scale :: OOProg r vis stmt mthd stvr attch prg file mod bod block => MS (r mthd)
...
print_ :: OOProg r vis stmt mthd stvr attch prg file mod bod block => MS (r mthd)
print_ = docFunc "Prints the vector elements to console." [] Nothing $
  pubMethod "printSelf" void [] $ oneLiner $ printLn $ valueOf thisV

main :: OOProg r vis stmt mthd stvr attch prg file mod bod block => MS (r mthd)
