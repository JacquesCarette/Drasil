...
compoundNC t1 t2 = nc
  (uidToStr (t1 ^. uid) ++ uidToStr (t2 ^. uid)) (compoundPhrase (t1 ^. term) (t2 ^. term))
...
compoundNCPP t1 t2 = nc
  (uidToStr (t1 ^. uid) ++ uidToStr (t2 ^. uid)) (compoundPhrase'' D.pluralNP D.pluralNP (t1 ^. term) (t2 ^. term))
...
compoundNCGen f1 f2 t1 t2 = nc
  (uidToStr (t1 ^. uid) ++ uidToStr (t2 ^. uid))
...
compoundNCGenP f1 t1 t2 = nc
  (uidToStr (t1 ^. uid) ++ uidToStr (t2 ^. uid)) (compoundPhrase''' f1 (t1 ^. term) (t2 ^. term))
