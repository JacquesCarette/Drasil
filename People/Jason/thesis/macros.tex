...
% Common variant
\newcommand{\porthref}[2]{\href{#2}{#1}\footnote{\href{#2}{#2}}}
% Custom URLs
...
\newenvironment{haskell}[4]
    {\VerbatimEnvironment\singlespacing\begin{code}\captionof{listing}[#1]{\protect\porthreftm{#1}{#4}}\footnotetext{\protect\href{#4}{#3}}\label{lst:#2}\begin{minted}[frame=lines,framerule=2pt,breaklines]{haskell}}
