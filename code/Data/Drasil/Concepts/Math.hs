...
normal       = dcc "normal" (cn' "normal" ) 
              "object that is perpendicular to a given object"
perp         = dcc "perp" (cn' "perpendicular") "at right angles"
traceyMatrix = dcc "traceyMatrix" (cnICES "traceability matrix")
               "traceability matrix" -- CINP type, correct?
