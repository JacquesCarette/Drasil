...
mkSRS = [
  ...
  RefSec $ RefProg intro,
    TUnits TUProg,
    TSymb $ tsymb [TSPurpose, SymbConvention [Lit $ nw htTrans, Doc' $ nw progName], SymbOrder, VectorUnits],
    TAandA TAAProg,
  ...
  SSDSec $ SSDProg EmptyS,
    ...
    SolChSpec $ SCSProg EmptyS,
      ...
      Constraints $ ConstProg dataContMid constrained,
      CorrSolnPpties $ CorrSolProg dataConstListOut [],
  ReqrmntSec $ ReqsProg EmptyS,
    FReqsSub' $ FReqsProg' [inputInitValsTable],
