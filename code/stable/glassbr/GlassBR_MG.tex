...
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{M:modInputParams}:]Input Parameters Module
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{M:modInputConstraints}:]Input Constraints Module
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{M:modoutputfdesc}:]Output Format Module
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{M:modDerivedVals}:]Derived Values Module
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{M:modcalcdesc}:]Calculations Module
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{M:modControl}:]Control Module
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{M:modInterpData}:]Interpolation Data Module
\end{description}
\begin{description}
...
\end{description}
\subsection{Input Parameters Module (M\ref{M:modInputParams})}
...
\item[Implemented By:]GlassBR
\end{description}
\subsection{Input Constraints Module (M\ref{M:modInputConstraints})}
...
\item[Implemented By:]GlassBR
\end{description}
\subsection{Derived Values Module (M\ref{M:modDerivedVals})}
...
\item[Implemented By:]GlassBR
\end{description}
\subsection{Calculations Module (M\ref{M:modcalcdesc})}
\label{Sec:CalcModu()}
\begin{description}
...
\item[Implemented By:]GlassBR
\end{description}
\subsection{Interpolation Data Module (M\ref{M:modInterpData})}
...
\\
\midrule
R1 & M\ref{MhwHiding}, M\ref{M:modInputFormat}, M\ref{M:modInputParams}, M\ref{M:modControl}
\\
R2 & M\ref{M:modInputFormat}, M\ref{M:modInputParams}
\\
R3 & M\ref{M:modInputConstraints}
\\
...
\\
LC\ref{LC:parameters} & M\ref{M:modInputParams}
\\
...
\\
LC\ref{LC:interpd} & M\ref{M:modInterpData}
\\
...
node [style = "n"];
"Input Format Module (M\ref{M:modInputFormat})" -> "Hardware Hiding Module (M\ref{MhwHiding})";
"Input Format Module (M\ref{M:modInputFormat})" -> "Input Parameters Module (M\ref{M:modInputParams})";
"Input Parameters Module (M\ref{M:modInputParams})" -> "Input Constraints Module (M\ref{M:modInputConstraints})";
"Output Format Module (M\ref{M:modoutputfdesc})" -> "Hardware Hiding Module (M\ref{MhwHiding})";
"Output Format Module (M\ref{M:modoutputfdesc})" -> "Input Parameters Module (M\ref{M:modInputParams})";
"Derived Values Module (M\ref{M:modDerivedVals})" -> "Input Parameters Module (M\ref{M:modInputParams})";
"Calculations Module (M\ref{M:modcalcdesc})" -> "Input Parameters Module (M\ref{M:modInputParams})";
"Control Module (M\ref{M:modControl})" -> "Input Format Module (M\ref{M:modInputFormat})";
"Control Module (M\ref{M:modControl})" -> "Input Parameters Module (M\ref{M:modInputParams})";
"Control Module (M\ref{M:modControl})" -> "Input Constraints Module (M\ref{M:modInputConstraints})";
"Control Module (M\ref{M:modControl})" -> "Derived Values Module (M\ref{M:modDerivedVals})";
"Control Module (M\ref{M:modControl})" -> "Calculations Module (M\ref{M:modcalcdesc})";
...
"Interpolation Module (M\ref{M:modInterpolation})" -> "Interpolation Data Module (M\ref{M:modInterpData})";
}
\end{dot2tex}
\end{tikzpicture}
\end{adjustbox}
