...
r5 = ReqChunk (nw $ emptyN) [mod_outputf, mod_temp, mod_ctrl, Drasil.SWHS.Modules.mod_seq, mod_ode,
  mod_plot]
r6 = ReqChunk (nw $ emptyN) [mod_outputf, mod_temp, mod_ctrl, Drasil.SWHS.Modules.mod_seq, mod_ode,
  mod_plot]
r7 = ReqChunk (nw $ emptyN) [mod_outputf, mod_ener, mod_ctrl, Drasil.SWHS.Modules.mod_seq, mod_plot]
r8 = ReqChunk (nw $ emptyN) [mod_outputf, mod_ener, mod_ctrl, Drasil.SWHS.Modules.mod_seq, mod_plot]
