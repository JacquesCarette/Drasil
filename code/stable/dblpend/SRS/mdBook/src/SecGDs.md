...
\\[v\_{\text{x}1}=\frac{\\,dL\_{1}\\,\sin\left(θ\_{1}\right)}{\\,dt}\\]
...
\\[v\_{\text{y}1}=-\left(\frac{\\,dL\_{1}\\,\cos\left(θ\_{1}\right)}{\\,dt}\right)\\]
...
\\[v\_{\text{x}2}=\frac{\\,dp\_{\text{x}1}+L\_{2}\\,\sin\left(θ\_{2}\right)}{\\,dt}\\]
...
\\[v\_{\text{y}2}=-\left(\frac{\\,dp\_{\text{y}1}-L\_{2}\\,\cos\left(θ\_{2}\right)}{\\,dt}\right)\\]
...
\\[a\_{\text{x}1}=\frac{\\,dw\_{1}\\,L\_{1}\\,\cos\left(θ\_{1}\right)}{\\,dt}\\]

By the product and chain rules, we find

\\[a\_{\text{x}1}=\frac{\\,dw\_{1}}{\\,dt}\\,L\_{1}\\,\cos\left(θ\_{1}\right)-w\_{1}\\,L\_{1}\\,\sin\left(θ\_{1}\right)\\,\frac{\\,dθ\_{1}}{\\,dt}\\]
...
\\[a\_{\text{y}1}=\frac{\\,dw\_{1}\\,L\_{1}\\,\sin\left(θ\_{1}\right)}{\\,dt}\\]

By the product and chain rules, we find

\\[a\_{\text{y}1}=\frac{\\,dw\_{1}}{\\,dt}\\,L\_{1}\\,\sin\left(θ\_{1}\right)+w\_{1}\\,L\_{1}\\,\cos\left(θ\_{1}\right)\\,\frac{\\,dθ\_{1}}{\\,dt}\\]
...
\\[a\_{\text{x}2}=\frac{\\,dv\_{\text{x}1}+w\_{2}\\,L\_{2}\\,\cos\left(θ\_{2}\right)}{\\,dt}\\]
...
\\[a\_{\text{y}2}=\frac{\\,dv\_{\text{y}1}+w\_{2}\\,L\_{2}\\,\sin\left(θ\_{2}\right)}{\\,dt}\\]
