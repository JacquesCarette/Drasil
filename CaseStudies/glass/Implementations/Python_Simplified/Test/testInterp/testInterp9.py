...
# value1 in data1 and jdx == 0 and data2[jdx, idx] == data2[jdx+1, idx]
    def test_find_bounds(self):
        idx, jdx, kdx, num_interp1, num_interp2 = interp.find_bounds(self.data1, self.data2, 140, 4.3)
        self.assertEqual(idx, 3)
        self.assertEqual(jdx, 1)
