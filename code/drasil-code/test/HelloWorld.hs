...
helloWorldOO :: (OOProg r vis stmt mthd stvr attch prg file) => OO.GSProgram r prg
...
helloWorldMainOO :: (OOProg r vis stmt mthd stvr attch prg file) => MS (r mthd)
...
objectTests :: (OOProg r vis stmt mthd stvr attch prg file) => MS (r Block)
...
helloWorldClass :: (OOProg r vis stmt mthd stvr attch prg file) => CS (r Class)
