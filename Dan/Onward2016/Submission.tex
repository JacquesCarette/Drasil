...
will sum conclude the section by discussing which ideas we intend to borrow and
...
Finally, we also believe that software we create should be reproducible. We want to ensure that given all of the appropriate knowledge surrounding a piece of software, scientists would be able to reproduce the software and any results obtained therein.
