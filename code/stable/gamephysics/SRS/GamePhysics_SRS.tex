...
\\
${d_{j}}$ & Distance Between the J-Th Particle and the Axis of Rotation & m
\\
$\mathbf{F}$ & Force & N
\\
...
\\
$\mathbf{u}\text{(}t\text{)}$ & Linear Displacement & m
\\
${\mathbf{u}_{\text{O}\text{B}}}$ & Displacement vector between the origin and point B & m
\\
...
\\
$\text{||}{\mathbf{u}_{\text{A}\text{P}}}\text{*}\mathbf{n}\text{||}$ & Length of the Perpendicular Vector to the Contact Displacement Vector of Rigid Body A & m
\\
$\text{||}{\mathbf{u}_{\text{B}\text{P}}}\text{*}\mathbf{n}\text{||}$ & Length of the Perpendicular Vector to the Contact Displacement Vector of Rigid Body B & m
\\
...
\\ \midrule \\
Equation & \begin{displaymath}
           \mathbf{F}=G \frac{{m_{1}} {m_{2}}}{\text{||}\mathbf{r}\text{||}^{2}} \mathbf{\hat{r}}=G \frac{{m_{1}} {m_{2}}}{\text{||}\mathbf{r}\text{||}^{2}} \frac{\mathbf{u}}{\text{||}\mathbf{r}\text{||}}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
              \item{$\mathbf{F}$ is the force (N)}
              ...
              \item{$\mathbf{u}$ is the displacement (m)}
              \end{symbDescription}
\\ \midrule \\
Notes & Two rigid bodies in the universe attract each other with a force $\mathbf{F}$ that is directly proportional to the product of their masses, ${m_{1}}$ and ${m_{2}}$, and inversely proportional to the squared distance ${\text{||}\mathbf{r}\text{||}^{2}}$ between them.
        ...
        The vector $\mathbf{u}$ is the displacement between the centres of the rigid bodies and $\text{||}\mathbf{r}\text{||}$ is the absolute distance between the two.
...
=======
           \mathbf{g}=-\frac{G M}{\mathbf{u}^{2}} \mathbf{\hat{r}}
>>>>>>> master
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
...
Description & \begin{symbDescription}
              ...
              \item{$\text{||}{\mathbf{u}_{\text{A}\text{P}}}\text{*}\mathbf{n}\text{||}$ is the length of the perpendicular vector to the contact displacement vector of rigid body A (m)}
              \item{${\mathbf{I}_{\text{A}}}$ is the moment of inertia of rigid body A (kg$\text{m}^{2}$)}
              \item{$\text{||}{\mathbf{u}_{\text{B}\text{P}}}\text{*}\mathbf{n}\text{||}$ is the length of the perpendicular vector to the contact displacement vector of rigid body B (m)}
...
\\ \midrule \\
Description & \begin{symbDescription}
              \item{$\mathbf{u}\text{(}t\text{)}$ is the linear displacement (m)}
...
Description & \begin{symbDescription}
              ...
              \item{$ω$ is the angular velocity ($\frac{\text{rad}}{\text{s}}$)}
              \item{${\mathbf{u}_{\text{O}\text{B}}}$ is the displacement vector between the origin and point B (m)}
              \end{symbDescription}
\\ \midrule \\
...
Description & \begin{symbDescription}
              \item{$\mathbf{I}$ is the moment of inertia (kg$\text{m}^{2}$)}
              \item{${m_{j}}$ is the mass of the j-th particle (kg)}
              \item{${d_{j}}$ is the distance between the j-th particle and the axis of rotation (m)}
              \end{symbDescription}
\\ \midrule \\
