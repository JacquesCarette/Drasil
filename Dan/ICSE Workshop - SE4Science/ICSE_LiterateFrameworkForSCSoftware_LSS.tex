...
lead other software by leveraging its solid, existing knowledge base.  By
...
face of the ever changing nature of scientific computing projects, and ensure
that software artifacts can be easily and quickly be extracted from \lss{}.
...
\keywords{Literate software, traceability, knowledge capture, software development, scientific computing, artifact generation.} %TODO
...
of high quality software.  More precisely, our goal s to use this knowledge
...
to improve developer productivity to save time and money on SCS development,
...
focus on SC software quality and literate programming.
%Section~\ref{sec:lss} 
...
\subsection{Current state} \label{ssec:example}
...
nuclear reactor (see \cite{SmithAndKoothoor2016} for more details). As an
example, let us look specifically at the term $h_c$ (defined in
Figure~\ref{fig:h_c}).
...
similar to those found in \cite{Carette???, Szymczak2014}
%self-source or is that tacky?
%D Which of Jacques papers can I cite to show similarities? GE?
