...
\\ \midrule \\
Equation & \begin{displaymath}
           \mathbf{F}=G \frac{{m_{1}} {m_{2}}}{\text{||}\mathbf{d}\text{||}^{2.0}} \mathbf{\hat{d}}=G \frac{{m_{1}} {m_{2}}}{\text{||}\mathbf{d}\text{||}^{2.0}} \frac{\mathbf{d}}{\text{||}\mathbf{d}\text{||}}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
              \item{$\mathbf{F}$ is the force (${\text{N}}$)}
...
\\ \midrule \\
Equation & \begin{displaymath}
           \mathbf{g}=-\frac{G M}{\text{||}\mathbf{d}\text{||}^{2.0}} \mathbf{\hat{d}}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
...
\\ \midrule \\
Equation & \begin{displaymath}
           j=\frac{-\left(1.0+{C_{\text{R}}}\right) {{\mathbf{v}_{\text{i}}}^{\text{A}\text{B}}}\cdot{}\mathbf{n}}{\left(\frac{1.0}{{m_{\text{A}}}}+\frac{1.0}{{m_{\text{B}}}}\right) \text{||}\mathbf{n}\text{||}^{2.0}+\frac{\text{||}{\mathbf{u}_{\text{A}\text{P}}}\text{*}\mathbf{n}\text{||}^{2.0}}{{\mathbf{I}_{\text{A}}}}+\frac{\text{||}{\mathbf{u}_{\text{B}\text{P}}}\text{*}\mathbf{n}\text{||}^{2.0}}{{\mathbf{I}_{\text{B}}}}}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & The coefficient of restitution ${C_{\text{R}}}$ determines the elasticity of a collision between two rigid bodies. ${C_{\text{R}}}=1.0$ results in an elastic collision, ${C_{\text{R}}}\lt{}1.0$ results in an inelastic collision, and ${C_{\text{R}}}=0.0$ results in a totally inelastic collision.
...
\begin{displaymath}
\int_{{t_{1}}}^{{t_{2}}}{\mathbf{F}}\,dt=m \left(\int_{{\mathbf{v}_{1}}}^{{\mathbf{v}_{2}}}{1.0}\,d\mathbf{v}\right)
\end{displaymath}
...
\\ \midrule \\
Equation & \begin{displaymath}
           \mathbf{I}=\displaystyle\sum{{m_{j}} {d_{j}}^{2.0}}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
              \item{$\mathbf{I}$ is the moment of inertia ($\text{kg}\text{m}^{2}$)}
...
\midrule
\endhead
${C_{\text{R}}}$ & $0.0\leq{}{C_{\text{R}}}\leq{}1.0$ & -- & $0.8$ & 10$\%$
\\
$\mathbf{F}$ & -- & -- & $98.1$ ${\text{N}}$ & 10$\%$
\\
$G$ & -- & -- & $66.743\cdot{}10^{-12}$ $\frac{\text{m}^{3}}{\text{kg}\text{s}^{2}}$ & 10$\%$
\\
$\mathbf{I}$ & $\mathbf{I}\gt{}0.0$ & -- & $74.5$ $\text{kg}\text{m}^{2}$ & 10$\%$
\\
$L$ & $L\gt{}0.0$ & -- & $44.2$ ${\text{m}}$ & 10$\%$
\\
$m$ & $m\gt{}0.0$ & -- & $56.2$ ${\text{kg}}$ & 10$\%$
\\
...
\\
$ϕ$ & -- & $0.0\leq{}ϕ\leq{}2.0 π$ & $\frac{π}{2}$ ${\text{rad}}$ & 10$\%$
\\
\bottomrule
