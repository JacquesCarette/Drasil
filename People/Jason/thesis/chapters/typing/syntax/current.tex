...
\startSyntaxTable
    ...
    \syntaxRow{Vector($\tau$, $n$)}{[\tau]_n}{Vectors (single element type, fixed length)}
    \syntaxRow{Tuple($\tau_1...\tau_n$)}{\tau_1 \times \tau_2 \times ... \times \tau_n}{Alternative vectors/tuples (fixed length+differently typed elements)}
     \\
