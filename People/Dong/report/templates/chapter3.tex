...
% The reality is outputting an infinite sequence is not always available in the four selected libraries. 

% The return of \verb|Ode.RK547M| is equivalent to an infinite sequence of real numbers, $\mathbb{R}^n$. The return of \verb|sol.SolveFromToStep| is equivalent to a finite sequence of real numbers, $\mathbb{R}^k$. 

Code~\ref{code_csharposlo} shows the full details of how to solve Example~\ref{ex_firstorderode} in the OSLO library.
\begin{listing}[ht]
\begin{csharp1}
