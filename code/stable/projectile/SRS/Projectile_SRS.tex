...
\begin{itemize}
\item[targetHit (GS1):\phantomsection\label{targetHit}]{Determine if the projectile hits the target.}
\end{itemize}
...
\begin{itemize}
\item[twoDMotion (A1):\phantomsection\label{twoDMotion}]{The projectile motion is two-dimensional (2D). (RefBy: \hyperref[GD:velVec]{GD: velVec} and \hyperref[GD:posVec]{GD: posVec}.)}
\item[cartSyst (A2):\phantomsection\label{cartSyst}]{A Cartesian coordinate system is used (from \hyperref[neglectCurv]{A: neglectCurv}). (RefBy: \hyperref[GD:velVec]{GD: velVec} and \hyperref[GD:posVec]{GD: posVec}.)}
\item[yAxisGravity (A3):\phantomsection\label{yAxisGravity}]{The direction of the $y$-axis is directed opposite to gravity. (RefBy: \hyperref[IM:calOfLandingTime]{IM: calOfLandingTime}, \hyperref[IM:calOfLandingDist]{IM: calOfLandingDist}, and \hyperref[accelYGravity]{A: accelYGravity}.)}
\item[launchOrigin (A4):\phantomsection\label{launchOrigin}]{The launcher is coincident with the origin. (RefBy: \hyperref[IM:calOfLandingTime]{IM: calOfLandingTime} and \hyperref[IM:calOfLandingDist]{IM: calOfLandingDist}.)}
\item[targetXAxis (A5):\phantomsection\label{targetXAxis}]{The target lies on the $x$-axis (from \hyperref[neglectCurv]{A: neglectCurv}). (RefBy: \hyperref[IM:calOfLandingTime]{IM: calOfLandingTime}.)}
\item[posXDirection (A6):\phantomsection\label{posXDirection}]{The positive $x$-direction is from the launcher to the target. (RefBy: \hyperref[IM:calOfLandingTime]{IM: calOfLandingTime}, \hyperref[IM:offsetIM]{IM: offsetIM}, \hyperref[IM:messageIM]{IM: messageIM}, and \hyperref[IM:calOfLandingDist]{IM: calOfLandingDist}.)}
\item[constAccel (A7):\phantomsection\label{constAccel}]{The acceleration is constant (from \hyperref[accelXZero]{A: accelXZero}, \hyperref[accelYGravity]{A: accelYGravity}, \hyperref[neglectDrag]{A: neglectDrag}, and \hyperref[freeFlight]{A: freeFlight}). (RefBy: \hyperref[GD:velVec]{GD: velVec} and \hyperref[GD:posVec]{GD: posVec}.)}
\item[accelXZero (A8):\phantomsection\label{accelXZero}]{The acceleration in the $x$-direction is zero. (RefBy: \hyperref[IM:calOfLandingDist]{IM: calOfLandingDist} and \hyperref[constAccel]{A: constAccel}.)}
\item[accelYGravity (A9):\phantomsection\label{accelYGravity}]{The acceleration in the $y$-direction is the acceleration due to gravity (from \hyperref[yAxisGravity]{A: yAxisGravity}). (RefBy: \hyperref[IM:calOfLandingTime]{IM: calOfLandingTime} and \hyperref[constAccel]{A: constAccel}.)}
\item[neglectDrag (A10):\phantomsection\label{neglectDrag}]{Air drag is neglected. (RefBy: \hyperref[constAccel]{A: constAccel}.)}
\item[pointMass (A11):\phantomsection\label{pointMass}]{The size and shape of the projectile are negligible, so that it can be modelled as a point mass. (RefBy: \hyperref[GD:rectVel]{GD: rectVel} and \hyperref[GD:rectPos]{GD: rectPos}.)}
\item[freeFlight (A12):\phantomsection\label{freeFlight}]{The flight is free; there are no collisions during the trajectory of the projectile. (RefBy: \hyperref[constAccel]{A: constAccel}.)}
\item[neglectCurv (A13):\phantomsection\label{neglectCurv}]{The distance is small enough that the curvature of the Earth can be neglected. (RefBy: \hyperref[targetXAxis]{A: targetXAxis} and \hyperref[cartSyst]{A: cartSyst}.)}
\item[timeStartZero (A14):\phantomsection\label{timeStartZero}]{Time starts at zero. (RefBy: \hyperref[GD:velVec]{GD: velVec}, \hyperref[IM:calOfLandingTime]{IM: calOfLandingTime}, \hyperref[GD:rectVel]{GD: rectVel}, \hyperref[GD:rectPos]{GD: rectPos}, and \hyperref[GD:posVec]{GD: posVec}.)}
\end{itemize}
...
\toprule \textbf{Refname} & \textbf{TM:acceleration} (TM1)
\phantomsection 
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{TM:velocity} (TM2)
\phantomsection 
\label{TM:velocity}
\\ \midrule \\
Label & Velocity
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{GD:rectVel} (GD1)
\phantomsection 
\label{GD:rectVel}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{GD:rectPos} (GD2)
\phantomsection 
\label{GD:rectPos}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{GD:velVec} (GD3)
\phantomsection 
\label{GD:velVec}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{GD:posVec} (GD4)
\phantomsection 
\label{GD:posVec}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:vecMag} (DD1)
\phantomsection 
\label{DD:vecMag}
\\ \midrule \\
Label & Speed
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:speedIX} (DD2)
\phantomsection 
\label{DD:speedIX}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:speedIY} (DD3)
\phantomsection 
\label{DD:speedIY}
\\ \midrule \\
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{IM:calOfLandingTime} (IM1)
\phantomsection 
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{IM:calOfLandingDist} (IM2)
\phantomsection 
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{IM:offsetIM} (IM3)
\phantomsection 
\label{IM:offsetIM}
\\ \midrule \\
Label & Offset
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{IM:messageIM} (IM4)
\phantomsection 
\label{IM:messageIM}
\\ \midrule \\
...
\begin{itemize}
\item[Input-Parameters (FR1):\phantomsection\label{inputParams}]{Input the quantities from \hyperref[Table:ReqInputs]{Table:ReqInputs}, which define the launch angle, launch speed, and target position.}
\item[Verify-Parameters (FR2):\phantomsection\label{verifyParams}]{Check the entered input parameters to ensure that they do not exceed the data constraints mentioned in \hyperref[Sec:DataConstraints]{Section: Data Constraints}. If any of the input parameters are out of bounds, an error message is displayed and the calculations stop.}
\item[Calculate-Values (FR3):\phantomsection\label{calcValues}]{Calculate the following quantities: ${t_{\text{flight}}}$ (from \hyperref[IM:calOfLandingTime]{IM: calOfLandingTime}), ${p_{\text{land}}}$ (from \hyperref[IM:calOfLandingDist]{IM: calOfLandingDist}), ${d_{\text{offset}}}$ (from \hyperref[IM:offsetIM]{IM: offsetIM}), and $s$ (from \hyperref[IM:messageIM]{IM: messageIM}).}
\item[Output-Values (FR4):\phantomsection\label{outputValues}]{Output $s$ (from \hyperref[IM:messageIM]{IM: messageIM}) and ${d_{\text{offset}}}$ (from \hyperref[IM:offsetIM]{IM: offsetIM}).}
\end{itemize}
\begin{longtable}{l l l}
\toprule
\textbf{Symbol} & \textbf{Description} & \textbf{Units}
...
\toprule
\textbf{} & \textbf{\hyperref[twoDMotion]{A1}} & \textbf{\hyperref[cartSyst]{A2}} & \textbf{\hyperref[yAxisGravity]{A3}} & \textbf{\hyperref[launchOrigin]{A4}} & \textbf{\hyperref[targetXAxis]{A5}} & \textbf{\hyperref[posXDirection]{A6}} & \textbf{\hyperref[constAccel]{A7}} & \textbf{\hyperref[accelXZero]{A8}} & \textbf{\hyperref[accelYGravity]{A9}} & \textbf{\hyperref[neglectDrag]{A10}} & \textbf{\hyperref[pointMass]{A11}} & \textbf{\hyperref[freeFlight]{A12}} & \textbf{\hyperref[neglectCurv]{A13}} & \textbf{\hyperref[timeStartZero]{A14}}
\\
\midrule
\endhead
\hyperref[DD:vecMag]{DD1} &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:speedIX]{DD2} &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:speedIY]{DD3} &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[TM:acceleration]{TM1} &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[TM:velocity]{TM2} &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[GD:rectVel]{GD1} &  &  &  &  &  &  &  &  &  &  & X &  &  & X
\\
\hyperref[GD:rectPos]{GD2} &  &  &  &  &  &  &  &  &  &  & X &  &  & X
\\
\hyperref[GD:velVec]{GD3} & X & X &  &  &  &  & X &  &  &  &  &  &  & X
\\
\hyperref[GD:posVec]{GD4} & X & X &  &  &  &  & X &  &  &  &  &  &  & X
\\
\hyperref[IM:calOfLandingTime]{IM1} &  &  & X & X & X & X &  &  & X &  &  &  &  & X
\\
\hyperref[IM:calOfLandingDist]{IM2} &  &  & X & X &  & X &  & X &  &  &  &  &  & 
\\
\hyperref[IM:offsetIM]{IM3} &  &  &  &  &  & X &  &  &  &  &  &  &  & 
\\
\hyperref[IM:messageIM]{IM4} &  &  &  &  &  & X &  &  &  &  &  &  &  & 
\\
\hyperref[inputParams]{FR1} &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[verifyParams]{FR2} &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[calcValues]{FR3} &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[outputValues]{FR4} &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
...
\toprule
\textbf{} & \textbf{\hyperref[DD:vecMag]{DD1}} & \textbf{\hyperref[DD:speedIX]{DD2}} & \textbf{\hyperref[DD:speedIY]{DD3}} & \textbf{\hyperref[TM:acceleration]{TM1}} & \textbf{\hyperref[TM:velocity]{TM2}} & \textbf{\hyperref[GD:rectVel]{GD1}} & \textbf{\hyperref[GD:rectPos]{GD2}} & \textbf{\hyperref[GD:velVec]{GD3}} & \textbf{\hyperref[GD:posVec]{GD4}} & \textbf{\hyperref[IM:calOfLandingTime]{IM1}} & \textbf{\hyperref[IM:calOfLandingDist]{IM2}} & \textbf{\hyperref[IM:offsetIM]{IM3}} & \textbf{\hyperref[IM:messageIM]{IM4}}
\\
\midrule
\endhead
\hyperref[DD:vecMag]{DD1} &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:speedIX]{DD2} & X &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:speedIY]{DD3} & X &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[TM:acceleration]{TM1} &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[TM:velocity]{TM2} &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[GD:rectVel]{GD1} &  &  &  & X &  &  &  &  &  &  &  &  & 
\\
\hyperref[GD:rectPos]{GD2} &  &  &  &  & X & X &  &  &  &  &  &  & 
\\
\hyperref[GD:velVec]{GD3} &  &  &  &  &  & X &  &  &  &  &  &  & 
\\
\hyperref[GD:posVec]{GD4} &  &  &  &  &  &  & X &  &  &  &  &  & 
\\
\hyperref[IM:calOfLandingTime]{IM1} &  &  & X &  &  &  &  &  & X &  &  &  & 
\\
\hyperref[IM:calOfLandingDist]{IM2} &  & X &  &  &  &  &  &  & X & X &  &  & 
\\
\hyperref[IM:offsetIM]{IM3} &  &  &  &  &  &  &  &  &  &  & X &  & 
\\
\hyperref[IM:messageIM]{IM4} &  &  &  &  &  &  &  &  &  &  &  & X & 
...
\toprule
\textbf{} & \textbf{\hyperref[DD:vecMag]{DD1}} & \textbf{\hyperref[DD:speedIX]{DD2}} & \textbf{\hyperref[DD:speedIY]{DD3}} & \textbf{\hyperref[TM:acceleration]{TM1}} & \textbf{\hyperref[TM:velocity]{TM2}} & \textbf{\hyperref[GD:rectVel]{GD1}} & \textbf{\hyperref[GD:rectPos]{GD2}} & \textbf{\hyperref[GD:velVec]{GD3}} & \textbf{\hyperref[GD:posVec]{GD4}} & \textbf{\hyperref[IM:calOfLandingTime]{IM1}} & \textbf{\hyperref[IM:calOfLandingDist]{IM2}} & \textbf{\hyperref[IM:offsetIM]{IM3}} & \textbf{\hyperref[IM:messageIM]{IM4}} & \textbf{\hyperref[inputParams]{FR1}} & \textbf{\hyperref[verifyParams]{FR2}} & \textbf{\hyperref[calcValues]{FR3}} & \textbf{\hyperref[outputValues]{FR4}} & \textbf{\hyperref[correct]{NFR1}} & \textbf{\hyperref[verifiable]{NFR2}} & \textbf{\hyperref[understandable]{NFR3}} & \textbf{\hyperref[reusable]{NFR4}} & \textbf{\hyperref[maintainable]{NFR5}} & \textbf{\hyperref[portable]{NFR6}}
\\
\midrule
\endhead
\hyperref[targetHit]{GS1} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[inputParams]{FR1} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[verifyParams]{FR2} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[calcValues]{FR3} &  &  &  &  &  &  &  &  &  & X & X & X & X &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[outputValues]{FR4} &  &  &  &  &  &  &  &  &  &  &  & X & X &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[correct]{NFR1} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[verifiable]{NFR2} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
