...
Drasil. Deeply embedded in Haskell \cite{Haskell2010} (and currently built
against \acs{ghc} $8.8.4$ \cite{GHC884}), Drasil currently focuses on building
tooling around 8 case studies, each following the formalized \ACF{srs} template
