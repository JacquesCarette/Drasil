...
\begin{figure}[!ht]
    ...
    \begin{tikzpicture}[node distance = 2cm, auto, align=center]
      ...
      \node [unital, above of = tm] (unIsSafeProb) {$is-safeProb$};
      ...
      \node [unital, above of = unPb, node distance = 6cm] (unIsSafePb) {$is-safePb$};
