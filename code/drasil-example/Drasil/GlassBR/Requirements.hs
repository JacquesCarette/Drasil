...
-- References --
reqRefs :: [Reference]
reqRefs = map rw [sysSetValsFollowingAssumpsTable, outputValuesTable] ++ map rw [datCon ([]::[Contents]) ([]::[Section]), (propCorSol [] [])]
  ++ map rw [(inReq EmptyS), sysSetValsFollowingAssumps] ++ map rw [pbIsSafe, lrIsSafe]
