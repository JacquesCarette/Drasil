...
\\ \midrule
RefBy & \hyperref[IM:transMot]{IM:transMot} and \hyperref[outputValues]{FR:Output-Values}
...
\\ \midrule
RefBy & \hyperref[IM:rotMot]{IM:rotMot} and \hyperref[outputValues]{FR:Output-Values}
...
\\
$v\text{(}t\text{)}$ & Linear velocity & \hyperref[DD:linVel]{DD:linVel} & $\frac{\text{m}}{\text{s}}$
\\
$ω$ & Angular velocity & \hyperref[DD:angVel]{DD:angVel} & $\frac{\text{rad}}{\text{s}}$
