...
As artifacts in a software project begin to fall out of sync with each other, the qualities of the project as a whole suffer. Namely, traceability can be completely lost and maintaining the project becomes much more difficult.
...
%
%The issues arising from knowledge duplication impact both traceability and maintainability in fairly obvious ways. They also, however, impact other software qualities such as reproducibility and verifiability.
