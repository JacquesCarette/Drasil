...
The 3 software generators need to be rewritten using [`ToFiles`](https://github.com/JacquesCarette/Drasil/pull/5201). However, we should also recognize a few issues related to the above 3:
