...
public class InputParameters {
    ...
    */
    private void get_input(string filename) {
        ...
        outfile = new StreamWriter("log.txt", true);
        outfile.Write("var 'self.a' assigned ");
        ...
        outfile = new StreamWriter("log.txt", true);
        outfile.Write("var 'self.b' assigned ");
        ...
        outfile = new StreamWriter("log.txt", true);
        outfile.Write("var 'self.w' assigned ");
        ...
        outfile = new StreamWriter("log.txt", true);
        outfile.Write("var 'self.P_btol' assigned ");
        ...
        outfile = new StreamWriter("log.txt", true);
        outfile.Write("var 'self.TNT' assigned ");
        ...
        outfile = new StreamWriter("log.txt", true);
        outfile.Write("var 'self.g' assigned ");
        ...
        outfile = new StreamWriter("log.txt", true);
        outfile.Write("var 'self.t' assigned ");
        ...
        outfile = new StreamWriter("log.txt", true);
        outfile.Write("var 'self.SD_x' assigned ");
        ...
        outfile = new StreamWriter("log.txt", true);
        outfile.Write("var 'self.SD_y' assigned ");
        ...
        outfile = new StreamWriter("log.txt", true);
        outfile.Write("var 'self.SD_z' assigned ");
    ...
    */
    private void derived_values() {
        ...
        outfile = new StreamWriter("log.txt", true);
        outfile.Write("var 'self.h' assigned ");
        ...
        outfile = new StreamWriter("log.txt", true);
        outfile.Write("var 'self.LDF' assigned ");
        ...
        if (this.g == "AN") {
            this.GTF = 1;
            outfile = new StreamWriter("log.txt", true);
            outfile.Write("var 'self.GTF' assigned ");
        ...
        outfile = new StreamWriter("log.txt", true);
        outfile.Write("var 'self.SD' assigned ");
        ...
        outfile = new StreamWriter("log.txt", true);
        outfile.Write("var 'self.AR' assigned ");
        ...
        outfile = new StreamWriter("log.txt", true);
        outfile.Write("var 'self.w_TNT' assigned ");
