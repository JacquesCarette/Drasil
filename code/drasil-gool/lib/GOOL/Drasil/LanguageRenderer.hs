...
type ModuleDocRenderer = String -> [String] -> String -> DrasilConfig -> String -> [String]

moduleDox :: ModuleDocRenderer
moduleDox desc as date dc m = (doxFile ++ m) : 
  [doxAuthor ++ stringList as | not (null as)] ++
  [doxDate ++ date | not (null date)] ++ 
  [doxBrief ++ desc | not (null desc)] ++ 
  [doxVersion ++ version dc]
...
doxCommand, doxBrief, doxParam, doxReturn, doxFile, doxAuthor, doxDate, doxVersion :: String
doxCommand = "\\"
...
doxVersion = doxCommand ++ "Generated by Drasil "
