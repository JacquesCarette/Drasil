...
\item\label{it:probdesc} Describe the problem:
  ...
  \item Identify the naturally occurring known quantities in the
    problem domain, as well as their associated constraints.
  \end{enumerate}
...
of software.  Our process requirements that this knowledge be made explicit,
a fundamental step in \emph{Knowledge Management}~\cite{KM-textbook}.
