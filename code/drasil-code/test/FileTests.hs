...
fileTestsProc :: (ProcProg r stmt mthd prg) => GProc.GSProgram r prg
...
readStory :: (SharedProg r stmt mthd) => MS (r stmt)
...
goodBye :: (SharedProg r stmt mthd) => MS (r Block)
goodBye = block [
