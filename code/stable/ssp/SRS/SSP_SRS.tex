...
\\
${{x_{\text{slip}}}^{\text{minEtr}}}$ & Minimum Entry $x$-coordinate: Minimum potential x-coordinate for the entry point of a slip surface. & m
\\
...
\item{Stress: The forces that are exerted between planes internal to a larger body subject to external loading.}
