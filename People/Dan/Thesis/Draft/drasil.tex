...
in less than 370 lines of code\footnote{Including many comments, whitespace, 
and import statements.}. Teasing our results: the generated SRS in PDF format 
is 44 pages in length (with the generated \LaTeX{} source being 1742 
lines\footnote{at time of writing}). This is partially due to our ability to 
strip away all of the common boilerplate text that we need not worry about 
right now, as that will be a problem for the generator (Section~\ref{sec:gen}). 
...
languages). Drasil achieves this through a set of dedicated \emph{printers} 
