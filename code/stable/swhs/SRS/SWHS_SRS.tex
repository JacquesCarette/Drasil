...
\end{displaymath}
Using \hyperref[DD:htFluxC]{DD: htFluxC} for ${q_{\text{C}}}$ and \hyperref[DD:htFluxP]{DD: htFluxP} for ${q_{\text{P}}}$, this can be written as:
...
\\
\hyperref[GD:nwtnCooling]{GD1} &  & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[GD:rocTempSimp]{GD2} &  &  & X & X & X & X &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
...
\\
\hyperref[GD:nwtnCooling]{GD1} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[GD:rocTempSimp]{GD2} &  &  &  &  &  &  &  &  &  & X &  &  &  & X &  &  &  & 
\\
