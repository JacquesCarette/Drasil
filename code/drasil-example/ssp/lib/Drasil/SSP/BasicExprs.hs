...
eqlExpr :: ExprC r => (r -> r) -> (r -> r) -> (r -> r -> r) -> r
...
eqlExprN :: ExprC r => (r -> r) -> (r -> r) -> (r -> r -> r) -> r
...
eqlExprSepG :: ExprC r => (r -> r) -> (r -> r) -> (r -> r -> r) -> r
...
eqlExprNSepG :: ExprC r => (r -> r) -> (r -> r) -> (r -> r -> r) -> r
...
eqlExprNoKQ :: ExprC r => (r -> r) -> (r -> r) -> (r -> r -> r) -> r
...
eqlExprNNoKQ :: ExprC r => (r -> r) -> (r -> r) -> (r -> r -> r) -> r
