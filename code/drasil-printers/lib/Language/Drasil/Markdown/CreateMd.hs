...
instDoc cfp name inoutn = regularSec (text "Making Examples") 
    (runInstDoc inoutn <> doubleSep <> makeInstDoc) <> inOutFile name inoutn <> makefileInfo <> configSec cfp
...
-- | Helper for notifying users about Makefiles being generated by Drasil.
makefileInfo :: Doc
makefileInfo = doubleSep <> text "*The Makefile in this program is a software artifact generated by Drasil.*"
