...
module GOOL.CodeGeneration.AbstractCode (
    -- * AbstractCode
    -- ** Statement Structure
    Body, Block(..),
...
import GOOL.Auxil.Helper (capitalize)
...
data Class = Enum {
            ...
            | MainClass {
               ...
               classVars :: [StateVar],
               classMethods :: [Method]}
data Package = Pack Label [Class] Payload
data AbstractCode = AbsCode Package
data Payload = Payload [String] -- that many random numbers
