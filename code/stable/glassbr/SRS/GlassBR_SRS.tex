...
Notes & $a$, $b$ are dimensions of the plate, where ($a>b$).
        $h$ is the true thickness, which is based on the nominal thicknesses as shown in DD2.
