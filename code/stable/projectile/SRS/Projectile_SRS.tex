...
\\
${{a_{\text{x}}}^{c}}$ & $x$-component of constant acceleration & $\frac{\text{m}}{\text{s}^{2}}$
\\
${a_{\text{y}}}$ & $y$-component of acceleration & $\frac{\text{m}}{\text{s}^{2}}$
\\
${{a_{\text{y}}}^{c}}$ & $y$-component of constant acceleration & $\frac{\text{m}}{\text{s}^{2}}$
\\
...
\\
${{p_{\text{x}}}^{i}}$ & $x$-component of initial position & m
\\
${p_{\text{y}}}$ & $y$-component of position & m
\\
${{p_{\text{y}}}^{i}}$ & $y$-component of initial position & m
\\
$\mathbf{p}$ & Position & m
\\
...
\\
${{v_{\text{x}}}^{i}}$ & $x$-component of initial velocity & $\frac{\text{m}}{\text{s}}$
\\
${v_{\text{y}}}$ & $y$-component of velocity & $\frac{\text{m}}{\text{s}}$
\\
${{v_{\text{y}}}^{i}}$ & $y$-component of initial velocity & $\frac{\text{m}}{\text{s}}$
\\
...
Equation & \begin{displaymath}
           \mathbf{v}=\begin{bmatrix}
                      {{v_{\text{x}}}^{i}}+{{a_{\text{x}}}^{c}} t\\
{{v_{\text{y}}}^{i}}+{{a_{\text{y}}}^{c}} t
                      \end{bmatrix}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
              \item{$\mathbf{v}$ is the velocity ($\frac{\text{m}}{\text{s}}$)}
              \item{${{v_{\text{x}}}^{i}}$ is the $x$-component of initial velocity ($\frac{\text{m}}{\text{s}}$)}
              \item{${{a_{\text{x}}}^{c}}$ is the $x$-component of constant acceleration ($\frac{\text{m}}{\text{s}^{2}}$)}
              \item{$t$ is the time (s)}
              \item{${{v_{\text{y}}}^{i}}$ is the $y$-component of initial velocity ($\frac{\text{m}}{\text{s}}$)}
              \item{${{a_{\text{y}}}^{c}}$ is the $y$-component of constant acceleration ($\frac{\text{m}}{\text{s}^{2}}$)}
              \end{symbDescription}
\\ \midrule \\
Source & --
\\ \midrule \\
...
Equation & \begin{displaymath}
           \mathbf{p}=\begin{bmatrix}
                      {{p_{\text{x}}}^{i}}+{{v_{\text{x}}}^{i}} t+\frac{{{a_{\text{x}}}^{c}} t^{2}}{2}\\
{{p_{\text{y}}}^{i}}+{{v_{\text{y}}}^{i}} t+\frac{{{a_{\text{y}}}^{c}} t^{2}}{2}
                      \end{bmatrix}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
              \item{$\mathbf{p}$ is the position (m)}
              \item{${{p_{\text{x}}}^{i}}$ is the $x$-component of initial position (m)}
              \item{${{v_{\text{x}}}^{i}}$ is the $x$-component of initial velocity ($\frac{\text{m}}{\text{s}}$)}
              \item{$t$ is the time (s)}
              \item{${{a_{\text{x}}}^{c}}$ is the $x$-component of constant acceleration ($\frac{\text{m}}{\text{s}^{2}}$)}
              \item{${{p_{\text{y}}}^{i}}$ is the $y$-component of initial position (m)}
              \item{${{v_{\text{y}}}^{i}}$ is the $y$-component of initial velocity ($\frac{\text{m}}{\text{s}}$)}
              \item{${{a_{\text{y}}}^{c}}$ is the $y$-component of constant acceleration ($\frac{\text{m}}{\text{s}^{2}}$)}
              \end{symbDescription}
\\ \midrule \\
...
\\ \midrule \\
Equation & \begin{displaymath}
           {{v_{\text{x}}}^{i}}={v^{i}} \cos\left(θ\right)
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
              \item{${{v_{\text{x}}}^{i}}$ is the $x$-component of initial velocity ($\frac{\text{m}}{\text{s}}$)}
...
\\ \midrule \\
Equation & \begin{displaymath}
           {{v_{\text{y}}}^{i}}={v^{i}} \sin\left(θ\right)
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
              \item{${{v_{\text{y}}}^{i}}$ is the $y$-component of initial velocity ($\frac{\text{m}}{\text{s}}$)}
...
Notes & The constraint $0<θ<\frac{π}{2}$ is from \hyperref[posXDirection]{A: posXDirection} and \hyperref[yAxisGravity]{A: yAxisGravity}, and is shown in \hyperref[Figure:Launch]{Fig:Launch}.
        ...
        The constraint ${t_{\text{flight}}}>0$ is from \hyperref[timeStartZero]{A: timeStartZero}.
\\ \midrule \\
Source & --
\\ \midrule \\
...
We know that ${{p_{\text{y}}}^{i}}=0$ (\hyperref[launchOrigin]{A: launchOrigin}) and ${{a_{\text{y}}}^{c}}=-g$ (\hyperref[accelYGravity]{A: accelYGravity}). Substituting these values into the y-direction of \hyperref[GD:posVec]{GD: posVec} gives us:
\begin{displaymath}
{p_{\text{y}}}={{v_{\text{y}}}^{i}} t-\frac{g t^{2}}{2}
\end{displaymath}
...
\begin{displaymath}
{{v_{\text{y}}}^{i}} {t_{\text{flight}}}-\frac{g {t_{\text{flight}}}^{2}}{2}=0
\end{displaymath}
Dividing by ${t_{\text{flight}}}$ (with the constraint ${t_{\text{flight}}}>0$) gives us:
\begin{displaymath}
{{v_{\text{y}}}^{i}}-\frac{g {t_{\text{flight}}}}{2}=0
\end{displaymath}
Solving for ${t_{\text{flight}}}$ gives us:
\begin{displaymath}
{t_{\text{flight}}}=\frac{2 {{v_{\text{y}}}^{i}}}{g}
\end{displaymath}
From \hyperref[DD:speedIY]{DD: speedIY} (with ${v^{i}}={v_{\text{launch}}}$) we can replace ${{v_{\text{y}}}^{i}}$:
\begin{displaymath}
{t_{\text{flight}}}=\frac{2 {v_{\text{launch}}} \sin\left(θ\right)}{g}
\end{displaymath}
\par~
...
Notes & The constraint $0<θ<\frac{π}{2}$ is from \hyperref[posXDirection]{A: posXDirection} and \hyperref[yAxisGravity]{A: yAxisGravity}, and is shown in \hyperref[Figure:Launch]{Fig:Launch}.
        $g$ is defined in \hyperref[Sec:AuxConstants]{Section: Values of Auxiliary Constants}.
        The constraint ${p_{\text{land}}}>0$ is from \hyperref[posXDirection]{A: posXDirection}.
\\ \midrule \\
Source & --
\\ \midrule \\
...
We know that ${{p_{\text{x}}}^{i}}=0$ (\hyperref[launchOrigin]{A: launchOrigin}) and ${{a_{\text{x}}}^{c}}=0$ (\hyperref[accelXZero]{A: accelXZero}). Substituting these values into the x-direction of \hyperref[GD:posVec]{GD: posVec} gives us:
\begin{displaymath}
{p_{\text{x}}}={{v_{\text{x}}}^{i}} t
\end{displaymath}
...
\begin{displaymath}
{p_{\text{land}}}=\frac{{{v_{\text{x}}}^{i}}\cdot{}2 {v_{\text{launch}}} \sin\left(θ\right)}{g}
\end{displaymath}
From \hyperref[DD:speedIX]{DD: speedIX} (with ${v^{i}}={v_{\text{launch}}}$) we can replace ${{v_{\text{x}}}^{i}}$:
\begin{displaymath}
...
Notes & ${p_{\text{land}}}$ is from \hyperref[IM:calOfLandingDist]{IM: calOfLandingDist}.
        The constraints ${p_{\text{land}}}>0$ and ${p_{\text{target}}}>0$ are from \hyperref[posXDirection]{A: posXDirection}.
\\ \midrule \\
Source & --
\\ \midrule \\
...
Equation & \begin{displaymath}
           s=\begin{cases}
             \text{``The target was hit.''}, & |\frac{{d_{\text{offset}}}}{{p_{\text{target}}}}|<ε\\
\text{``The projectile fell short.''}, & {d_{\text{offset}}}<0\\
\text{``The projectile went long.''}, & {d_{\text{offset}}}>0
             \end{cases}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
...
Notes & ${d_{\text{offset}}}$ is from \hyperref[IM:offsetIM]{IM: offsetIM}.
        The constraint ${p_{\text{target}}}>0$ is from \hyperref[posXDirection]{A: posXDirection}.
        The constraint ${d_{\text{offset}}}>-{p_{\text{land}}}$ is from the fact that ${p_{\text{land}}}>0$, from \hyperref[posXDirection]{A: posXDirection}.
...
\midrule
\endhead
${p_{\text{target}}}$ & ${p_{\text{target}}}>0$ & $1000$ m & 10$\%$
\\
${v_{\text{launch}}}$ & ${v_{\text{launch}}}>0$ & $100$ $\frac{\text{m}}{\text{s}}$ & 10$\%$
\\
...
\midrule
\endhead
${p_{\text{land}}}$ & ${p_{\text{land}}}>0$
\\
${d_{\text{offset}}}$ & ${d_{\text{offset}}}>-{p_{\text{land}}}$
\\
\bottomrule
