...
filled in using one of many \ACFP{dsl}. Each individual fragment of knowledge in
...
(\refExampleAngleVariableEncoding{}), we might write the
following\footnote{Assuming no air drag or resistance}\footnote{Similar to
      \refExampleAngleVariableEncoding{}, based on the \acs{projectile} Drasil case
      study.}:
