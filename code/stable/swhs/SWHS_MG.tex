...
"Temperature ODEs Module (M\ref{Mmodtempdesc})" -> "Input Parameter Module (M\ref{MmodInputParam})";
"Temperature ODEs Module (M\ref{Mmodtempdesc})" -> "Sequence Data Structure Module (M\ref{Mmodseqserv})";
"Energy Equations Module (M\ref{Mmodenerdesc})" -> "Input Parameter Module (M\ref{MmodInputParam})";
