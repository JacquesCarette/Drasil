...
annealedGl    = cc' annealed
  ...
  S "the residual surface stresses are almost zero, as defined in", makeRef2S astm2016])
aspectRatio   = cc aR
...
fTemperedGl   = cc' fullyT
  ...
  S "compression not less than 67 MPa (9700 psi), as defined in", makeRef2S astm2012])
...
hStrengthGl   = cc' heatS
  ...
  S "52 MPa (7500 psi), as defined in", makeRef2S astm2012])
...
loadResis     = cc' lResistance
  ...
  makeRef2S astm2009, S "(pg. 1, 53), following", foldlList Comma List $ map makeRefS 
...
probBreak     = cc' prob_br
  ...
  S "in lites per 1000", sParen $ makeRef2S astm2016])
