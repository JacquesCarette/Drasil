...
%to create a local hack to get things working. With Drasil it's an all-or-nothing
%approach. Any hacks added to the generated artifact sources will be overwritten
