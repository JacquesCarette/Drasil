...
assump1, assump2, assump3, assump4, assump5, assump6, assump7, assump8, assump9,
  assump10, assump11, assump12 :: Contents
assump1 = Assumption (nw $ npnc "assump1" $ nounPhraseSP ("The form of energy that is relevant " ++
  "for this problem is thermal energy. All other forms of energy such as mechanical " ++
  "energy are assumed to be negligible.")) EmptyS
assump2 = Assumption (nw $ npnc "assump2" $ nounPhraseSP ("All heat transfer coefficients " ++
  "are constant over time.")) EmptyS
assump3 = Assumption (nw $ npnc "assump3" $ nounPhraseSP ("The water in the tank is fully " ++
  "mixed, so the water temperature is the same throughout the entire tank.")) EmptyS
assump4 = Assumption (nw $ npnc "assump4" $ nounPhraseSP ("Density of the water has no " ++
  "spatial variation; that is it is constant over the entire volume.")) EmptyS
assump5 = Assumption (nw $ npnc "assump5" $ nounPhraseSP ("Specific heat capacity of water " ++
  "has no spatial variation; that is it is constant over the entire volume.")) EmptyS
assump6 = Assumption (nw $ npnc "assump6" $ nounPhraseSP ("Newton's law of convective cooling " ++
  "applies between the coil and the water.")) EmptyS
assump7 = Assumption (nw $ npnc "assump7" $ nounPhraseSP ("The temperature of the heating coil " ++
  "is constant over time.")) EmptyS
assump8 = Assumption (nw $ npnc "assump8" $ nounPhraseSP ("The temperature of the heating coil " ++
  "does not vary along its length.")) EmptyS
assump9 = Assumption (nw $ npnc "assump9" $ nounPhraseSP ("The model only accounts for charging " ++
  "of the tank, not discharging. The temperature of the water can only increase, or " ++
  "remain constant; it cannot decrease. This implies that the initial temperature " ++
  "is less than (or equal to) the temperature of the coil.")) EmptyS
assump10 = Assumption (nw $ npnc "assump10" $ nounPhraseSP ("The operating temperature range of " ++
  "the system is such that the water is always in liquid form. That is, the " ++
  "temperature will not drop below the melting point of water, or rise above " ++
  "its boiling point.")) EmptyS
assump11 = Assumption (nw $ npnc "assump11" $ nounPhraseSP ("The tank is perfectly insulated " ++
  "so that there is no heat loss from the tank.")) EmptyS
assump12 = Assumption (nw $ npnc "assump12" $ nounPhraseSP ("No internal heat is generated by " ++
  "the water; therefore, the volumetric heat generation is zero.")) EmptyS
