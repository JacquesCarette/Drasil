...
\item[startOrigin:\phantomsection\label{startOrigin1x}]{The pendulum is attached to the origin.}
\end{description}
...
\textbf{} & \textbf{\hyperref[twoDMotion]{A:twoDMotion}} & \textbf{\hyperref[cartSys]{A:cartSys}} & \textbf{\hyperref[cartSysR]{A:cartSysR}} & \textbf{\hyperref[yAxisDir]{A:yAxisDir}} & \textbf{\hyperref[startOrigin1x]{A:startOrigin}}
\\
...
\\
\hyperref[startOrigin1x]{A:startOrigin} &  &  &  &  & 
