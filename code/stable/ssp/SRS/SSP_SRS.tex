...
\\
$\mathbf{b}$ & Base Width of a Slice: in the x-direction & m
\\
...
\\
$\mathbf{G}$ & Interslice Normal Force: per meter in the z-direction exerted between adjacent slices & $\frac{\text{N}}{\text{m}}$
\\
...
\\
$\mathbf{N}$ & Normal Force: total reactive force per meter in the z-direction for a soil surface subject to a body resting on it & $\frac{\text{N}}{\text{m}}$
\\
$\mathbf{N'}$ & Effective Normal Force: per meter in the z-direction for a soil surface, subtracting pore water reactive force from total reactive force & $\frac{\text{N}}{\text{m}}$
\\
...
\\
$\mathbf{Q}$ & External Force: a force per meter in the z-direction acting into the surface from the midpoint of a slice & $\frac{\text{N}}{\text{m}}$
\\
$\mathbf{R}$ & Resistive Shear Force Without the Influence of Interslice Forces: per meter in the z-direction & $\frac{\text{N}}{\text{m}}$
\\
$\mathbf{S}$ & Mobilized Shear Force: per meter in the z-direction & $\frac{\text{N}}{\text{m}}$
\\
$\mathbf{T}$ & Mobilized Shear Force Without the Influence of Interslice Forces: per meter in the z-direction & $\frac{\text{N}}{\text{m}}$
\\
$u$ & Pore Pressure: from water within the soil & Pa
\\
${\mathbf{U}_{b}}$ & Base Hydrostatic Force: per meter in the z-direction from water pressure within a slice & $\frac{\text{N}}{\text{m}}$
\\
${{\mathbf{U}^{L}}_{b}}$ & Left Base Hydrostatic Force on a Slice: per meter in the z-direction from water pressure within a slice, assuming the entire slice has the height of the left side of the slice & $\frac{\text{N}}{\text{m}}$
\\
${\mathbf{U}_{t}}$ & Surface Hydrostatic Force: per meter in the z-direction from water pressure acting into the slice from standing water on the slope surface & $\frac{\text{N}}{\text{m}}$
\\
${{\mathbf{U}^{L}}_{t}}$ & Left Surface Hydrostatic Force on a Slice: per meter in the z-direction from water pressure acting into the slice from standing water on the slope surface, assuming the entire slice has the height of the left side of the slice & $\frac{\text{N}}{\text{m}}$
\\
${{\mathbf{U}^{R}}_{b}}$ & Right Base Hydrostatic Force on a Slice: per meter in the z-direction from water pressure within a slice, assuming the entire slice has the height of the right side of the slice & $\frac{\text{N}}{\text{m}}$
\\
${{\mathbf{U}^{R}}_{t}}$ & Right Surface Hydrostatic Force on a Slice: per meter in the z-direction from water pressure acting into the slice from standing water on the slope surface, assuming the entire slice has the height of the right side of the slice & $\frac{\text{N}}{\text{m}}$
\\
$v$ & Local Index: used as a bound variable index in calculations & --
\\
$\mathbf{W}$ & Weight: downward force per meter in the z-direction caused by gravity on slice i & $\frac{\text{N}}{\text{m}}$
\\
${\mathbf{W}^{L}}$ & Left Weight of a Slice: weight of a slice per meter in the z-direction, assuming the entire slice has the height of the left side of the slice & $\frac{\text{N}}{\text{m}}$
\\
${\mathbf{W}^{R}}$ & Right Weight of a Slice: weight of a slice per meter in the z-direction, assuming the entire slice has the height of the right side of the slice & $\frac{\text{N}}{\text{m}}$
\\
$\mathbf{X}$ & Interslice Shear Force: per meter in the z-direction exerted between adjacent slices & $\frac{\text{N}}{\text{m}}$
\\
${\mathbf{x}_{slip}}$ & X-Coordinate of the Slip Surface: distance of the slip surface & m
\\
${\mathbf{x}_{slope}}$ & X-Coordinate of the Slope: x-coordinate of a point on the slope & m
\\
${\mathbf{x}_{wt}}$ & X-Coordinate: x-position of the water table & m
\\
${\mathbf{y}_{slip}}$ & Y-Coordinate of the Slip Surface: height of the slip surface & m
\\
${\mathbf{y}_{slope}}$ & Y-Coordinate of the Slope: y-coordinate of a point on the soil slope & m
\\
${\mathbf{y}_{wt}}$ & Y-Coordinate of the Water Table: height of the water table & m
\\
$z$ & Z-Coordinate: in the Cartesian coordinate system & m
\\
$\mathbf{α}$ & Base Angle: between the base of a slice and the horizontal & ${}^{\circ}$
\\
$\mathbf{β}$ & Surface Angle: between the surface of a slice and the horizontal & ${}^{\circ}$
\\
...
\\
$\mathbf{ω}$ & Imposed Load Angle: between the external force acting into the surface and the vertical & ${}^{\circ}$
\\
${\mathbf{ℓ}_{b}}$ & Total Base Length of a Slice: in the direction parallel to the slope of the base & m
\\
${\mathbf{ℓ}_{s}}$ & Surface Length of a Slice: in the direction parallel to the slope of the surface & m
\\
\bottomrule
\label{Table:ToS}
\end{longtabu}
...
\item[Interslice-Norm-Shear-Forces-Linear:\phantomsection\label{assumpINSFL}]Following the assumption of Morgenstern and Price (\cite{morgenstern1965}), interslice normal force and interslice shear force have a proportional relationship, depending on a proportionality constant ($λ$) and a function ($\mathbf{f}$) describing variation depending on $x$ position. \hyperref[IM:nrmShrFor]{IM: nrmShrFor} \hyperref[GD:normShrR]{GD: normShrR} \hyperref[IM:fctSfty]{IM: fctSfty} \hyperref[UC_normshearlinear]{UC: Normal-And-Shear-Linear-Only}.
...
Label & Factor of safety
        ...
        Equation & \begin{displaymath}
                   {F_{S}}=\frac{\mathbf{P}}{\mathbf{S}}
                   \end{displaymath}
                   \\ \midrule \\
                   Description & \begin{symbDescription}
                                 \item{${F_{S}}$ is the factor of safety (Unitless)}
                                 \item{$\mathbf{P}$ is the resistive shear force ($\frac{\text{N}}{\text{m}}$)}
...
Label & Normal force equilibrium
        ...
        Units & $\frac{\text{N}}{\text{m}}$
                ...
                Equation & \begin{displaymath}
                           ...
                           \\ \midrule \\
                           Description & \begin{symbDescription}
                                         \item{$\mathbf{N}$ is the normal force ($\frac{\text{N}}{\text{m}}$)}
                                         \item{$i$ is the index (Unitless)}
                                         \item{$\mathbf{W}$ is the weight ($\frac{\text{N}}{\text{m}}$)}
                                         \item{$\mathbf{X}$ is the interslice shear force ($\frac{\text{N}}{\text{m}}$)}
                                         \item{${\mathbf{U}_{t}}$ is the surface hydrostatic force ($\frac{\text{N}}{\text{m}}$)}
                                         \item{$\mathbf{β}$ is the surface angle (${}^{\circ}$)}
                                         \item{$\mathbf{Q}$ is the external force ($\frac{\text{N}}{\text{m}}$)}
                                         \item{$\mathbf{ω}$ is the imposed load angle (${}^{\circ}$)}
                                         \item{$\mathbf{α}$ is the base angle (${}^{\circ}$)}
                                         \item{${K_{c}}$ is the seismic coefficient (Unitless)}
                                         \item{$\mathbf{G}$ is the interslice normal force ($\frac{\text{N}}{\text{m}}$)}
                                         \item{$\mathbf{H}$ is the interslice normal water force  ($\frac{\text{N}}{\text{m}}$)}
                                         \end{symbDescription}
                                         \\ \midrule \\
        ...
        Units & $\frac{\text{N}}{\text{m}}$
                ...
                Equation & \begin{displaymath}
                           ...
                           Description & \begin{symbDescription}
                                         \item{$\mathbf{P}$ is the resistive shear force ($\frac{\text{N}}{\text{m}}$)}
                                         \item{$i$ is the index (Unitless)}
                                         \item{$\mathbf{N'}$ is the effective normal force ($\frac{\text{N}}{\text{m}}$)}
                                         \item{$φ'$ is the effective angle of friction (${}^{\circ}$)}
                                         \item{$c'$ is the effective cohesion (Pa)}
                                         \item{${\mathbf{ℓ}_{b}}$ is the total base length of a slice (m)}
                                         \end{symbDescription}
                                         \\ \midrule \\
...
\\ \bottomrule \end{tabular}
\end{minipage}
Mobilized shear force is derived by dividing the definition of the $\mathbf{P}$ from \hyperref[GD:resShr]{GD: resShr}. by the definition of the factor of safety from \hyperref[TM:factOfSafety]{TM: factOfSafety}. The factor of safety ${F_{S}}$ is not indexed by $i$ because it is assumed to be constant for the entire slip surface (\hyperref[assumpFOS]{A: Factor-of-Safety}).
\par~
        ...
        Units & $\frac{\text{N}}{\text{m}}$
                ...
                Equation & \begin{displaymath}
                           ...
                           Description & \begin{symbDescription}
                                         ...
                                         \item{$i$ is the index (Unitless)}
                                         \item{$\mathbf{N}$ is the normal force ($\frac{\text{N}}{\text{m}}$)}
                                         \item{${\mathbf{U}_{b}}$ is the base hydrostatic force ($\frac{\text{N}}{\text{m}}$)}
                                         \end{symbDescription}
                                         \\ \midrule \\
...
Label & Resistive shear force, without interslice normal and shear forces
        ...
        Units & $\frac{\text{N}}{\text{m}}$
                ...
                Equation & \begin{displaymath}
                           ...
                           \\ \midrule \\
                           Description & \begin{symbDescription}
                                         \item{$\mathbf{R}$ is the resistive shear force without the influence of interslice forces ($\frac{\text{N}}{\text{m}}$)}
                                         \item{$i$ is the index (Unitless)}
                                         \item{$\mathbf{W}$ is the weight ($\frac{\text{N}}{\text{m}}$)}
                                         \item{${\mathbf{U}_{t}}$ is the surface hydrostatic force ($\frac{\text{N}}{\text{m}}$)}
                                         \item{$\mathbf{β}$ is the surface angle (${}^{\circ}$)}
...
Label & Mobilized shear force, without interslice normal and shear forces
        ...
        Units & $\frac{\text{N}}{\text{m}}$
                ...
                Equation & \begin{displaymath}
                           ...
                           \\ \midrule \\
                           Description & \begin{symbDescription}
                                         \item{$\mathbf{T}$ is the mobilized shear force without the influence of interslice forces ($\frac{\text{N}}{\text{m}}$)}
                                         \item{$i$ is the index (Unitless)}
                                         \item{$\mathbf{W}$ is the weight ($\frac{\text{N}}{\text{m}}$)}
                                         \item{${\mathbf{U}_{t}}$ is the surface hydrostatic force ($\frac{\text{N}}{\text{m}}$)}
                                         \item{$\mathbf{β}$ is the surface angle (${}^{\circ}$)}
        ...
        Units & N
                ...
                Equation & \begin{displaymath}
                           ...
                           Description & \begin{symbDescription}
                                         \item{$\mathbf{G}$ is the interslice normal force ($\frac{\text{N}}{\text{m}}$)}
                                         \item{$i$ is the index (Unitless)}
                                         \item{${\mathbf{h}_{z}}$ is the height of center of slice (m)}
                                         \item{$\mathbf{b}$ is the base width of a slice (m)}
                                         \item{$\mathbf{α}$ is the base angle (${}^{\circ}$)}
                                         \item{$\mathbf{H}$ is the interslice normal water force  ($\frac{\text{N}}{\text{m}}$)}
                                         \item{${\mathbf{h}_{z,w}}$ is the height halfway to water table (m)}
                                         \item{$\mathbf{X}$ is the interslice shear force ($\frac{\text{N}}{\text{m}}$)}
                                         \item{${K_{c}}$ is the seismic coefficient (Unitless)}
                                         \item{$\mathbf{W}$ is the weight ($\frac{\text{N}}{\text{m}}$)}
                                         \item{$\mathbf{h}$ is the y-direction height of a slice (m)}
                                         \item{${\mathbf{U}_{t}}$ is the surface hydrostatic force ($\frac{\text{N}}{\text{m}}$)}
                                         \item{$\mathbf{β}$ is the surface angle (${}^{\circ}$)}
                                         \item{$\mathbf{Q}$ is the external force ($\frac{\text{N}}{\text{m}}$)}
                                         \item{$\mathbf{ω}$ is the imposed load angle (${}^{\circ}$)}
        ...
        Symbol & $\mathbf{W}$
                 ...
                 Units & $\frac{\text{N}}{\text{m}}$
                         ...
                         Equation & \begin{displaymath}
                                    ...
                                    Description & \begin{symbDescription}
                                                  \item{$\mathbf{W}$ is the weight ($\frac{\text{N}}{\text{m}}$)}
                                                  \item{${\mathbf{W}^{L}}$ is the left weight of a slice ($\frac{\text{N}}{\text{m}}$)}
                                                  \item{$i$ is the index (Unitless)}
                                                  \item{${\mathbf{W}^{R}}$ is the right weight of a slice ($\frac{\text{N}}{\text{m}}$)}
                                                  \end{symbDescription}
                                                  \\ \midrule \\
        ...
        Symbol & ${\mathbf{U}_{b}}$
                 ...
                 Units & $\frac{\text{N}}{\text{m}}$
                         ...
                         Equation & \begin{displaymath}
                                    ...
                                    Description & \begin{symbDescription}
                                                  \item{${\mathbf{U}_{b}}$ is the base hydrostatic force ($\frac{\text{N}}{\text{m}}$)}
                                                  \item{${{\mathbf{U}^{L}}_{b}}$ is the left base hydrostatic force on a slice ($\frac{\text{N}}{\text{m}}$)}
                                                  \item{$i$ is the index (Unitless)}
                                                  \item{${{\mathbf{U}^{R}}_{b}}$ is the right base hydrostatic force on a slice ($\frac{\text{N}}{\text{m}}$)}
                                                  \end{symbDescription}
                                                  \\ \midrule \\
        ...
        Symbol & ${\mathbf{U}_{t}}$
                 ...
                 Units & $\frac{\text{N}}{\text{m}}$
                         ...
                         Equation & \begin{displaymath}
                                    ...
                                    Description & \begin{symbDescription}
                                                  \item{${\mathbf{U}_{t}}$ is the surface hydrostatic force ($\frac{\text{N}}{\text{m}}$)}
                                                  \item{${{\mathbf{U}^{L}}_{t}}$ is the left surface hydrostatic force on a slice ($\frac{\text{N}}{\text{m}}$)}
                                                  \item{$i$ is the index (Unitless)}
                                                  \item{${{\mathbf{U}^{R}}_{t}}$ is the right surface hydrostatic force on a slice ($\frac{\text{N}}{\text{m}}$)}
                                                  \end{symbDescription}
                                                  \\ \midrule \\
...
\end{cases}
                                    ...
                                    Description & \begin{symbDescription}
                                                  \item{$\mathbf{H}$ is the interslice normal water force  ($\frac{\text{N}}{\text{m}}$)}
                                                  \item{${\mathbf{y}_{slope}}$ is the y-coordinate of the slope (m)}
                                                  \item{$i$ is the index (Unitless)}
                                                  \item{${\mathbf{y}_{slip}}$ is the y-coordinate of the slip surface (m)}
                                                  \item{${γ_{w}}$ is the unit weight of water ($\frac{\text{N}}{\text{m}^{3}}$)}
                                                  \item{${\mathbf{y}_{wt}}$ is the y-coordinate of the water table (m)}
                                                  \end{symbDescription}
                                                  \\ \midrule \\
                                                  Source & \cite{fredlund1977}
                                                           \\ \midrule \\
                 ...
                 Units & ${}^{\circ}$
                         ...
                         Equation & \begin{displaymath}
                                    ...
                                    Description & \begin{symbDescription}
                                                  ...
                                                  \item{${\mathbf{y}_{slip}}$ is the y-coordinate of the slip surface (m)}
                                                  \item{$i$ is the index (Unitless)}
                                                  \item{${\mathbf{x}_{slip}}$ is the x-coordinate of the slip surface (m)}
                                                  \end{symbDescription}
                                                  \\ \midrule \\
                 ...
                 Units & ${}^{\circ}$
                         ...
                         Equation & \begin{displaymath}
                                    ...
                                    Description & \begin{symbDescription}
                                                  ...
                                                  \item{${\mathbf{y}_{slope}}$ is the y-coordinate of the slope (m)}
                                                  \item{$i$ is the index (Unitless)}
                                                  \item{${\mathbf{x}_{slope}}$ is the x-coordinate of the slope (m)}
                                                  \end{symbDescription}
                                                  \\ \midrule \\
        ...
        Symbol & ${\mathbf{ℓ}_{s}}$
                 ...
                 Units & m
                         ...
                         Equation & \begin{displaymath}
                                    ...
                                    \\ \midrule \\
                                    Description & \begin{symbDescription}
                                                  \item{${\mathbf{ℓ}_{s}}$ is the surface length of a slice (m)}
                                                  \item{$\mathbf{b}$ is the base width of a slice (m)}
                                                  \item{$i$ is the index (Unitless)}
                                                  \item{$\mathbf{β}$ is the surface angle (${}^{\circ}$)}
                                                  \end{symbDescription}
        ...
        Symbol & $\mathbf{h}$
                 ...
                 Units & m
                         ...
                         Equation & \begin{displaymath}
                                    ...
                                    Description & \begin{symbDescription}
                                                  \item{$\mathbf{h}$ is the y-direction height of a slice (m)}
                                                  \item{${\mathbf{h}^{R}}$ is the height of the right side of a slice (m)}
                                                  \item{${\mathbf{h}^{L}}$ is the height of the left side of a slice (m)}
                                                  \end{symbDescription}
                                                  \\ \midrule \\
        ...
        Symbol & ${{\mathbf{F}_{x}}^{G}}$
                 ...
                 Units & N
                         ...
                         Equation & \begin{displaymath}
                                    ...
                                    \\ \midrule \\
                                    Description & \begin{symbDescription}
                                                  \item{${{\mathbf{F}_{x}}^{G}}$ is the sum of the interslice normal forces (N)}
                                                  \item{$\mathbf{G}$ is the interslice normal force ($\frac{\text{N}}{\text{m}}$)}
                                                  \item{$i$ is the index (Unitless)}
                                                  \end{symbDescription}
                                                  \\ \midrule \\
        ...
        Symbol & ${{\mathbf{F}_{x}}^{H}}$
                 ...
                 Units & N
                         ...
                         Equation & \begin{displaymath}
                                    ...
                                    \\ \midrule \\
                                    Description & \begin{symbDescription}
                                                  \item{${{\mathbf{F}_{x}}^{H}}$ is the sum of the interslice normal water forces (N)}
                                                  \item{$\mathbf{H}$ is the interslice normal water force  ($\frac{\text{N}}{\text{m}}$)}
                                                  \item{$i$ is the index (Unitless)}
                                                  \end{symbDescription}
                                                  \\ \midrule \\
...
\end{displaymath}
An expression for the effective normal force, $\mathbf{N'}$, can be derived by substituting the normal force equilibrium from \hyperref[GD:normForcEq]{GD: normForcEq} into the definition for effective normal force from \hyperref[GD:resShearWO]{GD: resShearWO}. This results in Equation (2):
\begin{displaymath}
...
\end{displaymath}
Since the interslice shear force $\mathbf{X}$ and interslice normal force $\mathbf{G}$ are unknown, they are separated from the other terms as follows:
\begin{displaymath}
...
\end{displaymath}
The interslice shear force $\mathbf{X}$ can be expressed in terms of the interslice normal force $\mathbf{G}$ using \hyperref[assumpINSFL]{A: Interslice-Norm-Shear-Forces-Linear} and \hyperref[GD:normShrR]{GD: normShrR}, resulting in:
\begin{displaymath}
...
\end{displaymath}
Equation (16) for $λ$ is a function of the unknown interslice normal force $\mathbf{G}$ (\hyperref[IM:intsliceFs]{IM: intsliceFs}) which itself depends on the unknown factor of safety ${F_{S}}$ (\hyperref[IM:fctSfty]{IM: fctSfty}).
\par~
                                             ...
                                             Output Constraints & \\ \midrule \\
                                                                  Equation & \begin{displaymath}
                                                                             ...
                                                                             Description & \begin{symbDescription}
                                                                                           ...
                                                                                           \item{${\mathbf{x}_{slope}}$ is the x-coordinate of the slope (m)}
                                                                                           \item{${\mathbf{y}_{slope}}$ is the y-coordinate of the slope (m)}
                                                                                           \item{${\mathbf{x}_{wt}}$ is the x-coordinate (m)}
                                                                                           \item{${\mathbf{y}_{wt}}$ is the y-coordinate of the water table (m)}
                                                                                           \item{$c'$ is the effective cohesion (Pa)}
                                                                                           \item{$φ'$ is the effective angle of friction (${}^{\circ}$)}
                                                                                           \item{$γ$ is the soil dry unit weight ($\frac{\text{N}}{\text{m}^{3}}$)}
