...
module GOOL.Drasil (Label, GSProgram, SFile, MSBody, MSBlock, VSType, 
  ...
  TypeSym(..), TypeElim(..), StatementSym(..), AssignStatement(..), (&=), assignToListIndex, 
  ...
  ifNoElse, switchAsIf, VariableSym(..), VariableElim(..), ($->), listOf, ValueSym(..), 
  ...
  libNewObj, exists, objMethodCallMixedArgs, 
  FunctionSym(..), ($.), selfAccess, GetSet(..), List(..), listIndexExists, at,
  Iterator(..), StatePattern(..), ObserverPattern(..), StrategyPattern(..), 
  ScopeSym(..), 
...
import GOOL.Drasil.ClassInterface (Label, GSProgram, SFile, MSBody, MSBlock, 
  ...
  listSlice, TypeSym(..), TypeElim(..), StatementSym(..), AssignStatement(..), (&=), 
  ...
  ($->), listOf, 
  ValueSym(..), Literal(..), MathConstant(..), VariableValue(..), CommandLineArgs(..), NumericExpression(..), BooleanExpression(..), Comparison(..), ValueExpression(..), funcApp, funcAppNamedArgs, selfFuncApp, extFuncApp, libFuncApp, newObj, extNewObj, libNewObj, exists, objMethodCallMixedArgs, FunctionSym(..), ($.), selfAccess, GetSet(..), List(..), listIndexExists, at, Iterator(..), StatePattern(..), ObserverPattern(..), StrategyPattern(..), ScopeSym(..), ParameterSym(..), MethodSym(..), 
