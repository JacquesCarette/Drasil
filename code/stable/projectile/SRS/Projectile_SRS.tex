...
\\
${\mathbf{v}^{\text{speed}}}$ & Vector speed & $\frac{\text{m}}{\text{s}}$
\\
$ε$ & Hit tolerance & --
\\
...
\end{displaymath}
Performing the integration, replacing $v$ with ${v^{\text{f}}}$, we have the required equation:
...
\\ \midrule \\
Equation & \begin{displaymath}
           {\mathbf{v}^{\text{speed}}}=\|\mathbf{v}\|
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
              \item{${\mathbf{v}^{\text{speed}}}$ is the vector speed ($\frac{\text{m}}{\text{s}}$)}
              \item{$\mathbf{v}$ is the velocity ($\frac{\text{m}}{\text{s}}$)}
              \end{symbDescription}
\\ \midrule \\
