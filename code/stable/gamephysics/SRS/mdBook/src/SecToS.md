...
|\\({\boldsymbol{v}\text{(}t\text{)}^{\text{A}\text{B}}\_{\text{f}}}\\)|Final Relative Velocity Between Rigid Bodies of A and B                                 |\\(\frac{\text{m}}{\text{s}}\\)                 |
|\\({\boldsymbol{v}\text{(}t\text{)}^{\text{A}\text{B}}\_{\text{i}}}\\)|Initial Relative Velocity Between Rigid Bodies of A and B                               |\\(\frac{\text{m}}{\text{s}}\\)                 |
