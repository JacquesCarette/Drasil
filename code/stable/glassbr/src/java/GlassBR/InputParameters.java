...
public class InputParameters {
    ...
    */
    private void get_input(String filename) throws FileNotFoundException, IOException {
        ...
        outfile = new PrintWriter(new FileWriter(new File("log.txt"), true));
        outfile.print("var 'self.a' assigned ");
        ...
        outfile = new PrintWriter(new FileWriter(new File("log.txt"), true));
        outfile.print("var 'self.b' assigned ");
        ...
        outfile = new PrintWriter(new FileWriter(new File("log.txt"), true));
        outfile.print("var 'self.w' assigned ");
        ...
        outfile = new PrintWriter(new FileWriter(new File("log.txt"), true));
        outfile.print("var 'self.P_btol' assigned ");
        ...
        outfile = new PrintWriter(new FileWriter(new File("log.txt"), true));
        outfile.print("var 'self.TNT' assigned ");
        ...
        outfile = new PrintWriter(new FileWriter(new File("log.txt"), true));
        outfile.print("var 'self.g' assigned ");
        ...
        outfile = new PrintWriter(new FileWriter(new File("log.txt"), true));
        outfile.print("var 'self.t' assigned ");
        ...
        outfile = new PrintWriter(new FileWriter(new File("log.txt"), true));
        outfile.print("var 'self.SD_x' assigned ");
        ...
        outfile = new PrintWriter(new FileWriter(new File("log.txt"), true));
        outfile.print("var 'self.SD_y' assigned ");
        ...
        outfile = new PrintWriter(new FileWriter(new File("log.txt"), true));
        outfile.print("var 'self.SD_z' assigned ");
    ...
    */
    private void derived_values() throws Exception, IOException {
        ...
        outfile = new PrintWriter(new FileWriter(new File("log.txt"), true));
        outfile.print("var 'self.h' assigned ");
        ...
        outfile = new PrintWriter(new FileWriter(new File("log.txt"), true));
        outfile.print("var 'self.LDF' assigned ");
        ...
        if (this.g.equals("AN")) {
            this.GTF = 1;
            outfile = new PrintWriter(new FileWriter(new File("log.txt"), true));
            outfile.print("var 'self.GTF' assigned ");
        ...
        outfile = new PrintWriter(new FileWriter(new File("log.txt"), true));
        outfile.print("var 'self.SD' assigned ");
        ...
        outfile = new PrintWriter(new FileWriter(new File("log.txt"), true));
        outfile.print("var 'self.AR' assigned ");
        ...
        outfile = new PrintWriter(new FileWriter(new File("log.txt"), true));
        outfile.print("var 'self.w_TNT' assigned ");
