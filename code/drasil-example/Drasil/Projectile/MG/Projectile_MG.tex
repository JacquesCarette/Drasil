...
R5 & \mref{mOutput}, \mref{mControl}, \mref{mSeqDS}\\ %, \mref{mPlot}\\
R6 & \mref{mOutput}, \mref{mControl}, \mref{mSeqDS}\\ %, \mref{mPlot}\\
R7 & \mref{mOutput}, \mref{mControl}, \mref{mSeqDS}\\ %, \mref{mPlot}\\
R8 & \mref{mOutput}, \mref{mControl}, \mref{mSeqDS}\\ %, \mref{mPlot}\\
%R9 & \mref{mVerifyOut}\\
