...
import Drasil.GlassBR.DataDefs (dataDefns, gbQDefns, probOfBreak, calofCapacity)
import Drasil.GlassBR.IMods (glassBRsymb, calofDemand, gbrIMods)
    ...
    (SSDProg
      ...
      , SSDSolChSpec 
        (SCSProg
          ...
          , IMs ([Label, Input, Output, InConstraints, OutConstraints] ++ stdFields) [calofDemand] HideDerivation
