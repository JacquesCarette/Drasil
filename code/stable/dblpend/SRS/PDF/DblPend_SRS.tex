...
\\
${F_{\text{x}1}}$ & Horizontal force on the first object & ${\text{N}}$
\\
${F_{\text{x}2}}$ & Horizontal force on the second object & ${\text{N}}$
\\
${F_{\text{y}1}}$ & Vertical force on the first object & ${\text{N}}$
\\
${F_{\text{y}2}}$ & Vertical force on the second object & ${\text{N}}$
\\
$\symbf{F}$ & Force & ${\text{N}}$
\\
...
\\ \midrule
Equation & \begin{displaymath}
           \resizeExpression{{F_{\text{x}1}}=m \symbf{a}\text{(}t\text{)}=-{\symbf{T}_{1}}\,\sin\left({θ_{1}}\right)+{\symbf{T}_{2}}\,\sin\left({θ_{2}}\right)}
           \end{displaymath}
\\ \midrule
Description & \begin{symbDescription}
              \item{${F_{\text{x}1}}$ is the horizontal force on the first object (${\text{N}}$)}
              \item{$m$ is the mass (${\text{kg}}$)}
              \item{$\symbf{a}\text{(}t\text{)}$ is the acceleration ($\frac{\text{m}}{\text{s}^{2}}$)}
...
\\ \midrule
Equation & \begin{displaymath}
           \resizeExpression{{F_{\text{y}1}}=m \symbf{a}\text{(}t\text{)}={\symbf{T}_{1}}\,\cos\left({θ_{1}}\right)-{\symbf{T}_{2}}\,\cos\left({θ_{2}}\right)-{m_{1}}\,\symbf{g}}
           \end{displaymath}
\\ \midrule
Description & \begin{symbDescription}
              \item{${F_{\text{y}1}}$ is the vertical force on the first object (${\text{N}}$)}
              \item{$m$ is the mass (${\text{kg}}$)}
              \item{$\symbf{a}\text{(}t\text{)}$ is the acceleration ($\frac{\text{m}}{\text{s}^{2}}$)}
              \item{${\symbf{T}_{1}}$ is the tension of the first object (${\text{N}}$)}
              \item{${θ_{1}}$ is the angle of the first rod (${\text{rad}}$)}
...
\\ \midrule
Equation & \begin{displaymath}
           \resizeExpression{{F_{\text{x}2}}=m \symbf{a}\text{(}t\text{)}=-{\symbf{T}_{2}}\,\sin\left({θ_{2}}\right)}
           \end{displaymath}
\\ \midrule
Description & \begin{symbDescription}
              \item{${F_{\text{x}2}}$ is the horizontal force on the second object (${\text{N}}$)}
              \item{$m$ is the mass (${\text{kg}}$)}
              \item{$\symbf{a}\text{(}t\text{)}$ is the acceleration ($\frac{\text{m}}{\text{s}^{2}}$)}
              \item{${\symbf{T}_{2}}$ is the tension of the second object (${\text{N}}$)}
              \item{${θ_{2}}$ is the angle of the second rod (${\text{rad}}$)}
...
\\ \midrule
Equation & \begin{displaymath}
           \resizeExpression{{F_{\text{y}2}}=m \symbf{a}\text{(}t\text{)}={\symbf{T}_{2}}\,\cos\left({θ_{2}}\right)-{m_{2}}\,\symbf{g}}
           \end{displaymath}
\\ \midrule
Description & \begin{symbDescription}
              \item{${F_{\text{y}2}}$ is the vertical force on the second object (${\text{N}}$)}
              \item{$m$ is the mass (${\text{kg}}$)}
              \item{$\symbf{a}\text{(}t\text{)}$ is the acceleration ($\frac{\text{m}}{\text{s}^{2}}$)}
              \item{${\symbf{T}_{2}}$ is the tension of the second object (${\text{N}}$)}
              \item{${θ_{2}}$ is the angle of the second rod (${\text{rad}}$)}
