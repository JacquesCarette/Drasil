...
\\ \bottomrule \end{tabular}
\end{minipage}
\textbf{Detailed derivation of rectilinear velocity:}
...
\\ \bottomrule \end{tabular}
\end{minipage}
\textbf{Detailed derivation of rectilinear position:}
...
\\ \bottomrule \end{tabular}
\end{minipage}
\textbf{Detailed derivation of velocity vector:}
...
\\ \bottomrule \end{tabular}
\end{minipage}
\textbf{Detailed derivation of position vector:}
...
\\ \bottomrule \end{tabular}
\end{minipage}
\textbf{Detailed derivation of flight duration:}
...
\\ \bottomrule \end{tabular}
\end{minipage}
\textbf{Detailed derivation of landing position:}
