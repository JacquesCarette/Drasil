...
\imptodo{Get rid of this chapter, move everything needed out of it.}
...
Drasil uses a series of variably sized \ACFP{dsl} to describe various fragments
...
may be generated. Drasil currently focuses on \ACF{scs}, following Smith and
Lai's \ACF{srs} template as described in \cite{SmithAndLai2005}. Behind the
...
\ACF{gool} \cite{Carette2019}. Through encoding knowledge in Drasil, an increase
...
\porthref{website}{https://jacquescarette.github.io/Drasil/}. \footnote{The
...
point to Haskell programs, the \inlineHs{main :: IO ()} function is
