...
\end{description}
\begin{description}
\item[\refstepcounter{assumpnum}\atheassumpnum\label{A:collisionType}:]All rigid bodies collisions are vertex-to-edge collisions. \hyperref[DD:impulse]{DD: impulse} \hyperref[IM:col2D]{IM: col2D}..
\end{description}
\begin{description}
...
\end{description}
\begin{description}
\item[\refstepcounter{assumpnum}\atheassumpnum\label{A:constraintsAndJointsInvolvement}:]There are no constraints and joints involved throughout the simulation. \hyperref[IM:transMot]{IM: transMot} \hyperref[IM:rotMot]{IM: rotMot} \hyperref[IM:col2D]{IM: col2D}..
\end{description}
