...
data SomeProgGenerator where
  SomeProgGenerator
    :: forall repr vis typ param val stmt mthd stvr attch prg file mod bod block. (OOProg repr vis typ param val stmt mthd stvr attch prg file mod bod block)
...
genPackage
  ::
    ( OOProg progRepr vis typ param val stmt mthd stvr attch prg file mod bod block
...
generateCodeProc
  ::
    ...
    , ProcProg progRepr vis typ param val stmt mthd prg file mod bod block
    , SoftwareDossierSym packRepr
    , Monad packRepr
    )
  => Lang
