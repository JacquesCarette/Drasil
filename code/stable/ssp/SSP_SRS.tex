...
\\
\bottomrule
\caption{Table 2: Input Data Constraints}
\label{Table:Tabl2:InpuDataCons}
\end{longtable}
\begin{longtable}{l l l}
\toprule
...
\\
\bottomrule
\caption{Table 3: Output Data Constraints}
\label{Table:Tabl3:OutpDataCons}
\end{longtable}
