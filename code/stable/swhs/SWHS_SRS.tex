...
The instance models that govern solar water heating systems incorporating PCM are presented in Section~\ref{Sec:IMs}. The information to understand the meaning of the instance models and their derivation is also presented, so that the instance models can be verified.
...
\noindent \begin{minipage}{\textwidth}
\begin{tabular}{p{0.2\textwidth} p{0.73\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:ht\_flux\_P}
\phantomsection 
\label{DD:ht\_flux\_P}
\\ \midrule \\
...
\noindent \begin{minipage}{\textwidth}
\begin{tabular}{p{0.2\textwidth} p{0.73\textwidth}}
\toprule \textbf{Refname} & \textbf{DD:melt\_frac}
\phantomsection 
\label{DD:melt\_frac}
\\ \midrule \\
Label & Melt fraction
...
\\ \midrule \\
Description & \begin{description}
              \item{$\phi{}$ is the melt fraction (Unitless)}
...
\\ \midrule \\
Input & $t$, ${\tau{}_{W}}$, ${T_{C}}$, $\eta{}$, ${T_{P}}$, ${t_{final}}$, ${T_{init}}$, ${A_{C}}$
\\ \midrule \\
Output & ${T_{W}}$
\\ \midrule \\
...
\\ \midrule \\
Equation & \begin{dmath}
           \frac{d\,{T_{W}}}{d\,t}=\frac{1}{{\tau{}_{W}}} \left({T_{C}}-{T_{W}}\left(t\right)+\eta{} \left({T_{P}}\left(t\right)-{T_{W}}\left(t\right)\right)\right)
           \end{dmath}
\\ \midrule \\
Description & \begin{description}
              \item{${T_{W}}$ is the temperature of the water (${}^{\circ}$C)}
              ...
              \item{${T_{C}}$ is the temperature of the heating coil (${}^{\circ}$C)}
              \item{$\eta{}$ is the ODE parameter (Unitless)}
              \item{${T_{P}}$ is the temperature of the phase change material (${}^{\circ}$C)}
              \end{description}
\\ \midrule \\
Source & 
...
Description & \begin{description}
              \item{${T_{P}}$ is the temperature of the phase change material (${}^{\circ}$C)}
              \item{$t$ is the time (s)}
              \item{${{\tau{}_{P}}^{S}}$ is the ODE parameter for solid PCM (s)}
              \item{${T_{W}}$ is the temperature of the water (${}^{\circ}$C)}
              \item{${{\tau{}_{P}}^{L}}$ is the ODE parameter for liquid PCM (s)}
