...
The current state of Scientific Computing software development leaves 
...
verifiability, reproducibility, and reusability. That may be too broad of a
target, so I will be focusing on well-understood domains; specifically
Scientific Computing (SC). To refine the idea even more, I want to focus on
applications where agile development is ill-suited or completely unusable, such
as those that are safety-critical.
...
to automate as much as possible in the software development process.
