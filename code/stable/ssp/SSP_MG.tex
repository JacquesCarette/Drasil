...
\end{description}
\begin{description}
\item[\refstepcounter{lcnum}\lcthelcnum\label{LC:control}:]The algorithm for the overall operation procedure of the program.
\end{description}
\begin{description}
...
\end{description}
\begin{description}
\item[\refstepcounter{lcnum}\lcthelcnum\label{LC:genalg}:]Algorithm for determining the critical slip surface.
\end{description}
\begin{description}
\item[\refstepcounter{lcnum}\lcthelcnum\label{LC:kin}:]Criteria for a slip surface to be considered physically realistic/kinematically admissible.
\end{description}
\begin{description}
\item[\refstepcounter{lcnum}\lcthelcnum\label{LC:slicer}:]The algorithm for creating the slice points for slip surface analysis.
\end{description}
\begin{description}
\item[\refstepcounter{lcnum}\lcthelcnum\label{LC:fsweight}:]The weighting scheme for comparing slip surfaces factors of safety.
\end{description}
\begin{description}
\item[\refstepcounter{lcnum}\lcthelcnum\label{LC:mp}:]The algorithm for implementation of the Morgenstern Price Solver.
\end{description}
\begin{description}
\item[\refstepcounter{lcnum}\lcthelcnum\label{LC:rfem}:]The algorithm for implementation of the RFEM Solver.
\end{description}
\begin{description}
\item[\refstepcounter{lcnum}\lcthelcnum\label{LC:prop}:]The algorithm for assigning soil properties to slices.
\end{description}
\begin{description}
\item[\refstepcounter{lcnum}\lcthelcnum\label{LC:array}:]The implementation for the sequence (array) data structure.
\end{description}
\begin{description}
\item[\refstepcounter{lcnum}\lcthelcnum\label{LC:rand}:]The method of generating pseudo-random numbers.
\end{description}
\begin{description}
\item[\refstepcounter{lcnum}\lcthelcnum\label{LC:plot}:]The method of displaying the final output.
\end{description}
...
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{M:modinputfdesc}:]Input Format Module
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{M:modoutputfdesc}:]Output Format Module
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{M:modgenalgdesc}:]Genetic Algorithm Module
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{M:modkinadmdesc}:]Kinetic Admissibility Module
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{M:modslipslicerdesc}:]Slip Slicer Module
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{M:modslipweightdesc}:]Slip Weighting Module
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{M:modmpdesc}:]Morgenstern Price Solver Module
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{M:modrfemdesc}:]RFEM Solver Module
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{M:modspsdesc}:]Slice Property Sorter Module
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{M:modseqserv}:]Sequence Data Structure Module
\end{description}
\begin{description}
\item[\refstepcounter{modnum}\mthemodnum\label{M:modrngdesc}:]Random Number Generator Module
\end{description}
\begin{description}
...
node [style = "n"];
"Control Module (M\ref{M:modControl})" -> "Input Format Module (M\ref{M:modinputfdesc})";
"Control Module (M\ref{M:modControl})" -> "Output Format Module (M\ref{M:modoutputfdesc})";
"Control Module (M\ref{M:modControl})" -> "Genetic Algorithm Module (M\ref{M:modgenalgdesc})";
"Input Format Module (M\ref{M:modinputfdesc})" -> "Hardware Hiding Module (M\ref{M:hwHiding})";
"Output Format Module (M\ref{M:modoutputfdesc})" -> "Plotting Module (M\ref{M:modplotdesc})";
"Output Format Module (M\ref{M:modoutputfdesc})" -> "Slip Slicer Module (M\ref{M:modslipslicerdesc})";
"Output Format Module (M\ref{M:modoutputfdesc})" -> "Morgenstern Price Solver Module (M\ref{M:modmpdesc})";
"Output Format Module (M\ref{M:modoutputfdesc})" -> "RFEM Solver Module (M\ref{M:modrfemdesc})";
"Genetic Algorithm Module (M\ref{M:modgenalgdesc})" -> "Slip Slicer Module (M\ref{M:modslipslicerdesc})";
"Genetic Algorithm Module (M\ref{M:modgenalgdesc})" -> "Kinetic Admissibility Module (M\ref{M:modkinadmdesc})";
"Genetic Algorithm Module (M\ref{M:modgenalgdesc})" -> "Random Number Generator Module (M\ref{M:modrngdesc})";
"Genetic Algorithm Module (M\ref{M:modgenalgdesc})" -> "Slip Weighting Module (M\ref{M:modslipweightdesc})";
"Genetic Algorithm Module (M\ref{M:modgenalgdesc})" -> "Morgenstern Price Solver Module (M\ref{M:modmpdesc})";
"Morgenstern Price Solver Module (M\ref{M:modmpdesc})" -> "Slice Property Sorter Module (M\ref{M:modspsdesc})";
"RFEM Solver Module (M\ref{M:modrfemdesc})" -> "Slice Property Sorter Module (M\ref{M:modspsdesc})";
"Plotting Module (M\ref{M:modplotdesc})" -> "Hardware Hiding Module (M\ref{M:hwHiding})";
}
\end{dot2tex}
\end{tikzpicture}
\end{adjustbox}
