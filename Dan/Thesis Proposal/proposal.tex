...
explain the implementation; it is not necessarily used in the same way as
artifacts that software engineers expect. LP also does not really simplify the
...
artifacts. This is one area where I believe Drasil will outperform WebBox.
