...
\item[\refstepcounter{acnum} \actheacnum \label{acOutput}:] The format of the
  final output data.
% \item[\refstepcounter{acnum} \actheacnum \label{acVerifyOut}:] The constraints 
...
\item [\refstepcounter{mnum} \mthemnum \label{mInCons}:] Input Constraints Module
...
\begin{description}
\item[Secrets:] The format and structure of the physical constraints. % and software constraints.
\item[Services:] Verifies that the input parameters comply with physical 
  ...
  % Throws a warning if a parameter violates a software constraint.
\item[Implemented By:] Projectile
\end{description}
