...
ooVector :: OOProg r tp => GSProgram r
ooVector = prog "OOVector" "" [fileDoc (buildModule "OOVector" []
  [main] [vectorClass])]

vectorClass :: OOProg r tp => SClass r
...
dimension :: OOProg r tp => SMethod r
...
magnitude :: OOProg r tp => SMethod r
