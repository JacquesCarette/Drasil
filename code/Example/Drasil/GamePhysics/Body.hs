...
s8_intro1 = Paragraph $ foldlSent [S "The", (phrase purpose), S "of", 
  ...
  S "should be modified as well.", makeRef s8_table1, S "shows the dependencies of", 
  (plural goalStmt) `sC` (plural requirement) `sC` (plural inModel) `sC` S "and",
  (plural datumConstraint), S "with each other.", makeRef s8_table2,
  S "shows the dependencies of", (plural thModel) `sC` (plural genDefn) `sC`
  (plural dataDefn) `sC` S "and", (plural inModel), 
  S "on the assumptions. Finally,", makeRef s8_table3,
