...
The following section provides an overview of the software requirements specification (SRS) for the HGHC (HGHC) program. This section explains the purpose of this document.
