...
instance Render Zeta where
  render TeX Zeta_L   = "\\zeta{}"
  render TeX Zeta     = "\\Zeta{}"
  render Plain Zeta_L = "zeta"
  render Plain Zeta   = "uZeta"
  render HTML Zeta_L  = "&zeta;"
  render HTML Zeta    = "&Zeta;"
