...
req3 = mkRequirement "req3" ( foldlSent [
  ...
  --FIXME , makeRef s7_table1-}] ) (S "checkConsReq")
--
req4 = mkRequirement "req4" ( foldlSent [
  ...
  sParen (S "from" +:+ acroIM 2)] ) (S "derivQuantReq")
--
req5 = mkRequirement "req5" ( foldlSent [
  ...
  phrase simulation, phrase time, sParen (S "from" +:+ acroIM 1)] ) (S "tempWReq")
--
req6 = mkRequirement "req6" ( foldlSent [
  ...
  phrase simulation, phrase time, sParen (S "from" +:+ acroIM 2)] ) (S "tempPCMReq")
--
req7 = mkRequirement "req7" ( foldlSent [
  ...
  phrase simulation, phrase time, sParen (S "from" +:+ acroIM 3)] ) (S "changeHeatEnergyWReq")
--
req8 = mkRequirement "req8" ( foldlSent [
  ...
  phrase simulation, phrase time, sParen (S "from" +:+ acroIM 4)] ) (S "changeHeatEnergyPCMReq")
--
req9 = mkRequirement "req9" ( foldlSent [
  ...
  S "with relative error no greater than 0.001%"] ) (S "checkConsEnergyReq")
--
req10 = mkRequirement "req10" ( foldlSent [
  ...
  getES t_init_melt, sParen (S "from" +:+ acroIM 2)] ) (S "meltBeginTimeReq")
--
req11 = mkRequirement "req11" ( foldlSent [
  S "Calculate and", phrase output_, S "the", phrase time,
  S "at which the", short phsChgMtrl, S "stops", phrase CT.melting,
  getES t_final_melt, sParen (S "from" +:+ acroIM 2)] ) (S "meltEndTimeReq")
