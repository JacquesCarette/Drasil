...
\begin{displaymath}
\resizeExpression{{m_{\text{P}}}\,{C^{\text{S}}_{\text{P}}}\,\frac{\,d{T_{\text{P}}}}{\,dt}={q_{\text{P}}}\,{A_{\text{P}}}}
\end{displaymath}
Using \hyperref[GD:htFluxPCMFromWater]{GD:htFluxPCMFromWater} for ${q_{\text{P}}}$, this equation can be written as:

\begin{displaymath}
\resizeExpression{{m_{\text{P}}}\,{C^{\text{S}}_{\text{P}}}\,\frac{\,d{T_{\text{P}}}}{\,dt}={h_{\text{P}}}\,{A_{\text{P}}}\,\left({T_{\text{W}}}-{T_{\text{P}}}\right)}
\end{displaymath}
Dividing by ${m_{\text{P}}}$ ${C^{\text{S}}_{\text{P}}}$ we obtain:

\begin{displaymath}
\resizeExpression{\frac{\,d{T_{\text{P}}}}{\,dt}=\frac{{h_{\text{P}}}\,{A_{\text{P}}}}{{m_{\text{P}}}\,{C^{\text{S}}_{\text{P}}}}\,\left({T_{\text{W}}}-{T_{\text{P}}}\right)}
\end{displaymath}
By substituting ${τ^{\text{S}}_{\text{P}}}$ (from \hyperref[DD:balanceSolidPCM]{DD:balanceSolidPCM}), this can be written as:

\begin{displaymath}
\resizeExpression{\frac{\,d{T_{\text{P}}}}{\,dt}=\frac{1}{{τ^{\text{S}}_{\text{P}}}}\,\left({T_{\text{W}}}-{T_{\text{P}}}\right)}
\end{displaymath}
