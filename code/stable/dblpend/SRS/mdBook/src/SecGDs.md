...
|Units      |\\({\text{N}}\\)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|Equation   |\\[{f\_{1}}={\boldsymbol{T}\_{1}} \begin{bmatrix}-\sin\left({θ\_{1}}\right)\\\\\cos\left({θ\_{1}}\right)\end{bmatrix}+-\left({\boldsymbol{T}\_{2}} \begin{bmatrix}-\sin\left({θ\_{2}}\right)\\\\\cos\left({θ\_{2}}\right)\end{bmatrix}\right)+\begin{bmatrix}0\\\\-{m\_{1}}\\,g\end{bmatrix}\\]                                                                                                                                                                                                                                                                                                         |
...
\\[{f\_{1}}={\boldsymbol{T}\_{1}} \begin{bmatrix}-\sin\left({θ\_{1}}\right)\\\\\cos\left({θ\_{1}}\right)\end{bmatrix}+-\left({\boldsymbol{T}\_{2}} \begin{bmatrix}-\sin\left({θ\_{2}}\right)\\\\\cos\left({θ\_{2}}\right)\end{bmatrix}\right)+\begin{bmatrix}0\\\\-{m\_{1}}\\,g\end{bmatrix}\\]
...
|Units      |\\({\text{N}}\\)                                                                                                                                                                                                                                                                                                                                                                                                                         |
|Equation   |\\[{f\_{2}}={\boldsymbol{T}\_{2}} \begin{bmatrix}-\sin\left({θ\_{2}}\right)\\\\\cos\left({θ\_{2}}\right)\end{bmatrix}+\begin{bmatrix}0\\\\-{m\_{2}}\\,g\end{bmatrix}\\]                                                                                                                                                                                                                                                                  |
...
\\[{f\_{2}}={\boldsymbol{T}\_{2}} \begin{bmatrix}-\sin\left({θ\_{2}}\right)\\\\\cos\left({θ\_{2}}\right)\end{bmatrix}+\begin{bmatrix}0\\\\-{m\_{2}}\\,g\end{bmatrix}\\]
