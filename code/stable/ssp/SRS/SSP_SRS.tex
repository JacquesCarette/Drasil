...
\item[Determine-Normal-Forces:\phantomsection\label{determineNormalF}]Determine the interslice normal force between each pair of vertical slices of the slope.
\item[Determine-Shear-Forces:\phantomsection\label{determineShearF}]Determine the interslice shear force between each pair of vertical slices of the slope.
\end{itemize}
