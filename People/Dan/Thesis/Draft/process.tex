...
\ds{**NOTE: Also ensure each artifact has a 'who' (audience), 'what' (problem 
...
those used by \smithea{} \ds{source\citep{}} Also, as mentioned in 
...
often until \ds{DRASILSECTION} since it did not inform Drasil's design or 
