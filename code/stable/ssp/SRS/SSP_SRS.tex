...
\\
${{\mathbf{F}_{\text{x}}}^{\text{G}}}$ & Sums of the Interslice Normal Forces: The sum of the forces for each pair of adjacent interslice boundaries. & N
\\
${{\mathbf{F}_{\text{x}}}^{\text{H}}}$ & Sums of the Interslice Normal Water Forces: The sum of the forces for each pair of adjacent interslice boundaries. & N
\\
$\mathbf{f}$ & Interslice Normal to Shear Force Ratio Variation Function: A function of distance in the $x$-direction. & --
\\
$\mathbf{G}$ & Interslice Normal Forces: Forces per meter in the $z$-direction exerted between each pair of adjacent slices. & $\frac{\text{N}}{\text{m}}$
\\
$g$ & Gravitational Acceleration: The approximate acceleration due to gravity on Earth at sea level. & $\frac{\text{m}}{\text{s}^{2}}$
\\
$\mathbf{H}$ & Interslice Normal Water Forces: Forces per meter in the $z$-direction exerted in the $x$-direction between each pair of adjacent slices. & $\frac{\text{N}}{\text{m}}$
\\
...
\\
${\mathbf{h}^{\text{L}}}$ & Heights of the Left Side of Slices: The maximum height of a slice, assuming slice surfaces have negative slope. & m
\\
${\mathbf{h}^{\text{R}}}$ & Heights of the Right Side of Slices: The minimum height of a slice, assuming slice surfaces have negative slope. & m
\\
...
\\
$\mathbf{N'}$ & Effective Normal Forces: Forces per meter in the $z$-direction for each slice of a soil surface, subtracting pore water reactive force from total reactive force. & $\frac{\text{N}}{\text{m}}$
\\
$n$ & Number of Slices: How many slices the slip mass has been divided into. & --
\\
...
\\
$\mathbf{R}$ & Resistive Shear Forces Without the Influence of Interslice Forces: The resistive shear forces per meter in the $z$-direction for each slice. & $\frac{\text{N}}{\text{m}}$
\\
...
\\
$\mathbf{T}$ & Mobilized Shear Forces Without the Influence of Interslice Forces: The mobilized shear forces per meter in the $z$-direction for each slice. & $\frac{\text{N}}{\text{m}}$
\\
${\mathbf{U}_{\text{b}}}$ & Base Hydrostatic Forces: Forces per meter in the $z$-direction from water pressure within each slice. & $\frac{\text{N}}{\text{m}}$
\\
${\mathbf{U}_{\text{g}}}$ & Surface Hydrostatic Forces: Forces per meter in the $z$-direction from water pressure acting into each slice from standing water on the slope surface. & $\frac{\text{N}}{\text{m}}$
\\
...
\\
$\mathbf{X}$ & Interslice Shear Forces: Forces per meter in the $z$-direction exerted between adjacent slices. & $\frac{\text{N}}{\text{m}}$
\\
...
\\
${\mathbf{x}_{\text{cs}}}\text{,}{\mathbf{y}_{\text{cs}}}$ & The Set of $x$-coordinates and $y$-coordinates: Describe the vertices of the critical slip surface. & m
\\
...
\\
$λ$ & Proportionality Constant: The ratio of the interslice normal to the shear force. & --
\\
...
\\
$\mathbf{ω}$ & Imposed Load Angles: The angles between the external force acting into the surface of each sliceand the vertical. & ${}^{\circ}$
\\
