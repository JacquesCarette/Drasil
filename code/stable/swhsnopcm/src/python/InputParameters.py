...
def input_constraints(A_C, C_W, h_C, T_init, t_final, L, T_C, t_step, rho_W, D, E_W):
    if not(A_C <= Constants.Constants.A_CMAX):
        print("Warning: ", end="")
        print("A_C has value ", end="")
        print(A_C, end="")
        print(", but is suggested to be ", end="")
        print("below ", end="")
        print(Constants.Constants.A_CMAX, end="")
        print(" (A_Cmax)", end="")
        print(".")
    if not(Constants.Constants.C_WMIN < C_W and C_W < Constants.Constants.C_WMAX):
        print("Warning: ", end="")
        print("C_W has value ", end="")
        print(C_W, end="")
        print(", but is suggested to be ", end="")
        print("between ", end="")
        print(Constants.Constants.C_WMIN, end="")
        print(" (C_Wmin)", end="")
        print(" and ", end="")
        print(Constants.Constants.C_WMAX, end="")
        print(" (C_Wmax)", end="")
        print(".")
    if not(Constants.Constants.H_CMIN <= h_C and h_C <= Constants.Constants.H_CMAX):
        print("Warning: ", end="")
        print("h_C has value ", end="")
        print(h_C, end="")
        print(", but is suggested to be ", end="")
        print("between ", end="")
        print(Constants.Constants.H_CMIN, end="")
        print(" (h_Cmin)", end="")
        print(" and ", end="")
        print(Constants.Constants.H_CMAX, end="")
        print(" (h_Cmax)", end="")
        print(".")
    if not(t_final < Constants.Constants.T_FINALMAX):
        print("Warning: ", end="")
        print("t_final has value ", end="")
        print(t_final, end="")
        print(", but is suggested to be ", end="")
        print("below ", end="")
        print(Constants.Constants.T_FINALMAX, end="")
        print(" (t_finalmax)", end="")
        print(".")
    if not(Constants.Constants.L_MIN <= L and L <= Constants.Constants.L_MAX):
        ...
        print(" (L_max)", end="")
        print(".")
    if not(Constants.Constants.RHO_WMIN < rho_W and rho_W <= Constants.Constants.RHO_WMAX):
        print("Warning: ", end="")
        print("rho_W has value ", end="")
        print(rho_W, end="")
        print(", but is suggested to be ", end="")
        print("between ", end="")
        print(Constants.Constants.RHO_WMIN, end="")
        print(" (rho_Wmin)", end="")
        print(" and ", end="")
        print(Constants.Constants.RHO_WMAX, end="")
        print(" (rho_Wmax)", end="")
        print(".")
