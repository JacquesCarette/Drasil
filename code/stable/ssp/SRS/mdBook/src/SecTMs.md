...
|:----------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|Label      |Equilibrium                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
|Equation   |\\[\displaystyle\sum{{F\_{\text{x}}}}=0\land{}\displaystyle\sum{{F\_{\text{y}}}}=0\land{}\displaystyle\sum{M}=0\\]                                                                                                                                                                                                                                                                                                                                              |
|Description|<ul><li>\\({F\_{\text{x}}}\\) is the \\(x\\)-coordinate of the force (\\({\text{N}}\\))</li><li>\\({F\_{\text{y}}}\\) is the \\(y\\)-coordinate of the force (\\({\text{N}}\\))</li><li>\\(M\\) is the moment (\\(\text{N}\text{m}\\))</li></ul>                                                                                                                                                                                                                |
