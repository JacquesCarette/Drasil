...
helloWorldOO :: (OOProg r vis smt md svr) => OO.GSProgram r
...
helloWorldMainOO :: (OOProg r vis smt md svr) => MS (r md)
...
objectTests :: (OOProg r vis smt md svr) => MSBlock r
...
helloWorldClass :: (OOProg r vis smt md svr) => SClass r
