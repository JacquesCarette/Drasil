...
\label{Sec:Non-Requ}
Games are resource intensive, so performance is a high priority. Other non-functionals that are a: priority are correctness, understandability, portability, reliability, and maintainability.
