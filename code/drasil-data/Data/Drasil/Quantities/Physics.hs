...
acceleration, angularAccel, angularDisplacement, angularVelocity, chgInVelocity,
  ...
  ixDist, iyDist, xPos, xVel, yAccel, yConstAccel, yDist, yPos, yVel, momentum, moment, 
  moment2D, fOfGravity, positionVec, tension, angularFrequency, period, frequency :: UnitalChunk
