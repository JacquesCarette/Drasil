...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & the $a$ and $b$ are dimensions of the plate, where ($a\geq{}b$).
...
Notes & ${\hat{q}_{\text{tol}}}$ is defined in \hyperref[DD:tolLoad]{DD: tolLoad}.
        ...
        the $a$ and $b$ are dimensions of the plate, where ($a\geq{}b$).
...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & The glass is considered to be a single lite (from \hyperref[assumpGL]{A: glassLite}).
...
Notes & $LR$ is also called capacity.
        ...
        The glass is considered to be a single lite (from \hyperref[assumpGL]{A: glassLite}).
