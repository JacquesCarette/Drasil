...
def input_constraints(A_C, C_W, h_C, T_init, t_final, L, T_C, t_step, rho_W, D, E_W, A_C_MAX, C_W_MIN, C_W_MAX, H_C_MIN, H_C_MAX, T_FINAL_MAX, L_MIN, L_MAX, RHO_W_MIN, RHO_W_MAX, AR_MIN, AR_MAX):
    if not(A_C <= A_C_MAX):
        print("Warning: ", end="")
        ...
        print(" (A_C_max)", end="")
        print(".")
    if not(C_W_MIN < C_W and C_W < C_W_MAX):
        print("Warning: ", end="")
        ...
        print(" (C_W_max)", end="")
        print(".")
    if not(H_C_MIN <= h_C and h_C <= H_C_MAX):
        print("Warning: ", end="")
    ...
    if not(L_MIN <= L and L <= L_MAX):
        ...
        print(" (L_max)", end="")
        print(".")
    if not(RHO_W_MIN < rho_W and rho_W <= RHO_W_MAX):
        print("Warning: ", end="")
