...
traceability and consistency, by construction.  Figure~\ref{Fig_DrasilAndChange} illustrates traceability by showing that we can track where we use each
concept.  The table of symbols in our generated documentation shows an example of consistency.  The user does not enter the list of symbols; it is automatically constructed from the base knowledge.
