...
r3 = ReqChunk (nw $ ncWDS "" $ S "") [mod_inputv]
r4 = ReqChunk (nw $ ncWDS "" $ S "") [mod_outputf, mod_ctrl]
r5 = ReqChunk (nw $ ncWDS "" $ S "") [mod_outputf, mod_temp, mod_ctrl, mod_seq, mod_ode,
  mod_plot]
r6 = ReqChunk (nw $ ncWDS "" $ S "") [mod_outputf, mod_temp, mod_ctrl, mod_seq, mod_ode,
  mod_plot]
r7 = ReqChunk (nw $ ncWDS "" $ S "") [mod_outputf, mod_ener, mod_ctrl, mod_seq, mod_plot]
r8 = ReqChunk (nw $ ncWDS "" $ S "") [mod_outputf, mod_ener, mod_ctrl, mod_seq, mod_plot]
