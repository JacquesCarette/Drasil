...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & This instance model is based on our assumptions regarding rigid body A\ref{A:objectTy} A\ref{A:objectDimension} collisions A\ref{A:collisionType} Again, this does not take damping A\ref{A:dampingInvolvement} or constraints A\ref{A:constraintsAndJointsInvolvement} into account. A\ref{A:axesDefined}
\\ \midrule \\
Source & 
\\ \midrule \\
RefBy & FIXME: This needs to be filled in
