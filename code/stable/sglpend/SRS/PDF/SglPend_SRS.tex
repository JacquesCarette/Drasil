...
\\
${F_{x}}$ & Horizontal force on the pendulum & ${\text{N}}$
\\
${F_{y}}$ & Vertical force on the pendulum & ${\text{N}}$
\\
$\symbf{F}$ & Force & ${\text{N}}$
\\
$f$ & Frequency & ${\text{Hz}}$
...
\\ \midrule
Equation & \begin{displaymath}
           \resizeExpression{{F_{x}}=m\,{a_{\text{x}}}=-\symbf{T}\,\sin\left({θ_{p}}\right)}
           \end{displaymath}
\\ \midrule
Description & \begin{symbDescription}
              \item{${F_{x}}$ is the horizontal force on the pendulum (${\text{N}}$)}
              \item{$m$ is the mass (${\text{kg}}$)}
              \item{${a_{\text{x}}}$ is the $x$-component of acceleration ($\frac{\text{m}}{\text{s}^{2}}$)}
...
\\ \midrule
Equation & \begin{displaymath}
           \resizeExpression{{F_{y}}=m\,{a_{\text{y}}}=\symbf{T}\,\cos\left({θ_{p}}\right)-m\,\symbf{g}}
           \end{displaymath}
\\ \midrule
Description & \begin{symbDescription}
              \item{${F_{y}}$ is the vertical force on the pendulum (${\text{N}}$)}
              \item{$m$ is the mass (${\text{kg}}$)}
              \item{${a_{\text{y}}}$ is the $y$-component of acceleration ($\frac{\text{m}}{\text{s}^{2}}$)}
              \item{$\symbf{T}$ is the tension (${\text{N}}$)}
              \item{${θ_{p}}$ is the displacement angle of the pendulum (${\text{rad}}$)}
...
\\ \midrule
RefBy & \hyperref[GD:periodPend]{GD:periodPend}, \hyperref[GD:angFrequencyGD]{GD:angFrequencyGD}, and \hyperref[DD:periodSHMDD]{DD:periodSHMDD}
