...
\begin{description}[font=\normalfont]
\item[twoBody:\phantomsection\label{twoBody}]{The system consists of exactly two stars with masses ${m_{1}}$ and ${m_{2}}$ . Third-body gravitational perturbations are ignored. (RefBy: \hyperref[IM:accelY2]{IM:accelY2}, \hyperref[IM:accelY1]{IM:accelY1}, \hyperref[IM:accelX2]{IM:accelX2}, \hyperref[IM:accelX1]{IM:accelX1}, and \hyperref[lcDerivedOutputs]{LC:Derived-Output-Quantities}.)}
\item[isolated:\phantomsection\label{isolated}]{Non-gravitational forces (e.g., drag, thrust, radiation pressure) are neglected; the only interaction modeled is mutual Newtonian gravitation between the two stars (from \hyperref[newtonianGravity]{A:newtonianGravity}). (RefBy: \hyperref[IM:accelY2]{IM:accelY2}, \hyperref[IM:accelY1]{IM:accelY1}, \hyperref[IM:accelX2]{IM:accelX2}, \hyperref[IM:accelX1]{IM:accelX1}, and \hyperref[lcDerivedOutputs]{LC:Derived-Output-Quantities}.)}
...
\item[Maintainability:\phantomsection\label{maintainable}]{Routine updates to the software shall be manageable and predictable. When changes are made, their impact on the generated artifacts should be clear and traceable.}
