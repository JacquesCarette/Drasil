...
class TestInterp(unittest.TestCase):
    ...
    def test_lin_interp(self):
        y = interp.lin_interp(4, 8, 2, 4, 3)  # x in [x1,x2]
        self.assertEqual(y, 6)

    def test_find_bounds(self):
        idx, jdx, kdx, num_interp1, num_interp2 = interp.find_bounds(self.data1, self.data2, 18, 3.5)
        self.assertEqual(idx, 2)
        self.assertEqual(jdx, 2)
    ...
    def test_interp(self):
        ...
        self.assertEqual(interp_value, 4.3)
