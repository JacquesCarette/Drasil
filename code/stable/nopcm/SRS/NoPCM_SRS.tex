...
\item[Calculate-Change-Heat\_Energy-Water-Time:\label{Calculate-Change-Heat\_Energy-Water-Time}]Calculate and output the change in heat energy in the water (${E_{W}}$($t$)) over the simulation time (from \hyperref[IM:heatEInWtr]{Definition~IM:heatEInWtr}).
\end{itemize}
