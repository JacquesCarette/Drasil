...
\item[startOrigin:\phantomsection\label{startOrigin2x}]{The first rod is attached to the origin.}
...
\textbf{} & \textbf{\hyperref[twoDMotion]{A:twoDMotion}} & \textbf{\hyperref[cartSys]{A:cartSys}} & \textbf{\hyperref[cartSysR]{A:cartSysR}} & \textbf{\hyperref[yAxisDir]{A:yAxisDir}} & \textbf{\hyperref[startOrigin1x]{A:startOrigin}} & \textbf{\hyperref[startOrigin2x]{A:startOrigin}} & \textbf{\hyperref[firstPend]{A:firstPend}} & \textbf{\hyperref[secondPend]{A:secondPend}}
\\
...
\\
\hyperref[startOrigin2x]{A:startOrigin} &  &  &  &  &  &  &  & 
\\
