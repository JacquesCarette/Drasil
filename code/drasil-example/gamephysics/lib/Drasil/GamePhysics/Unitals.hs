...
orientCons     = constrained' QM.orientation        [sfwrc $ Bounded (Inc, exactDbl 0) (Inc, exactDbl 2 `mul` sy QM.pi_)] (half $ sy QM.pi_) -- physical constraint not needed space is radians
