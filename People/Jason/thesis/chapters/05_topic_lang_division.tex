...
\refPseudoExampleExpression{}\footnote{Notably, \refPseudoExampleExpression{}
...
% ``code'' can also be impossible without extra information, or commitment to an
% approximation formula at least (both options should not be imposed on users by
% Drasil either!).
...
% Namely, there are two main use-cases of mathematical expressions in Drasil:
