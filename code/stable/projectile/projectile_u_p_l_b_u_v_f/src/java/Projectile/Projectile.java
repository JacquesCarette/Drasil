...
public class Projectile {
    ...
    */
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        outfile = new PrintWriter(new FileWriter(new File("log.txt"), true));
        outfile.print("var 'g' assigned ");
        outfile.print(g);
        outfile.println(" in module Projectile");
        outfile.close();
        outfile = new PrintWriter(new FileWriter(new File("log.txt"), true));
        outfile.print("var 'epsilon' assigned ");
        outfile.print(epsilon);
        outfile.println(" in module Projectile");
        outfile.close();
        InputParameters inParams = new InputParameters(filename);
        float t_flight = func_t_flight(inParams, g);
        outfile = new PrintWriter(new FileWriter(new File("log.txt"), true));
        outfile.print("var 't_flight' assigned ");
        outfile.print(t_flight);
        outfile.println(" in module Projectile");
        outfile.close();
        float p_land = func_p_land(inParams, g);
        outfile = new PrintWriter(new FileWriter(new File("log.txt"), true));
    ...
    */
    public static float func_t_flight(InputParameters inParams, float g) throws IOException {
        PrintWriter outfile;
        outfile = new PrintWriter(new FileWriter(new File("log.txt"), true));
        ...
        return 2.0f * inParams.v_launch * (float)(Math.sin(inParams.theta)) / g;
    }
    ...
    */
    public static float func_p_land(InputParameters inParams, float g) throws IOException {
        PrintWriter outfile;
        outfile = new PrintWriter(new FileWriter(new File("log.txt"), true));
        ...
        return 2.0f * (float)(Math.pow(inParams.v_launch, 2.0f)) * (float)(Math.sin(inParams.theta)) * (float)(Math.cos(inParams.theta)) / g;
    }
    ...
    */
    public static String func_s(InputParameters inParams, float epsilon, float d_offset) throws IOException {
        PrintWriter outfile;
        outfile = new PrintWriter(new FileWriter(new File("log.txt"), true));
