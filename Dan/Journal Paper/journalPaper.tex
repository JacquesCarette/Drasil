...
implemented each class property using lenses. Now our knowledge can be captured 
in a variety of data structures, but we are able to project out only what is 
relevant in a given context, or related to a specific property. 
...
We discuss the recipe language in more depth in Section~\ref{S:RecipeLang}.
