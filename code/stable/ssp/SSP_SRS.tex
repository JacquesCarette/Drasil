...
\\
$C1_{i}$ & Interslice Normal Force Function: FIXME: missing discription & Nm
\\
$C2_{i}$ & Interslice Shear Force Function: FIXME: missing discription & Nm
\\
...
Units & $\frac{\text{Pa}}{\text{m}}$
\\ \midrule \\
Equation & $K_{bt,i}$ = $\frac{E_{i}}{2\left(1+\nu{}\right)}\frac{0.1}{b_{i}}+\frac{c'-\sigma{}\tan\left(\varphi{}'\right)}{|\delta{}u_{i}|+a}$
\\ \midrule \\
Description & $K_{bt,i}$ is the shear stiffness\newline$E_{i}$ is the interslice normal force\newline$\nu{}$ is the Poisson's ratio\newline$b_{i}$ is the base width of a slice\newline$c'$ is the effective cohesion\newline$\sigma{}$ is the normal stress\newline$\varphi{}'$ is the effective angle of friction\newline$\delta{}u_{i}$ is the displacement\newline$a$ is the constant
\\ \bottomrule \end{tabular}
\end{minipage}\\
~\newline
\noindent \begin{minipage}{\textwidth}
...
Units & $\frac{\text{Pa}}{\text{m}}$
\\ \midrule \\
Equation & $K_{bn,i}$ = $\begin{cases}
\frac{E_{i}\left(1-\nu{}\right)}{\left(1+\nu{}\right)\left(1-2\nu{}+b_{i}\right)}, & \nu{}<0\\
0.01\frac{E_{i}\left(1-\nu{}\right)}{\left(1+\nu{}\right)\left(1-2\nu{}+b_{i}\right)}+\frac{\kappa{}}{\delta{}v_{i}+A}, & \nu{}\geq{}0
\end{cases}$
\\ \midrule \\
Description & $K_{bn,i}$ is the normal stiffness\newline$E_{i}$ is the interslice normal force\newline$\nu{}$ is the Poisson's ratio\newline$b_{i}$ is the base width of a slice\newline$\kappa{}$ is the constant\newline$\delta{}v_{i}$ is the displacement\newline$A$ is the constant
\\ \bottomrule \end{tabular}
\end{minipage}\\
...
b_{i}f_{i}E_{i}, & i=1\\
b_{i}\left(f_{i}E_{i}+f_{i}E_{i}\right), & 2\leq{}i\leq{}n-1\\
b_{i}f_{i}E_{i}, & i=1
\end{cases}=\lambda{}=\frac{\displaystyle\sum_{i=1}^{n}{\left[C1_{i}\right]}}{\displaystyle\sum_{i=1}^{n}{\left[C2_{i}\right]}}$
\\ \midrule \\
