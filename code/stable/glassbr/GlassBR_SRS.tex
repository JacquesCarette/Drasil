...
\noindent \begin{minipage}{\textwidth}
\begin{tabular}{p{0.2\textwidth} p{0.73\textwidth}}
\toprule \textbf{Refname} & \textbf{MG:B}
\phantomsection 
\label{MG:B}
\\ \midrule \\
Label & $B$
...
\noindent \begin{minipage}{\textwidth}
\begin{tabular}{p{0.2\textwidth} p{0.73\textwidth}}
\toprule \textbf{Refname} & \textbf{MG:h}
\phantomsection 
\label{MG:h}
\\ \midrule \\
Label & $h$
...
\noindent \begin{minipage}{\textwidth}
\begin{tabular}{p{0.2\textwidth} p{0.73\textwidth}}
\toprule \textbf{Refname} & \textbf{MG:LDF}
\phantomsection 
\label{MG:LDF}
\\ \midrule \\
Label & $LDF$
...
\noindent \begin{minipage}{\textwidth}
\begin{tabular}{p{0.2\textwidth} p{0.73\textwidth}}
\toprule \textbf{Refname} & \textbf{MG:NFL}
\phantomsection 
\label{MG:NFL}
\\ \midrule \\
Label & $NFL$
...
\noindent \begin{minipage}{\textwidth}
\begin{tabular}{p{0.2\textwidth} p{0.73\textwidth}}
\toprule \textbf{Refname} & \textbf{MG:GTF}
\phantomsection 
\label{MG:GTF}
\\ \midrule \\
Label & $GTF$
...
\noindent \begin{minipage}{\textwidth}
\begin{tabular}{p{0.2\textwidth} p{0.73\textwidth}}
\toprule \textbf{Refname} & \textbf{MG:q.hat}
\phantomsection 
\label{MG:q.hat}
\\ \midrule \\
Label & $\hat{q}$
...
\noindent \begin{minipage}{\textwidth}
\begin{tabular}{p{0.2\textwidth} p{0.73\textwidth}}
\toprule \textbf{Refname} & \textbf{MG:q.hat.tol}
\phantomsection 
\label{MG:q.hat.tol}
\\ \midrule \\
Label & $\hat{q}_{tol}$
...
\noindent \begin{minipage}{\textwidth}
\begin{tabular}{p{0.2\textwidth} p{0.73\textwidth}}
\toprule \textbf{Refname} & \textbf{MG:J.tol}
\phantomsection 
\label{MG:J.tol}
\\ \midrule \\
Label & $J_{tol}$
...
\item[R6:]Output the following quantities:
          ...
          \item{Actual thickness ($h$) (\hyperref[MG:h]{Definition~MG:h})}
          \item{Load Duration Factor ($LDF$) (\hyperref[MG:LDF]{Definition~MG:LDF})}
          \item{Stress distribution factor (Function) ($J$) (\hyperref[MG:J]{Definition~MG:J})}
          \item{Non-Factored Load ($NFL$) (\hyperref[MG:NFL]{Definition~MG:NFL})}
          \item{Glass Type Factor ($GTF$) (\hyperref[MG:GTF]{Definition~MG:GTF})}
          \item{Dimensionless load ($\hat{q}$) (\hyperref[MG:q.hat]{Definition~MG:q.hat})}
          \item{Tolerable load ($\hat{q}_{tol}$) (\hyperref[MG:q.hat.tol]{Definition~MG:q.hat.tol})}
          \item{Stress distribution factor (Function) based on Pbtol ($J_{tol}$) (\hyperref[MG:J.tol]{Definition~MG:J.tol})}
...
\toprule
 & T1 (\hyperref[T:SR]{Definition~T:SR}) & T2 (\hyperref[T:SR]{Definition~T:SR}) & IM1 (\hyperref[T:PoGB]{Definition~T:PoGB}) & IM2 (\hyperref[T:CoC]{Definition~T:CoC}) & IM3 (\hyperref[T:CoD]{Definition~T:CoD}) & DD1 (\hyperref[MG:B]{Definition~MG:B}) & DD2 (\hyperref[MG:h]{Definition~MG:h}) & DD3 (\hyperref[MG:LDF]{Definition~MG:LDF}) & DD4 (\hyperref[MG:J]{Definition~MG:J}) & DD5 (\hyperref[MG:NFL]{Definition~MG:NFL}) & DD6 (\hyperref[MG:GTF]{Definition~MG:GTF}) & DD7 (\hyperref[MG:q.hat]{Definition~MG:q.hat}) & DD8 (\hyperref[MG:q.hat.tol]{Definition~MG:q.hat.tol}) & DD9 (\hyperref[MG:J.tol]{Definition~MG:J.tol})
\\
\midrule
...
\\
DD1 (\hyperref[MG:B]{Definition~MG:B}) &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
DD2 (\hyperref[MG:h]{Definition~MG:h}) &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
DD3 (\hyperref[MG:LDF]{Definition~MG:LDF}) &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
DD4 (\hyperref[MG:J]{Definition~MG:J}) &  &  &  &  &  &  &  &  &  &  &  & X &  & 
\\
DD5 (\hyperref[MG:NFL]{Definition~MG:NFL}) &  &  &  &  &  &  & X &  &  &  &  &  & X & 
\\
DD6 (\hyperref[MG:GTF]{Definition~MG:GTF}) &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
DD7 (\hyperref[MG:q.hat]{Definition~MG:q.hat}) &  &  &  &  & X &  & X &  &  &  & X &  &  & 
\\
DD8 (\hyperref[MG:q.hat.tol]{Definition~MG:q.hat.tol}) &  &  &  &  &  &  &  &  &  &  &  &  &  & X
\\
DD9 (\hyperref[MG:J.tol]{Definition~MG:J.tol}) &  &  &  &  &  &  & X & X &  &  &  &  &  & 
\\
\bottomrule
...
\toprule
 & T1 (\hyperref[T:SR]{Definition~T:SR}) & T2 (\hyperref[T:SR]{Definition~T:SR}) & IM1 (\hyperref[T:PoGB]{Definition~T:PoGB}) & IM2 (\hyperref[T:CoC]{Definition~T:CoC}) & IM3 (\hyperref[T:CoD]{Definition~T:CoD}) & DD1 (\hyperref[MG:B]{Definition~MG:B}) & DD2 (\hyperref[MG:h]{Definition~MG:h}) & DD3 (\hyperref[MG:LDF]{Definition~MG:LDF}) & DD4 (\hyperref[MG:J]{Definition~MG:J}) & DD5 (\hyperref[MG:NFL]{Definition~MG:NFL}) & DD6 (\hyperref[MG:GTF]{Definition~MG:GTF}) & DD7 (\hyperref[MG:q.hat]{Definition~MG:q.hat}) & DD8 (\hyperref[MG:q.hat.tol]{Definition~MG:q.hat.tol}) & DD9 (\hyperref[MG:J.tol]{Definition~MG:J.tol}) & Data Constraints (Section~\ref{Sec:DC}) & R1 (in Section~\ref{Sec:FRs}) & R2 (in Section~\ref{Sec:FRs})
\\
\midrule
...
DD2 (\hyperref[MG:h]{Definition~MG:h}) &  &  &  &  &  &  &  & 
\\
DD3 (\hyperref[MG:LDF]{Definition~MG:LDF}) &  &  &  & X &  &  &  & X
\\
DD4 (\hyperref[MG:J]{Definition~MG:J}) &  &  &  &  &  &  &  & 
\\
DD5 (\hyperref[MG:NFL]{Definition~MG:NFL}) &  &  &  & X &  &  &  & 
\\
DD6 (\hyperref[MG:GTF]{Definition~MG:GTF}) &  &  &  &  &  &  &  & 
\\
DD7 (\hyperref[MG:q.hat]{Definition~MG:q.hat}) &  &  &  &  & X &  &  & 
\\
DD8 (\hyperref[MG:q.hat.tol]{Definition~MG:q.hat.tol}) &  &  &  &  &  &  &  & 
\\
DD9 (\hyperref[MG:J.tol]{Definition~MG:J.tol}) &  &  &  & X &  &  &  & 
\\
