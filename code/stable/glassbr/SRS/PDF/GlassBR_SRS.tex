...
\\
${J_{\text{tol}}}$ & Stress distribution factor (Function) & --
\\
...
Description & \begin{symbDescription}
              ...
              \item{$\mathit{interpY}$ is the interpY (Unitless)}
              \item{$\mathit{AR}$ is the aspect ratio (Unitless)}
              \item{${J_{\text{tol}}}$ is the stress distribution factor (Function) (Unitless)}
              \end{symbDescription}
\\ \midrule
...
\\
${J_{\text{tol}}}$ & Stress distribution factor (Function) & \hyperref[IM:sdfTol]{IM:sdfTol} & --
\\
