...
ldfConstant: With reference to [A:standardValues](./SecAssumps.md#assumpSV), the Load Duration Factor (LDF) is constant. (RefBy: [LC:Variable-Values-of-m,k,E](./SecLCs.md#varValsOfmkE) and [DD:loadDurFactor](./SecDDs.md#DD:loadDurFactor).)
