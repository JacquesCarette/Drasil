...
\\
${E_{\text{P}}}$ & Change in heat energy in the PCM & \hyperref[IM:heatEInPCM]{IM:heatEInPCM} & ${\text{J}}$
\\
${E_{\text{W}}}$ & Change in heat energy in the water & \hyperref[IM:heatEInWtr]{IM:heatEInWtr} & ${\text{J}}$
\\
${T_{\text{P}}}$ & Temperature of the phase change material & \hyperref[IM:eBalanceOnPCM]{IM:eBalanceOnPCM} & ${{}^{\circ}\text{C}}$
\\
