...
The following section provides an overview of the software requirements specification (SRS) for the Solar Water Heating System With No Phase Change Material (SWHSNoPCM) program. The  program is based on the original, manually created version of [SWHSNoPCM](https://github.com/smiths/caseStudies/blob/master/CaseStudies/noPCM). This section explains the purpose of this document, the scope of the requirements, the characteristics of the intended reader, and the organization of the document.
