...
\lstdefinelanguage{haskell1}{
	...
	UnitalChunk, CI, CodeExpr, Expr, Special, LinkType},
	keywordstyle=[2]\color{McMasterWorldBlue},
	keywords=[3]{equationsSent, lbldExpr, unlbldExpr, lo, makeEquation, toEqn, 
	layLabelled, layUnlabelled, makeMetadata, DocDesc, printLO, makeTable, 
	makeRows, makeHeaderCols, makeColumns, markdownCell, mkLsnDesc, mkNb, 
	section, mkIntro, mkLearnObj, mkReview, mkCaseProb, mkExample, mkSmmry, 
	mkBib, mkAppndx, mkSections, mkNB, unlbldCode, codeCell, rectVel},
	keywordstyle=[3]\color{McMasterHeritageMaroon},
	keywords=[4]{T, QP, P, J, NB, Lsn, CP, TeX},
