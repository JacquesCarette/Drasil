...
meant to give a generic (non-system-specific) overview, some is specific to the 
...
unimpressive, but it is a necessary step before we can move on to other \sfs{}. 
...
there's the same info moving from SRS -> MG -> MIS -> Code without stating it 
explicitly which we can do in the pattern section.}
...
\ds{This section may need to swap with the breakdown section for better flow. 
This feels like a good place for a soft-intro to some of the things I could've 
covered to help the previous section, or maybe it should get wrapped into the 
\sfs{} section in the BG}
