...
\\
$f$ & Scaling Function: magnitude of interslice forces as a function of the x coordinatefor interslice index i; can be constant or a half-sine & Unitless
\\
$FS$ & Factor of Safety: The global stability of a surface in a slope & Unitless
\\
${FS_{Loc,i}}$ & Local Factor of Safety: for slice index i & Unitless
\\
...
\\
$i$ & Index: used to show a quantity applies to only one slice & Unitless
\\
...
\\
$u$ & Local Index: used as a bound variable index in calculations & Unitless
\\
$v$ & Local Index: used as a bound variable index in calculations & Unitless
\\
...
\\
$\lambda{}$ & Interslice Normal/shear Force Ratio: applied to all interslices & Unitless
\\
$\mu{}$ & Pore Pressure: from water within the soil & Pa
\\
$\nu{}$ & Poisson's Ratio: The ratio of perpendicular strain to parellel strain. & Unitless
\\
...
\\
$\Upsilon{}$ & Function: generic minimization function or algorithm & Unitless
\\
...
b_{i}\left(\left(E_{i}+E_{i-1}\right)+\left(H_{i}+H_{i-1}\right)\right)\tan\left(\alpha{}_{i}\right)+h\left({K_{c}}W_{i}-2{U_{t,i}}\sin\left(\beta{}_{i}\right)-2Q_{i}\cos\left(\omega{}_{i}\right)\right), & 2\leq{}i\leq{}n-1\\
...
\begin{dmath}
\lambda{}_{i}=\frac{\displaystyle\sum_{i=1}^{n}{\left[b_{i}\left(\left(E_{i}+E_{i-1}\right)+\left(H_{i}+H_{i-1}\right)\right)\tan\left(\alpha{}_{i}\right)+h_{i}\left({K_{c}}W_{i}-2{U_{t,i}}\sin\left(\beta{}_{i}\right)-2Q_{i}\sin\left(\omega{}_{i}\right)\right)\right]}}{\displaystyle\sum_{i=1}^{n}{\left[b_{i}\left(E_{i}f_{i}+E_{i-1}f_{i-1}\right)\right]}}
\end{dmath}
...
\\ \midrule \\
Equation & ${FS_{Loc,i,i}}=\frac{{c'}_{i}-{K_{bn,i}}{\delta{}v}_{i}\tan\left({\varphi{}'}_{i}\right)}{{K_{bt,i}}{\delta{}u}_{i}}=\frac{\displaystyle\sum_{i=1}^{n}{\left[{\ell{}_{b,i}}\left({c'}_{i}-{K_{bn,i}}{\delta{}v}_{i}\tan\left({\varphi{}'}_{i}\right)\right)\right]}}{\displaystyle\sum_{i=1}^{n}{\left[{\ell{}_{b,i}}\left({K_{bt,i}}{\delta{}u}_{i}\right)\right]}}$
\\ \midrule \\
...
\begin{dmath}
FS=\frac{\displaystyle\sum_{i=1}^{n}{\left[{\ell{}_{b,i}}s_{i}\right]}}{\displaystyle\sum_{i=1}^{n}{\left[{\ell{}_{b,i}}\tau{}_{i}\right]}}=\frac{\displaystyle\sum_{i=1}^{n}{\left[{\ell{}_{b,i}}\left({c'}_{i}-{K_{bn,i}}{\delta{}v}_{i}\tan\left({\varphi{}'}_{i}\right)\right)\right]}}{\displaystyle\sum_{i=1}^{n}{\left[{\ell{}_{b,i}}\left({K_{bt,i}}{\delta{}u}_{i}\right)\right]}}
\end{dmath}
~\newline
\noindent \begin{minipage}{\textwidth}
\begin{tabular}{p{0.2\textwidth} p{0.73\textwidth}}
...
@article{Qian_Zhu_Lee_Chen_2005,
...
year={2005},
place={Paris, France},
note={In J. Ralyt\'{e}, P. Agerfalk, and N. Kraiem, editors, Proceedings of the First International Workshopon Situational Requirements Engineering Processes - Methods, Techniques and Tools to Support Situation-Specific Requirements Engineering Processes. In conjunction with 13th IEEE International Requirements Engineering Conference.}}

@article{Stolle_Guo_2008,
...
@article{Yu-Chao_Yun-Min_Zhan_Sao-Sheng_Cleall_2010,
