...
Equation & \begin{displaymath}
           \resizeExpression{\symbf{v}\text{(}t\text{)}=\begin{bmatrix}
                                                        {{v_{\text{y}}}^{\text{i}}}+{{a_{\text{y}}}^{\text{c}}}\,t & {{v_{\text{x}}}^{\text{i}}}+{{a_{\text{x}}}^{\text{c}}}\,t
                                                        \end{bmatrix}}
           \end{displaymath}
\\ \midrule
Description & \begin{symbDescription}
...
Equation & \begin{displaymath}
           \resizeExpression{\symbf{p}\text{(}t\text{)}=\begin{bmatrix}
                                                        {{p_{\text{y}}}^{\text{i}}}+{{v_{\text{y}}}^{\text{i}}}\,t+\frac{{{a_{\text{y}}}^{\text{c}}}\,t^{2}}{2} & {{p_{\text{x}}}^{\text{i}}}+{{v_{\text{x}}}^{\text{i}}}\,t+\frac{{{a_{\text{x}}}^{\text{c}}}\,t^{2}}{2}
                                                        \end{bmatrix}}
           \end{displaymath}
\\ \midrule
Description & \begin{symbDescription}
