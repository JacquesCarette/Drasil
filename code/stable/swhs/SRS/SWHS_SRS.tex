...
\\ \midrule \\
Source & \href{http://www.efunda.com/formulae/heat_transfer/conduction/overview_cond.cfm}{heatConduction}
\\ \midrule \\
...
\\ \midrule \\
Source & \href{http://en.wikipedia.org/wiki/Sensible_heat}{sensibleHeat}
\\ \midrule \\
RefBy & FIXME: This needs to be filled in
\\ \bottomrule \end{tabular}
\end{minipage}\\
...
\\ \midrule \\
Source & \href{http://en.wikipedia.org/wiki/Latent_heat}{latentHeat}
\\ \midrule \\
RefBy & FIXME: This needs to be filled in
\\ \bottomrule \end{tabular}
\end{minipage}\\
