...
"Input Format Module (M\ref{MmodInputFormat})" -> "Input Parameters Module (M\ref{MmodInputParam})";
"Input Format Module (M\ref{MmodInputFormat})" -> "Sequence Data Structure Module (M\ref{Mmodseqserv})";
"Input Parameters Module (M\ref{MmodInputParam})" -> "Sequence Data Structure Module (M\ref{Mmodseqserv})";
"Input Verification Module (M\ref{MmodInputVerif})" -> "Input Parameters Module (M\ref{MmodInputParam})";
...
"Output Format Module (M\ref{Mmodoutputfdesc})" -> "Input Parameters Module (M\ref{MmodInputParam})";
"Output Format Module (M\ref{Mmodoutputfdesc})" -> "Sequence Data Structure Module (M\ref{Mmodseqserv})";
"Output Verification Module (M\ref{Mmodoutputvdesc})" -> "Input Parameters Module (M\ref{MmodInputParam})";
"Output Verification Module (M\ref{Mmodoutputvdesc})" -> "Sequence Data Structure Module (M\ref{Mmodseqserv})";
"Temperature ODEs Module (M\ref{Mmodtempdesc})" -> "Input Parameters Module (M\ref{MmodInputParam})";
"Temperature ODEs Module (M\ref{Mmodtempdesc})" -> "Sequence Data Structure Module (M\ref{Mmodseqserv})";
"Energy Equations Module (M\ref{Mmodenerdesc})" -> "Input Parameters Module (M\ref{MmodInputParam})";
"Energy Equations Module (M\ref{Mmodenerdesc})" -> "Sequence Data Structure Module (M\ref{Mmodseqserv})";
"Control Module (M\ref{MmodControl})" -> "Hardware Hiding Module (M\ref{MhwHiding})";
"Control Module (M\ref{MmodControl})" -> "Input Parameters Module (M\ref{MmodInputParam})";
