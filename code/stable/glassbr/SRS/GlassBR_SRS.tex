...
\label{Sec:FRs}
\begin{description}
\item[\refstepcounter{reqnum}\rthereqnum\label{FR:Input-Glass-Props}:]Input the quantities from Table~\ref{Table:InputGlassPropsReqInputs}, which define the glass dimensions, type of glass, tolerable probability of failure, and the characteristics of the blast. Note: $a$ and $b$ will be input in terms of millimetres and will be converted to the equivalent value in metres.
\end{description}
\begin{itemize}
\item[System-Set-Values-Following-Assumptions:\phantomsection\label{FR:System-Set-Values-Following-Assumptions}]The system shall set the known values as follows:
                                                                                                                \begin{itemize}
...
\end{description}
\begin{description}
\item[\refstepcounter{reqnum}\rthereqnum\label{FR:Output-Values-and-Known-Quantities}:]Output the input quantities from R\ref{FR:Input-Glass-Props} and the known quantities from List~\ref{FR:System-Set-Values-Following-Assumptions}.
\end{description}
\begin{description}
...
\end{description}
\begin{itemize}
\item[Output-Quantities:\phantomsection\label{FR:Output-Quantities}]Output the following quantities:
                                                                    \begin{itemize}
...
\\
\bottomrule
\caption{Required Inputs following R\ref{FR:Input-Glass-Props}}
...
\\
R6 (in List~\ref{FR:Output-Quantities}) &  &  & X & X & X &  & X & X & X & X & X & X & X &  &  &  &  &  &  & 
\\
\bottomrule
...
\\
R2 (List~\ref{FR:System-Set-Values-Following-Assumptions}) &  &  &  & X & X &  &  & X
\\
