...
Modifying $h_g$ or $h_c$ to reflect changes in requirements is not a simple
matter. It involves the following steps (at the very least):
\begin{itemize}
