...
\item[standardValues:\phantomsection\label{assumpSV}]{The values provided in \hyperref[Sec:AuxConstants]{Sec:Values of Auxiliary Constants} are assumed for the duration of load (${t_{\text{d}}}$), and the material properties of $m$, $k$, and $E$. (RefBy: \hyperref[IM:sdfTol]{IM:sdfTol}, \hyperref[IM:nFL]{IM:nFL}, \hyperref[IM:dimlessLoad]{IM:dimlessLoad}, \hyperref[varValsOfmkE]{LC:Variable-Values-of-m,k,E}, \hyperref[sysSetValsFollowingAssumps]{FR:System-Set-Values-Following-Assumptions}, \hyperref[DD:loadDurFactor]{DD:loadDurFactor}, and \hyperref[assumpLDFC]{A:ldfConstant}.)}
\item[glassLite:\phantomsection\label{assumpGL}]{Glass under consideration is assumed to be a single lite; hence, the value of LSF is equal to 1 for all calculations in GlassBR. (RefBy: \hyperref[sysSetValsFollowingAssumps]{FR:System-Set-Values-Following-Assumptions} and \hyperref[accMoreThanSingleLite]{LC:Accomodate-More-than-Single-Lite}.)}
...
\\ \midrule
RefBy & \hyperref[IM:sdfTol]{IM:sdfTol}, \hyperref[IM:riskFun]{IM:riskFun}, \hyperref[IM:nFL]{IM:nFL}, \hyperref[IM:dimlessLoad]{IM:dimlessLoad}, and \hyperref[sysSetValsFollowingAssumps]{FR:System-Set-Values-Following-Assumptions}
...
\\ \midrule
RefBy & \hyperref[IM:sdfTol]{IM:sdfTol}, \hyperref[IM:riskFun]{IM:riskFun}, and \hyperref[sysSetValsFollowingAssumps]{FR:System-Set-Values-Following-Assumptions}
...
\\ \midrule
RefBy & \hyperref[IM:calofCapacity]{IM:calofCapacity}, \hyperref[IM:dimlessLoad]{IM:dimlessLoad}, and \hyperref[sysSetValsFollowingAssumps]{FR:System-Set-Values-Following-Assumptions}
...
\\ \midrule
RefBy & \hyperref[sysSetValsFollowingAssumps]{FR:System-Set-Values-Following-Assumptions} and \hyperref[DD:calofDemand]{DD:calofDemand}
...
\\ \midrule
RefBy & \hyperref[IM:tolLoad]{IM:tolLoad}, \hyperref[IM:stressDistFac]{IM:stressDistFac}, and \hyperref[sysSetValsFollowingAssumps]{FR:System-Set-Values-Following-Assumptions}
...
\\ \midrule
RefBy & \hyperref[IM:probOfBreak]{IM:probOfBreak} and \hyperref[outputValues]{FR:Output-Values}
...
\\ \midrule
RefBy & \hyperref[IM:riskFun]{IM:riskFun} and \hyperref[outputValues]{FR:Output-Values}
...
\\ \midrule
RefBy & \hyperref[IM:calofCapacity]{IM:calofCapacity} and \hyperref[outputValues]{FR:Output-Values}
...
\\ \midrule
RefBy & \hyperref[IM:stressDistFac]{IM:stressDistFac} and \hyperref[outputValues]{FR:Output-Values}
...
\\ \midrule
RefBy & \hyperref[IM:nFL]{IM:nFL} and \hyperref[outputValues]{FR:Output-Values}
...
\\ \midrule
RefBy & \hyperref[IM:tolLoad]{IM:tolLoad} and \hyperref[outputValues]{FR:Output-Values}
...
\\ \midrule
RefBy & \hyperref[IM:isSafeLR]{IM:isSafeLR}, \hyperref[outputValues]{FR:Output-Values}, and \hyperref[checkGlassSafety]{FR:Check-Glass-Safety}
...
\\ \midrule
RefBy & \hyperref[IM:isSafePb]{IM:isSafePb}, \hyperref[outputValues]{FR:Output-Values}, and \hyperref[checkGlassSafety]{FR:Check-Glass-Safety}
...
\\
\hyperref[sysSetValsFollowingAssumps]{FR:System-Set-Values-Following-Assumptions} &  &  &  & X & X &  &  & 
\\
...
\hyperref[inputValues]{FR:Input-Values} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[sysSetValsFollowingAssumps]{FR:System-Set-Values-Following-Assumptions} & X & X & X & X & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[checkInputWithDataCons]{FR:Check-Input-with-Data\_Constraints} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
...
\\
\hyperref[outputValues]{FR:Output-Values} &  &  &  &  &  &  &  &  &  & X & X & X & X & X & X &  &  & X & X &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[correct]{NFR:Correct} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[verifiable]{NFR:Verifiable} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
