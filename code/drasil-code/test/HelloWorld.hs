...
helloInitVariables = block [comment "Initializing variables",
  ...
  arrayElem (var "arr2" (arrayType int)) (litInt 0) &= litInt 4,
  arrayElem (var "arr2" (arrayType int)) (litInt 1) &= litInt 5,
  arrayElem (var "arr2" (arrayType int)) (litInt 2) &= litInt 6,
  ...
  arrayElem (var "arr" (arrayType int)) (litInt 1) &= litInt 42,
