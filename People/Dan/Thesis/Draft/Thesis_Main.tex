...
\usepackage[T1]{fontenc} % Supports names containing characters such as a-ogonek
...
\usepackage[authoryear,round]{natbib} % Author-year citations and bibliography formatting
...
\usepackage[colorlinks=true]{hyperref} % Linking to LaTeX labels and external 
%URLs
\usepackage{lastpage} % Robust reference to the final shipped page
...
\definecolor{annotblue}{RGB}{44,103,176}
\definecolor{annotorange}{RGB}{217,95,2}
\definecolor{annotgreen}{RGB}{27,158,119}
\definecolor{annotred}{RGB}{204,0,0}
\definecolor{citationgreen}{RGB}{20,85,20}
\hypersetup{citecolor=citationgreen}

\tikzset{
  boiler/.style={draw=annotblue, line width=1.2pt},
  system/.style={draw=annotorange, line width=1.2pt},
  domainbox/.style={draw=annotgreen, dashed, line width=1.2pt},
  annotlabel/.style={fill=white, draw=black, font=\scriptsize\bfseries, inner sep=1.5pt},
  callnum/.style={circle, draw=annotred, fill=white, font=\scriptsize\bfseries, inner sep=1pt, line width=1pt}
}

\newcommand{\takeawayicon}{%
    \tikz[baseline=0.0ex,x=1.1pt,y=1.1pt]{%
        \draw[annotblue,line width=1pt,rounded corners=1pt]
            (1,6) -- (3,8) -- (7,8) -- (9,6) -- (7.8,0) -- (2.2,0) -- cycle;
        \draw[annotblue,line width=1pt] (1,6) -- (9,6);
        \draw[annotblue,line width=1pt]
            (2,7.2) .. controls (2,11) and (8,11) .. (8,7.2);
    }%
}
...
\newcommand{\takeaway}[1]{%
    ...
    \fcolorbox{annotblue}{annotblue!7}{%
        \begin{minipage}{0.88\linewidth}
        {\color{annotblue}\large\bfseries
        \takeawayicon\hspace{0.55em}Takeaway}\par\smallskip
        #1
        \end{minipage}%
    }
    \end{center}
...
\fancypagestyle{embeddedappendix}{
  \fancyhf{}
  \rfoot{\thepage}
