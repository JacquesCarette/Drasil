...
\\[v\_{\text{x}}=\frac{\\,dL\_{\text{rod}}\\,\sin\left(θ\_{p}\right)}{\\,dt}\\]
...
\\[v\_{\text{y}}=-\left(\frac{\\,dL\_{\text{rod}}\\,\cos\left(θ\_{p}\right)}{\\,dt}\right)\\]
...
\\[a\_{\text{x}}=\frac{\\,dω}{\\,dt}\\,L\_{\text{rod}}\\,\cos\left(θ\_{p}\right)-ω\\,L\_{\text{rod}}\\,\sin\left(θ\_{p}\right)\\,\frac{\\,dθ\_{p}}{\\,dt}\\]
...
\\[a\_{\text{y}}=\frac{\\,dω}{\\,dt}\\,L\_{\text{rod}}\\,\sin\left(θ\_{p}\right)+ω\\,L\_{\text{rod}}\\,\cos\left(θ\_{p}\right)\\,\frac{\\,dθ\_{p}}{\\,dt}\\]
...
\\[\boldsymbol{I}\\,\frac{\\,d\frac{\\,dθ\_{p}}{\\,dt}}{\\,dt}=-L\_{\text{rod}}\\,m\\,\boldsymbol{g}\\,\sin\left(θ\_{p}\right)\\]

Substituting for \\(\boldsymbol{I}\\)

\\[m\\,L\_{\text{rod}}^{2}\\,\frac{\\,d\frac{\\,dθ\_{p}}{\\,dt}}{\\,dt}=-L\_{\text{rod}}\\,m\\,\boldsymbol{g}\\,\sin\left(θ\_{p}\right)\\]

Crossing out \\(m\\) and \\(L\_{\text{rod}}\\) we have

\\[\frac{\\,d\frac{\\,dθ\_{p}}{\\,dt}}{\\,dt}=-\left(\frac{\boldsymbol{g}}{L\_{\text{rod}}}\right)\\,\sin\left(θ\_{p}\right)\\]

For small angles, we approximate sin \\(θ\_{p}\\) to \\(θ\_{p}\\)

\\[\frac{\\,d\frac{\\,dθ\_{p}}{\\,dt}}{\\,dt}=-\left(\frac{\boldsymbol{g}}{L\_{\text{rod}}}\right)\\,θ\_{p}\\]
