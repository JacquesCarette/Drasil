...
\begin{displaymath}
\resizeExpression{v_{\text{x}}=\frac{\,dL_{\text{rod}}\,\sin\left(θ_{p}\right)}{\,dt}}
\end{displaymath}
...
\begin{displaymath}
\resizeExpression{v_{\text{y}}=-\left(\frac{\,dL_{\text{rod}}\,\cos\left(θ_{p}\right)}{\,dt}\right)}
\end{displaymath}
$L_{\text{rod}}$ is constant with respect to time, so
...
\begin{displaymath}
\resizeExpression{a_{\text{x}}=\frac{\,dω}{\,dt}\,L_{\text{rod}}\,\cos\left(θ_{p}\right)-ω\,L_{\text{rod}}\,\sin\left(θ_{p}\right)\,\frac{\,dθ_{p}}{\,dt}}
\end{displaymath}
Simplifying,
...
\begin{displaymath}
\resizeExpression{a_{\text{y}}=\frac{\,dω}{\,dt}\,L_{\text{rod}}\,\sin\left(θ_{p}\right)+ω\,L_{\text{rod}}\,\cos\left(θ_{p}\right)\,\frac{\,dθ_{p}}{\,dt}}
\end{displaymath}
Simplifying,
...
\begin{displaymath}
\resizeExpression{\symbf{I}\,\frac{\,d\frac{\,dθ_{p}}{\,dt}}{\,dt}=-L_{\text{rod}}\,m\,\symbf{g}\,\sin\left(θ_{p}\right)}
\end{displaymath}
Substituting for $\symbf{I}$

\begin{displaymath}
\resizeExpression{m\,L_{\text{rod}}^{2}\,\frac{\,d\frac{\,dθ_{p}}{\,dt}}{\,dt}=-L_{\text{rod}}\,m\,\symbf{g}\,\sin\left(θ_{p}\right)}
\end{displaymath}
Crossing out $m$ and $L_{\text{rod}}$ we have

\begin{displaymath}
\resizeExpression{\frac{\,d\frac{\,dθ_{p}}{\,dt}}{\,dt}=-\left(\frac{\symbf{g}}{L_{\text{rod}}}\right)\,\sin\left(θ_{p}\right)}
\end{displaymath}
For small angles, we approximate sin $θ_{p}$ to $θ_{p}$

\begin{displaymath}
\resizeExpression{\frac{\,d\frac{\,dθ_{p}}{\,dt}}{\,dt}=-\left(\frac{\symbf{g}}{L_{\text{rod}}}\right)\,θ_{p}}
\end{displaymath}
...
\\ \midrule
Equation & \begin{displaymath}
           \resizeExpression{p^{\text{i}}_{\text{x}}=L_{\text{rod}}\,\sin\left(θ_{i}\right)}
           \end{displaymath}
\\ \midrule
Description & \begin{symbDescription}
              \item{$p^{\text{i}}_{\text{x}}$ is the $x$-component of initial position (${\text{m}}$)}
              \item{$L_{\text{rod}}$ is the length of the rod (${\text{m}}$)}
              \item{$θ_{i}$ is the initial pendulum angle (${\text{rad}}$)}
              \end{symbDescription}
\\ \midrule
Notes & $p^{\text{i}}_{\text{x}}$ is the horizontal position
        
        $p^{\text{i}}_{\text{x}}$ is shown in \hyperref[Figure:sglpend]{Fig:sglpend}.
...
\\ \midrule
Equation & \begin{displaymath}
           \resizeExpression{p^{\text{i}}_{\text{y}}=-L_{\text{rod}}\,\cos\left(θ_{i}\right)}
           \end{displaymath}
\\ \midrule
Description & \begin{symbDescription}
              \item{$p^{\text{i}}_{\text{y}}$ is the $y$-component of initial position (${\text{m}}$)}
              \item{$L_{\text{rod}}$ is the length of the rod (${\text{m}}$)}
              \item{$θ_{i}$ is the initial pendulum angle (${\text{rad}}$)}
              \end{symbDescription}
\\ \midrule
Notes & $p^{\text{i}}_{\text{y}}$ is the vertical position
        
        $p^{\text{i}}_{\text{y}}$ is shown in \hyperref[Figure:sglpend]{Fig:sglpend}.
...
\begin{displaymath}
\resizeExpression{-m\,\symbf{g}\,\sin\left(θ_{p}\right)\,L_{\text{rod}}=m\,L_{\text{rod}}^{2}\,\frac{\,d\frac{\,dθ_{p}}{\,dt}}{\,dt}}
\end{displaymath}
And rearranged as:

\begin{displaymath}
\resizeExpression{\frac{\,d\frac{\,dθ_{p}}{\,dt}}{\,dt}+\frac{\symbf{g}}{L_{\text{rod}}}\,\sin\left(θ_{p}\right)=0}
\end{displaymath}
...
\begin{displaymath}
\resizeExpression{\frac{\,d\frac{\,dθ_{p}}{\,dt}}{\,dt}+\frac{\symbf{g}}{L_{\text{rod}}}\,θ_{p}=0}
\end{displaymath}
...
\begin{figure}[H]
\begin{center}
\includesvg[width=\textwidth, inkscapelatex = false]{../../../../traceygraphs/sglpend/avsa}
...
\begin{figure}[H]
\begin{center}
\includesvg[width=\textwidth, inkscapelatex = false]{../../../../traceygraphs/sglpend/avsall}
...
\begin{figure}[H]
\begin{center}
\includesvg[width=\textwidth, inkscapelatex = false]{../../../../traceygraphs/sglpend/refvsref}
...
\begin{figure}[H]
\begin{center}
\includesvg[width=\textwidth, inkscapelatex = false]{../../../../traceygraphs/sglpend/allvsr}
...
\begin{figure}[H]
\begin{center}
\includesvg[width=\textwidth, inkscapelatex = false]{../../../../traceygraphs/sglpend/allvsall}
...
\begin{itemize}
\item{\hyperref{../../../../traceygraphs/sglpend/avsa.svg}{}{}{TraceGraphAvsA}}
\item{\hyperref{../../../../traceygraphs/sglpend/avsall.svg}{}{}{TraceGraphAvsAll}}
\item{\hyperref{../../../../traceygraphs/sglpend/refvsref.svg}{}{}{TraceGraphRefvsRef}}
\item{\hyperref{../../../../traceygraphs/sglpend/allvsr.svg}{}{}{TraceGraphAllvsR}}
\item{\hyperref{../../../../traceygraphs/sglpend/allvsall.svg}{}{}{TraceGraphAllvsAll}}
\end{itemize}
