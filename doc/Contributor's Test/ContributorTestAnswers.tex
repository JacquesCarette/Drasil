...
\end{enumerate}
Explain your answer here.
\answer{Sample Answer: it is important to stage \textbf{all} changed files (stable and code) using multiple \lstinline{git add} before doing a single commit to avoid Travis build errors}{0cm}{1.5cm}
