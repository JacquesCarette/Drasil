...
the SRS and in every downstream artifact derived from that chunk,
...
issue types reinforced that centralized knowledge capture makes such problems 
easier to detect, localize, and correct.
