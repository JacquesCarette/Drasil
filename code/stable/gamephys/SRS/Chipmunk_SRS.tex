...
\noindent \begin{minipage}{\textwidth}
\begin{tabular}{p{0.2\textwidth} p{0.73\textwidth}}
\toprule \textbf{Refname} & \textbf{IM:im1}
\phantomsection 
\label{IM:im1}
\\ \midrule \\
...
\noindent \begin{minipage}{\textwidth}
\begin{tabular}{p{0.2\textwidth} p{0.73\textwidth}}
\toprule \textbf{Refname} & \textbf{IM:im2}
\phantomsection 
\label{IM:im2}
\\ \midrule \\
...
Description & \begin{description}
               ...
               \item{$t$ is the time (s)}
               \item{$ω$ is the angular velocity ($\frac{\text{rad}}{\text{s}}$)}
               \item{${τ_{i}}$ is the is the torque applied to the i-th body (Nm)}
               \item{$\mathbf{I}$ is the moment of inertia (kg$\text{m}^{2}$)}
               \end{description}
\\ \midrule \\
Source &
...
\noindent \begin{minipage}{\textwidth}
\begin{tabular}{p{0.2\textwidth} p{0.73\textwidth}}
\toprule \textbf{Refname} & \textbf{IM:im3}
\phantomsection 
\label{IM:im3}
\\ \midrule \\
...
\\ \midrule \\
Description & \begin{description}
              \item{${\mathbf{p}_{CM}}$ is the the mass-weighted average position of a rigid body's particles (m)}
              \item{${m_{j}}$ is the mass of the j-th particle (kg)}
