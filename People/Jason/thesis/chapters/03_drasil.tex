...
purposes of this work). In Haskell, \Chunk{}s are any data that one may
register in the \ChunkDB{}:
...
\intodo{Code snippet: ``main'' function of one of the case studies.}

\todo{Ref. ``main'' function code snippet} displays an example, from the
...
for the desired outputs, and performs an \inlineHs{IO ()} effect that dumps an
\acs{srs} and a software artifact to the host computer, in the local working
directory. \todo{continue here}
