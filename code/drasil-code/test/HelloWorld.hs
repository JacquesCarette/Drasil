...
helloWorldOO :: (OOProg r vis smt md svr att) => OO.GSProgram r
...
helloWorldMainOO :: (OOProg r vis smt md svr att) => MS (r md)
...
objectTests :: (OOProg r vis smt md svr att) => MSBlock r
...
helloWorldClass :: (OOProg r vis smt md svr att) => SClass r
