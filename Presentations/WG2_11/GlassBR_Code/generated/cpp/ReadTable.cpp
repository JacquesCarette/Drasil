...
vector<double> GlassBR_program::read_z_array(string filename) {
    ifstream infile;
...
vector< vector<double> > GlassBR_program::read_x_array(string filename) {
    ifstream infile;
    infile.open(filename, std::fstream::in);
...
vector< vector<double> > GlassBR_program::read_y_array(string filename) {
    ifstream infile;
    infile.open(filename, std::fstream::in);
    vector<string> lines(0);
    string nextLine;
