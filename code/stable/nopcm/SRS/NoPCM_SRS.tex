...
$L$ & Length of tank & m
\\
${L_{\text{max}}}$ & Maximum length of tank & m
\\
${L_{\text{min}}}$ & Minimum length of tank & m
\\
$m$ & Mass & kg
\\
...
\item[Predict-Water-Energy (GS2):\phantomsection\label{waterEnergyGS}]{Predict the change in heat energy in the water over time.}
\end{itemize}
...
\item[Constant-Water-Temp-Across-Tank (A3):\phantomsection\label{assumpCWTAT}]{The water in the tank is fully mixed, so the temperature of the water is the same throughout the entire tank. (RefBy: \hyperref[GD:rocTempSimp]{GD: rocTempSimp}.)}
\item[Density-Water-Constant-over-Volume (A4):\phantomsection\label{assumpDWCoW}]{The density of water has no spatial variation; that is, it is constant over their entire volume. (RefBy: \hyperref[GD:rocTempSimp]{GD: rocTempSimp}.)}
\item[Specific-Heat-Energy-Constant-over-Volume (A5):\phantomsection\label{assumpSHECoW}]{The specific heat capacity of water has no spatial variation; that is, it is constant over its entire volume. (RefBy: \hyperref[GD:rocTempSimp]{GD: rocTempSimp}.)}
\item[Newton-Law-Convective-Cooling-Coil-Water (A6):\phantomsection\label{assumpLCCCW}]{Newton's law of convective cooling applies between the heating coil and the water. (RefBy: \hyperref[GD:htFluxWaterFromCoil]{GD: htFluxWaterFromCoil}.)}
\item[Temp-Heating-Coil-Constant-over-Time (A7):\phantomsection\label{assumpTHCCoT}]{The temperature of the heating coil is constant over time. (RefBy: \hyperref[likeChgTCVOD]{LC: Temperature-Coil-Variable-Over-Day} and \hyperref[GD:htFluxWaterFromCoil]{GD: htFluxWaterFromCoil}.)}
\item[Temp-Heating-Coil-Constant-over-Length (A8):\phantomsection\label{assumpTHCCoL}]{The temperature of the heating coil does not vary along its length. (RefBy: \hyperref[likeChgTCVOL]{LC: Temperature-Coil-Variable-Over-Length}.)}
\item[Charging-Tank-No-Temp-Discharge (A9):\phantomsection\label{assumpCTNTD}]{The model only accounts for charging of the tank, not discharging. The temperature of the water can only increase, or remain constant; it cannot decrease. This implies that the initial temperature is less than (or equal to) the temperature of the heating coil. (RefBy: \hyperref[likeChgDT]{LC: Discharging-Tank}.)}
\item[Water-Always-Liquid (A10):\phantomsection\label{assumpWAL}]{The operating temperature range of the system is such that the material (water in this case) is always in liquid state. That is, the temperature will not drop below the melting point temperature of water, or rise above its boiling point temperature. (RefBy: \hyperref[unlikeChgWFS]{UC: Water-Fixed-States}, \hyperref[TM:sensHtE]{TM: sensHtE}, \hyperref[IM:heatEInWtr]{IM: heatEInWtr}, and \hyperref[IM:eBalanceOnWtr]{IM: eBalanceOnWtr}.)}
\item[Perfect-Insulation-Tank (A11):\phantomsection\label{assumpPIT}]{The tank is perfectly insulated so that there is no heat loss from the tank. (RefBy: \hyperref[likeChgTLH]{LC: Tank-Lose-Heat} and \hyperref[IM:eBalanceOnWtr]{IM: eBalanceOnWtr}.)}
\item[No-Internal-Heat-Generation-By-Water (A12):\phantomsection\label{assumpNIHGBW}]{No internal heat is generated by the water; therefore, the volumetric heat generation per unit volume is zero. (RefBy: \hyperref[unlikeChgNIHG]{UC: No-Internal-Heat-Generation} and \hyperref[IM:eBalanceOnWtr]{IM: eBalanceOnWtr}.)}
\item[Atmospheric-Pressure-Tank (A13):\phantomsection\label{assumpAPT}]{The pressure in the tank is atmospheric, so the melting point temperature and boiling point temperature of water are 0${}^{\circ}$C and 100${}^{\circ}$C, respectively (RefBy: \hyperref[IM:heatEInWtr]{IM: heatEInWtr}.)}
\end{itemize}
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{TM:nwtnCooling} (TM3)
\phantomsection 
...
Notes & ${τ_{\text{W}}}$ is calculated from \hyperref[DD:balanceDecayRate]{DD: balanceDecayRate}.
        ...
        The above equation applies as long as the water is in liquid form, $0\lt{}{T_{\text{W}}}\lt{}100$ (${}^{\circ}$C) where $0$ (${}^{\circ}$C) and $100$ (${}^{\circ}$C) are the melting and boiling point temperatures of water, respectively (\hyperref[assumpWAL]{A: Water-Always-Liquid}).
...
\begin{minipage}{\textwidth}
\begin{tabular}{>{\raggedright}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.82\textwidth}}
\toprule \textbf{Refname} & \textbf{IM:heatEInWtr} (IM2)
\phantomsection 
\label{IM:heatEInWtr}
\\ \midrule \\
...
\\
${T_{\text{init}}}$ & $0\lt{}{T_{\text{init}}}\lt{}100$ & -- & $40.0$ ${}^{\circ}$C & 10$\%$
\\
...
\item[Find-Mass (FR2):\phantomsection\label{findMass}]{Use the inputs in \hyperref[inputInitQuants]{FR: Input-Initial-Quantities} to find the mass needed for \hyperref[IM:eBalanceOnWtr]{IM: eBalanceOnWtr}, using ${m_{\text{W}}}={V_{\text{W}}} {ρ_{\text{W}}}=π \left(\frac{D}{2}\right)^{2} L {ρ_{\text{W}}}$, where ${V_{\text{W}}}$ is the volume of water.}
...
\item[Calculate-Change-Heat\_Energy-Water-Over-Time (FR6):\phantomsection\label{calcChgHeatEnergyWtrOverTime}]{Calculate and output the change in heat energy in the water (${E_{\text{W}}}$($t$)) over the simulation time (from \hyperref[IM:heatEInWtr]{IM: heatEInWtr}).}
\end{itemize}
\begin{longtabu}{l X[l] l}
\toprule
\textbf{Symbol} & \textbf{Description} & \textbf{Units}
...
\begin{itemize}
\item[Temperature-Coil-Variable-Over-Day (LC1):\phantomsection\label{likeChgTCVOD}]{\hyperref[assumpTHCCoT]{A: Temp-Heating-Coil-Constant-over-Time} - The temperature of the heating coil will change over the course of the day, depending on the energy received from the sun.}
\item[Temperature-Coil-Variable-Over-Length (LC2):\phantomsection\label{likeChgTCVOL}]{\hyperref[assumpTHCCoL]{A: Temp-Heating-Coil-Constant-over-Length} - The temperature of the heating coil will actually change along its length as the water within it cools.}
\item[Discharging-Tank (LC3):\phantomsection\label{likeChgDT}]{\hyperref[assumpCTNTD]{A: Charging-Tank-No-Temp-Discharge} - The model currently only accounts for charging of the tank. That is, increasing the temperature of the water to match the temperature of the coil. A more complete model would also account for discharging of the tank.}
\item[Tank-Lose-Heat (LC4):\phantomsection\label{likeChgTLH}]{\hyperref[assumpPIT]{A: Perfect-Insulation-Tank} - Any real tank cannot be perfectly insulated and will lose heat.}
\end{itemize}
...
\begin{itemize}
\item[Water-Fixed-States (UC1):\phantomsection\label{unlikeChgWFS}]{\hyperref[assumpWAL]{A: Water-Always-Liquid} - It is unlikely for the change of water from liquid to a solid, or from liquid to gas to be considered.}
\item[No-Internal-Heat-Generation (UC2):\phantomsection\label{unlikeChgNIHG}]{\hyperref[assumpNIHGBW]{A: No-Internal-Heat-Generation-By-Water} - Is used for the derivations of \hyperref[IM:eBalanceOnWtr]{IM: eBalanceOnWtr}.}
\end{itemize}
...
\toprule
\textbf{} & \textbf{\hyperref[assumpTEO]{A1}} & \textbf{\hyperref[assumpHTCC]{A2}} & \textbf{\hyperref[assumpCWTAT]{A3}} & \textbf{\hyperref[assumpDWCoW]{A4}} & \textbf{\hyperref[assumpSHECoW]{A5}} & \textbf{\hyperref[assumpLCCCW]{A6}} & \textbf{\hyperref[assumpTHCCoT]{A7}} & \textbf{\hyperref[assumpTHCCoL]{A8}} & \textbf{\hyperref[assumpCTNTD]{A9}} & \textbf{\hyperref[assumpWAL]{A10}} & \textbf{\hyperref[assumpPIT]{A11}} & \textbf{\hyperref[assumpNIHGBW]{A12}} & \textbf{\hyperref[assumpAPT]{A13}}
\\
\midrule
\endhead
...
\\
\hyperref[TM:nwtnCooling]{TM3} &  & X &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[GD:rocTempSimp]{GD1} &  &  & X & X & X &  &  &  &  &  &  &  & 
\\
\hyperref[GD:htFluxWaterFromCoil]{GD2} &  &  &  &  &  & X & X &  &  &  &  &  & 
\\
\hyperref[IM:eBalanceOnWtr]{IM1} &  &  &  &  &  &  &  &  &  & X & X & X & 
\\
\hyperref[IM:heatEInWtr]{IM2} &  &  &  &  &  &  &  &  &  & X &  &  & X
\\
\hyperref[inputInitQuants]{FR1} &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[findMass]{FR2} &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
...
\\
\hyperref[calcChgHeatEnergyWtrOverTime]{FR6} &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
...
\\
\hyperref[likeChgTCVOD]{LC1} &  &  &  &  &  &  & X &  &  &  &  &  & 
\\
\hyperref[likeChgTCVOL]{LC2} &  &  &  &  &  &  &  & X &  &  &  &  & 
\\
\hyperref[likeChgDT]{LC3} &  &  &  &  &  &  &  &  & X &  &  &  & 
\\
\hyperref[likeChgTLH]{LC4} &  &  &  &  &  &  &  &  &  &  & X &  & 
\\
\hyperref[unlikeChgWFS]{UC1} &  &  &  &  &  &  &  &  &  & X &  &  & 
\\
...
\toprule
\textbf{} & \textbf{\hyperref[DD:balanceDecayRate]{DD1}} & \textbf{\hyperref[TM:consThermE]{TM1}} & \textbf{\hyperref[TM:sensHtE]{TM2}} & \textbf{\hyperref[TM:nwtnCooling]{TM3}} & \textbf{\hyperref[GD:rocTempSimp]{GD1}} & \textbf{\hyperref[GD:htFluxWaterFromCoil]{GD2}} & \textbf{\hyperref[IM:eBalanceOnWtr]{IM1}} & \textbf{\hyperref[IM:heatEInWtr]{IM2}}
\\
\midrule
\endhead
\hyperref[DD:balanceDecayRate]{DD1} &  &  &  &  &  &  &  & 
...
\toprule
\textbf{} & \textbf{\hyperref[DD:balanceDecayRate]{DD1}} & \textbf{\hyperref[TM:consThermE]{TM1}} & \textbf{\hyperref[TM:sensHtE]{TM2}} & \textbf{\hyperref[TM:nwtnCooling]{TM3}} & \textbf{\hyperref[GD:rocTempSimp]{GD1}} & \textbf{\hyperref[GD:htFluxWaterFromCoil]{GD2}} & \textbf{\hyperref[IM:eBalanceOnWtr]{IM1}} & \textbf{\hyperref[IM:heatEInWtr]{IM2}} & \textbf{\hyperref[inputInitQuants]{FR1}} & \textbf{\hyperref[findMass]{FR2}} & \textbf{\hyperref[checkWithPhysConsts]{FR3}} & \textbf{\hyperref[outputInputDerivQuants]{FR4}} & \textbf{\hyperref[calcTempWtrOverTime]{FR5}} & \textbf{\hyperref[calcChgHeatEnergyWtrOverTime]{FR6}} & \textbf{\hyperref[correct]{NFR1}} & \textbf{\hyperref[verifiable]{NFR2}} & \textbf{\hyperref[understandable]{NFR3}} & \textbf{\hyperref[reusable]{NFR4}} & \textbf{\hyperref[maintainable]{NFR5}}
\\
\midrule
\endhead
\hyperref[waterTempGS]{GS1} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[waterEnergyGS]{GS2} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[inputInitQuants]{FR1} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[findMass]{FR2} &  &  &  &  &  &  & X &  & X &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[checkWithPhysConsts]{FR3} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[outputInputDerivQuants]{FR4} & X &  &  &  &  &  &  &  & X & X &  &  &  &  &  &  &  &  & 
\\
\hyperref[calcTempWtrOverTime]{FR5} &  &  &  &  &  &  & X &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[calcChgHeatEnergyWtrOverTime]{FR6} &  &  &  &  &  &  &  & X &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[correct]{NFR1} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[verifiable]{NFR2} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 
