...
\\
$σ$ & Total Stress: The total force per area acting on the soil mass. & ${\text{Pa}}$
\\
...
\\
$τ$ & Shear Strength: The strength of a material against shear failure. & ${\text{Pa}}$
\\
...
\\ \midrule \\
Description & \begin{symbDescription}
              \item{$τ$ is the shear strength (${\text{Pa}}$)}
...
Description & \begin{symbDescription}
              ...
              \item{$σ$ is the total stress (${\text{Pa}}$)}
