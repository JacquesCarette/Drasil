...
\begin{itemize}
\item Automated generation of some Drasil user-documentation using Haddock
\item Created new chunk and referencing databases %improved referencing
\item Added to, and refactored, the Drasil class hierarchy
% Citations, Theories, Labels, etc.
\item Finished creating Document Language (Continued on next slides)
\item Implemented Continuous Integration with automated tests
