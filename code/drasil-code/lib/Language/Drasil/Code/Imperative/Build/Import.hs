...
instance RuleTransformer CodeHarness where
  makeRule (Ch b r s m d) = maybe [mkRule ["Generated by Drasil " ++ 
    version drasilMeta,"Project Name: " ++ progName m, progPurpAdd m]  
    buildTarget [] []]
    ...
    in [
    mkRule ["Generated by Drasil " ++ version drasilMeta, "Project Name: " ++ 
    progName m, progPurpAdd m] buildTarget [outnm] [],
